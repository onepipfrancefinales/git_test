...
<table width="1740" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="41" height="16"><div id="coin4pts" > 
        <?php	echo $A3234; ?>
      </div></td>
  ...
  <tr> 
    ...
    <td width="41" height="11"><div id="coin4pts" > 
        <?php	echo $A3236; ?>
      </div></td>
  ...
  <tr> 
    ...
    <td width="41" height="25"><div id="coin4pts" > 
        <?php	echo $A3238; ?>
      </div></td>
  ...
  <tr> 
    ...
    <td width="201" align="left">&nbsp;</td>
    <td width="23"> 
      <div id="Layer11" style="position:absolute; width:306px; height:33px; z-index:7; left: 1413px; top: 691px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
