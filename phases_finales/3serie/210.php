...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="235" align="left" height="13">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="48" height="13">&nbsp;</td>
    <td width="25" height="13">&nbsp;</td>
    <td width="235" height="13"> 
      <div id="coin5" >Quarts de finale</div>
    </td>
    <td width="36" height="13">&nbsp;</td>
    <td width="21" height="13">&nbsp;</td>
    <td width="235" align="left" height="13"> 
  ...
  <tr> 
    ...
    <td width="235" align="left" height="12">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="235" height="16">&nbsp;</td>
    <td width="36" height="16">&nbsp;</td>
    <td width="21" height="16">&nbsp;</td>
    <td width="235" height="16" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="231" height="9"> </td>
    <td width="48" height="9"> </td>
    <td width="235" height="9"> 
      <div id="coin4" > 
        <?php	echo $clubA4001; ?>
      </div>
    </td>
    ...
    <td width="235" align="left" height="9">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="235" height="11">&nbsp;</td>
    <td width="36" height="11">&nbsp;</td>
    <td width="235" height="11" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td rowspan="18" width="13"><img src="../../images/accolade.png" width="10" height="383"></td>
    <td width="231">&nbsp;</td>
    <td width="24">&nbsp;</td>
    <td width="35">&nbsp;</td>
  </tr>
  ...
  <tr> 
    ...
    <td width="235" height="25" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="235" align="left" height="20">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="235" align="left" height="17">&nbsp; </td>
  ...
  <tr> 
    ...
    <td width="235" align="left" height="23"> 
      <div id="coin4" > 
        <?php	echo $clubA2004; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td width="235" height="10" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="231" valign="bottom" height="5"> 
      <div id="coin4" > 
        <?php	echo $clubA8015; ?>
      </div>
    </td>
    <td width="48" valign="bottom" height="5"> 
      <div id="coin4" > 
        <?php	echo $A8015; ?>
      </div>
    </td>
    ...
    <td width="235" align="left" height="5">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="34" height="14" valign="top"> 
      <div id="coin5" > 
        <?php	echo $A1631; ?>
      </div>
    </td>
    ...
    <td width="235" height="14">&nbsp;</td>
    <td width="36" height="14">&nbsp;</td>
    <td width="21" height="14">&nbsp;</td>
    <td width="235" height="14" align="left">&nbsp;</td>
  ...
  <tr> 
    <td width="231" height="2" valign="top"> 
      <div id="coin5" > 
        <?php	echo $clubA1632; ?>
      </div>
    </td>
    ...
    <td width="235" height="2">&nbsp;</td>
    <td width="36" height="2">&nbsp;</td>
    <td width="21" height="2">&nbsp;</td>
    <td width="235" align="left" height="2">&nbsp;</td>
