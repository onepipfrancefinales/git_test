...
$clubA1601= ' Deux Ponts (AP)';
$clubA1602= ' Nancy Seichamps (AL)';
$clubA1603= ' Maubourguet (AB)';
$clubA1604= ' Brioude (AU)';


$clubA1605= '  Nord Bearn (BE)';
$clubA1606= '  (BG)';
$clubA1607= '  (BR)';
$clubA1608='  Joue les Tours (CE)';



$clubA1609= '  Souston (CBL)';
$clubA1610= '  Bayonne (CBL)';
$clubA1611= '  Blaye (CA)';
$clubA1612= '  Floirac (CA)';
...
$clubA1619= ' Mantes Limay (IDF)';
$clubA1620= '  (LD)';


$clubA1621= ' Naves(LM)';
$clubA1622= ' Saint Jean de Bournay(LY)';
$clubA1623= ' Arcol (LY)';
$clubA1624= ' Saint Affrique (MPY)';



$clubA1625= ' Saint Gaudens (MPY)';
$clubA1626= ' Sor Agout (MPY)';
$clubA1627= ' Havre AC (N)';
$clubA1628= '  (PL)';
...
<div id="Layer4" style="position:absolute; width:826px; height:538px; z-index:6; left: 302px; top: 263px; background-color: #FFFFFF; layer-background-color: #FFFFFF; border: 1px none #000000"> 
  <table width="109%" border="1">
    ...
    <tr> 
      ...
      <td height="36" rowspan="17" bgcolor="#003399" width="5%">&nbsp;</td>
      <td height="83" width="20%"> 
        <div align="center"><b>COMITES</b></div>
      </td>
    ...
    <tr> 
      <td height="24" width="15%">Alpes</td>
      ...
      <td width="18%" height="24" bgcolor="#FFFFFF"> 
        <div align="center"><b><font color="#000000"><font size="4"></font></font></b> 
        </div>
      </td>
    </tr>
    <tr> 
      <td width="15%" bgcolor="#999999" height="21">Alsace</td>
      ...
      <td width="20%" bgcolor="#999999" height="21">Flandres</td>
      <td width="17%" height="21" bgcolor="#999999"> 
        <div align="center">1</div>
      </td>
      <td width="18%" bgcolor="#999999" height="21">&nbsp;</td>
    </tr>
    <tr> 
      <td width="15%">Armagnac Bigorre</td>
      <td width="15%"> 
        <div align="center">1</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#FFFFFF">Ile de France</td>
    ...
    <tr bgcolor="#999999"> 
      <td width="15%">Auvergne</td>
      <td width="15%"> 
        <div align="center">1</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#999999">Languedoc</td>
      <td width="17%"> 
        <div align="center">1</div>
      </td>
      <td width="18%">&nbsp;</td>
    ...
    <tr> 
      <td width="15%">Bearn</td>
      <td width="15%"> 
        <div align="center">1</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#FFFFFF">Limousin</td>
      <td width="17%" bgcolor="#FFFFFF"> 
        <div align="center">1</div>
      </td>
      <td width="18%" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr bgcolor="#999999"> 
      <td width="15%">Bourgogne</td>
      <td width="15%"> 
        <div align="center">2</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#999999">Lyonnais</td>
      <td width="17%"> 
        <div align="center">2</div>
      </td>
      <td width="18%">&nbsp;</td>
    ...
    <tr bgcolor="#999999"> 
      <td width="15%">Centre</td>
      <td width="15%"> 
        <div align="center">1</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#999999">Normandie</td>
    ...
    <tr> 
      <td width="15%">Cote D&#146;Argent</td>
      <td width="15%"> 
        <div align="center">2</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#FFFFFF">Pays Catalan</td>
      <td width="17%" bgcolor="#FFFFFF"> 
        <div align="center">1</div>
      </td>
      <td width="18%" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr bgcolor="#999999"> 
      <td width="15%">Cote D&#146;Azur </td>
      <td width="15%"> 
        <div align="center">avec Provence</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%">Pays de Loire</td>
      <td width="17%"> 
        <div align="center">1</div>
      </td>
      <td width="18%">&nbsp;</td>
    ...
    <tr> 
      <td width="15%">Corse </td>
      <td width="15%"> 
        <div align="center">avec Provence</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%" bgcolor="#FFFFFF">Poitou Charente</td>
      <td width="17%" bgcolor="#FFFFFF"> 
        <div align="center">1</div>
      </td>
      <td width="18%" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr bgcolor="#999999"> 
      <td width="15%">Cote Basque Landes</td>
      <td width="15%"> 
        <div align="center">2</div>
      </td>
      <td width="10%">&nbsp;</td>
      <td width="20%">Perigord Agenais</td>
      <td width="17%"> 
        <div align="center">1</div>
      </td>
      <td width="18%">&nbsp;</td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="15%" height="24">Drome Ardeche</td>
      ...
      <td width="20%"><font color="#000000">Provence</font></td>
      <td width="17%"> 
        <div align="center"><font color="#000000">2</font></div>
      </td>
      <td width="18%"> 
        <div align="center"><b><font color="#FFFFFF"><font color="#000000"><font size="4"></font></font></font> 
          </b></div>
      </td>
    </tr>
    <tr bgcolor="#999999"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="18%"><b><font color="#000000"></font> </b></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="15%">&nbsp;</td>
      <td width="15%">&nbsp;</td>
