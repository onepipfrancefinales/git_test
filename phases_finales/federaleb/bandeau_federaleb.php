...
<table width="100%" border="0" height="90">
  <tr valign="top" align="center"> 
    <td colspan="16" bgcolor="006699" height="36"><font size="5" color="#FFCC00"><b> 
      ...
      <?php echo $annee;?>
      : 
      <?php echo "F&eacute;d&eacute;rale B";?>
      </b></font></td>
  </tr>
  <tr valign="top" align="center"> 
    ...
    <td bgcolor="#EAECEB" height="28" valign="middle" align="center" width="26%"> 
      <a href="/phases_finales/federaleb/pagefederaleb.php?variable_1=<?php echo $anneemoins;?>" target="_top"><font size="6" color="#FF0000"><b>&lt;&lt;</b></font></a> 
      <font size="5" color="#EAECEB">nnnnne</font> 
      <?php if ($variable_1 < 2018 or $annee < 2018)	
		{
		?>
      <a href="/phases_finales/federaleb/pagefederaleb.php?variable_1=<?php echo $anneeplus;?>" target="_top"><font color="#FF0000" size="6"><b>&gt;&gt;</b></font></a> 
    </td>
    ...
    <?php
	  	...
	  	{
		?>
    <a href="/phases_finales2019/affichagePhasesFinales/pagePhaseFinale.php?annee=<?php echo $anneeplus;?>&division=250" target="_top"><font color="#FF0000" size="6"><b>&gt;&gt;</b></font></a> 
    <td bgcolor="#EAECEB" height="28" valign="middle" align="center" width="25%"> 
