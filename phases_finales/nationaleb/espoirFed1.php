...
<?php require ("../fonctionsPhasesFinales.php");
...
$clubA4001="Albi (MPY)";
$clubA4002="Chambery (AP)";
$clubA4003="Limoges (LM)";
$clubA4004="Provence Rugby (PR)";
$clubA4005="Roval Drôme XV (DA)";
$clubA4006="Bagnères de Bigorre (AB)";
$clubA4007="Stadoceste Tarbes (AB)";
$clubA4008="Rouen (N)";
?>
<body bgcolor="#EAECEB">
<table width="1200" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="28">&nbsp;</td>
    <td width="28">&nbsp;</td>
    <td width="222" align="left"> <div id="coin5" >Finale</div></td>
    <td width="35">&nbsp;</td>
    <td width="17">&nbsp;</td>
    <td width="222">&nbsp;</td>
    <td width="32">&nbsp;</td>
