...
$clubA3201= ' Charleville Mezieres (FL) ';
$clubA3202= ' Cote de Nacre (N)';

$clubA3203= ' US Berrichonne (CE)';
$clubA3204= ' Nanterre (IDF)  ';

$clubA3205= ' Saint Omer (FL)';
$clubA3206= ' Saint Dizier (IDF)';

$clubA3207= ' Laval (PL)';
$clubA3208= ' Coutances (N)  ';

$clubA3209= ' Lisieux (N) ';
$clubA3210= ' Saint Renan (BR)';

$clubA3211= ' Chapelle sur Erdre (PL)';
$clubA3212= ' Argenteuil (IDF)';

$clubA3213= ' Matignon (BR)';
$clubA3214= ' Sully sur Loire (CE)';

$clubA3215= ' Cherves (PCH)';
$clubA3216= ' Limoges EC (LM) ';

$clubA3217= ' Bain de Bretagne (BR)';
$clubA3218= ' Neuil l Espoir(PCH)';

$clubA3219= ' Lubersac (LM) ';
$clubA3220= ' Coutras (CA)';

$clubA3221= ' Seurre (BG)';
$clubA3222= ' Chamalieres (LM)';

$clubA3223= ' ASCP Mulhouse (AL)';
$clubA3224= ' Culin (LY) ';

$clubA3225= ' Neuilly sur Marne (IDF)';
$clubA3226= ' Bailleul (FL)';

$clubA3227= ' Selestat (AL)';
$clubA3228= ' Saint Martin du Lac (BG) ';

$clubA3229= ' Bagnolet (IDF)';
$clubA3230= ' Louhans (BG)';

$clubA3231= ' Blanzat (AU)';
$clubA3232= ' Saint Fons (LY) ';

$clubA3233= ' Trevoux (LY-)';
$clubA3234= ' Voreppe (AP-)';

$clubA3235= ' Thiers (AU)';
$clubA3236= ' Miramas (PR) ';

$clubA3237= ' Lucciana (C)';
$clubA3238= ' Noves Saint Remy (PR)';

$clubA3239= ' Trebes (LD)';
$clubA3240= ' Bompas (PC)';

$clubA3241= ' Crest (DA)';
$clubA3242= ' Pont en Royans (AP) ';

$clubA3243= ' Tournay (AB) ';
$clubA3244= ' Aussonne (MPY) ';

$clubA3245= ' Villelongue de la Salanque (PC)';
$clubA3246= ' Haut Languedoc (LD)';

$clubA3247= ' Monein (BE) ';
$clubA3248= ' Toulouce AC (MPY) ';

$clubA3249= ' Orange (PR)';
$clubA3250= ' Vinassan (LD)';

$clubA3251= ' Ciboure (CBL) ';
$clubA3252= ' Labastide Beauvoir (MPY) ';

$clubA3253= ' Port Sainte Marie (PA) ';
$clubA3254= ' Buzy Ogeu (BE) ';

$clubA3255= ' Meyssac (LM) ';
$clubA3256= ' Viviez (MPY) ';

$clubA3257= ' Biganos (CA)';
$clubA3258= ' Lesperon Onesse (CBL)'; 

$clubA3259= ' Launaguet (MPY) ';
$clubA3260= ' Perigueux uest (PA) ';

$clubA3261= ' Oursbellile Borderes (AB) ';
$clubA3262= ' Caudecoste (PA)';

$clubA3263= ' Izon (CA) ';
$clubA3264= ' Montech (MPY) ';
...
<div id="Layer5" style="position:absolute; width:350px; height:20px; z-index:7; left: 20px; top: 760px; background-image: url(../unique32.jpg); layer-background-image: url(../unique32.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer7" style="position:absolute; width:55px; height:20px; z-index:8; background-image: url(../resultdouble.jpg); layer-background-image: url(../resultdouble.jpg); border: 1px none #000000; left: 350px; top: 0px"><b><font color="#FFFFFF" face="Arial, Helvetica, sans-serif" size="3">00- 
      10</font></b></div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 280px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 202px; top: 1px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>15</b></font> 
    </div>
