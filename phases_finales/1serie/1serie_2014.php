...
$clubA3202= ' Saint Die (AL) ';

$clubA3203= ' Seurre (BG)';
$clubA3204= ' Neuilly sur Marne (IDF) ';

$clubA3205= ' AS Cheminots (AL) ';
$clubA3206= ' Chablis (BG) ';

$clubA3207= ' Blanzat (AU) ';
$clubA3208= ' Le Mole (AP)';

$clubA3209= ' La Motte Servolex (AP) ';
$clubA3210= ' Buxy (BG) ';

$clubA3211= ' Conflans Herblay (IDF) ';
$clubA3212= ' Dammarie (CE)';

$clubA3213= ' Paray le Monial (BG) ';
$clubA3214= ' Cours la Ville (LY)';

$clubA3215= ' Saint Quentin (FL)';
$clubA3216= ' Livry Gargan (IDF) ';

$clubA3217= ' Bresle Eu (N)';
$clubA3218= ' Iris Lille (FL) ';

$clubA3219= ' Chalon sur Marne (IDF) ';
$clubA3220= ' Pontlieue (PL)';

$clubA3221= ' Lisieux (N) ';
$clubA3222= ' Creteil (IDF)';

$clubA3223= ' Montbron (PCH)';
$clubA3224= ' Bruz (BR)';

$clubA3225= ' Fougeres (BR)';
$clubA3226= ' Coutances (N) ';

$clubA3227= ' Laval (PL)';
$clubA3228= ' La Rochefoucauld (PCH)';

$clubA3229= ' Ovale de Loire (CE) ';
$clubA3230= ' Redon (BR) ';

$clubA3231= ' Romagnat (AU) ';
$clubA3232= ' Port Ste Marie (PA)';

$clubA3233= ' Le Palais sur Vienne (LM)';
$clubA3234= ' Foix (MPY) ';

$clubA3235= ' Ychoux (CA) ';
$clubA3236= ' Montfort en Chalosse (CBL)';

$clubA3237= ' Verdun sur Garonne (MPY) ';
$clubA3238= ' Duras (PA) ';

$clubA3239= ' Tournay (AB) ';
$clubA3240= ' Beaulieu sur Dordogne (LM)';

$clubA3241= ' Martignas sur Jalle (CA)';
$clubA3242= ' Rabastens (MPY) ';

$clubA3243= ' Ondres (CBL)';
$clubA3244= ' Daglan (PA)';

$clubA3245= ' Oursbellile Borderes (AB) ';
$clubA3246= ' Toulouse EC (MPY)';

$clubA3247= ' Prigonrieux (PA) ';
$clubA3248= ' Folles (LM) ';

$clubA3249= ' Pontacq (BE)';
$clubA3250= ' St Martin de Seignanx (CBL)';

$clubA3251= 'Cruzy Saint Chinan (LD)';
$clubA3252= ' Saint Gilles (PR)';

$clubA3253= ' Launaguet (MPY) ';
$clubA3254= ' Montreal Malepere (LD) ';

$clubA3255= ' Bourg Saint Andeol (DA)';
$clubA3256= ' Feurs (LY)';

$clubA3257= ' Lezat sur Leze (MPY) ';
$clubA3258= ' Saint Cyprien la Tour (PC) '; 

$clubA3259= ' Noves (PR) ';
$clubA3260= ' Semeac (AB)';

$clubA3261= ' Firminy (LY)';
$clubA3262= ' Vinassan (LD)';

$clubA3263= ' Garde Pradet (CAZ) ';
$clubA3264= ' Chatre Neron (AP)';
...
<div id="Layer5" style="position:absolute; width:350px; height:20px; z-index:7; left: 20px; top: 760px; background-image: url(../unique32.jpg); layer-background-image: url(../unique32.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer7" style="position:absolute; width:55px; height:20px; z-index:8; background-image: url(../resultdouble.jpg); layer-background-image: url(../resultdouble.jpg); border: 1px none #000000; left: 350px; top: 0px"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>06 
      - 32</b></font> </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 280px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 202px; top: 1px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>16</b></font> 
    </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 320px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 1px; background-image:  url(../result22.jpg); layer-background-image:  url(../result22.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>61</b></font> 
    </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 520px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result22.jpg); layer-background-image:  url(../result22.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>53</b></font> 
    </div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3232;
  ?>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 680px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 1px; background-image:  url(../result22.jpg); layer-background-image:  url(../result22.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>27</b></font></div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 800px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 1px; background-image:  url(../result22.jpg); layer-background-image:  url(../result22.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>23</b></font></div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 980px; top: 300px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>14</b></font></div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3209;
  ?>
      </b></font> </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 980px; top: 460px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>46</b></font> 
    </div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3232;
  ?>
...
<div id="Layer11" style="position:absolute; width:306px; height:33px; z-index:7; left: 1494px; top: 688px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
  <div align="center"> <b><font color="#FF0000" size="5" face="Geneva, Arial, Helvetica, san-serif">Oursbellile 
    Borderes (AB)</font></b> </div>
</div>
