...
if ($annee=2006)
{
$clubA3201= ' Marcoussis (IDF) ';
$clubA3202= ' St Hilaire de Riez (PL) ';
$clubA3203= ' Cherbourg (N) ';
$clubA3204= ' ASPTT Lannion (BR) ';
$clubA3205= ' Laon(FL) ';
$clubA3206= ' Montreuil (IDF) ';
$clubA3207= ' Concarneau (BR) ';
$clubA3208= ' Clisson (PL) ';
$clubA3209= ' Vouvrillon (CE) ';
$clubA3210= ' Limoges EC (LM) ';
$clubA3211= ' La Rochefoucauld (PCH) ';
$clubA3212= ' Vielmur (MPY) ';
$clubA3213= ' Issigeac (PA) ';
$clubA3214= ' Castillon (CA) ';
$clubA3215= ' SA Litois (CBL) ';
$clubA3216= ' Ossun Laruns (BE) ';

$clubA3217= ' Chatellerault (PCH) ';
$clubA3218= ' RC Villenavais (CA) ';
$clubA3219= ' Egleton (LM) ';
$clubA3220= ' Prat Bonrepaux (MPY) ';
$clubA3221= ' St Martin de Seignanx (CBL) ';
$clubA3222= ' Sanguinet (CA) ';
$clubA3223= ' Baronnies (AB) ';
$clubA3224= ' Trelissac (PA) ';
$clubA3225= ' Laissac(MPY) ';
$clubA3226= ' Layrac (PA) ';
$clubA3227= ' La Fosseille (R) ';
$clubA3228= ' Saint Lary Soulan (AB) ';
$clubA3229= ' Miramas (PR) ';
$clubA3230= ' Leucate (LD) ';
$clubA3231= ' Nespouls (LM) ';
$clubA3232= ' Saint Jean du Falga (MPY) ';

$clubA3233= ' Saint Andree (LD) ';
$clubA3234= ' Briatexte (MPY) ';
$clubA3235= ' Royans Sport (AP) ';
$clubA3236= ' Salindre (PR) ';
$clubA3237= ' Colayrac (PA) ';
$clubA3238= ' Montech (MPY) ';
$clubA3239= ' Bages (R) ';
$clubA3240= ' Hyeres (CAZ) ';
$clubA3241= ' Serignan (LD) ';
$clubA3242= ' Guilherand Granges (DA) ';
$clubA3243= ' Cotes d Arey (LY) ';
$clubA3244= ' Chateaugay (AU) ';
$clubA3245= ' Thonon Chablais (AP) ';
$clubA3246= ' Menoues (CAZ) ';
$clubA3247= ' Cours la Ville  (CAZ) ';
$clubA3248= ' Toucy (FC) ';

$clubA3249= ' Forbach (AL) ';
$clubA3250= ' Bonneuil (IDF) ';
$clubA3251= ' Trevoux Chatillon (LY) ';
$clubA3252= ' AS Granoise (DA) ';
$clubA3253= ' Saint Bonnet pres Riom (AU) ';
$clubA3254= ' Salon la Tour (LM) ';
$clubA3255= ' Saint Berain sur Dheune (BG) ';
$clubA3256= ' Clermont (IDF) ';
$clubA3257= ' Clermont la Plaine (AU) ';
$clubA3258= ' Nemours la Pierre (IDF)';
$clubA3259= ' Grenoble UC(AP) ';
$clubA3260= ' Montbard Chatillon (BG) ';
$clubA3261= ' Sully (CE) ';
$clubA3262= ' Neuilly sur Seine (IDF) ';
$clubA3263= ' Ovale Gy (FL) ';
$clubA3264= ' Bernay (N) ';
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 560px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  <div align="center"> 
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 1px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"> 
      <div align="center"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>68 
        </b></font></div>
    </div>
    <font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b> 
    </b></font></div>
...
<div id="Layer11" style="position:absolute; width:306px; height:33px; z-index:7; left: 1494px; top: 688px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
  <div align="center"> <b><font size="5" color="#FF0000" face="Arial, Helvetica, sans-serif">SA 
    Litois</font></b></div>
</div>
