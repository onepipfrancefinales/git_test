...
if ($annee=2011)
{
$clubA3201= ' Montesson (IDF) ';
$clubA3202= ' Nantes ASPTT (PL) ';
$clubA3203= ' Alencon (N)';
$clubA3204= ' Vieux Marche (BR)';
$clubA3205= ' Le Touquet (FL)';
$clubA3206= ' Paris 1er (IDF)';
$clubA3207= ' Ancenis (PL)';
$clubA3208= ' Vitre (BR)';
$clubA3209= ' Romorantin (CE) ';
$clubA3210= ' Beaulieu(LM) ';
$clubA3211= ' Re (PCH) ';
$clubA3212= ' Seilh Fenouillet (MPY)';
$clubA3213= ' Montignac (PA)';
$clubA3214= ' Ychoux (CA)';
$clubA3215= ' Sault de Navailles (CBL)';
$clubA3216= ' Laruns(BE)';

$clubA3217= '  Jarnac (PCH)';
$clubA3218= '  Villenave d Ornon(CA)';
$clubA3219= ' Lagrauliere (LM) ';
$clubA3220= ' Lacaune (MPY)';
$clubA3221= ' Leognan (CA)';
$clubA3222= ' Salies du Bearn (CBL) ';
$clubA3223= ' Condom (AB)';
$clubA3224= ' Luynes (CE)';
$clubA3225= ' Montredon (MPY)';
$clubA3226= ' Penne St Sylvestre (PA)';
$clubA3227= ' Tournay (AB)';
$clubA3228= ' Ouveillan Cuxac (LD)';
$clubA3229= ' Beziers Riquet  (LD) ';
$clubA3230= ' Pernes les Fontaines (PR) ';
$clubA3231= ' L Isle sur Tarn (MPY)';
$clubA3232= ' Meymac (LM)';


$clubA3233= ' Poussan (LD)';
$clubA3234= ' Le Mas d Azil (MPY) ';
$clubA3235= ' Saint Remy(PR) ';
$clubA3236= ' le Mole (AP)';
$clubA3237= ' Briatexte (MPY) ';
$clubA3238= ' Mezin (PA) ';
$clubA3239= ' Prats de Molo (R)  ';
$clubA3240= ' Severac le Chateau (MPY)';
$clubA3241= ' Bourg Saint Andeol (DA)';
$clubA3242= ' Morteau (BG) ';
$clubA3243= ' Saint Genes Champanelle (AU)';
$clubA3244= ' Belley (LY)';
$clubA3245= ' Voreppe (AP) ';
$clubA3246= ' Canton Garde Pradet (CAZ)';
$clubA3247= ' Stains (IDF) ';
$clubA3248= ' Soane Seille (BG) ';

$clubA3249= ' Centre Meuse (AL)';
$clubA3250= ' Clermont (IDF) ';
$clubA3251= ' XV Suranais () ';
$clubA3252= ' Malissard (DA)';
$clubA3253= ' Brive Charensac (AU) ';
$clubA3254= ' Neuvic (LM) ';
$clubA3255= ' Plateau 25 (FC)';
$clubA3256= ' Val de Bievre (IDF)';
$clubA3257= ' Combronde (AU) ';
$clubA3258= ' Gif sur Yvette(IDF) '; 
$clubA3259= ' Ordon (BG) ';
$clubA3260= ' Saint Martin d heres (AP)';
$clubA3261= ' Loches  ((CE)';
$clubA3262= ' Coteaux de Seine (IDF)';
$clubA3263= ' Villeneuve d Ascq(FL) ';
$clubA3264= ' Vire (N)'; 
...
<div id="Layer11" style="position:absolute; width:306px; height:33px; z-index:7; left: 1494px; top: 688px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
  <div align="center"> <b><font color="#FF0000" size="5" face="Geneva, Arial, Helvetica, san-serif">Sault 
    de Navailles (CBL)</font></b></div>
</div>
