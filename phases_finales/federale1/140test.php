...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" > <font size="2">25</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="5"> 
      <div id="coin4" ><font size="2"> 0</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2"> 15</font></div>
    </td>
    <td width="204"> 
      <div id="coin4" > 
        <?php	echo $clubA4002; ?>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2"> 19</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="24">&nbsp;</td>
  ...
  <tr> 
    <td width="229" height="11"> 
      <div id="coin5" >La Seyne sur Mer (CAZ)
        <?php	echo $clubA8005; ?>
      </div>
    </td>
    ...
    <td width="32" height="11"> 
      <div id="coin5" ><font size="2"> 15</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
  ...
  <tr> 
    <td width="229"> 
      <div id="coin5" >Valence d'Agen (MPY) 
        <?php	echo $clubA8006; ?>
      </div>
    </td>
    <td width="28"> 
  ...
  <tr> 
    ...
    <td width="32" height="15"> 
      <div id="coin5" ><font size="2"> 20</font></div>
    </td>
  ...
  <tr> 
    ...
    <td rowspan="7" width="26"><img src="../../images/accolade.png" width="8" height="140"></td>
    <td width="180" align="left">&nbsp;</td>
    <td width="27">&nbsp;</td>
    <td width="27">&nbsp;</td>
    <td width="176">&nbsp;</td>
  ...
  <tr> 
    <td width="229" height="20"> 
      <div id="coin4" >Rodez (MPY)</div>
    </td>
    <td width="28" height="20"> 
      <div id="coin4pts" > 4</div>
    </td>
    <td width="32" height="20"> 
      <div id="coin4" ><font size="2"> 17</font></div>
    </td>
    ...
    <td valign="top" width="21" height="20"> 
      <div id="coin4pts" > </div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="11"> 
      <div id="coin4" ><font size="2"> 8</font></div>
    </td>
    <td width="204" height="11">&nbsp;</td>
    <td width="29" height="11">&nbsp;</td>
    <td width="24" height="11">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="28" height="21" bgcolor="#FFCC66">&nbsp;</td>
    <td valign="top" width="36">&nbsp;</td>
    <td valign="top" width="217"> 
      <div id="coin4" ></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="5"> 
      <div id="coin5" ><font size="2"> 26</font></div>
    </td>
    <td width="204" height="5"> 
      <div id="coin4" > 
        <?php	echo $clubA4007; ?>
  ...
  <tr> 
    ...
    <td width="32" height="2"> 
      <div id="coin5" ><font size="2"> 22</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="3"> 
      <div id="coin5" ><font size="2"> 27</font></div>
    </td>
