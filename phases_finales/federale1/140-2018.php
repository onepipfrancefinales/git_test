...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="32" height="5"> 
      <div id="coin4" ><font size="2"> 59</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="22"> 
      <div id="coin4" ><font size="2">32</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2">37</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="23">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32" height="11"> 
      <div id="coin5" ><font size="2">36</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin5" ><font size="2">37</font></div>
    </td>
    <td width="204"> 
      <div id="coin4" > 
        <?php echo $clubA8006; ?>
  ...
  <tr> 
    ...
    <td width="32" height="15"> 
      <div id="coin5" ><font size="2">54</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin5" ><font size="2">56</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="23">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2">47</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2">38</font></div>
    </td>
    <td width="204"> 
      <div id="coin4" > 
        <?php echo $clubA8009; ?>
  ...
  <tr> 
    ...
    <td width="32" height="20"> 
      <div id="coin4" ><font size="2">44</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="11"> 
      <div id="coin4" ><font size="2">39</font></div>
    </td>
    <td width="204" height="11">&nbsp;</td>
    <td width="29" height="11">&nbsp;</td>
    <td width="23" height="11">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32" height="20"> 
      <div id="coin5" ><font size="2">53</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
  ...
  <tr> 
    ...
    <td width="32" height="5"> 
      <div id="coin5" ><font size="2">73</font></div>
    </td>
    <td width="204" height="5"> 
      <div id="coin4" > 
        <?php echo $clubA8014; ?>
  ...
  <tr> 
    ...
    <td width="32" height="2"> 
      <div id="coin5" ><font size="2">58</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="3"> 
      <div id="coin5" ><font size="2">47</font></div>
    </td>
