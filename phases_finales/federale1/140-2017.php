...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="32" height="5"> 
      <div id="coin4" ><font size="2"> 30</font></div>
    </td>
  ...
  <tr> 
    ...
    <td valign="top" colspan="2" height="22" bgcolor="#FFFF00"> 
      <div align="center"><font face="Times New Roman, Times, serif" size="5"><b><font face="Arial, Helvetica, sans-serif" color="#FF0000">Massy 
        (IDF)</font></b></font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2">36</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="24">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32" height="11"> 
      <div id="coin5" ><font size="2">38</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin5" ><font size="2">24</font></div>
    </td>
    <td width="204"> 
      <div id="coin4" > 
        <?php	echo $clubA8007; ?>
  ...
  <tr> 
    ...
    <td width="32" height="15"> 
      <div id="coin5" ><font size="2">30</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin5" ><font size="2">42</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="24">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2">49</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div id="coin4" ><font size="2">33</font></div>
    </td>
    <td width="204"> 
    ...
    <td valign="top" width="36">&nbsp;</td>
    <td valign="top" width="217"> 
      <div id="coin4" >Provence Rugby (PR)</div>
    </td>
    <td valign="bottom" width="27"> 
      <div id="coin4pts" >5</div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="20"> 
      <div id="coin4" ><font size="2">45</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="20"> 
      <div id="coin5" ><font size="2">13</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
  ...
  <tr> 
    ...
    <td width="32" height="2"> 
      <div id="coin5" ><font size="2">55</font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="28" height="3"> 
      <div id="coin5pts" >9</div>
    </td>
    <td width="32" height="3"> 
      <div id="coin5" ><font size="2">98</font></div>
    </td>
  ...
  <tr> 
    ...
    <td height="17" colspan="2" bgcolor="#FFFF00">
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" color="#FF0000" size="4">Nevers 
        (BG)</font></b></div>
    </td>
    <td height="17">&nbsp;</td>
    <td height="17">&nbsp;</td>
