...
<?php	if ($A3233+$A3234>0) if ($A3233>$A3234)	$clubA1617= $clubA3225;	else	$clubA1617= $clubA3234; else $clubA1617=$clubA;?>
<?php	if ($A3235+$A3236>0) if ($A3235>$A3236)	$clubA1618= $clubA3227;	else	$clubA1618= $clubA3236; else $clubA1618=$clubA;?>
<?php	if ($A3237+$A3238>0) if ($A3237>$A3238)	$clubA1619= $clubA3229;	else	$clubA1619= $clubA3238; else $clubA1619=$clubA;?>
<?php	if ($A3239+$A3240>0) if ($A3239>$A3240)	$clubA1620= $clubA3231;	else	$clubA1620= $clubA3240; else $clubA1620=$clubA;?>

<?php	if ($A3241+$A3242>0) if ($A3241>$A3242)	$clubA1621= $clubA3225;	else	$clubA1621= $clubA3242; else $clubA1621=$clubA;?>
<?php	if ($A3243+$A3244>0) if ($A3243>$A3244)	$clubA1622= $clubA3227;	else	$clubA1622= $clubA3244; else $clubA1622=$clubA;?>
<?php	if ($A3245+$A3246>0) if ($A3245>$A3246)	$clubA1623= $clubA3229;	else	$clubA1623= $clubA3246; else $clubA1623=$clubA;?>
<?php	if ($A3247+$A3248>0) if ($A3247>$A3248)	$clubA1624= $clubA3231;	else	$clubA1624= $clubA3248; else $clubA1624=$clubA;?>

<?php	if ($A3249+$A3250>0) if ($A3249>$A3250)	$clubA1625= $clubA3225;	else	$clubA1625= $clubA3250; else $clubA1625=$clubA;?>
<?php	if ($A3251+$A3252>0) if ($A3251>$A3252)	$clubA1626= $clubA3227;	else	$clubA1626= $clubA3252; else $clubA1626=$clubA;?>
<?php	if ($A3253+$A3254>0) if ($A3253>$A3254)	$clubA1627= $clubA3229;	else	$clubA1627= $clubA3254; else $clubA1627=$clubA;?>
<?php	if ($A3255+$A3256>0) if ($A3255>$A3256)	$clubA1628= $clubA3231;	else	$clubA1628= $clubA3256; else $clubA1628=$clubA;?>

<?php	if ($A3257+$A3258>0) if ($A3257>$A3258)	$clubA1629= $clubA3225;	else	$clubA1629= $clubA3258; else $clubA1629=$clubA;?>
<?php	if ($A3259+$A3260>0) if ($A3259>$A3260)	$clubA1630= $clubA3227;	else	$clubA1630= $clubA3260; else $clubA1630=$clubA;?>
<?php	if ($A3261+$A3262>0) if ($A3261>$A3262)	$clubA1631= $clubA3229;	else	$clubA1631= $clubA3262; else $clubA1631=$clubA;?>
<?php	if ($A3263+$A3264>0) if ($A3263>$A3264)	$clubA1632= $clubA3231;	else	$clubA1632= $clubA3264; else $clubA1632=$clubA;?>	
