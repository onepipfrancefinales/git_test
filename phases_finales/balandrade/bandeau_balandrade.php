...
<table width="100%" border="0" height="90">
  ...
  <tr valign="top" align="center"> 
    ...
    <td bgcolor="#EAECEB" height="28" valign="middle" align="center" width="26%"> 
      <a href="/phases_finales/balandrade/pagebalandrade.php?variable_1=<?php echo $anneemoins;?>" target="_top"><font size="6" color="#FF0000"><b>&lt;&lt;</b></font></a> 
      <font size="5" color="#EAECEB">nnnnne</font> 
      <?php if ($variable_1 < 2018 or $annee < 2018)	
		{
		?>
      <a href="/phases_finales/balandrade/pagebalandrade.php?variable_1=<?php echo $anneeplus;?>" target="_top"><font color="#FF0000" size="6"><b>&gt;&gt;</b></font></a> 
    </td>
    ...
    <?php
	  	...
	  	{
		?>
    <a href="/phases_finales2019/affichagePhasesFinales/pagePhaseFinale.php?annee=<?php echo $anneeplus;?>&division=330" target="_top"><font color="#FF0000" size="6"><b>&gt;&gt;</b></font></a> 
    <td bgcolor="#EAECEB" height="28" valign="middle" align="center" width="25%"> 
      <div align="left"><font size="2" color="#000000"> ( 
        <?php echo $anneeplus; ?>
        ) </font></div>
