...
<table width="1740" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    <td width="395" height="7"> 
      <div id="coin4"> 
      	  <?php	echo $clubA3207.'" - "'.echo $clubA3208; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td width="201"></td>
    <td width="23"></td>
    <td colspan="3" height="50" valign="middle" rowspan="4" > 
      <div id="champion" > 
        <?php echo $clubA1000; ?>
      </div>
    </td>
