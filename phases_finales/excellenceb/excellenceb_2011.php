...
if ($annee==2011)
{
$clubA3201= ' Saint Maur (IDF)';
$clubA3202= ' Plaisir (IDF) ';
$clubA3203= ' l Aigle (N) ';
$clubA3204= ' Ris Orangis (IDF) ';
$clubA3205= ' Sarcelles (IDF)';
$clubA3206= ' Nuits Saint Georges (BG)';
$clubA3207= ' Poitiers (PCH) ';
$clubA3208= ' Thouars (PCH)';

$clubA3209= ' Saint Priest	(LY) ';
$clubA3210= ' Meyzieu (LY)';
$clubA3211= ' Saint Affrique (MPY)';
$clubA3212= ' Elne (R)';
$clubA3213= ' Vic Bigorre (AB)';
$clubA3214= ' Nogaro (AB) ';
$clubA3215= ' Arcachon (CA)';
$clubA3216= ' Navarrenx	(BE) ';

$clubA3217= ' Houilles (IDF)  ';
$clubA3218= ' Antony (IDF)  ';
$clubA3219= ' Basse Goulaine (PL)  ';
$clubA3220= ' Caen (N)  ';
$clubA3221= ' Saint denis (IDF) ';
$clubA3222= ' Clamart (IDF) ';
$clubA3223= ' Trignac (PL) ';
$clubA3224= ' Evreux (N)';

$clubA3225= ' Chalon sur Saone (BG) ';
$clubA3226= ' Versailles (IDF)';
$clubA3227= ' Le Rheu (BR)';
$clubA3228= ' Saintes (PCH)  ';
$clubA3229= ' Pontault Combault (IDF)';
$clubA3230= ' Besancon (FC) ';
$clubA3231= ' Angouleme (PCH) ';
$clubA3232= ' Royan Saujon (PCH) ';
...
$clubA3233= ' Givors (LY) ';
$clubA3234= ' Bievre Saint Geoirs (AP)';
$clubA3235= ' Villefranche de Lauragais	(MPY) ';
$clubA3236= ' Juillan (AB) ';
$clubA3237= ' Isle sur vienne (LM) ';
$clubA3238= ' Saint Sever (CBL)';
$clubA3239= ' Muret (MPY) ';
$clubA3240= ' Gaillac (MPY) ';

$clubA3241= ' Villars les Dombes (LY) ';
$clubA3242= ' Six fours	CAZ) ';
$clubA3243= ' Sarlat (PA)';
$clubA3244= ' Lembeye (BE)';
$clubA3245= ' SMUC (PR) '; 
$clubA3246= ' Tricastin (DA) ';
$clubA3247= ' Habas	(CBL)';
$clubA3248= ' Anglet (CBL)';


$clubA3249= ' La valette (CAZ)';
$clubA3250= ' Les angles (PR) ';
$clubA3251= ' Lunel	(LD) ';
$clubA3252= ' Palavas les Flots (LD) ';
$clubA3253= ' Balma	(MPY) ';
$clubA3254= ' Grenade (MPY) ';
$clubA3255= ' Saint Paul les Dax (CBL)';
$clubA3256= ' Saint Cernin	(LM) ';

$clubA3257= ' Sorgues (PR) ';
$clubA3258= ' Riom (AU) ';
$clubA3259= ' Coarraze  Nay	BE)';
$clubA3260= ' TUC (MPY) ';
$clubA3261= ' St Jean en Royans	(DA)';
$clubA3262= ' Ampuis (LY) ';
$clubA3263= ' Malemort (LM) ';
$clubA3264= ' Nontron (PA) ';
...
<div id="Layer11" style="position:absolute; width:306px; height:33px; z-index:7; left: 1494px; top: 688px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
  <div align="center"> <b><font color="#FF0000" size="5" face="Arial, Helvetica, sans-serif">Arcachon 
    (CA)</font></b></div>
</div>
