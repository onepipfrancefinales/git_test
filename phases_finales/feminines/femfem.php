...
<table width="1200" border="0" align="left" height="500" cellspacing="0">
  <tr bgcolor="#FFCC66"> 
    <td height="14" colspan="13"> 
      <div align="center"><i><b><i><b>1re Division Elite 1 TOP 8 - 1re Division 
        Elite 1 TOP 8 - 1re Division Elite 1 TOP 8 - 1re Division Elite 1 TOP 
        8 - 1re Division Elite 1 TOP 8 - 1re Division Elite 1</b></i></b></i></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="222" height="13">&nbsp;</td>
    <td width="46" height="13">&nbsp;</td>
    <td width="28" height="13">&nbsp;</td>
    <td width="28" height="13">&nbsp;</td>
    <td width="222" align="left" height="13">&nbsp;</td>
  ...
  <tr> 
    ...
    <td colspan="3" rowspan="3"> 
      <div align="center"><font size="5"><b>Champion de France 2016<br>
        Top 8</b></font></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="46"> 
      <div id="coin4" > <font color="#FF9933" size="3"><b>0</b></font></div>
    </td>
    <td width="28"> 
      <div id="coin4" > 7</div>
    </td>
    <td rowspan="6" width="28"><img src="../../images/accolade.png" width="8" height="127"></td>
    <td width="222" align="left">&nbsp;</td>
    <td width="35">&nbsp;</td>
    <td width="17">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="46"> 
      <div id="coin4" > <font size="3"><b><font color="#FF9933">10</font></b></font></div>
    </td>
    <td width="28"> 
      <div id="coin4" > 53</div>
    </td>
    <td width="222" height="11" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="17">&nbsp;</td>
    <td colspan="3" rowspan="4" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">Lille 
        Metropole <br>
        RCVilleneuve (FL)</font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="46" height="23"> 
      <div id="coin4" ><b><font size="3" color="#FF9933">4</font></b></div>
    </td>
    <td width="28" height="23"> 
      <div id="coin4" > 37</div>
    </td>
    <td width="222" align="left" height="23">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="46" height="26"> 
      <div id="coin4" ><font color="#FF9933"><b><font size="3">6</font></b></font></div>
    </td>
    <td width="28" height="26"> 
      <div id="coin4" > 49</div>
    </td>
    <td width="222" height="26" align="left">&nbsp;</td>
  ...
  <tr bgcolor="#FFCC66"> 
    <td colspan="13"><i><b>1re Division Elite 2 Armelle Auclair 1re Division Elite 
      2 Armelle Auclair 1re Division Elite 2 Armelle Auclair 1re Division Elite 
      2 Armelle Auclair 1re Division Elite 2 Arme</b></i></td>
  </tr>
  <tr> 
    <td colspan="13"></td>
  </tr>
  ...
  <tr> 
    ...
    <td width="28" height="9">&nbsp;</td>
    <td width="222" align="left" height="9">&nbsp;</td>
  ...
  <tr> 
    <td width="229" height="4"> 
      <div id="coin4" >Stado Tarbes (AB)</div>
    </td>
    <td width="54" height="4"> 
      <div id="coin4" >07 </div>
    </td>
    <td width="222" height="4">&nbsp;</td>
    <td width="46" height="4">&nbsp;</td>
    <td width="28" height="4">&nbsp;</td>
    <td width="28" height="4">&nbsp;</td>
    <td width="222" height="4" align="left">&nbsp;</td>
    <td width="35" height="4">&nbsp;</td>
    <td height="4" width="17">&nbsp;</td>
    <td width="222" height="4">&nbsp;</td>
  ...
  <tr> 
    ...
    <td rowspan="10" width="28"><img src="../../images/accolade.png" width="10" height="207"></td>
    <td width="222" align="left" height="2">&nbsp;</td>
    <td width="35" height="2">&nbsp;</td>
    <td height="2" width="17">&nbsp;</td>
    <td colspan="3" height="101" rowspan="4"> 
      <div align="center"><b><font size="5"><b>Champion de France 2016<br>
        Elite 2</b></font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="222" height="12"> 
      <div id="coin4" >Lons (BE) </div>
    </td>
    <td width="46" height="12"> 
      <div id="coin4" >7 </div>
    </td>
    <td width="222" align="left" height="12">&nbsp;</td>
    <td width="35" height="12">&nbsp;</td>
    <td height="12" width="17">&nbsp;</td>
  </tr>
  <tr> 
    <td width="229"> 
      <div id="coin4" >La Valette (CAZ)</div>
    </td>
    <td width="54"> 
      <div id="coin4" >10 </div>
    </td>
  ...
  <tr> 
    ...
    <td width="222" height="2">&nbsp;</td>
    <td width="46" height="2">&nbsp;</td>
    <td width="222" height="2" align="left">&nbsp;</td>
    <td width="35" height="2">&nbsp;</td>
    <td height="2" width="17">&nbsp;</td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="46">&nbsp;</td>
    <td width="222" align="left"> 
      <div id="coin4" >Lyon OU (LY) </div>
    </td>
    <td width="35"> 
      <div id="coin4" >07 </div>
    </td>
    <td colspan="4" rowspan="4" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">Romagnat 
        (AU) </font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="222" align="left" height="15">&nbsp;</td>
    <td width="35" height="15">&nbsp;</td>
  </tr>
  <tr> 
    <td width="229" height="11"> 
      <div id="coin4" >AS Bayonne (CBL) </div>
    </td>
  ...
  <tr> 
    ...
    <td width="54">&nbsp;</td>
    <td width="222"> 
      <div id="coin4" >Stade Bordelais ASPTT (CA) </div>
    </td>
    <td width="46"> 
      <div id="coin4" >8 </div>
    </td>
  ...
  <tr> 
    <td width="229" height="14"> 
      <div id="coin4" >Sassenage (AP)</div>
    </td>
    <td width="54" height="14"> 
      <div id="coin4" >13 </div>
    </td>
    <td width="222" height="14">&nbsp;</td>
    <td width="46" height="14">&nbsp;</td>
    <td width="28" height="14">&nbsp;</td>
    <td width="28" height="14">&nbsp;</td>
    <td width="222" align="left" height="14">&nbsp;</td>
  ...
  <tr> 
    <td width="229" bgcolor="#FFCC66">&nbsp;</td>
    <td bgcolor="#FFCC66" width="54">&nbsp;</td>
    <td bgcolor="#FFCC66" width="33">&nbsp;</td>
    <td width="222" bgcolor="#FFCC66">&nbsp;</td>
    <td bgcolor="#FFCC66" width="46">&nbsp;</td>
