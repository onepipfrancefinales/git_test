...
<table width="1200" border="0" align="left" height="163" cellspacing="0">
  <tr> 
  ...
  <tr> 
    ...
    <td width="28" height="8">&nbsp;</td>
    <td width="222" align="left" height="8">&nbsp;</td>
  ...
  <tr> 
    <td width="229" height="29"> </td>
    <td width="54" height="29"> </td>
    <td width="33" height="29">&nbsp;</td>
    <td width="222" height="29"> 
      <div id="coin4" >Blagnac (MPY)</div>
    </td>
    ...
    <td width="222" align="left" height="29">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="33">&nbsp;</td>
    <td width="222"> 
      <div id="coin4" >Montpellier RC (LD)</div>
    </td>
    <td width="46"> 
  ...
  <tr> 
    ...
    <td width="28" height="2">&nbsp;</td>
    <td width="222" align="left" height="2"> 
      <div id="coin4" >Montpellier RC (LD)</div>
    </td>
  ...
  <tr> 
    ...
    <td colspan="3" rowspan="4" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">Montpellier 
        (LD)</font></b></div>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td colspan="13" bgcolor="#FFCC66" height="25"><i><b>1re Division Elite 2 
      Armelle Auclair 1re Division Elite 2 Armelle Auclair 1re Division Elite 
...
<br>
<br>
<table width="1200" border="0" align="left" height="317" cellspacing="0">
  <tr> 
    <td colspan="13"></td>
  </tr>
  <tr> 
...
?>
  ...
  <tr> 
    ...
    <td width="28" height="9">&nbsp;</td>
    <td width="222" height="9" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="222" align="left" height="11">&nbsp;</td>
    <td width="35" height="11">&nbsp;</td>
    <td height="11" width="17">&nbsp;</td>
    <td colspan="3" height="11" valign="top"> 
  ...
  <tr> 
    ...
    <td colspan="3" height="35" valign="top" rowspan="3">
      <div align="center"><font size="5"><b>Champion de France 
        <?php echo $annee; ?>
        <br>
        Elite 2</b></font></div>
  ...
  <tr> 
    ...
    <td width="222" height="12">&nbsp;</td>
    <td width="46" height="12">&nbsp;</td>
    <td width="222" height="12" align="left">&nbsp;</td>
    <td width="35" height="12">&nbsp;</td>
    <td height="12" width="17">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="222" height="23">&nbsp;</td>
    <td width="46" height="23">&nbsp;</td>
    <td width="222" align="left" height="23"> 
      <div id="coin4" > 
        <?php
  ...
  <tr> 
    ...
    <td width="54" height="9">&nbsp;</td>
    <td width="33" height="9">&nbsp;</td>
    <td width="222" height="9">&nbsp;</td>
    <td width="46" height="9">&nbsp;</td>
    <td width="222" align="left" height="9"> 
      <div id="coin4" > 
        <?php	echo $clubA1002; ?>
      </div>
    </td>
    ...
    <td colspan="4" rowspan="4" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">Grenoble 
        uc (AP)</font></b></div>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="28" height="17">&nbsp;</td>
    <td width="222" align="left" height="17">&nbsp;</td>
