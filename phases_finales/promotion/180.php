...
<table width="1740" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="9" height="13" valign="middle" align="center">&nbsp;</td>
    <td width="219" height="13"> 
      <div id="coin4" > 
        <?php
    ...
    <td rowspan="4" height="38" width="17"><img src="../../images/accolade.png" width="8" height="82"> 
    </td>
    <td width="187" height="13">&nbsp;</td>
    <td width="41" height="13">&nbsp;</td>
    <td width="22" height="13">&nbsp;</td>
  ...
  <tr> 
    ...
    <td rowspan="4" width="17"><img src="../../images/accolade.png" width="8" height="82"></td>
    <td width="187">&nbsp;</td>
    <td width="41">&nbsp;</td>
    <td width="201"> 
      <div id="coin4" > 
  ...
  <tr> 
    ...
    <td rowspan="4" width="17"><img src="../../images/accolade.png" width="8" height="82"> 
    </td>
    <td width="187">&nbsp;</td>
    <td width="41">&nbsp;</td>
    <td width="22">&nbsp;</td>
  ...
  <tr> 
    ...
    <td rowspan="6" width="22"><img src="../../images/accolade.png" width="10" height="118"></td>
    <td width="201">&nbsp;</td>
    <td width="31">&nbsp;</td>
    <td width="18">&nbsp;</td>
    <td width="201" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td rowspan="4" height="28" width="17"><img src="../../images/accolade.png" width="8" height="82"></td>
    <td width="187" height="17">&nbsp;</td>
  ...
  <tr> 
    ...
    <td height="2" rowspan="4" width="17"><img src="../../images/accolade.png" width="8" height="82"></td>
    <td width="187" height="2">&nbsp;</td>
    <td width="41" height="2">&nbsp;</td>
    <td width="201" height="2" valign="top"> 
      <div id="coin4" > 
        <?php	echo $clubA4008; ?>
      </div>
    </td>
    <td width="31" height="2" valign="top"> 
      <div id="coin4" > 
        <?php	echo $A4008; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td width="187" height="11" valign="top"> 
      <div id="coin4" > 
        <?php	echo $clubA8016; ?>
      </div>
    </td>
