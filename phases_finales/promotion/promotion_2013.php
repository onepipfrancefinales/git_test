...
if ($annee>0)
{
$clubA3201= ' Cambrai (FL)';
$clubA3202= ' Havre RC (N)';

$clubA3203= ' Limay (IDF)';
$clubA3204= ' Romorantin (CE) ';

$clubA3205= ' Villeneuve d Ascq (FL) ';
$clubA3206= ' Nemours (IDF)';

$clubA3207= ' Fontenay Lucon (PL)';
$clubA3208= ' Yvetot (N) ';

$clubA3209= ' Vire (N)';
$clubA3210= ' Saint Brieuc (BR)';

$clubA3211= ' Le Baule (PL)';
$clubA3212= ' Val de Bievre (IDF) ';



$clubA3213= ' Grandchamp (BR)';
$clubA3214= ' Arcay (CE) ';

$clubA3215= ' Villeneuve (PCH)';
$clubA3216= ' Gramat (LM)';

$clubA3217= ' Plabennec (BR)';
$clubA3218= ' ST Georges les Baillargeaux (PCH) ';

$clubA3219= ' Pompadour (LM)';
$clubA3220= ' Labouheyre (CA)';

$clubA3221= ' Autun (BG)';
$clubA3222= ' Riom les Montagnes (AU) ';

$clubA3223= ' Raon Baccarat (AL)';
$clubA3224= ' Saint Genis Laval (LY)';

$clubA3225= ' Cergy Pontoise (IDF)';
$clubA3226= ' Grande Synthe (FL)3 ';

$clubA3227= ' Lauterbourg (AL)';
$clubA3228= ' Chenove (BG)';

$clubA3229= ' Rambouillet (IDF)';
$clubA3230= ' Vesoul (BG)';

$clubA3231= ' Gerzat (AU)';
$clubA3232= ' Roanne (LY)';

$clubA3233= ' La Verpilliere (LY)';
$clubA3234= ' Aix les Bains (AP) ';

$clubA3235= ' Commentry (AU)';
$clubA3236= ' Sanary sur Mer (CAZ)';

$clubA3237= ' La Voulte sur Rhone (DA)';
$clubA3238= ' Le Beausset (PR)';

$clubA3239= ' Limoux (LD)';
$clubA3240= ' Entente la Tet (PC)';

$clubA3241= ' Vaulnaveys le Haut (AP)';
$clubA3242= ' Valreas (PR) ';

$clubA3243= ' Entente Baronnies (AB)';
$clubA3244= ' Leguevin (MPY)';

$clubA3245= ' ESC BAC ASP (PC)';
$clubA3246= ' Olonzac (LD)';

$clubA3247= ' Arudy (BE) ';
$clubA3248= ' Saint Nicolas (MPY)';

$clubA3249= ' Ajaccio (C)';
$clubA3250= ' Rives d Orb (LD) ';

$clubA3251= ' Sault Navailles (CBL)';
$clubA3252= ' Espalion (MPY)';


$clubA3253= ' Villefranche du Queyran (PA)';
$clubA3254= ' Sevignacq Theze (BE)';

$clubA3255= ' Causse vezere (LM)';
$clubA3256= ' Lauzerte (MPY)';


$clubA3257= ' Leognan ((CA)';
$clubA3258= ' Tartas (CBL)';


$clubA3259= ' Aviron Castrais (MPY)';
$clubA3260= ' Laroque Timbaut (PA)';
 

$clubA3261= ' Vic Fezenzac (AB)';
$clubA3262= ' Payzac Savignac (PA)';

$clubA3263= ' La Reole (CA)';
$clubA3264= ' Andorre (MPY)';
}
...
<div id="Layer5" style="position:absolute; width:350px; height:20px; z-index:7; left: 20px; top: 760px; background-image: url(../unique32.jpg); layer-background-image: url(../unique32.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer7" style="position:absolute; width:55px; height:20px; z-index:8; background-image: url(../resultdouble.jpg); layer-background-image: url(../resultdouble.jpg); border: 1px none #000000; left: 350px; top: 0px"><b><font color="#FFFFFF" face="Arial, Helvetica, sans-serif" size="3">48 
      - 21</font></b> </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 459px; top: 400px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>37</b></font></div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3220;
  ?>
      </b></font> </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 520px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 1px; background-image:  url(../result22.jpg); layer-background-image:  url(../result22.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>08</b></font> 
    </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 459px; top: 600px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>03</b></font></div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3239;
  ?>
      </b></font> </div>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 460px; top: 680px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result22.jpg); layer-background-image:  url(../result22.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>14</b></font> 
    </div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique4.jpg); layer-background-image:  url(../unique4.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3247;
  ?>
...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 720px; top: 260px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  ...
  ?>
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 200px; top: 21px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b>32</b></font> 
    </div>
    <div id="Layer9" style="position:absolute; width:200px; height:20px; z-index:2; left: 0px; top: 20px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b>
      <?php echo $clubA3207;
  ?>
...
<div id="Layer11" style="position:absolute; width:306px; height:33px; z-index:7; left: 1494px; top: 688px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
  <div align="center"> <b><font color="#FF0000" size="5" face="Arial, Helvetica, sans-serif">Entente 
    Baronnies (AB)</font></b></div>
</div>
<div id="Layer11" style="position:absolute; width:306px; height:59px; z-index:7; left: 1495px; top: 615px; background-color: #FFFF00; layer-background-color: #FFFF00; border: 1px none #000000"> 
  <div align="center"> <font size="5"><b>Champion de France Promotion 
    <?php echo $annee;?>
    </b></font></div>
</div>
