...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="198" height="13"> 
      <?php
	  if ($ptsA3205+$ptsA3206>0)  if ($ptsA3205>$ptsA3206 or $A1605>$A1606) $clubA8003= $clubA1605;	else	$clubA8003= $clubA1606;	else $clubA8003=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3207+$ptsA3208>0)  if ($ptsA3207>$ptsA3208 or $A1607>$A1608) $clubA8004= $clubA1607;	else	$clubA8004= $clubA1608;	else $clubA8004=$clubA;
	
	 ?>
      <?php	 if ($ptsA3213+$ptsA3214>0)  if ($ptsA3213>$ptsA3214 or $A1613>$A1614) $clubA8007= $clubA1613;	else	$clubA8007= $clubA1614;	else $clubA8007=$clubA;
		 ?>
      <?php
	 if ($ptsA3215+$ptsA3216>0)  if ($ptsA3215>$ptsA3216 or $A1615>$A1616) $clubA8008= $clubA1615;	else	$clubA8008= $clubA1616;	else $clubA8008=$clubA;
		 ?>
      <?php
	 if ($ptsA3201+$ptsA3202>0)  if ($ptsA3201>$ptsA3202 or $A1601>$A1602) $clubA8001= $clubA1601;	else	$clubA8001= $clubA1602; else $clubA8001=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3203+$ptsA3204>0)  if ($ptsA3203>$ptsA3204 or $A1603>$A1604) $clubA8002= $clubA1603;	else	$clubA8002= $clubA1604; else $clubA8002=$clubA;
	
	 ?>
      <?php	
		  if ($ptsA3209+$ptsA3210>0)  if ($ptsA3209>$ptsA3210 or $A1609>$A1610) $clubA8005= $clubA1609;	else	$clubA8005= $clubA1610; else $clubA8005=$clubA;
		 ?>
      <?php
		 if ($ptsA3211+$ptsA3212>0)  if ($ptsA3211>$ptsA3212 or $A1611>$A1612) $clubA8006= $clubA1611;	else	$clubA8006= $clubA1612; else $clubA8006=$clubA;
		 ?>
    </td>
    <td width="41" height="13"> 
      <div align="center"><font face="Arial, Helvetica, sans-serif"><b>Pts</b></font></div>
  ...
  <tr> 
    ...
    <td width="201"> 
      <?php
	 if ($ptsA3233+$ptsA3234>0)  if ($ptsA3233>$ptsA3234 or $A8001>$A8002) $clubA4001= $clubA8001;	else	$clubA4001= $clubA8002; else $clubA4001=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3235+$ptsA3236>0)  if ($ptsA3235>$ptsA3236 or $A8003>$A8004) $clubA4002= $clubA8003;	else	$clubA4002= $clubA8004; else $clubA4002=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3237+$ptsA3238>0)  if ($ptsA3237>$ptsA3238 or $A8001>$A8002) $clubA4003= $clubA8005;	else	$clubA4003= $clubA8006; else $clubA4003=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3239+$ptsA3240>0)  if ($ptsA3239>$ptsA3240 or $A8003>$A8004) $clubA4004= $clubA8007;	else	$clubA4004= $clubA8008; else $clubA4004=$clubA;
  ...
  <tr> 
    ...
    <td width="201" height="11" align="left"> 
  ...
  <tr> 
    ...
    <td width="198"> 
      <?php
		 if ($ptsA3217+$ptsA3218>0)  if ($ptsA3217>$ptsA3218 or $A1617>$A1618) $clubA8009= $clubA1617;	else	$clubA8009= $clubA1618; else $clubA8009=$clubA;
		 ?>
      <?php
		  if ($ptsA3219+$ptsA3220>0)  if ($ptsA3219>$ptsA3220 or $A1619>$A1620) $clubA8010= $clubA1619;	else	$clubA8010= $clubA1620; else $clubA8010=$clubA;
		 ?>
      <?php
		   if ($ptsA3221+$ptsA3222>0)  if ($ptsA3221>$ptsA3222 or $A1621>$A1622) $clubA8011= $clubA1621;	else	$clubA8011= $clubA1622;	else $clubA8011=$clubA;
		 ?>
      <?php
		  if ($ptsA3223+$ptsA3224>0)  if ($ptsA3223>$ptsA3224 or $A1623>$A1624) $clubA8012= $clubA1623;	else	$clubA8012= $clubA1624; else $clubA8012=$clubA;
		?>
      <?php	
		  if ($ptsA3225+$ptsA3226>0)  if ($ptsA3225>$ptsA3226 or $A1625>$A1626) $clubA8013= $clubA1625;	else	$clubA8013= $clubA1626; else $clubA8013=$clubA;
		?>
      <?php
		 if ($ptsA3227+$ptsA3228>0)  if ($ptsA3227>$ptsA3228 or $A1627>$A1628) $clubA8014= $clubA1627;	else	$clubA8014= $clubA1628; else $clubA8014=$clubA;
		 ?>
      <?php
		 if ($ptsA3229+$ptsA3230>0)  if ($ptsA3229>$ptsA3230 or $A1629>$A1630) $clubA8015= $clubA1629;	else	$clubA8015= $clubA1630;	else $clubA8015=$clubA;
			 ?>
      <?php	
		 if ($ptsA3231+$ptsA3232>0)  if ($ptsA3231>$ptsA3232 or $A1631>$A1632) $clubA8016= $clubA1631;	else	$clubA8016= $clubA1632;	else $clubA8016=$clubA;
		 ?>
    </td>
    <td width="41">&nbsp;</td>
    <td width="41">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="201" height="23"> 
      <?php
	 if ($ptsA3241+$ptsA3242>0)  if ($ptsA3241>$ptsA3242 or $A8001>$A8002) $clubA4005= $clubA8009;	else	$clubA4005= $clubA8010; else $clubA4005=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3243+$ptsA3244>0)  if ($ptsA3243>$ptsA3244 or $A8003>$A8004) $clubA4006= $clubA8011;	else	$clubA4006= $clubA8012; else $clubA4006=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3245+$ptsA3246>0)  if ($ptsA3245>$ptsA3246 or $A8001>$A8002) $clubA4007= $clubA8013;	else	$clubA4007= $clubA8014; else $clubA4007=$clubA;
	
	 ?>
      <?php
	 if ($ptsA3247+$ptsA3248>0)  if ($ptsA3247>$ptsA3248 or $A8003>$A8004) $clubA4008= $clubA8015;	else	$clubA4008= $clubA8016; else $clubA4008=$clubA;
	
	 ?>
    </td>
    <td width="31" height="23">&nbsp;</td>
    <td width="18" height="23">&nbsp;</td>
    <td width="201" align="left" height="23">
    ...
    <td width="198" height="23"> <?php if ($A2001+$A2002>0)  if ($A2001>$A2002)	$clubA1001= $clubA2001;	else	$clubA1001= $clubA2002;  else $clubA1001=$clubA;?>
