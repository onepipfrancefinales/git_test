...
<table width="1200" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    <td width="131"> </td>
    <td width="202"> 
      <div id="coin4" >USA Perpignan (PC)</div>
    </td>
    <td width="50"> 
  ...
  <tr> 
    ...
    <td width="50"> 
      <div id="coin4" > <font size="3"><b>23</b></font></div>
    </td>
  ...
  <tr> 
    ...
    <td colspan="2" bgcolor="#FFFF00" rowspan="3"> 
      <div align="center"><b><font color="#FF0000" size="5">USA Perpignan<br>
        (PC)</font></b></div>
    </td>
    <td width="114">&nbsp;</td>
  </tr>
  ...
  <tr> 
    ...
    <td width="50" height="3"> 
      <div id="coin4" ><font color="#FF9933"><b><font color="#FFFFFF">28</font></b></font></div>
    </td>
  ...
  <tr> 
    <td width="131" height="2"></td>
    <td width="202"> 
      <div id="coin4" >US Dax (CBL)</div>
    </td>
    <td width="50"> 
      <div id="coin4" > <font size="3"><b>8</b></font></div>
    </td>
    <td width="198" height="11" align="left">&nbsp;</td>
    <td width="38" height="11">&nbsp;</td>
    <td width="39" height="2">&nbsp;</td>
  ...
  <tr> 
    ...
    <td colspan="2" height="10" bgcolor="#FFFF00" rowspan="3"> 
      <div align="center"><b><font color="#FF0000" size="5">CA Brive (LM)</font></b></div>
    </td>
    <td width="114" height="2">&nbsp;</td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="202" height="7"> 
      <div id="coin4" >AS Beziers (LD)</div>
    </td>
