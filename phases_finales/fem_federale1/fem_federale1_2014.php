...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 280px; top: 420px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  <div align="center"> 
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 199px; top: 17px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"> 
    </div>
