...
$clubA1601= 'Stade Francais (IDF)';
$clubA1602= 'Massy (IDF)';
$clubA1603= 'Reuil Malmaison (IDF)';
$clubA1604= 'Saint Genis Laval (LY)';
$clubA1605= 'Tourcoing (FL)';
$clubA1606= 'Nancy Seichamps (AL)';
$clubA1607= 'Limoges (LM)';
$clubA1608= 'Savoie Feminines (AP)';
$clubA1609= 'Illkricht Graffenstaden (AL)';
$clubA1610= 'Firminy (LY)';
$clubA1611= 'Nevers (CE)';
$clubA1612= 'Violettes Bressanes (LY)';
$clubA1613= 'Pontarlier  (FC)';
$clubA1614= 'Amiens (FL)';
$clubA1615= 'Clermont la Plaine (AU)';
$clubA1616= 'RC Paris XV (IDF)';
$clubA1617= 'Bruges Blanquefort (CA)';
$clubA1618= 'Luzech (MPY)';
$clubA1619= 'Stade Montois (CBL)';
$clubA1620= 'Sud Toulousain (AB)';
$clubA1621= 'Section Paloise  (BE)';
$clubA1622= ' Bergerac (PA)';

$clubA1623= 'Stade Nicois (CAZ)';
$clubA1624= 'Villelongue de La Salanque (PC)';
$clubA1625= 'RC Narbonne (LD)';
$clubA1626= 'Velleron (PR)';
$clubA1627= 'Poitiers (PCH)';
$clubA1628= 'Bagneres (AB)';


$clubA1629='P�rigord Blanc (PA)';
$clubA1630='Saint Mandrier (CAZ)';
$clubA1631='Pachys d Herm (CBL)';
$clubA1632='Pays Saint Yrieix (LM)';
...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="31" height="8"> 
      <div id="coin4" >13 
        <?php	echo $A4006; ?>
      </div>
    </td>
    <td width="201" align="left" height="8">&nbsp; </td>
    <td width="23" height="8">&nbsp;</td>
    <td colspan="3" height="50" rowspan="4" bgcolor="#FFFF00" valign="middle"> 
      <div align="center"> 
        <p><b><font color="#FF0000" size="5" face="Arial, Helvetica, sans-serif">Villelongue<br>
          de la Salanque</font></b><b><font color="#FF0000" size="5" face="Arial, Helvetica, sans-serif"> 
          <?php if ($A1001>$A1002)
		echo $clubA1001;
		else
		echo $clubA1002;
  ...
  <tr> 
    <td width="198" height="17" valign="top"> 
      <div id="coin5" > 
        <?php	echo $clubA1631; ?>
      </div>
    </td>
    <td width="36" height="17" valign="top"> 
      <div id="coin5" >32 
        <?php	echo $A1631; ?>
      </div>
    </td>
    ...
    <td width="41" height="17" valign="top"> 
      <div id="coin4" >18 
        <?php	echo $A8016; ?>
      </div>
    </td>
