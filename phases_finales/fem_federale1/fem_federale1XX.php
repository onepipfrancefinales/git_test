...
<div id="Layer1" style="position:absolute; width:200px; height:20px; z-index:3; left: 996px; top: 542px; background-image:  url(../unique3.jpg); layer-background-image:  url(../unique3.jpg); border: 1px none #000000"> 
  <div align="center"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b> 
    ...
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 229px; top: 1px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"></div>  
    <div id="Layer10" style="position:absolute; width:30px; height:20px; z-index:3; left: 229px; top: 21px; background-image:  url(../result2.jpg); layer-background-image:  url(../result2.jpg); border: 1px none #000000"></div>
  </div>
</div>
