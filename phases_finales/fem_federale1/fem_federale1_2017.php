...
<table width="1200" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    <td width="229" height="22"> 
      <div id="coin4" >&nbsp;&nbsp;Sud Toulousain (MPY)</div>
    </td>
    ...
    <td width="28" height="22">&nbsp;</td>
    <td width="222" align="left" height="22">&nbsp;</td>
  ...
  <tr> 
    <td width="229" height="9"> 
      <div id="coin4" >Illkricht Graffenstaden (AL)</div>
    </td>
  ...
  <tr> 
    <td width="229" height="12"> 
      <div id="coin4" >Bruges Blanquefort (CA)</div>
    </td>
  ...
  <tr> 
    ...
    <td colspan="4" rowspan="5" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">RC 
        Narbonne (LD)</font></b></div>
    </td>
  </tr>
  <tr> 
    <td width="229">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="222" align="left" height="19">&nbsp;</td>
    <td width="35" height="19">&nbsp;</td>
  </tr>
  <tr> 
    <td width="229" height="11"> 
      <div id="coin4" >Clermont la Plaine (AU)</div>
    </td>
  ...
  <tr> 
    <td width="229" height="22"> 
      <div id="coin4" >Agen Guyenne (PA)</div>
    </td>
    <td width="54" height="22"> 
      <div id="coin4" >15</div>
    </td>
  ...
  <tr> 
    ...
    <td colspan="4" height="22" rowspan="5" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">Vitry 
        (IDF) </font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="222" height="6">&nbsp;</td>
    <td width="46" height="6">&nbsp;</td>
    <td width="222" align="left" height="6"> 
      <div id="coin4" >Vitry (IDF)</div>
    </td>
    <td width="35" height="6"> 
      <div id="coin4" >07</div>
    </td>
  </tr>
  <tr> 
    <td width="229" height="19"> 
      <div id="coin4" >Dijon (BG)</div>
    </td>
    <td width="54" height="19"> 
      <div id="coin4" >17</div>
    </td>
  ...
  <tr> 
    <td width="229" height="11"> 
      <div id="coin4" >Sainte Genevieve(IDF)</div>
    </td>
    <td width="54" height="11"> 
      <div id="coin4" >05</div>
    </td>
