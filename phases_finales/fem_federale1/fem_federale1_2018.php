...
<table width="1200" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="222" height="12"> 
      <div id="coin4" >USA Limoges (LM)</div>
    </td>
  ...
  <tr> 
    <td width="229" height="14"> 
      <div id="coin4" >Pontarlier Besan&ccedil;on(FC)</div>
    </td>
  ...
  <tr> 
    ...
    <td colspan="4" rowspan="5" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">Bruges 
        Blanquefort (CA)&nbsp;&nbsp;</font></b></div>
    </td>
  </tr>
  <tr> 
    <td width="229">&nbsp;</td>
  ...
  <tr> 
    <td width="229" height="11"> 
      <div id="coin4" >Grenoble UC (AP)</div>
    </td>
  ...
  <tr> 
    <td width="229" height="14"> 
      <div id="coin4" >SCUF-PORC (IDF)</div>
    </td>
    <td width="54" height="14"> 
      <div id="coin4" >3</div>
    </td>
  ...
  <tr> 
    ...
    <td colspan="4" height="22" rowspan="5" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5" color="#FF0000">TCMS 
        (MPY)</font></b></div>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td width="229" height="11"> 
      <div id="coin4" >RC Marseille (PR)</div>
    </td>
    <td width="54" height="11"> 
      <div id="coin4" >6</div>
    </td>
