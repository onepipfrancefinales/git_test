...
( Clubs) </font><br/>
  <br/>
  <?php 
$reponse = $bdd->query("SELECT * FROM bdequipe1 WHERE rang2='117'and titre='champion'ORDER BY saison DESC"); // Requ�te SQL
while ($donnees = $reponse->fetch())
{ 
?>
  <h4>
...
( Clubs) </font><br/>
  <br/>
  <?php 
$reponse = $bdd->query("SELECT * FROM bdequipe1 WHERE rang2='116'and titre='champion'ORDER BY saison DESC"); // Requ�te SQL
while ($donnees = $reponse->fetch())
{ 
?>
  <h4> 
...
( Clubs) </font><br/>
  <br/>
  <?php
$reponse = $bdd->query("SELECT * FROM bdequipe1 WHERE rang2='114'and titre='champion'ORDER BY saison DESC"); // Requ�te SQL
while ($donnees = $reponse->fetch())
{ 
?>
  <h4>
 ...
 ?>
  ...
  <br/>
<font face="Arial, Helvetica, sans-serif" size="4"><b> <font size="5" color="#000000">Champions 
de France 1re Série</font></b></font><font color="#000000"><br/>
( Clubs) </font><br/>
  <br/>
  <?php
$reponse = $bdd->query("SELECT * FROM bdequipe1 WHERE championnat='de France' and rang2='111'and titre='champion'ORDER BY saison DESC"); // Requ�te SQL
while ($donnees = $reponse->fetch())
{ 
?>
  <h4>
