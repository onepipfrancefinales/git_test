...
$query1="SELECT logodom.url as logodom, logoext.url as logoext, phpl_matchs.buts_dom, phpl_matchs.buts_ext, phpl_journees.date_prevue, logodom.id as logoiddom, logoext.id as logoidext
                FROM phpl_equipes as dom, phpl_equipes as ext, phpl_matchs, phpl_journees, phpl_logo as logodom, phpl_logo as logoext
                WHERE phpl_matchs.id_equipe_dom=dom.id
                      AND phpl_matchs.id_equipe_ext=ext.id
                      AND phpl_journees.id_champ='$champ'
                      AND phpl_journees.numero='$numero'
