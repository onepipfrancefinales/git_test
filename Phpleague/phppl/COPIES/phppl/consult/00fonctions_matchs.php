...
$result=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phpfed2_matchs.buts_dom, phpfed2_matchs.buts_ext,
...
//mise en forme tableau oppositions
        echo "<table align=\"center\" class=\"tablephpfed22\"  width=\"100%\" cellspacing=\"1\" cellpadding=\"1\"><tr><td><table cellspacing=\"0\" align=\"center\" width=\"100%\" cellpadding=\"1\">\n";
        $x=1;
        $minute = 0;
        $heure = 0;
        $jour = 0;
        ...
        $annee = 0;
             ...
             $extproba= $row[3];
                ...
                {
               $result2=$idconnect->query("SELECT DOMBUTSPOUR, DOMG, DOMN, DOMP, DOMBUTSCONTRE FROM phpfed2_clmnt_cache WHERE ID_EQUIPE='$row[eqdom]'");
               // $result2=mysqli_query($query2);
                ...
                $result2=$idconnect->query("SELECT EXTG, EXTN, EXTP, EXTBUTSCONTRE, EXTBUTSPOUR FROM phpfed2_clmnt_cache WHERE ID_EQUIPE='$row[eqext]'");
               // $result2=mysqli_query($query2);
                      while ($row2=mysqli_fetch_array($result2))
                      {
...
$resultats=$idconnect->query("SELECT phpfed2_clubs.nom, CLEXT.nom, phpfed2_matchs.buts_dom, phpfed2_matchs.buts_ext,
...
if($cache=="1")
	{
	mysqli_query($idconnect, ("DELETE FROM phpfed2_clmnt_cache 
							   WHERE nom='exempte'"));
	}
else
	{
	mysqli_query($idconnect, ("DELETE FROM phpfed2_clmnt 
							   WHERE nom='exempte'"));
	}
