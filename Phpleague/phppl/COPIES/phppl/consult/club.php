...
$result= $idconnect->query("SELECT phppl_clubs.id, phppl_clubs.nom, id_champ, id_club
							FROM phppl_clubs, phppl_equipes
							WHERE phppl_equipes.id_champ='$champ' and phppl_equipes.id_club=phppl_clubs.id
							ORDER BY nom");
...
$result= $idconnect->query("SELECT phppl_classe.nom, phppl_classe.id 
							FROM phppl_classe 
							order by rang");
//$result=mysql_query ($query);
        ...
        echo "<tr class=\"trphppl3\"><td align=\"center\"><b>$row[0]</b></td></tr>";
        $id_classe=$row[1];
        echo "<tr><td><table cellspacing=\"0\"><tr class=\"trphppl\"><td>";
...
echo "<table class=\"tablephppl2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphppl3\"><td align=\"center\"><b>Effectif</b></td></tr><tr><td>";

$result= $idconnect->query("SELECT phppl_equipes.id 
							FROM phppl_equipes, phppl_clubs 
							WHERE phppl_clubs.id='$id_clubs' 
							AND id_champ='$champ' 
...
{ $row[0]=addslashes($row[0]);
 $resultats1 = $idconnect->query("SELECT nom, prenom, phppl_joueurs.id
									FROM phppl_joueurs, phppl_effectif
									WHERE phppl_joueurs.id=phppl_effectif.id_joueur
									AND phppl_effectif.id_equipe='$equipe'
...
echo "<table class=\"tablephppl2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphppl3\"><td align=\"center\"><b>".CONSULT_CLUB_4."</b></td></tr>";
        echo "<tr><td><center><img src=\"graph.php?equipe=$equipe\" alt=\"\"></center></td></tr>";


echo"</table><br /><br /><br />";

echo "<table class=\"tablephppl2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphppl3\" align=\"center\"><td><b>".CONSULT_CLUB_3."</b></td></tr>";
...
$result= $idconnect->query("SELECT annee, phppl_divisions.nom, phppl_championnats.id, phppl_equipes.id
							...
							AND phppl_equipes.id_club='$id_clubs'
