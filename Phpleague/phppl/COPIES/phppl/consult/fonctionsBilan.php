...
$result=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phppl_matchs.buts_dom, phppl_matchs.buts_ext,
        ...
        $annee = 0;
             ...
             $extproba= $row[3];
                ...
                //$result2=mysqli_query($query2);
                 ...
                 $result2=$idconnect->query("SELECT EXTG, EXTN, EXTP, EXTBUTSCONTRE, EXTBUTSPOUR FROM phppl_clmnt_cache WHERE ID_EQUIPE='$row[eqext]'");
...
//suppression des liens sur les scores
  ...
  $requete="SELECT phppl_clubs.nom, CLEXT.nom, phppl_matchs.buts_dom, phppl_matchs.buts_ext,
