...
$color=0;
$result= $idconnect->query("SELECT phppl_divisions.nom, phppl_saisons.annee, (phppl_saisons.annee)+1 
...
$result= $idconnect->query("SELECT phppl_journees.numero, cldom.nom, clext.nom, phppl_matchs.buts_dom, phppl_matchs.buts_ext, phppl_matchs.date_reelle, phppl_matchs.id
...
echo "<tr class=\"trphppl3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
