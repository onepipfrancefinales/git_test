...
function aff_journee($champ, $bdd)
{
  ...
  echo "<br>";
  echo "<table class=\"tablephppl2 marginAuto width90PC \" ><tr><td>
...
//mise en forme tableau oppositions
echo "<br>";
echo "<table class=\"marginAuto tablephppl2 width90PC \" ><tr>
        ...
        AND phppl_equipes.id_club=phppl_clubs.id");
            ...
            AND phppl_equipes.id_club=phppl_clubs.id";
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  if ($cache == "1") {
                    $question .= "phppl_clmnt_cache ";
                  } else {
                    $question .= "phppl_clmnt ";
                  }
          ...
          PEN='$PEN'";
              ...
              function clmnt($champ, $smart, $bdd)
              {
                ...
                echo "<table class=\"tablephppl2 marginAuto width80PC borderSpacing\" ><tr class=\"trphppl3\"><th colspan=\"4\">" . $legende . "</th></tr>\n";
                echo "<tr class=\"trphppl3\">
                    ...
                    while ($x < 3)   // nb de colones
                    {
                      ...
                      if ($x == 0) {
                        ...
                        if ($lienmini == 'non') {
                          ...
                          echo "<a href=\"" . $phpplEAGUE_RACINE . "consult/detaileq.php?champ=$champmini&amp;id_equipe=" . $row['ID_EQUIPE'] . "\" target=\"_parent\">$row[$x]</a>";
                        }
                        if ($row['ID_EQUIPE'] == $id_equipe_fetiche) {
                          echo "</b>";
                        }
