...
$query1="SELECT logodom.url as logodom, logoext.url as logoext, phppl_matchs.buts_dom, phppl_matchs.buts_ext, phppl_journees.date_prevue, logodom.id as logoiddom, logoext.id as logoidext
                FROM phppl_equipes as dom, phppl_equipes as ext, phppl_matchs, phppl_journees, phppl_logo as logodom, phppl_logo as logoext
                WHERE phppl_matchs.id_equipe_dom=dom.id
                      AND phppl_matchs.id_equipe_ext=ext.id
                      AND phppl_journees.id_champ='$champ'
                      AND phppl_journees.numero='$numero'
