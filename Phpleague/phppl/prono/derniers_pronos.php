...
$result = $idconnect->query("SELECT phppl_clubs.nom, CLEXT.nom, phppl_matchs.buts_dom, phppl_matchs.buts_ext, phppl_matchs.id, phppl_matchs.date_reelle, phppl_journees.numero, pts_prono_exact, pts_prono_participation,phppl_matchs.id_equipe_dom,phppl_matchs.id_equipe_ext
