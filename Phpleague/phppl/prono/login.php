...
echo "pass : ".$pass;echo "<br>";
	...
	else
	{
      echo "test7";echo "<br>";
		...
		$result =$idconnect->query( "SELECT * FROM phppl_membres WHERE pseudo='$user'");
		...
		mysqli_query( $idconnect,("UPDATE phppl_membres SET ip='$ip', last_connect='$time' WHERE pseudo='$user'"));
