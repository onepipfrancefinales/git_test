...
<head>
  ...
  <title>phpcaeague - Administration</title>
  <link rel="stylesheet" type="text/css" href="style.css">

</head>

<body topmargin="0" leftmargin="0" class="phpca">
      ...
      <table cellspacing="0" width="100%" height="100%" cellpadding="0">
        <tr>
          ...
          <td colspan="1" background="haut.gif" valign="middle" align="center" style="border-bottom-style: dashed;border-bottom-width : 1px; border-color:#3b487f">
            <font class="phpca">Ligue
              Occitanie - Administration</font>
          </td>
          ...
          <td valign="top" colspan="2">
            <div align="center">
              ...
              if (isset($_COOKIE['user'])) {
                $user_pseudo = $_COOKIE['user'];
              } else {
                $user_pseudo = '';
              }
              if (isset($_COOKIE['mot_de_passe'])) {
                $user_mdp = $_COOKIE['mot_de_passe'];
              } else {
                $user_mdp = '';
              }
              ...
              if (isset($_REQUEST['actionc'])) {
                $actionc = $_REQUEST['actionc'];
              } else {
                $actionc = '';
              }
              ...
              if (VerifSession($user_pseudo, $user_mdp, $idconnect) == "1" or VerifSession($user_pseudo, $user_mdp, $idconnect) == "0") {
                if ($page == "championnat") {
                  include("championnat.php");
                } elseif ($page == "groupes_championnats") {
                  include("groupes_championnats.php");
                } elseif ($page == "mini_classement") {
                  include("mini_classement.php");
                } elseif ($page == "fiches_clubs") {
                  include("fiches_clubs.php");
                } elseif ($page == "membres") {
                  include("membres.php");
                } elseif ($page == "credits") {
                  include("credits.htm");
              ...
              } elseif ($identification == "non") {
                echo "Veuillez renseigner tous les champs !";
              } elseif ($identification == "non2") {
        ...
        <tr>
          <td class="phpca" height="10" colspan="1"><img border="0" src="bouton.gif" width="111" height="25">
          </td>
          <td class="phpca" colspan="3" width="70%" height="10" colspan="2" align="right">
          </td>
        </tr>
      </table>
    </center>
