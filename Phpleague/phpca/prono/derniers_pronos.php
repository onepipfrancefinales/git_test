...
$result = $idconnect->query("SELECT phpca_clubs.nom, CLEXT.nom, phpca_matchs.buts_dom, phpca_matchs.buts_ext, phpca_matchs.id, phpca_matchs.date_reelle, phpca_journees.numero, pts_prono_exact, pts_prono_participation,phpca_matchs.id_equipe_dom,phpca_matchs.id_equipe_ext
