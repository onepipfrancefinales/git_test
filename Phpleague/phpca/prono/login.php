...
echo "pass : ".$pass;echo "<br>";
	...
	if(!isset($_REQUEST['user']) or !isset($_REQUEST['pass']))
	{
		...
		echo "test5";echo "<br>";
   	 header("Location: /Phpleague/phpca/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=0");
	}
	...
	else
	{
      echo "test7";echo "<br>";
		...
		{
        	header("Location: /Phpleague/phpca/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=1");
		}
