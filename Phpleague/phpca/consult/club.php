...
$result= $idconnect->query("SELECT phpca_clubs.id, phpca_clubs.nom, id_champ, id_club
							FROM phpca_clubs, phpca_equipes
							WHERE phpca_equipes.id_champ='$champ' and phpca_equipes.id_club=phpca_clubs.id
							ORDER BY nom");
...
$result= $idconnect->query("SELECT phpca_classe.nom, phpca_classe.id 
							FROM phpca_classe 
							order by rang");
//$result=mysql_query ($query);
        ...
        echo "<tr class=\"trphpca3\"><td align=\"center\"><b>$row[0]</b></td></tr>";
        $id_classe=$row[1];
        echo "<tr><td><table cellspacing=\"0\"><tr class=\"trphpca\"><td>";
...
echo "<table class=\"tablephpca2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpca3\"><td align=\"center\"><b>Effectif</b></td></tr><tr><td>";

$result= $idconnect->query("SELECT phpca_equipes.id 
							FROM phpca_equipes, phpca_clubs 
							WHERE phpca_clubs.id='$id_clubs' 
							AND id_champ='$champ' 
...
{ $row[0]=addslashes($row[0]);
 $resultats1 = $idconnect->query("SELECT nom, prenom, phpca_joueurs.id
									FROM phpca_joueurs, phpca_effectif
									WHERE phpca_joueurs.id=phpca_effectif.id_joueur
									AND phpca_effectif.id_equipe='$equipe'
...
echo "<table class=\"tablephpca2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpca3\"><td align=\"center\"><b>".CONSULT_CLUB_4."</b></td></tr>";
        echo "<tr><td><center><img src=\"graph.php?equipe=$equipe\" alt=\"\"></center></td></tr>";


echo"</table><br /><br /><br />";

echo "<table class=\"tablephpca2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpca3\" align=\"center\"><td><b>".CONSULT_CLUB_3."</b></td></tr>";
...
$result= $idconnect->query("SELECT annee, phpca_divisions.nom, phpca_championnats.id, phpca_equipes.id
							...
							AND phpca_equipes.id_club='$id_clubs'
