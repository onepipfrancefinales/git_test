...
function aff_journee($champ, $bdd)
{
  ...
  echo "<br>";
  echo "<table class=\"tablephpca2 marginAuto width90PC \" ><tr><td>
...
//mise en forme tableau oppositions
echo "<br>";
echo "<table class=\"marginAuto tablephpca2 width90PC \" ><tr>
...
function classementDetaille($champ, $bdd)
{
  ...
  echo "<table class=\"tablephpca2\" cellspacing=\"0\" width=\"80%\"><tr class=\"trphpca3\"><th colspan=\"14\">" . $legende . "</th></tr>\n";
  echo "<tr class=\"trphpca3\">
        ...
        AND phpca_equipes.id_club=phpca_clubs.id");
            ...
            AND phpca_equipes.id_club=phpca_clubs.id";
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  if ($cache == "1") {
                    $question .= "phpca_clmnt_cache ";
                  } else {
                    $question .= "phpca_clmnt ";
                  }
          ...
          PEN='$PEN'";
              ...
              function clmnt($champ, $smart, $bdd)
              {
                ...
                echo "<table class=\"tablephpca2 marginAuto width80PC borderSpacing\" ><tr class=\"trphpca3\"><th colspan=\"4\">" . $legende . "</th></tr>\n";
                echo "<tr class=\"trphpca3\">
