...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpca_divisions.nom, phpca_saisons.annee, (phpca_saisons.annee)+1
...
$resultats2=$idconnect->query("SELECT phpca_clubs.nom, CLEXT.nom, phpca_matchs.buts_dom, phpca_matchs.buts_ext, phpca_matchs.id, phpca_matchs.date_reelle
...
$result=$idconnect->query("SELECT phpca_journees.numero, phpca_journees.date_prevue, cldom.nom, clext.nom, phpca_matchs.buts_dom, phpca_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpca2" cellspacing="0" width="290" align="center">
