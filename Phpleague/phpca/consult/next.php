...
// Nom du champ
$query2="SELECT nom FROM phpca_divisions, phpca_championnats WHERE id_division=phpca_divisions.id and phpca_championnats.id='$champ'";
...
$query1="SELECT cldom.nom as cldom, clext.nom as clext, phpca_matchs.buts_dom, phpca_matchs.buts_ext , phpca_journees.date_prevue, cldom.id as cliddom, clext.id as clidext, phpca_matchs.date_reelle
      ...
      $row[1] = stripslashes($row[1]);
             ...
             if ($x==1)
                ...
                echo "<TR class=phpca ><TH class=phpca colspan=5 text-align=\"center\"><b> ". $numero."".$legende." le ".$jour."/".$mois."/".$annee."".CONSULT_CLMNT_MSG5."".$heure."h".$minute."</b></th></tr>";
                }
                ...
                echo "<TR class=phpca bgcolor=$bgcolor width=\"100%\"><TD class=phpca align=\"right\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phpca align=\"center\">".$domproba."<TD class=phpca align=center>-<TD class=phpca>".$extproba."<TD class=phpca align=\"left\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
