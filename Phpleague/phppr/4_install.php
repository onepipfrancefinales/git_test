<link rel="stylesheet" type="text/css" href="../phppr/league.css">
<body class=phpl>
...
$sql_maj_1="
  RENAME TABLE buteurs TO phppr_buteurs,
  championnats TO phppr_championnats,
  classe TO phppr_classe,
  clmnt TO phppr_clmnt,
  clmnt_graph TO phppr_clmnt_graph,
  clmnt_pronos TO phppr_clmnt_pronos,
  clubs TO phppr_clubs,
  divisions TO phppr_divisions,
  donnee TO phppr_donnee,
  equipes TO phppr_equipes,
  joueurs TO phppr_joueurs,
  journees TO phppr_journees,
  logo TO phppr_logo,
  matchs TO phppr_matchs,
  membres TO phppr_membres,
  parametres TO phppr_parametres,
  pronostics TO phppr_pronostics,
  rens TO phppr_rens,
  saisons TO phppr_saisons,
  tapis_vert TO phppr_tapis_vert;
  ALTER TABLE `phppr_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phppr_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phppr_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phppr_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phppr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppr_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phppr_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phppr_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phppr_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppr_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phppr_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phppr_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phppr_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppr_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phppr_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppr_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phppr_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phppr_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phppr_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppr_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppr_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppr_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppr_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phppr_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phppr_buteurs` DROP `id_joueur`;
ALTER TABLE `phppr_joueurs` DROP `id_club`;
DROP TABLE `phppr_logo`";
  
$sql_maj_3 = "ALTER TABLE `phppr_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phppr_clubs` DROP INDEX `id`;
ALTER TABLE `phppr_clubs` DROP INDEX `nom`;
ALTER TABLE `phppr_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppr_championnats` DROP INDEX `id`;
ALTER TABLE `phppr_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phppr_championnats` DROP INDEX `id_division`;
ALTER TABLE `phppr_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppr_classe` DROP INDEX `id`;
ALTER TABLE `phppr_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phppr_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phppr_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phppr_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phppr_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phppr_divisions` DROP PRIMARY KEY;
ALTER TABLE `phppr_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phppr_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppr_divisions` DROP INDEX `id`;
ALTER TABLE `phppr_equipes` DROP INDEX `id`;
ALTER TABLE `phppr_journees` DROP INDEX `id`;
ALTER TABLE `phppr_journees` DROP INDEX `numero`;
ALTER TABLE `phppr_logo` DROP PRIMARY KEY;
ALTER TABLE `phppr_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phppr_logo` DROP INDEX `id_club`;
ALTER TABLE `phppr_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phppr_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phppr_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phppr_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phppr_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phppr_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppr_rens` DROP INDEX `id`;
ALTER TABLE `phppr_saisons` DROP INDEX `id_2`;
ALTER TABLE `phppr_saisons` DROP PRIMARY KEY;
ALTER TABLE `phppr_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phppr_tapis_vert`;
ALTER TABLE `phppr_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phppr_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phppr_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phppr_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppr_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppr_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppr_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppr_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppr_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppr_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phppr_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phppr_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phppr_joueurs.id, phppr_equipes.id
          FROM phppr_joueurs, phppr_equipes, phppr_buteurs, phppr_matchs, phppr_clubs
          WHERE phppr_equipes.id_club=phppr_clubs.id
          AND (
           phppr_matchs.id_equipe_dom = phppr_equipes.id
           OR phppr_matchs.id_equipe_ext = phppr_equipes.id
              )
          AND phppr_matchs.id=phppr_buteurs.id_match
          AND phppr_joueurs.id_club=phppr_equipes.id_club
          AND phppr_buteurs.id_joueur=phppr_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phppr_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phppr_effectif.id, phppr_buteurs.id_match, phppr_joueurs.id
          FROM phppr_joueurs, phppr_equipes, phppr_buteurs, phppr_matchs, phppr_clubs, phppr_effectif
          WHERE phppr_equipes.id_club=phppr_clubs.id
          AND (
           phppr_matchs.id_equipe_dom = phppr_equipes.id
           OR phppr_matchs.id_equipe_ext = phppr_equipes.id
          ...
          AND phppr_joueurs.id_club=phppr_equipes.id_club
          AND phppr_buteurs.id_joueur=phppr_joueurs.id
          AND phppr_effectif.id_joueur=phppr_joueurs.id
          AND phppr_effectif.id_equipe=phppr_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phppr_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phppr_joueurs.nom, phppr_joueurs.prenom, phppr_buteurs.id, phppr_journees.numero, phppr_matchs.date_reelle, phppr_joueurs.id
FROM phppr_joueurs, phppr_buteurs, phppr_matchs, phppr_equipes, phppr_journees
WHERE phppr_matchs.id = phppr_buteurs.id_match
AND phppr_buteurs.id_joueur = phppr_joueurs.id
AND phppr_buteurs.id_effectif =0
AND (
phppr_matchs.id_equipe_dom = phppr_equipes.id
OR phppr_matchs.id_equipe_ext = phppr_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phppr//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phppr_clubs.nom, phppr_equipes.id, phppr_matchs.id
             FROM phppr_joueurs, phppr_equipes, phppr_buteurs, phppr_matchs, phppr_clubs, phppr_journees
             WHERE phppr_equipes.id_club = phppr_clubs.id
             AND (
             phppr_matchs.id_equipe_dom = phppr_equipes.id
             OR phppr_matchs.id_equipe_ext = phppr_equipes.id
...
$sql_maj_1="ALTER TABLE `phppr_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phppr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phppr_clubs` DROP INDEX `id`;
ALTER TABLE `phppr_clubs` DROP INDEX `nom`;
ALTER TABLE `phppr_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppr_championnats` DROP INDEX `id`;
ALTER TABLE `phppr_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phppr_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phppr_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phppr_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phppr_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phppr_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phppr_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phppr_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phppr_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phppreague@univert.org<phpleague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phppreague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phppr//%22$url_site/%22>$url_site</a></font></p>
