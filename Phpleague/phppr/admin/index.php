  ...
  <table cellspacing="0" width="100%" height="100%" cellpadding="0">
    <tr>
      <td colspan="1" align="center" height="100"  bgcolor="#C0C0C0"></td>
        <td colspan="1" background="haut.gif" valign="middle" align="center" style="border-bottom-style: dashed;border-bottom-width : 1px; border-color:#3b487f"><font class="phppr">Ligue 
          Provence Alpes C&ocirc;te d'Azur - Administration</font></td>
...
/*pas de verif du mdp et user php7*/
   if (VerifSession ($user_pseudo,$user_mdp, $idconnect)=="1" or VerifSession ($user_pseudo,$user_mdp, $idconnect)=="0")
    ...
    <tr>
      ...
      <td class="phppr" colspan="3" width="70%" height="10" colspan="2" align="right">
        </td>
    </tr>
  </table>
  </center>
