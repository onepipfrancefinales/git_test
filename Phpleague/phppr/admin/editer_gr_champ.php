 ...
 $nb_resultats=mysqli_num_rows($resultats);
  ...
  if ($nb_resultats>0)
   ...
   else
     {
	  ...
	  mysqli_query($idconnect,("
	  INSERT INTO phppr_gr_championnats (id_champ, pts_prono_exact, pts_prono_participation, id_master, tps_avant_prono) 
...
echo "nom : ".$nom_gr_champ;
    mysqli_query($idconnect,("DELETE FROM phppr_gr_championnats 
							  WHERE id = '$gr_champ'"));

     reset ($champ);
	 while ( list($cle, $val)= each($champ))
         {
		  mysqli_query($idconnect,("INSERT INTO phppr_gr_championnats (id, nom, id_champ, activ_prono, pts_prono_exact, pts_prono_participation, id_master,tps_avant_prono)
...
<table class=phppr width="80%">
            <tr>
              <td class=phppr2 align="center" colspan="4"><?php echo ADMIN_GR_CHAMP_EDIT." " ; affich_gr_champ ($gr_champ, $idconnect);echo "aaaa"; echo $gr_champ;?></td><td class=phppr2 align="right"><a href="#" onclick="window.open('Assistant_fr/equipes_2.htm','Assistant','toolbar=0,location=0,directories=0,status=0,scrollbars=1,resizable=0,copyhistory=0,menuBar=0,width=512,height=512');return false;"><img border="0" alt="Assistant" src="aide.gif"></a></td>
            </tr>

            <tr>
              <td align="center" class=phppr6 colspan="4"><b><?php echo ADMIN_GR_CHAMP_EDIT_2; ?></b></td>
            </tr>
            ...
            <tr>
              <td align="center" class=phppr6 colspan="4"><b><?php echo ADMIN_GR_CHAMP_EDIT_5; ?></b></td>
            </tr>
              <td class=phppr3 colspan="5" align="center"><?php  champ_gr_menu ($gr_champ, $idconnect);echo "test3"; ?></td>
...
<table class=phppr width="80%">
            <tr>
              <td class=phppr2 align="center" colspan="3"><?php echo ADMIN_PARAM_MSG13." "; affich_gr_champ ($gr_champ, $idconnect);echo "test4"; ?></td>
            </tr>
            <tr>
