...
$result=$idconnect->query("
		...
		FROM phppr_clmnt_pronos, phppr_membres, phppr_gr_championnats
		WHERE type='general' 
		AND phppr_membres.id=phppr_clmnt_pronos.id_membre 
		AND phppr_gr_championnats.id='$gr_champ' 
		AND phppr_clmnt_pronos.id_champ='$gr_champ' 
		AND phppr_membres.id_prono='$user_id'
		GROUP BY participation
		ORDER by points 
		DESC, participation 
		DESC, phppr_membres.pseudo");
...
FROM phppr_clmnt_pronos, phppr_membres, phppr_gr_championnats
WHERE type='mensuel_en_cours' AND phppr_membres.id=phppr_clmnt_pronos.id_membre and phppr_gr_championnats.id='$gr_champ' and phppr_clmnt_pronos.id_champ='$gr_champ' and phppr_membres.id_prono='$user_id'
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phppr_clmnt_pronos, phppr_membres, phppr_gr_championnats
WHERE type='mensuel_30_jours' AND phppr_membres.id=phppr_clmnt_pronos.id_membre and phppr_gr_championnats.id='$gr_champ' and phppr_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phppr_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phppr_clmnt_pronos, phppr_membres, phppr_gr_championnats
WHERE type='hebdo' AND phppr_membres.id=phppr_clmnt_pronos.id_membre and phppr_gr_championnats.id='$gr_champ' and phppr_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phppr_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
