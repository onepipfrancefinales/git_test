...
if (isset($type))
{
   ...
   $row=mysqli_fetch_array($res);
    ...
    $res2=$idconnect->query("SELECT phppr_equipes.id FROM phppr_equipes, phppr_clubs
...
if ($debut=="1" and $fin==$nb_journees)
{
   ...
   $res3=$idconnect->query("SELECT max(phppr_journees.numero) FROM phppr_journees, phppr_matchs WHERE phppr_journees.id=phppr_matchs.id_journee and buts_dom is not NULL and     phppr_journees.id_champ='$champ'");
