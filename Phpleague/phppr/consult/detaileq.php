...
$color=0;
$result= $idconnect->query("SELECT phppr_divisions.nom, phppr_saisons.annee, (phppr_saisons.annee)+1 
...
$result= $idconnect->query("SELECT phppr_journees.numero, cldom.nom, clext.nom, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_matchs.date_reelle, phppr_matchs.id
...
echo "<tr class=\"trphppr3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
