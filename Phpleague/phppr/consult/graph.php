...
$query="SELECT phppr_clubs.nom, phppr_equipes.id_club, phppr_equipes.id_champ FROM phppr_equipes, phppr_clubs where phppr_clubs.id=phppr_equipes.id_club AND phppr_equipes.id='$equipe'";
...
$query="SELECT phppr_equipes.id FROM phppr_equipes, phppr_clubs WHERE id_champ='$champ' AND phppr_equipes.id_club=phppr_clubs.id AND phppr_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phppr_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phppr_saisons.annee, phppr_divisions.nom FROM phppr_saisons, phppr_divisions, phppr_championnats where phppr_championnats.id=$champ AND phppr_divisions.id=phppr_championnats.id_division and phppr_championnats.id_saison=phppr_saisons.id";
$result=mysql_query($query);
