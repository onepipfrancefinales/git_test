      ...
      $row[1] = stripslashes($row[1]);
             ...
             $extproba= $row[3];
              ...
              if ($x==1)
                ...
                echo "<TR bgcolor=$bgcolor width=\"100%\"><TD class=phppr align=\"center\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phppr align=\"center\">".$domproba."<TD class=phppr align=\"center\">-<TD>".$extproba."<TD align=\"center\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
        echo "</table>";
                               }
