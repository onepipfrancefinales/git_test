...
function nb_journees($id_champ, $idconnect)
         ...
         $reponse=$idconnect->query("SELECT id FROM phppr_equipes WHERE id_champ='$id_champ'");
...
function aff_journee($champ, $numero, $legende, $proba, $fiches_clubs, $id_equipe_fetiche)
    ...
    // cellule d'affichage des derniers résultats
      // cellule d'affichage des derniers résultats
  $color=0;
        $reponse=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phppr_matchs.buts_dom, phppr_matchs.buts_ext,
...
//suppression des liens sur les scores
  ...
  $resultats=$idconnect->query("SELECT phppr_clubs.nom, CLEXT.nom, phppr_matchs.buts_dom, phppr_matchs.buts_ext,
...
{
echo "<table class=\"tablephppr2\" align=\"center\" cellspacing=\"0\" width=\"95%\"><tr class=\"trphppr3\"><th colspan=\"11\">".$legende."</th></tr>\n";
echo "<tr class=\"trphppr3\">
