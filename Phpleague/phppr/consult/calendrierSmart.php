...
$reponse=$idconnect->query("SELECT id_equipe_fetiche, phppr_divisions.nom, phppr_saisons.annee, (phppr_saisons.annee)+1
...
$reponse= $idconnect->query("SELECT phppr_clubs.nom, CLEXT.nom, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_matchs.id, phppr_matchs.date_reelle
...
$reponse= $idconnect->query("SELECT phppr_journees.numero, phppr_journees.date_prevue, cldom.nom, clext.nom, phppr_matchs.buts_dom, phppr_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephppr2" cellspacing="0" width="100%" align="center">
...
<table class="tablephppr2" cellspacing="0" width="100%" align="center">
<tr class="trphppr3"><td colspan="3" align="center"><b>
<?php echo ADMIN_COHERENCE_MSG2." ".$row[0].CONSULT_MATCHS_MSG2.$date."</b></td></tr>";
                $x=2;
            }
