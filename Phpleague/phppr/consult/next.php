...
// Nom du champ
$query2="SELECT nom FROM phppr_divisions, phppr_championnats WHERE id_division=phppr_divisions.id and phppr_championnats.id='$champ'";
...
$query1="SELECT cldom.nom as cldom, clext.nom as clext, phppr_matchs.buts_dom, phppr_matchs.buts_ext , phppr_journees.date_prevue, cldom.id as cliddom, clext.id as clidext, phppr_matchs.date_reelle
      ...
      $row[1] = stripslashes($row[1]);
             ...
             if ($x==1)
                ...
                echo "<TR class=phppr ><TH class=phppr colspan=5 text-align=\"center\"><b> ". $numero."".$legende." le ".$jour."/".$mois."/".$annee."".CONSULT_CLMNT_MSG5."".$heure."h".$minute."</b></th></tr>";
                }
                ...
                echo "<TR class=phppr bgcolor=$bgcolor width=\"100%\"><TD class=phppr align=\"right\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phppr align=\"center\">".$domproba."<TD class=phppr align=center>-<TD class=phppr>".$extproba."<TD class=phppr align=\"left\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
