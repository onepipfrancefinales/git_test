...
<a href=\"http://phpleague.univert.org\">Phpleague</a> : Gestionnaire de championnats sportifs et de pronostics !
  ...
  if ($email)
  {
    ...
    echo "<tr><td colspan=\"2\" align=\"center\">".PRONO_INSCRIPTION_SUCCES."<br /><a href=\"\">".PRONO_INSCRIPTION_CONNEXION."</a></td></tr>";
    echo "</table>";
  }
  else 
  {
    echo "<table align=\"center\">";
    echo "<tr><td colspan=\"2\" align=\"center\">".PRONO_INSCRIPTION_ECHOUE."<br /><a href=\"index.php\">Connexion !</a></td></tr>";
    echo "</table>";
  }
...
{
  echo "<table align=\"center\">";
  echo "<tr><td colspan=\"2\" align=\"center\">$message<br /><a href=\"javascript:history.back(1)\">".RETOUR."</a></td></tr>";
  echo "</table>";
}
