...
$query1="SELECT cldom.nom as cldom, clext.nom as clext, phpl_matchs.buts_dom, phpl_matchs.buts_ext , phpl_journees.date_prevue, cldom.id as cliddom, clext.id as clidext, phpl_matchs.date_reelle
      ...
      $row[1] = stripslashes($row[1]);
             ...
             if ($x==1)
                ...
                echo "<TR class=phpl ><TH class=phpl colspan=5 text-align=\"center\"><b> ". $numero."".$legende." le ".$jour."/".$mois."/".$annee."".CONSULT_CLMNT_MSG5."".$heure."h".$minute."</b></th></tr>";
                }
                ...
                echo "<TR class=phpl bgcolor=$bgcolor width=\"100%\"><TD class=phpl align=\"right\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phpl align=\"center\">".$domproba."<TD class=phpl align=center>-<TD class=phpl>".$extproba."<TD class=phpl align=\"left\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
