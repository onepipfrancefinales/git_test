...
//buteurs
 ...
 $nb_buteurs=mysql_num_rows( $result3 );
	 ...
	 $row_menu[0] = stripslashes($row_menu[0]);
         ...
         echo "<tr>";
         print "<td align=\"right\" class=$class>$row_menu[0]<td class=$class>";
         echo "<input type=\"hidden\" name=\"nbdom[]\" value=\"$row_menu[2]\">";
         echo "<input type=\"hidden\" name=\"matchs_id[]\" value=\"$row_menu[4]\">";
         echo "<input type=\"hidden\" name=\"butd[]\" value=\"1\">";
         echo "<input type=\"hidden\" name=\"butv[]\" value=\"1\">";
         echo "<input type=\"hidden\" name=\"nbext[]\" value=\"$row_menu[3]\">";
         $x=0;
          while ($x<$row_menu[2])
               {  
