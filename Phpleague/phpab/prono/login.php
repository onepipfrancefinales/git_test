<?php
echo "Phpleague (login)";echo "<br>";
if (isset($_GET['mode'])) $mode = $_GET['mode'];
else $mode = "AAAA";
if (isset($_REQUEST['champLigue'])) $champLigue = $_REQUEST['champLigue'];
else $champLigue = "AAAA";


echo "mode1 : " . $mode;echo "<br>";
...
echo "user : " . $user;
echo "<br>";
echo "autoidentification : " . $autoidentification;
echo "<br>";
echo "mode : " . $mode;
echo "<br>";
echo "pass : " . $pass;
...
if (!isset($_REQUEST['user']) or !isset($_REQUEST['pass'])) {
	...
	echo "Phpleague5";
	echo "<br>";
		 header("Location: /Phpleague/phpab/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=0");
	...
	if ($row['mot_de_passe'] != $password_crypt or mysqli_num_rows($result) == "0") {
		 	header("Location: /Phpleague/phpab/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=1");
	} else {
		echo "<br>";
		echo "Phpleague7";
		echo "<br>";
...
echo "mode : " . $mode;
echo "<br>";
		//header("Location: /Phpleague/phpab/prono/index.php?champLigue=$champLigue");
			header("Location: /Phpleague/phpab/prono/index.php?page=pronos&mode=$mode&champLigue=$champLigue");
