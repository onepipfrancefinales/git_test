...
$result=$idconnect->query("
		...
		FROM phpca_clmnt_pronos, phpca_membres, phpca_gr_championnats
		WHERE type='general' 
		AND phpca_membres.id=phpca_clmnt_pronos.id_membre 
		AND phpca_gr_championnats.id='$gr_champ' 
		AND phpca_clmnt_pronos.id_champ='$gr_champ' 
		AND phpca_membres.id_prono='$user_id'
		GROUP BY participation
		ORDER by points 
		DESC, participation 
		DESC, phpca_membres.pseudo");
...
FROM phpca_clmnt_pronos, phpca_membres, phpca_gr_championnats
WHERE type='mensuel_en_cours' AND phpca_membres.id=phpca_clmnt_pronos.id_membre and phpca_gr_championnats.id='$gr_champ' and phpca_clmnt_pronos.id_champ='$gr_champ' and phpca_membres.id_prono='$user_id'
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpca_clmnt_pronos, phpca_membres, phpca_gr_championnats
WHERE type='mensuel_30_jours' AND phpca_membres.id=phpca_clmnt_pronos.id_membre and phpca_gr_championnats.id='$gr_champ' and phpca_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpca_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpca_clmnt_pronos, phpca_membres, phpca_gr_championnats
WHERE type='hebdo' AND phpca_membres.id=phpca_clmnt_pronos.id_membre and phpca_gr_championnats.id='$gr_champ' and phpca_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpca_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
