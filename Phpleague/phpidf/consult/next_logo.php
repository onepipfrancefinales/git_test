...
$query1="SELECT logodom.url as logodom, logoext.url as logoext, phpidf_matchs.buts_dom, phpidf_matchs.buts_ext, phpidf_journees.date_prevue, logodom.id as logoiddom, logoext.id as logoidext
                FROM phpidf_equipes as dom, phpidf_equipes as ext, phpidf_matchs, phpidf_journees, phpidf_logo as logodom, phpidf_logo as logoext
                WHERE phpidf_matchs.id_equipe_dom=dom.id
                      AND phpidf_matchs.id_equipe_ext=ext.id
                      AND phpidf_journees.id_champ='$champ'
                      AND phpidf_journees.numero='$numero'
