...
?>
   ...
   $requete=$idconnect->query("SELECT DISTINCT * FROM phpidf_clmnt_cache WHERE ID_CHAMP='$champ' ORDER BY POINTS DESC, PEN DESC, DIFF DESC, BUTSPOUR DESC , BUTSCONTRE ASC, NOM");
