...
$color=0;
$result= $idconnect->query("SELECT phpidf_divisions.nom, phpidf_saisons.annee, (phpidf_saisons.annee)+1 
...
echo "<table class=\"tablephpidf2\" align=\"center\" cellspacing=\"0\"  width=\"100%\">";


$result= $idconnect->query("SELECT phpidf_journees.numero, cldom.nom, clext.nom, phpidf_matchs.buts_dom, phpidf_matchs.buts_ext, phpidf_matchs.date_reelle, phpidf_matchs.id
...
echo "<tr class=\"trphpidf3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
