...
function aff_journee($champ, $bdd)
{
  ...
  echo "<br>";
  echo "<table class=\"tablephpidf2 marginAuto width90PC \" ><tr><td>
...
//mise en forme tableau oppositions
echo "<br>";
echo "<table class=\"marginAuto tablephpidf2 width90PC \" ><tr>
        ...
        AND phpidf_equipes.id_club=phpidf_clubs.id");
            ...
            AND phpidf_equipes.id_club=phpidf_clubs.id";
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  if ($cache == "1") {
                    $question .= "phpidf_clmnt_cache ";
                  } else {
                    $question .= "phpidf_clmnt ";
                  }
          ...
          PEN='$PEN'";
              ...
              function clmnt($champ, $smart, $bdd)
              {
                ...
                echo "<table class=\"tablephpidf2 marginAuto width80PC borderSpacing\" ><tr class=\"trphpidf3\"><th colspan=\"4\">" . $legende . "</th></tr>\n";
                echo "<tr class=\"trphpidf3\">
