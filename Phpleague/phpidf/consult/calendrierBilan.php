...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpidf_divisions.nom, phpidf_saisons.annee, (phpidf_saisons.annee)+1
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpidf2" cellspacing="0" width="290" align="center">
