...
$reponse=$idconnect->query("SELECT id_equipe_fetiche, phpidf_divisions.nom, phpidf_saisons.annee, (phpidf_saisons.annee)+1
...
$reponse= $idconnect->query("SELECT phpidf_clubs.nom, CLEXT.nom, phpidf_matchs.buts_dom, phpidf_matchs.buts_ext, phpidf_matchs.id, phpidf_matchs.date_reelle
...
$reponse= $idconnect->query("SELECT phpidf_journees.numero, phpidf_journees.date_prevue, cldom.nom, clext.nom, phpidf_matchs.buts_dom, phpidf_matchs.buts_ext, dom.id, ext.id
