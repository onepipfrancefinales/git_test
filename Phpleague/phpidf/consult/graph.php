...
$query="SELECT phpidf_clubs.nom, phpidf_equipes.id_club, phpidf_equipes.id_champ FROM phpidf_equipes, phpidf_clubs where phpidf_clubs.id=phpidf_equipes.id_club AND phpidf_equipes.id='$equipe'";
...
$query="SELECT phpidf_equipes.id FROM phpidf_equipes, phpidf_clubs WHERE id_champ='$champ' AND phpidf_equipes.id_club=phpidf_clubs.id AND phpidf_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpidf_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpidf_saisons.annee, phpidf_divisions.nom FROM phpidf_saisons, phpidf_divisions, phpidf_championnats where phpidf_championnats.id=$champ AND phpidf_divisions.id=phpidf_championnats.id_division and phpidf_championnats.id_saison=phpidf_saisons.id";
$result=mysql_query($query);
