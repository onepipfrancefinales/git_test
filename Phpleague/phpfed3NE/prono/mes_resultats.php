...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpfed3NE_clmnt_pronos, phpfed3NE_membres, phpfed3NE_gr_championnats
WHERE type='mensuel_30_jours' AND phpfed3NE_membres.id=phpfed3NE_clmnt_pronos.id_membre and phpfed3NE_gr_championnats.id='$gr_champ' and phpfed3NE_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpfed3NE_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpfed3NE_clmnt_pronos, phpfed3NE_membres, phpfed3NE_gr_championnats
WHERE type='hebdo' AND phpfed3NE_membres.id=phpfed3NE_clmnt_pronos.id_membre and phpfed3NE_gr_championnats.id='$gr_champ' and phpfed3NE_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpfed3NE_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
