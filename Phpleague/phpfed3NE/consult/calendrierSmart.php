...
$reponse=$idconnect->query("SELECT id_equipe_fetiche, phpfed3NE_divisions.nom, phpfed3NE_saisons.annee, (phpfed3NE_saisons.annee)+1
...
$reponse= $idconnect->query("SELECT phpfed3NE_clubs.nom, CLEXT.nom, phpfed3NE_matchs.buts_dom, phpfed3NE_matchs.buts_ext, phpfed3NE_matchs.id, phpfed3NE_matchs.date_reelle
...
$reponse= $idconnect->query("SELECT phpfed3NE_journees.numero, phpfed3NE_journees.date_prevue, cldom.nom, clext.nom, phpfed3NE_matchs.buts_dom, phpfed3NE_matchs.buts_ext, dom.id, ext.id
