...
{
    $VER_PHP = 'Votre version PHP : '.PHP_VERSION.'.<br />PHPLeague peut comporter des erreurs � cause des fonctions obsol�tes.';
}
else
{
	$VER_PHP = '';
...
if (VerifSession($user_pseudo, $user_mdp) == 1)
{
	...
	{
		$FOLD_INST = InfoReqSql('InfInst', 0, 'error', 'alert', 'Dossier "install" encore pr�sent. Par mesure de s�curit�s, je vous conseille de le supprimer.');
	}
	else
	{
		$FOLD_INST = '';
...
?>
	...
	<div id="footer">
		<a>PHPLeague <?php echo VER; ?></a> - Copyright &copy; 2004-<?php echo date('Y'); ?> - Tous droits réservés - <a href="mailto:Alexis@univert.org">Alexis MANGIN</a>
	</div>
