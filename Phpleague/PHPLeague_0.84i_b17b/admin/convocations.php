...
echo InfoReqSql('Info', 0, 'error', 'alert', 'En cours de correction. D�sol� de la g�ne occasionn�e.');
...
?>
	...
	<div class="Cadre">
		...
		<label>Choix de la journée</label>
...
<?php
		...
		if ($nbav > 0)
		{
          ...
          order by phpl_convoques.id desc";               
			...
			echo InfoReqSql('InfSendMail', 0, 'error', 'alert', $nbav2.' mail'.$S.' non envoyé'.$S);
		}
		//--------------
