...
define('MENU_CONSULT', 'Consultation');
define("MENU_GEST_PHOTOS","Gestion photos");
...
// Championnats
define("ARBITRE","Arbitres");
define("LEAGUE","Championnats");
define("DATE","Dates");
define("TEAM","Equipes");
define("MATCH","Matchs");
define("PARAMETRE","Paramètres");
define("GENERER","Générer les résultats");
define("JOUEURS","Joueurs");
define("BUTEUR","Buteurs");

define("COMPTPS","Temps de jeu");
define("COMPTPS2","Temps de jeu");
define("COMPO","Titulaires");
define("COMPO2","Remplaçants");
define("CJ","Cartons jaunes");
define("CR","Cartons rouges");
...
define("ADMIN_GRP_CHAMP_CREA1", "Création du groupe de championnats avec succès");
define("ADMIN_GRP_CHAMP_CREA2", "Groupe de championnats non enregistré. Erreur");
define("ADMIN_GRP_CHAMP_SUPP1", "Supression du groupe de championnats avec succès");
define("ADMIN_GRP_CHAMP_SUPP2", "Groupe de championnats non supprimé. Erreur");
...
define("ADMIN_GR_CHAMP_CREER_1","Nom du groupe");
define("ADMIN_GR_CHAMPIONNATS_SUPP","Suppression d'un groupe de championnats");
...
// Création championnat
define("ADMIN_CHAMP_CREA1", "Création de la saison avec succès");
define("ADMIN_CHAMP_CREA2", "Création de la division avec succès");
define("ADMIN_CHAMP_CREA3", "Création du championnat avec succès");
define("ADMIN_CHAMP_EXIST1", "Saison existante");
define("ADMIN_CHAMP_EXIST2", "Division existante");
define("ADMIN_CHAMP_EXIST3", "Championnat existant");
define("ADMIN_CHAMP_SUPP1", "Suppression de la saison avec succès");
define("ADMIN_CHAMP_SUPP2", "Suppression de la division avec succès");
define("ADMIN_CHAMP_ERR1", "Saison non ajouté");
define("ADMIN_CHAMP_ERR2", "Division non ajouté");
define("ADMIN_CHAMP_ERR3", "Championnat non ajouté");
define("ADMIN_CHAMP_ERR4", "Saison non supprimée");
define("ADMIN_CHAMP_ERR5", "Division non supprimée");
...
// Equipes
define("ADMIN_EQUIPE_CREA_1", "Création de l'équipe effectuée avec succès");
define("ADMIN_EQUIPE_CREA_2", "Equipe existante");
define("ADMIN_EQUIPE_CREA_3", "Equipe non enregistrée");
define("ADMIN_EQUIPE_CREA_4", "Equipe ajouté dans le championnat avec succès");
define("ADMIN_EQUIPE_CREA_5", "Equipe non ajouté dans le championnat");
define("ADMIN_EQUIPE_SUPPR_1", "Suppression de l'équipe avec succès");
define("ADMIN_EQUIPE_SUPPR_2", "Suppression des données de l'équipe avec succès");
define("ADMIN_EQUIPE_SUPPR_4", "Equipe non supprimée");
...
define("ADMIN_JOURNEES_MSG10","sous la forme jjmmaaaa");
...
// Matchs
define("ADMIN_MATCHS_CREA1", "Match(s) enregistré(s) avec succès.");
...
define("ADMIN_COHERENCE_MSG4","incohérente ou incomplète");
...
// Paramètres
define("ADMIN_PARAM_CREA1","Paramètres enregistrés avec succès");
define("ADMIN_PARAM_CREA2","Paramètres non enregistrés. Erreur");
define("ADMIN_PARAM_MAJ1","Mise à jour des paramètres avec succès");
...
define("ADMIN_PARAM_TITRE","Paramètres");
define("ADMIN_TAPVERT_TITRE","Pénalité");
...
define("ADMIN_PARAM_MSG12","Nombre d'heure entre la fin de validation de la grille et le match");
define("ADMIN_PARAM_MSG13","Pronostics de");
define('ADMIN_PARAM_MSG14', 'Temps de jeux total d\'un match');
define('ADMIN_PARAM_MSG15', 'Points bonus offensif');
define('ADMIN_PARAM_MSG16', 'Points bonus défensif');
define("ADMIN_TAPVERT_MSG1","Vous pouvez gérer les points de pénalité, sanctions administratives, forfaits, etc ...");
...
define('ADMIN_TAPVERT_MSG6', 'Activer les estimations dans la page du classement');
define('ADMIN_TAPVERT_MSG7', 'Points de pénalité');


// Joueurs
define("ADMIN_JOUEUR_CREA_1", "Création du joueur effectuée avec succès");
define("ADMIN_JOUEUR_EDIT_1", "Mise à jour des renseignements effectuée avec succès");
define("ADMIN_JOUEUR_SUPPR_1", "Suppression du joueur effectuée avec succès");
define("ADMIN_JOUEUR_TRANS_1", "Transfert(s) effectué(s) avec succès");


// Résultats
define("ADMIN_RESULT_CREA1", "Résultat(s) enregistré(s) avec succès.");
...
// Titulaires
define("ADMIN_TIT_DOM_ADD1", "Ajout titulaire(s) domicile avec succès");
define("ADMIN_TIT_EXT_ADD2", "Ajout titulaire(s) extérieur avec succès");
define("ADMIN_TIT_DEL1", "Suppression du joueur effectuée avec succès");
define("ADMIN_TIT_DEL2", "Suppression non effectuée. Erreur");


// Remplaçants
define("ADMIN_REMP_DOM_ADD1", "Ajout titulaire(s) domicile avec succès");
define("ADMIN_REMP_EXT_ADD2", "Ajout titulaire(s) extérieur avec succès");
define("ADMIN_REMP_DEL1", "Suppression du joueur effectuée avec succès");
define("ADMIN_REMP_DEL2", "Suppression non effectuée. Erreur");


// Cartons Jaunes et Rouges
define("ADMIN_CART_J_DOM_ADD1", "Ajout carton(s) jaune(s) domicile avec succès");
define("ADMIN_CART_J_EXT_ADD2", "Ajout carton(s) jaune(s) extérieur avec succès");
define("ADMIN_CART_J_DOM_ADD3", "Carton(s) jaune(s) domicile non ajouté(s). Erreur");
define("ADMIN_CART_J_EXT_ADD4", "Carton(s) jaune(s) extérieur non ajouté(s). Erreur");
define("ADMIN_CART_R_DOM_ADD1", "Ajout carton(s) rouge(s) domicile avec succès");
define("ADMIN_CART_R_EXT_ADD2", "Ajout carton(s) rouge(s) extérieur avec succès");
define("ADMIN_CART_R_DOM_ADD3", "Carton(s) rouge(s) domicile non ajouté(s). Erreur");
define("ADMIN_CART_R_EXT_ADD4", "Carton(s) rouge(s) extérieur non ajouté(s). Erreur");


// Compo d'équipes
define("ADMIN_TPS_MAJ1","Mise à jour des temps de jeux domicile avec succès.");
define("ADMIN_TPS_MAJ2","Mise à jour des temps de jeux extérieur avec succès.");
define("ADMIN_TPS_MAJ3","Mise à jour non effectuée. Erreur");


define("ADMIN_COMPO_TITRE","Compositions d'équipes de");
define("ADMIN_TPS_TITRE","Temps de jeu de");
define("ADMIN_TPS2_TITRE","Temps de jeu de");
define("ADMIN_COMPO2_TITRE","Remplacements de"); 
define("ADMIN_CJ_TITRE","Cartons jaunes de");
define("ADMIN_CR_TITRE","Cartons rouges de");
...
define("ADMIN_GRAPH_4","Erreur lors de la création de graphique, réessayez ! Y a t-il eu au moins un pronostic ?");
define("ADMIN_GRAPH_4a","Erreur lors de la création de graphique, réessayez ! Y a t-il eu au moins un match de joué ?");
...
define("ADMIN_MINI_13","Code à copier dans vos pages.");
...
define("ADMIN_CLASSE_2","Paramètre(s) enregistré(s) avec succès.");
...
define("ADMIN_CLASSE_RENS","Renseignements");  // 0.82
define("ADMIN_CLASSE_GEST","Gestion des clubs");  // 0.82



// FICHIER admin/gestequipes.php
define("ADMIN_GESTEQUIPE_MAJ1", "Mise à jour du logo avec succès");
define("ADMIN_GESTEQUIPE_MAJ2", "Mise à jour de la photo d'équipe avec succès");
define("ADMIN_GESTEQUIPE_MAJ3", "Mise à jour des renseignements avec succès");
define("ADMIN_GESTEQUIPE_MAJ4", "Mise à jour non effectuée");
...
define("ADMIN_GESTEQUIPE_1","Réglage des paramètres de : "); // 0.82
define("ADMIN_GESTEQUIPE_3","Renseignement"); // 0.82
define("ADMIN_GESTEQUIPE_4","Valeur"); // 0.82
define("ADMIN_EQUIPE_5","Lien Web");
define("ADMIN_EQUIPE_6","Afficher");
define("ADMIN_EQUIPE_7","Nom du fichier logo");
define("ADMIN_EQUIPE_STADE","Url photo stade");
define("ADMIN_EQUIPE_8", "Non renseigné");
define("ADMIN_EQUIPE_9", "Nom du fichier photo équipe");

// FICHIER admin/rens.php
define("ADMIN_RENS_TITRE","Edition des renseignements");
define("ADMIN_RENS_SUPP1","Suppression d'un renseignement ");
define("ADMIN_RENS_BUTTON_SUPP","Suppression renseignement");
define("ADMIN_RENS_CREA","Ajout d'un renseignement");
define("ADMIN_RENS_NOM","Nom du renseignement : ");
define("ADMIN_RENS_BUTTON_CREA","Création renseignements");
define("ADMIN_RENS_CREA2","Création effectuée");
define("ADMIN_RENS_SUPP2","Suppression effectuée avec succès");
...
define("ADMIN_RENS_4","Insérer");
define("ADMIN_RENS_5","Supprimez les paramètres des renseignements (Choix multiple possible avec la touche SHIFT et CTRL) : ");
define("ADMIN_RENS_6"," dans ");
define("ADMIN_RENS_7","Ajouter");
define("ADMIN_RENS_8","Supprimer");
define("ADMIN_RENS_9","Ordre d'affichage");
define("ADMIN_RENS_10","Editer les renseignements");
...
define("ADMIN_RENS_16","Etes-vous sûr de vouloir supprimer le renseignement");
...
define("CONSULT_COMPO","Statistiques");
define("CONSULT_COMPO2","Remplacements");
define("CONSULT_CJ","Cartons J");
define("CONSULT_CR","Cartons R");
...
define('ADMIN_TAPVERT_MSG2', 'Choix d\'un championnat'); // Quel championnat :
define('ADMIN_TAPVERT_MSG2a', 'Choix d\'une équipe :');  // Quelle equipe :
define("GENERAL","Général");
define("ATTAQUE","Attaque");
define("DEFENSE","Défense");
define("GOALDIFF","Diff");
define("CONSULT_CLMNT_MSG2","journée");
...
define("CONSULT_CLMNT_MSG7","Estimation des scores de la prochaine journée :");
define("CONSULT_CLMNT_MSG8","Estimation prochaine journée n°");
...
define("JOURNEE","N°");
define("DETAILEQ_TITRE", 'Choix de l\'équipe'); // Quelle équipe :
...
// divers
define("RETOUR","Page précédente");

// FICHIER admin/clubs.php
define("ADMIN_CLUB_TITRE","Edition des clubs");
define("ADMIN_CLUB_SUPP1","Suppression d'un club");
...
define("ADMIN_CLUB_CREA2","Création effectuée avec succès.");
define("ADMIN_CLUB_SUPP2","Suppression effectuée avec succès");



define('CONSULT_NB1_M', 'er');
define('CONSULT_NB1_F', 'ère');
define('CONSULT_NB2', 'ème');
define('CONSULT_NB3', 'ème');
define('CONSULT_NBX', 'e');

define('CONSULT_JOURNEE_LAST', 'Dernière journée');
define('CONSULT_JOURNEE_NEXT', 'Prochaine journée');
define('CONSULT_JOURNEE_DE', 'journée de');

// consult/buteurs
define("CONSULT_BUTEUR_MSG1","Quel groupe de championnat ?");
define("CONSULT_BUTEUR_MSG20"," ");
define("CONSULT_BUTEUR_MSG2","Buteurs");
define("CONSULT_BUTEUR_TITRE_1","Classement des buteurs");

define("CONSULT_COMPO_TITRE_1","Titularisations");
define("CONSULT_COMPO2_TITRE_1","Remplacements");
define("CONSULT_CJ_TITRE_1","Cartons jaunes");
define("CONSULT_CR_TITRE_1","Cartons rouges");

define("CONSULT_BUTEUR_MSG3","Groupe de Championnats : ");
define("CONSULT_COMPO_MSG2","Groupe de Championnats : ");
define("CONSULT_BUTEUR_MSG4","comprenant : ");
define("CONSULT_COMPO_MSG3","comprenant : ");
...
define('ADMIN_COMPO_TITRE2', 'Composition d\'équipe de ');
...
define("ADMIN_JOUEURS_MSG1","Cette manipulation supprime les buts marqués par le joueur au cours de ce championnat"); // 0.82
...
define("ADMIN_JOUEURS_MSG6","Equipe"); // 0.82
define("ADMIN_JOUEURS_MSG7","Photo");
define("ADMIN_JOUEURS_MSG8","Date de naissance");
define("ADMIN_JOUEURS_MSG9","Position de terrain");
define("ADMIN_JOUEURS_MSG10","Pour <b>modifier</b> le nom d'un joueur, utilisez PHPMyAdmin");
define("ADMIN_JOUEURS_MSG11","Numéro du joueur :");
define("ADMIN_JOUEURS_MSG12","Pays");
define("ADMIN_JOUEURS_MSG13","Taille");
define("ADMIN_JOUEURS_MSG14","Poids");
define("ADMIN_JOUEURS_11","<b>Entrez</b> les joueurs match par match. Pour <b>supprimer</b> un joueur, cliquez sur celui-ci.");
define("ADMIN_JOUEURS_TPS","<b>Entrez</b> le temps de jeu pour chaque joueur.");
define("ADMIN_JOUEURS_TPS2","<b>Entrez</b> le temps de jeu pour chaque joueur.");
...
define("ADMIN_COMPO_2","Titulaires");
define("ADMIN_TPS","Tps de jeu");
define("ADMIN_TPS2","Tps de jeu remp");
define("ADMIN_COMPO2_2","Remplacants");
define("ADMIN_CJ_2","CJ");
define("ADMIN_CR_2","CR");
...
define("ADMIN_JOUEURS_EDITER","Choisir un joueur"); // 0.82
...
define("PRONO_MENU_GENERAL","Général");
define("PRONO_MENU_MOIS","Mois");
define("PRONO_MENU_PROCHAINE_GRILLE","Prochaine grille");
define("PRONO_MENU_DERNIERE_GRILLE","Dernière grille");
define("PRONO_MENU_MES_RESULTATS","Mes résultats");
define("PRONO_MENU_BAREME","Barème");
define("PRONO_MENU_AIDE","Aide");  // 0.82

// Menu non identifié
define("PRONO_MENU_LOGIN","Pseudo");
...
define("PRONO_CLASSEMENT_HEBDO","Classement hebdomadaire");
define("PRONO_CLASSEMENT_COMPLET","Classement complet");
define("PRONO_CLASSEMENT_REDUIT","Classement réduit");
...
// Profil
define("PRONO_PROFIL_SUR","Confirmez la suppression du compte");
...
define("PRONO_PROFIL_ANCIEN_MDP_2","Ancien mot de passe (<i>si vous changer de mot de passe</i>)");
define("PRONO_PROFIL_NOUVEAU_MDP","Nouveau mot de passe");
define("PRONO_PROFIL_NOUVEAU_MDP_2","Saisissez de nouveau votre mot de passe");
define("PRONO_PROFIL_MAIL","E-mail"); // 0.82

// prono.inc
define("PRONO_INC_INSCRIPTION","Inscription");
define("PRONO_INC_HEBDO","Classement hebdomadaire");
define("PRONO_INC_MOIS","Classement du mois");
define("PRONO_INC_GENERAL","Classement général");
...
// Fiches joueurs   //0.82
define("FICHE_NUMERO","Numéro");
define("FICHE_AGE","Age");
define("FICHE_DATE","Né le");
define("FICHE_NATIONALITE","Nationalité");
define("FICHE_TAILLE","Taille");
define("FICHE_POIDS","Poids");
define("FICHE_POSITION","Position sur le terrain");
define("FICHE_DETAIL","voir le détail des buts");
define("FICHE_DETAIL2","voir le détail des matchs");
define("FICHE_DETAIL3","voir le détail des entrées en jeu");
define("FICHE_DETAIL4","voir le détail des cartons jaunes");
define("FICHE_DETAIL5","voir le détail des cartons rouges");
define("FICHE_BUTS","but");
define("FICHE_STATS","match");
define("FICHE_STATS2","entrée");
define("FICHE_CJ","carton");
define("FICHE_CR","carton");
...
// MOD STATS V2
define("CONSULT_COMPO_MSG1","Classement des titularisations et temps de jeu");
define("CONSULT_COMPO2_MSG1","Classement des entrées en jeu");
define("CONSULT_CJ_MSG1","Classement des cartons jaunes");
define("CONSULT_CR_MSG1","Classement des cartons rouges");

//Convocation 
define("CONSULT_CONVOCATION","Convocation");
define("MENU_CONVOCATIONS","Convocation");
define("ADMIN_JOUEURS_CONVOC_MSG1","Email");
define("ADMIN_JOUEURS_CONVOC_MSG2","Adresse postale");
define("ADMIN_JOUEURS_CONVOC_MSG3","Numéro de téléphone");

define("FICHE_DRAPEAU","Activation du drapeau");
define("FICHE_MAILLOT","N°");
define("FICHE_MAILLOTa","Numero de maillot");
define("FICHE_POID","Poids");
define("FICHE_NATION","Nationalité");
define("ADMIN_POS","Création d'un poste");
