...
echo "pass : ".$pass;echo "<br>";
	...
	if(!isset($_REQUEST['user']) or !isset($_REQUEST['pass']))
	{
   	 ...
   	 header("Location: /Phpleague/phpau/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=0");
	}
	...
	else
	{
      echo "Phpleague7";echo "<br>";
		...
		{
        	header("Location: /Phpleague/phpau/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=1");
		}
		...
		$result =$idconnect->query( "SELECT * FROM phpau_membres WHERE pseudo='$user'");
		...
		mysqli_query( $idconnect,("UPDATE phpau_membres SET ip='$ip', last_connect='$time' WHERE pseudo='$user'"));
	...
	echo "login.php : mot_de_passe -".$_SESSION['mot_de_passe'];echo "<br>";
		...
		//header("Location: /Phpleague/phpau/prono/index.php?champLigue=$champLigue");
		header("Location: /Phpleague/phpau/prono/index.php?page=pronos&mode=$mode&champLigue=$champLigue");
