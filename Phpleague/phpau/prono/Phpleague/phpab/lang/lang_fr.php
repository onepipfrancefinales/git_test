...
define("SETUP_FIN","Pour plus de sécurité, vous devez &agrave; présent supprimer le fichiers install.php !
...
define("SETUP_MAJ_ACHEVEE","Mise &agrave; jour achevée");    // 0.82
...
define("ADMIN_GR_CHAMP_EDIT_1","Sélectionner les championnats &agrave; regrouper dans");
...
define("ADMIN_CHAMP_CREER_4","Saison (1�re aée;e)");
...
define("ADMIN_DATES_2","Attention, en faisant cette opération vous imposez la m�me heure &agrave; tous les matchs de la saison. Si vous ne voulez changer que la date ou l'heure d'un match ou d'une jouée;e passez plut�t par les");
...
define("ADMIN_GRAPH_PRONO","Le classement des membres a été réalisée avec succ�s"); //0.82
define("ADMIN_GRAPH_1","La création des graphiques a échoué, veuillez réessayer !");
define("ADMIN_GRAPH_2","Cette manoeuvre est &agrave; effectuer apr�s chaque ajout deée;sultats. Elle peut prendre un certain temps...");
...
define("ADMIN_CLASSE_2","<b>Param�tres enregisée;s !</b>");
...
define("ADMIN_GESTEQUIPE_1","Réglage des param&egrave;tres de : "); // 0.82
...
define("CONSULT_CLMNT_MSG61","Précédente journée (n&deg;");
...
define("CONSULT_CLMNT_MSG10","Classement &agrave; domicile, journées ");
...
define("CONSULT_CLMNT_MSG14","Classement &aacute; l'extérieur, journées ");
...
define("CONSULT_CALENDAR_4","Matchs précédentsournée n&deg;");
define("CONSULT_CALENDAR_5","Derniers résultats : journée n&deg;");
...
define("ADMIN_JOUEURS_TRANSFERT_VERS","&agrave; transférer vers"); // 0.82
define("ADMIN_JOUEURS_EDITER","Choisir le joueur &agrave; éditer :"); // 0.82
...
define("PRONO_OUBLIE_TEXTE_2","Votre nouveau mot de passe vous a été envoyé &agrave; l'adresse");
define("PRONO_OUBLIE_TEXTE_3","Le mot de passe ne peux vous �tre envée; !<br />Renouvelez votre demande dans un instant, merci.");
...
define("PRONO_INSCRIPTION_PSEUDO_UTILISE","Ce pseudo est déj&agrave; utilisé !");
...
define("PRONO_INSCRIPTION_SUCCES","Inscription réalisée avec succ�s ! Un email vous éeée; adreée; pour vous communiquez votre mot de passe !");
...
define("PRONO_PROFIL_ANCIEN_MDP_2","Ancien mot de passe (&agrave; compléter si vous changer de mot de passe)");
...
define("PRONO_BAREME_TPS","Vous pouvez validé la grille jusqu'&agrave;");
