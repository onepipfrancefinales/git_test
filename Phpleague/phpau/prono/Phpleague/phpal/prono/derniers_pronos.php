...
$query="SELECT phpal_clubs.nom, CLEXT.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, phpal_matchs.id, phpal_matchs.date_reelle, phpal_journees.numero, pts_prono_exact, pts_prono_participation
...
$query2= "SELECT pronostic FROM phpal_pronostics, phpal_membres WHERE phpal_pronostics.id_match='$row[4]' AND phpal_membres.id=phpal_pronostics.id_membre AND phpal_membres.id_prono='$user_id'";
