...
$reponse=$idconnect->query("SELECT id_equipe_fetiche, phpal_divisions.nom, phpal_saisons.annee, (phpal_saisons.annee)+1
...
$reponse= $idconnect->query("SELECT phpal_clubs.nom, CLEXT.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, phpal_matchs.id, phpal_matchs.date_reelle
...
$reponse= $idconnect->query("SELECT phpal_journees.numero, phpal_journees.date_prevue, cldom.nom, clext.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, dom.id, ext.id
