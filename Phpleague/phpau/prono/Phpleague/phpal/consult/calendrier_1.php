...
else
{
    ...
    echo "<div align=\"center\">";
      ...
      elseif (isset($numero))
      {
      $query="SELECT max(phpal_journees.numero) FROM phpal_journees, phpal_matchs where phpal_journees.id=phpal_matchs.id_journee and phpal_journees.id_champ='$champ' and phpal_journees.numero='$numero'";
      }
      ...
      $row=mysql_fetch_array($result);
             ...
             $result=(mysql_query("SELECT fiches_clubs, id_equipe_fetiche
                               ...
                               WHERE phpal_parametres.id_champ='$champ'"));
