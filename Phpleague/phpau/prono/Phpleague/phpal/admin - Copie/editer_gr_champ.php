 ...
 $nb_resultats=mysqli_num_rows($resultats);
  ...
  if ($nb_resultats>0)
   ...
   else
     {
	  ...
	  mysqli_query($idconnect,("
	  INSERT INTO phpal_gr_championnats (id_champ, pts_prono_exact, pts_prono_participation, id_master, tps_avant_prono) 
...
echo "nom : ".$nom_gr_champ;
    mysqli_query($idconnect,("DELETE FROM phpal_gr_championnats 
							  WHERE id = '$gr_champ'"));

     reset ($champ);
	 while ( list($cle, $val)= each($champ))
         {
		  mysqli_query($idconnect,("INSERT INTO phpal_gr_championnats (id, nom, id_champ, activ_prono, pts_prono_exact, pts_prono_participation, id_master,tps_avant_prono)
...
<table class=phpal width="80%">
            ...
            <tr>
              ...
              <td class=phpal3 colspan="5" align="center"><?php  champ_gr_menu ($gr_champ, $idconnect);echo "test3"; ?></td>
...
<table class=phpal width="80%">
            <tr>
              <td class=phpal2 align="center" colspan="3"><?php echo ADMIN_PARAM_MSG13." "; affich_gr_champ ($gr_champ, $idconnect);echo "test4"; ?></td>
            </tr>
            <tr>
