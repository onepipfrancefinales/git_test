...
function nb_journees($id_champ, $idconnect)
         ...
         $reponse=$idconnect->query("SELECT id FROM phpau_equipes WHERE id_champ='$id_champ'");
...
// cellule d'affichage des derniers r�sultats
  $color=0;
        $reponse=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phpau_matchs.buts_dom, phpau_matchs.buts_ext,
...
//suppression des liens sur les scores
  ...
  $resultats=$idconnect->query("SELECT phpau_clubs.nom, CLEXT.nom, phpau_matchs.buts_dom, phpau_matchs.buts_ext,
...
{
echo "<table class=\"tablephpau2\" align=\"center\" cellspacing=\"0\" width=\"95%\"><tr class=\"trphpau3\"><th colspan=\"11\">".$legende."</th></tr>\n";
echo "<tr class=\"trphpau3\">
