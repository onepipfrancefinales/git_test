...
?>
    ...
    $id_equipe_fetiche=$row['id_equipe_fetiche'];
     ...
     $resultats=$idconnect->query("SELECT phpau_equipes.id FROM phpau_equipes, phpau_clubs
   ...
   $requete=$idconnect->query("SELECT DISTINCT * FROM phpau_clmnt_cache WHERE ID_CHAMP='$champ' ORDER BY POINTS DESC, PEN DESC, DIFF DESC, BUTSPOUR DESC , BUTSCONTRE ASC, NOM");
