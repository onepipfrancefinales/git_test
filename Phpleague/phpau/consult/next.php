...
// Nom du champ
$query2="SELECT nom FROM phpau_divisions, phpau_championnats WHERE id_division=phpau_divisions.id and phpau_championnats.id='$champ'";
...
$query1="SELECT cldom.nom as cldom, clext.nom as clext, phpau_matchs.buts_dom, phpau_matchs.buts_ext , phpau_journees.date_prevue, cldom.id as cliddom, clext.id as clidext, phpau_matchs.date_reelle
      ...
      $row[1] = stripslashes($row[1]);
             ...
             if ($x==1)
                ...
                echo "<TR class=phpau ><TH class=phpau colspan=5 text-align=\"center\"><b> ". $numero."".$legende." le ".$jour."/".$mois."/".$annee."".CONSULT_CLMNT_MSG5."".$heure."h".$minute."</b></th></tr>";
                }
                ...
                echo "<TR class=phpau bgcolor=$bgcolor width=\"100%\"><TD class=phpau align=\"right\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phpau align=\"center\">".$domproba."<TD class=phpau align=center>-<TD class=phpau>".$extproba."<TD class=phpau align=\"left\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
