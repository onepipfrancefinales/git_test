...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpab_divisions.nom, phpab_saisons.annee, (phpab_saisons.annee)+1
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpab2" cellspacing="0" width="290" align="center">
