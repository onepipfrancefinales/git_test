...
<table class=phpfed3GS width="80%">
  <tr>
    <td class=phpfed3GS2 align="center" colspan="3">
  ...
  <tr>
    <td align="center">
	  <?php
		...
		mysqli_query($idconnect,("DELETE FROM phpfed3GS_clmnt_pronos 
		...
		$result=$idconnect->query(" 
				...
				FROM phpfed3GS_membres, phpfed3GS_pronostics
				WHERE id_champ='$gr_champ' 
		...
		$result=$idconnect->query("
				...
				FROM phpfed3GS_membres, phpfed3GS_pronostics, phpfed3GS_matchs
				WHERE id_champ='$gr_champ'
				AND id_membre=phpfed3GS_membres.id
