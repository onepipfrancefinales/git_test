...
// Nombres de renseignement dans cette classe à partir de l'id_classe  (utilisé dans phpfed3GS_classe.php)
...
// Nombres de classes enregistrées (ulilisé dans phpfed3GS_classe.php)
