...
{   
  mysqli_query ($idconnect,("INSERT INTO phpfed3GS_gr_championnats (nom) VALUES ('$nom_group')")) or die ("probleme " .mysql_error($idconnect));
}


if ($confirm=="ok" and $gr_champ and $action=="supp")
{
      mysqli_query($idconnect,("DELETE FROM phpfed3GS_gr_championnats WHERE id ='$gr_champ' "))or die ("probleme " .mysql_error($idconnect));
}
?>

<br /><font class=phpfed3GS><?php echo GR_LEAGUE; ?></font><br /><br />

<table class=phpfed3GS width="90%">
            <tr>
              <td class=phpfed3GS2><?php echo MENU_ID; ?></td>
              <td class=phpfed3GS2><?php echo MENU_NOM; ?></td>
              <td class=phpfed3GS2></td>
            </tr>
