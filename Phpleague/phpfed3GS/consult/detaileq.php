...
$color=0;
$result= $idconnect->query("SELECT phpfed3GS_divisions.nom, phpfed3GS_saisons.annee, (phpfed3GS_saisons.annee)+1 
...
$result= $idconnect->query("SELECT phpfed3GS_journees.numero, cldom.nom, clext.nom, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext, phpfed3GS_matchs.date_reelle, phpfed3GS_matchs.id
...
echo "<tr class=\"trphpfed3GS3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
