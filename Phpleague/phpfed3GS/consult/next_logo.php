...
$query1="SELECT logodom.url as logodom, logoext.url as logoext, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext, phpfed3GS_journees.date_prevue, logodom.id as logoiddom, logoext.id as logoidext
                FROM phpfed3GS_equipes as dom, phpfed3GS_equipes as ext, phpfed3GS_matchs, phpfed3GS_journees, phpfed3GS_logo as logodom, phpfed3GS_logo as logoext
                WHERE phpfed3GS_matchs.id_equipe_dom=dom.id
                      AND phpfed3GS_matchs.id_equipe_ext=ext.id
                      AND phpfed3GS_journees.id_champ='$champ'
                      AND phpfed3GS_journees.numero='$numero'
