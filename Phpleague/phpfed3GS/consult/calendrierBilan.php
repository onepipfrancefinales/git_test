...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpfed3GS_divisions.nom, phpfed3GS_saisons.annee, (phpfed3GS_saisons.annee)+1
...
$resultats2=$idconnect->query("SELECT phpfed3GS_clubs.nom, CLEXT.nom, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext, phpfed3GS_matchs.id, phpfed3GS_matchs.date_reelle
...
$result=$idconnect->query("SELECT phpfed3GS_journees.numero, phpfed3GS_journees.date_prevue, cldom.nom, clext.nom, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpfed3GS2" cellspacing="0" width="290" align="center">
