...
<table border="0" width="72%">
    <tr class="trphpfed3GS3" valign="top"> 
      <td height="18"> 
...
function aff_journee($champ, $numero, $legende, $proba, $fiches_clubs, $id_equipe_fetiche)
        ...
        $color=0;
        $query1="SELECT cldom.nom as cldom, clext.nom as clext, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext,
        ...
        echo "<table align=\"center\" class=\"tablephpfed3GS2\" width=\"80%\" cellspacing=\"0\" cellpadding=\"0\"><tr><td><table cellspacing=\"0\" align=\"center\" width=\"100%\" cellpadding=\"1\">\n";
        $x=1;
        $minute = 0;
        $heure = 0;
        $jour = 0;
        ...
        $annee = 0;
             ...
             $extproba= $row[3];
                ...
                {
                $query2="SELECT DOMBUTSPOUR, DOMG, DOMN, DOMP, DOMBUTSCONTRE FROM phpfed3GS_clmnt_cache WHERE ID_EQUIPE='$row[eqdom]'";
                ...
                $query2="SELECT EXTG, EXTN, EXTP, EXTBUTSCONTRE, EXTBUTSPOUR FROM phpfed3GS_clmnt_cache WHERE ID_EQUIPE='$row[eqext]'";
                $result2=mysql_query($query2);
                      while ($row2=mysql_fetch_array($result2))
                      {
  ...
  $requete="SELECT phpfed3GS_clubs.nom, CLEXT.nom, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext,
...
{
echo "<table class=\"tablephpfed3GS2\" align=\"center\" cellspacing=\"0\" width=\"100%\"><tr class=\"trphpfed3GS3\"><th colspan=\"11\">".$legende."</th></tr>\n";
echo "<tr class=\"trphpfed3GS3\">
...
{
echo "<table class=\"tablephpfed3GS2\" align=\"center\" cellspacing=\"0\" width=\"60%\" bgcolor=\"#FFFFFF\"><tr class=\"trphpfed3GS3\"><th colspan=\"11\">".$legende."<br /></th></tr>\n";
...
{
echo "<table class=\"tablephpfed3GS2\" align=\"center\" cellspacing=\"0\" width=\"60%\"><tr class=\"trphpfed3GS3\"><th colspan=\"11\">".$legende;
