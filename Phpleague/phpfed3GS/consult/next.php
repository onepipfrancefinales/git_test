...
// Nom du champ
$query2="SELECT nom FROM phpfed3GS_divisions, phpfed3GS_championnats WHERE id_division=phpfed3GS_divisions.id and phpfed3GS_championnats.id='$champ'";
...
$query1="SELECT cldom.nom as cldom, clext.nom as clext, phpfed3GS_matchs.buts_dom, phpfed3GS_matchs.buts_ext , phpfed3GS_journees.date_prevue, cldom.id as cliddom, clext.id as clidext, phpfed3GS_matchs.date_reelle
      ...
      $row[1] = stripslashes($row[1]);
             ...
             if ($x==1)
                ...
                echo "<TR class=phpfed3GS ><TH class=phpfed3GS colspan=5 text-align=\"center\"><b> ". $numero."".$legende." le ".$jour."/".$mois."/".$annee."".CONSULT_CLMNT_MSG5."".$heure."h".$minute."</b></th></tr>";
                }
                ...
                echo "<TR class=phpfed3GS bgcolor=$bgcolor width=\"100%\"><TD class=phpfed3GS align=\"right\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phpfed3GS align=\"center\">".$domproba."<TD class=phpfed3GS align=center>-<TD class=phpfed3GS>".$extproba."<TD class=phpfed3GS align=\"left\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
