...
$query="SELECT phpfed3GS_clubs.nom, phpfed3GS_equipes.id_club, phpfed3GS_equipes.id_champ FROM phpfed3GS_equipes, phpfed3GS_clubs where phpfed3GS_clubs.id=phpfed3GS_equipes.id_club AND phpfed3GS_equipes.id='$equipe'";
...
$query="SELECT phpfed3GS_equipes.id FROM phpfed3GS_equipes, phpfed3GS_clubs WHERE id_champ='$champ' AND phpfed3GS_equipes.id_club=phpfed3GS_clubs.id AND phpfed3GS_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpfed3GS_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpfed3GS_saisons.annee, phpfed3GS_divisions.nom FROM phpfed3GS_saisons, phpfed3GS_divisions, phpfed3GS_championnats where phpfed3GS_championnats.id=$champ AND phpfed3GS_divisions.id=phpfed3GS_championnats.id_division and phpfed3GS_championnats.id_saison=phpfed3GS_saisons.id";
$result=mysql_query($query);
