...
define("SETUP_FIN","Pour plus de sécurité, vous devez � ée;sent supprimer le fichiers install.php !
...
define("SETUP_MAJ_ACHEVEE","Mise � jour achée;e");    // 0.82
...
define("ADMIN_DATES_2","Attention, en faisant cette opération vous imposez la m�me heure � tous les matchs de la saison. Si vous ne voulez changer que la date ou l'heure d'un match ou d'une jéute;e passez plut�t par les");
...
define("ADMIN_GRAPH_2","Cette manoeuvre est � effectuer apr�s chaque ajout éute;sultats. Elle peut prendre un certain temps...");
...
define("ADMIN_MINI_12","Aper&ccedil;u");
...
define("ADMIN_JOUEURS_TRANSFERT_VERS","� tranée;rer vers"); // 0.82
define("ADMIN_JOUEURS_EDITER","Choisir le joueur �é;diter :"); // 0.82
...
define("PRONO_OUBLIE_TEXTE_2","Votre nouveau mot de passe vous a été envoyé � l'adresse");
...
define("PRONO_INSCRIPTION_PSEUDO_UTILISE","Ce pseudo est déj� utilée; !");
...
define("PRONO_PROFIL_ANCIEN_MDP_2","Ancien mot de passe (� comée;ter si vous changer de mot de passe)");
...
define("PRONO_BAREME_TPS","Vous pouvez validé la grille jusqu'�");
