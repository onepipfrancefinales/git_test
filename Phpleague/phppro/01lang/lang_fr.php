...
define("SETUP_FIN","Pour plus de s&eacute;curit&eacute;, vous devez à pr&eacute;sent supprimer le fichiers install.php !
...
define("SETUP_MAJ_ACHEVEE","Mise à jour achev&eacute;e");    // 0.82
...
define("ADMIN_GR_CHAMP_EDIT_1","S&eacute;lectionner les championnats à regrouper dans");
...
define("ADMIN_DATES_2","Attention, en faisant cette op&eacute;ration vous imposez la même heure à tous les matchs de la saison. Si vous ne voulez changer que la date ou l'heure d'un match ou d'une journ&eacute;e passez plutôt par les");
...
define("ADMIN_GRAPH_2","Cette manoeuvre est à effectuer après chaque ajout de r&eacute;sultats. Elle peut prendre un certain temps...");
...
define("CONSULT_CLMNT_MSG10","Classement à domicile, journ&eacute;es ");
...
define("ADMIN_JOUEURS_TRANSFERT_VERS","à transf&eacute;rer vers"); // 0.82
define("ADMIN_JOUEURS_EDITER","Choisir le joueur à &eacute;diter :"); // 0.82
...
define("PRONO_OUBLIE_TEXTE_2","Votre nouveau mot de passe vous a &eacute;t&eacute; envoy&eacute; à l'adresse");
...
define("PRONO_INSCRIPTION_PSEUDO_UTILISE","Ce pseudo est d&eacute;jà utilis&eacute; !");
...
define("PRONO_PROFIL_ANCIEN_MDP_2","Ancien mot de passe (à compl&eacute;ter si vous changer de mot de passe)");
...
define("PRONO_BAREME_TPS","Vous pouvez valid&eacute; la grille jusqu'à");
