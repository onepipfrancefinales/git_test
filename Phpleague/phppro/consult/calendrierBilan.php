...
$result=$idconnect->query("SELECT id_equipe_fetiche, phppro_divisions.nom, phppro_saisons.annee, (phppro_saisons.annee)+1
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephppro2" cellspacing="0" width="290" align="center">
