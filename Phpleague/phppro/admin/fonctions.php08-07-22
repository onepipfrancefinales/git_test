...
// TABLEAU DE CLASSEMENT
  ...
  $result=$idconnect->query("SELECT phppro_clubs.nom, phppro_equipes.penalite, phppro_equipes.id, phppro_equipes.pts_admin, phppro_equipes.jour_pere
	...
	*/
	...
	if($cache=="1")
	{$requete="DELETE FROM phppro_clmnt_cache WHERE nom='exempte'" or die (mysql_error($idconnect));}
	else
	{$requete="DELETE FROM phppro_clmnt WHERE nom='exempte'" or die (mysql_error($idconnect));}
