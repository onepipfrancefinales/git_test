<link rel="stylesheet" type="text/css" href="../phpProno/league.css">
<body class=phpl>
  ...
  if (!$test=="erreur")
    {
     ...
     $contenu .= "\$lang=\"$lang\";\n";
     $contenu .= "\$phpabEAGUE_RACINE=\"$repertoire_script\";\n";
     $contenu .= "?>\n";
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpab_buteurs,
  championnats TO phpab_championnats,
  classe TO phpab_classe,
  clmnt TO phpab_clmnt,
  clmnt_graph TO phpab_clmnt_graph,
  clmnt_pronos TO phpab_clmnt_pronos,
  clubs TO phpab_clubs,
  divisions TO phpab_divisions,
  donnee TO phpab_donnee,
  equipes TO phpab_equipes,
  joueurs TO phpab_joueurs,
  journees TO phpab_journees,
  logo TO phpab_logo,
  matchs TO phpab_matchs,
  membres TO phpab_membres,
  parametres TO phpab_parametres,
  pronostics TO phpab_pronostics,
  rens TO phpab_rens,
  saisons TO phpab_saisons,
  tapis_vert TO phpab_tapis_vert;
  ALTER TABLE `phpab_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpab_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpab_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpab_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpab_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpab_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpab_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpab_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpab_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpab_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpab_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpab_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpab_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpab_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpab_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpab_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpab_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpab_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpab_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpab_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpab_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpab_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpab_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpab_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpab_buteurs` DROP `id_joueur`;
ALTER TABLE `phpab_joueurs` DROP `id_club`;
DROP TABLE `phpab_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpab_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpab_clubs` DROP INDEX `id`;
ALTER TABLE `phpab_clubs` DROP INDEX `nom`;
ALTER TABLE `phpab_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpab_championnats` DROP INDEX `id`;
ALTER TABLE `phpab_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpab_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpab_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpab_classe` DROP INDEX `id`;
ALTER TABLE `phpab_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpab_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpab_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpab_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpab_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpab_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpab_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpab_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpab_divisions` DROP INDEX `id`;
ALTER TABLE `phpab_equipes` DROP INDEX `id`;
ALTER TABLE `phpab_journees` DROP INDEX `id`;
ALTER TABLE `phpab_journees` DROP INDEX `numero`;
ALTER TABLE `phpab_logo` DROP PRIMARY KEY;
ALTER TABLE `phpab_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpab_logo` DROP INDEX `id_club`;
ALTER TABLE `phpab_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpab_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpab_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpab_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpab_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpab_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpab_rens` DROP INDEX `id`;
ALTER TABLE `phpab_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpab_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpab_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpab_tapis_vert`;
ALTER TABLE `phpab_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpab_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpab_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpab_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpab_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpab_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpab_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpab_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpab_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpab_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpab_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpab_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpab_joueurs.id, phpab_equipes.id
          FROM phpab_joueurs, phpab_equipes, phpab_buteurs, phpab_matchs, phpab_clubs
          WHERE phpab_equipes.id_club=phpab_clubs.id
          AND (
           phpab_matchs.id_equipe_dom = phpab_equipes.id
           OR phpab_matchs.id_equipe_ext = phpab_equipes.id
              )
          AND phpab_matchs.id=phpab_buteurs.id_match
          AND phpab_joueurs.id_club=phpab_equipes.id_club
          AND phpab_buteurs.id_joueur=phpab_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpab_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpab_effectif.id, phpab_buteurs.id_match, phpab_joueurs.id
          FROM phpab_joueurs, phpab_equipes, phpab_buteurs, phpab_matchs, phpab_clubs, phpab_effectif
          WHERE phpab_equipes.id_club=phpab_clubs.id
          AND (
           phpab_matchs.id_equipe_dom = phpab_equipes.id
           OR phpab_matchs.id_equipe_ext = phpab_equipes.id
          ...
          AND phpab_joueurs.id_club=phpab_equipes.id_club
          AND phpab_buteurs.id_joueur=phpab_joueurs.id
          AND phpab_effectif.id_joueur=phpab_joueurs.id
          AND phpab_effectif.id_equipe=phpab_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpab_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpab_joueurs.nom, phpab_joueurs.prenom, phpab_buteurs.id, phpab_journees.numero, phpab_matchs.date_reelle, phpab_joueurs.id
FROM phpab_joueurs, phpab_buteurs, phpab_matchs, phpab_equipes, phpab_journees
WHERE phpab_matchs.id = phpab_buteurs.id_match
AND phpab_buteurs.id_joueur = phpab_joueurs.id
AND phpab_buteurs.id_effectif =0
AND (
phpab_matchs.id_equipe_dom = phpab_equipes.id
OR phpab_matchs.id_equipe_ext = phpab_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpProno//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpab_clubs.nom, phpab_equipes.id, phpab_matchs.id
             FROM phpab_joueurs, phpab_equipes, phpab_buteurs, phpab_matchs, phpab_clubs, phpab_journees
             WHERE phpab_equipes.id_club = phpab_clubs.id
             AND (
             phpab_matchs.id_equipe_dom = phpab_equipes.id
             OR phpab_matchs.id_equipe_ext = phpab_equipes.id
...
$sql_maj_1="ALTER TABLE `phpab_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpab_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpab_clubs` DROP INDEX `id`;
ALTER TABLE `phpab_clubs` DROP INDEX `nom`;
ALTER TABLE `phpab_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpab_championnats` DROP INDEX `id`;
ALTER TABLE `phpab_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpab_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpab_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpab_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpab_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpab_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpab_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpab_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpab_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpabeague@univert.org<phpleague@univert.org>";
...
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpProno//%22$url_site/%22>$url_site</a></font></p>
