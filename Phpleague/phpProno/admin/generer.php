...
<table class=phpProno width="80%">
            <tr>
              <td class=phpProno2 align="center" colspan="3"><?php echo ADMIN_GRAPH_TITRE." "; affich_champ ($champ, $idconnect); ?></td>
            </tr>
            <tr>
            <td align="center">
<?php
...
$pl=1;
      ...
      while ($row=mysqli_fetch_array($result))
        ...
        $query="INSERT INTO phpProno_clmnt_graph (id_equipe, fin, classement) VALUES ('$id_equipe','$fin', '$pl')" ;
...
//$idconnect=@mysqli_connect('127.0.0.1','root','','onepip-france-db3');	
  ...
  $result=$idconnect->query("SELECT phpProno_clmnt_graph.id_equipe 
