...
echo "action -> impacte uniquement la table phpProno_clmnt_pronos";echo "<br />";
?>
<table class=phpProno width="80%">
  <tr>
    <td class=phpProno2 align="center" colspan="3">
  ...
  <tr>
    <td align="center">
	  <?php
		...
		mysqli_query($idconnect,("DELETE FROM phpProno_clmnt_pronos 
		...
		$result=$idconnect->query(" 
				...
				FROM phpProno_membres, phpProno_pronostics
				WHERE id_champ='$gr_champ' 
		...
		$result=$idconnect->query("
				...
				FROM phpProno_membres, phpProno_pronostics, phpProno_matchs
				WHERE id_champ='$gr_champ'
				AND id_membre=phpProno_membres.id
