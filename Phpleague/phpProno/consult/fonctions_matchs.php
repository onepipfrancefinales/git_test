...
{
 $resultat=$bdd->query("
		  SELECT phpProno_clubs.nom FROM phpProno_clubs, phpProno_equipes 
		  WHERE phpProno_equipes.id='$id_equipe' 
...
echo "<table class=\"tablephpProno2\" align=\"center\" cellspacing=\"0\"  width=\"90%\">";

$resultat=$bdd->query("
		SELECT phpProno_journees.numero, cldom.nom, clext.nom, phpProno_matchs.buts_dom, phpProno_matchs.buts_ext, phpProno_matchs.date_reelle, phpProno_matchs.id
        ...
        WHERE phpProno_matchs.id_equipe_dom=dom.id
        AND phpProno_matchs.id_equipe_ext=ext.id
        AND (phpProno_matchs.id_equipe_ext='$id_equipe'
        OR phpProno_matchs.id_equipe_dom='$id_equipe')
        AND phpProno_journees.id_champ='$champ'
        AND dom.id_club=cldom.id
        AND ext.id_club=clext.id
        AND phpProno_matchs.id_journee=phpProno_journees.id
...
echo "<br />";echo "<br />";
	if ($smart == false)
	echo "<tr class=\"trphpProno3\"><td align=\"center\"><font color=\"#FFFF00\"><b>".JOURNEE."</b></font></td><td width=\"5% align=\"center\"></td><td width=\"30%\" ><font color=\"#FFFF00\"><b>".DATE."</b></font></td><td colspan=\"5\ align=\"center\"><font color=\"#FFFF00\"><b>Oppositions</b></font></td></tr>";
    else
	echo"<tr class=\"trphpProno3\"><td align=\"center\"><font color=\"#FFFF00\"><b>".JOURNEE."</b></font></td><td width=\"5% align=\"center\"></td><td colspan=\"5\ align=\"center\"><font color=\"#FFFF00\"><b>Oppositions</b></font></td></tr>";
...
{	
 ...
 $resultats2=$bdd->query("SELECT phpProno_clubs.nom, CLEXT.nom, phpProno_matchs.buts_dom, phpProno_matchs.buts_ext, phpProno_matchs.id, phpProno_matchs.date_reelle
 ...
 $result=$bdd->query("SELECT phpProno_journees.numero, phpProno_journees.date_prevue, cldom.nom, clext.nom, phpProno_matchs.buts_dom, phpProno_matchs.buts_ext, dom.id, ext.id
 ...
 while ($row=$result->fetch())
 {
  ...
  { 
   ...
   {   
    ...
    ?>    
	<table class="tablephpProno2" cellspacing="0" width="290" align="center">
	  <tr class="trphpProno3"><td colspan="3" align="center"><b><font color="#FFFF00">
