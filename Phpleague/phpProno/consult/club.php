...
$result= $idconnect->query("SELECT phpProno_clubs.id, phpProno_clubs.nom, id_champ, id_club
							FROM phpProno_clubs, phpProno_equipes
							WHERE phpProno_equipes.id_champ='$champ' and phpProno_equipes.id_club=phpProno_clubs.id
							ORDER BY nom");
...
$result= $idconnect->query("SELECT phpProno_classe.nom, phpProno_classe.id 
							FROM phpProno_classe 
							order by rang");
//$result=mysql_query ($query);
        ...
        echo "<tr class=\"trphpProno3\"><td align=\"center\"><b>$row[0]</b></td></tr>";
        $id_classe=$row[1];
        echo "<tr><td><table cellspacing=\"0\"><tr class=\"trphpProno\"><td>";
...
echo "<table class=\"tablephpProno2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpProno3\"><td align=\"center\"><b>Effectif</b></td></tr><tr><td>";

$result= $idconnect->query("SELECT phpProno_equipes.id 
							FROM phpProno_equipes, phpProno_clubs 
							WHERE phpProno_clubs.id='$id_clubs' 
							AND id_champ='$champ' 
...
{ $row[0]=addslashes($row[0]);
 $resultats1 = $idconnect->query("SELECT nom, prenom, phpProno_joueurs.id
									FROM phpProno_joueurs, phpProno_effectif
									WHERE phpProno_joueurs.id=phpProno_effectif.id_joueur
									AND phpProno_effectif.id_equipe='$equipe'
...
echo "<table class=\"tablephpProno2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpProno3\"><td align=\"center\"><b>".CONSULT_CLUB_4."</b></td></tr>";
        echo "<tr><td><center><img src=\"graph.php?equipe=$equipe\" alt=\"\"></center></td></tr>";


echo"</table><br /><br /><br />";

echo "<table class=\"tablephpProno2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpProno3\" align=\"center\"><td><b>".CONSULT_CLUB_3."</b></td></tr>";
...
$result= $idconnect->query("SELECT annee, phpProno_divisions.nom, phpProno_championnats.id, phpProno_equipes.id
							...
							AND phpProno_equipes.id_club='$id_clubs'
...
?>
<br />
<p align="right"><font face="Verdana" size="1">Powered by <a href="http://phpPronoeague.univert.org" target="_blank">phpPronoeague</a></font></p>
