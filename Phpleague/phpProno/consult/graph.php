...
$query="SELECT phpProno_clubs.nom, phpProno_equipes.id_club, phpProno_equipes.id_champ FROM phpProno_equipes, phpProno_clubs where phpProno_clubs.id=phpProno_equipes.id_club AND phpProno_equipes.id='$equipe'";
...
$query="SELECT phpProno_equipes.id FROM phpProno_equipes, phpProno_clubs WHERE id_champ='$champ' AND phpProno_equipes.id_club=phpProno_clubs.id AND phpProno_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpProno_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpProno_saisons.annee, phpProno_divisions.nom FROM phpProno_saisons, phpProno_divisions, phpProno_championnats where phpProno_championnats.id=$champ AND phpProno_divisions.id=phpProno_championnats.id_division and phpProno_championnats.id_saison=phpProno_saisons.id";
$result=mysql_query($query);
