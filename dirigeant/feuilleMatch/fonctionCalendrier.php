...
<?php if ($valeur5>0)
	...
	$reponse = mysql_query("SELECT idffr, comite, code FROM bdclubs WHERE code='$equipe'"); // Requ�te SQL 
	...
	$reponse = mysql_query("SELECT sigle,comite, code FROM bdclubs WHERE idffr='$id_equipe'"); // Requ�te SQL 
	While ($donnees = mysql_fetch_array($reponse) )
		{ 
  		$equipe = $donnees['code'];
		}
...
<?php //recherche d'un club de federale 1
	...
	$reponse = mysql_query("SELECT id_club FROM phpf1_equipes WHERE id_club='$equipe'"); // Requ�te SQL 
	While ($donnees = mysql_fetch_array($reponse) )
		{ 
...
<?php //recherche d'un club de federale 2
	...
	$reponse = mysql_query("SELECT id_club FROM phpfed2_equipes WHERE id_club='$equipe'"); // Requ�te SQL 
	While ($donnees = mysql_fetch_array($reponse) )
		{ 
...
<?php //recherche d'un club de federale 3GS
	...
	$reponse = mysql_query("SELECT id_club FROM phpfed3GS_equipes WHERE id_club='$equipe'"); // Requ�te SQL 
	While ($donnees = mysql_fetch_array($reponse) )
		{ 
...
<?php //recherche d'un club de federale 3NE
	...
	$reponse = mysql_query("SELECT id_club FROM phpfed3NE_equipes WHERE id_club='$equipe'"); // Requ�te SQL 
	While ($donnees = mysql_fetch_array($reponse) )
		{ 
