...
<table width="43%" height="39">
  <tr>
    ...
    <td width="61%"> 
      <?php //include "ftp.php"; ?>
      <?php include "uploadListeOnepipDir.php"; ?>
     
      <hr/>
	  <hr/>
      <?php //include "uploadListeOnepip.php"; ?>
      Vous pouvez v&eacute;rifier, en cliquant sur les boutons effectif complet 
      ou Informations licence </td>
  </tr>
</table>
</body>
</html>
