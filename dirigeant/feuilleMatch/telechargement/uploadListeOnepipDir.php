...
$cheminn=dirname(__FILE__)."/dirigeants/listeDirigeantsOnepip.csv";
/*
echo "chemin : ".$cheminn;
echo "<br/>";
/*
...
//recherche des caractere mentionne dans la premi�re ligne
...
if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
   ...
   // echo 'Le dossier n\'existe pas';
	...
	echo "<br/>";
     ...
     {
          echo 'Transfert des licences effectu&eacute; avec succès !';echo "<br/>";
     }
...
if ($fonction == 1 )
	...
	$query="DELETE FROM $table
		WHERE id_perso BETWEEN 1 AND 500 and club='$club'";
...
// ***** Traitement du fichier *******;
	...
	echo "Nombre de licence int�gr� : ".$nbreDeLigne;
	echo "<br/>";
	echo "<br/>";
   $caratereSeparation =",";
   while (!feof($fp)) 
