...
?>
  ...
  <table width="1300" border="0">
    <tr> 
      ...
      <td rowspan="25" height="441" bgcolor="#999999" width="10"></td>
      ...
      <td rowspan="25" height="529" bgcolor="999999" width="6">&nbsp;</td>
      <td width="317" height="31"> 
        <div id="listeJoueurs"> 
    ...
    <tr> 
      ...
      <td width="317" height="2" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
    ...
    <tr> 
      ...
      <td width="317" height="26" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom81.' '.$tabPrenom81;?>
        </div>
      </td>
      <td width="38" height="26" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id81; ?>" value="<?php echo $retour81 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267"> 
      ...
      <td width="317"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom82.' '.$tabPrenom82;?>
        </div>
      </td>
      <td width="38"> 
        <input type="text" name="M<?php echo $id82; ?>" value="<?php echo $retour82 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" bgcolor="#CCCCCC"> 
      ...
      <td width="317" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom83.' '.$tabPrenom83;?>
        </div>
      </td>
      <td width="38" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id83; ?>" value="<?php echo $retour83 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="28"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom84.' '.$tabPrenom84;?>
        </div>
      </td>
      <td width="38" height="28"> 
        <input type="text" name="M<?php echo $id84; ?>" value="<?php echo $retour84 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" bgcolor="#CCCCCC"> 
      ...
      <td width="317" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom85.' '.$tabPrenom85;?>
        </div>
      </td>
      <td width="38" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id85; ?>" value="<?php echo $retour85 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="21"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom86.' '.$tabPrenom86;?>
        </div>
      </td>
      <td width="38" height="21"> 
        <input type="text" name="M<?php echo $id86; ?>" value="<?php echo $retour86 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="27" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom87.' '.$tabPrenom87;?>
        </div>
      </td>
      <td width="38" height="27" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id87; ?>" value="<?php echo $retour87 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="31"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom88.' '.$tabPrenom88;?>
        </div>
      </td>
      <td width="38" height="31"> 
        <input type="text" name="M<?php echo $id88; ?>" value="<?php echo $retour88 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="22" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom89.' '.$tabPrenom89;?>
        </div>
      </td>
      <td width="38" height="22" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id89; ?>" value="<?php echo $retour89 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="13"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom90.' '.$tabPrenom90;?>
        </div>
      </td>
      <td width="38" height="13"> 
        <input type="text" name="M<?php echo $id90; ?>" value="<?php echo $retour90 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="33" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom16.' '.$tabPrenom16;?>
        </div>
      </td>
      <td width="28" height="33" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id16; ?>"  value="<?php echo $retour16 ;?>" size="2">
      </td>
      <td height="33" width="255" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom41.' '.$tabPrenom41;?>
        </div>
      </td>
      <td width="34" height="33" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id41; ?>" value="<?php echo $retour41 ;?>"  size="2">
      </td>
      <td height="33" width="256" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
      ...
      <td width="317" height="33" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom91.' '.$tabPrenom91;?>
        </div>
      </td>
      <td width="38" height="33" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id91; ?>" value="<?php echo $retour91 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="317" height="2"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom92.' '.$tabPrenom92;?>
        </div>
      </td>
      <td width="38" height="2"> 
        <input type="text" name="M<?php echo $id92; ?>" value="<?php echo $retour92 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="29" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom18.' '.$tabPrenom18;?>
        </div>
      </td>
      <td width="28" height="29" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id18; ?>"  value="<?php echo $retour18 ;?>" size="2">
      </td>
      <td height="29" width="255" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom43.' '.$tabPrenom43;?>
        </div>
      </td>
      <td width="34" height="29" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id43; ?>" value="<?php echo $retour43 ;?>"  size="2">
      </td>
      <td height="29" width="256" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom68.' '.$tabPrenom68; ?>
        </div>
      </td>
      <td width="33" height="29" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id68; ?>" value="<?php echo $retour68 ;?>"  size="2">
      </td>
      <td width="317" height="29" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom93.' '.$tabPrenom93;?>
        </div>
      </td>
      <td width="38" height="29" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id93; ?>" value="<?php echo $retour93 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td height="18" width="256"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom69.' '.$tabPrenom69; ?>
        </div>
      </td>
      <td width="33" height="18"> 
        <input type="text" name="M<?php echo $id69; ?>" value="<?php echo $retour69 ;?>"  size="2">
      </td>
      <td width="317" height="18"> 
        <div id="listeJoueurs"> </div>
        <?php echo $tabNom94.' '.$tabPrenom94;?>
      </td>
      <td width="38" height="18"> 
        <input type="text" name="M<?php echo $id94; ?>" value="<?php echo $retour94 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="26" bgcolor="#CCCCCC"> 
      ...
      <td width="317" height="26" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom95.' '.$tabPrenom95;?>
        </div>
      </td>
      <td width="38" height="26" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id95; ?>" value="<?php echo $retour95 ;?>"  size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="19"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom21.' '.$tabPrenom21;?>
        </div></td>
      <td width="28" height="19">
        <input type="text" name="M<?php echo $id21; ?>"  value="<?php echo $retour20 ;?>" size="2">
      </td>
      <td height="19" width="255"> 
        <div id="listeJoueurs"> 
      ...
      <td width="317" height="19">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom96.' '.$tabPrenom96;?>
        </div></td>
      <td width="38" height="19"> 
        <input type="text" name="M<?php echo $id96; ?>"  value="<?php echo $retour96 ;?>" size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="19" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom22.' '.$tabPrenom22;?>
        </div></td>
      <td width="28" height="19" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id22; ?>"  value="<?php echo $retour22 ;?>" size="2">
      </td>
      <td height="19" width="255" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom47.' '.$tabPrenom47;?>
        </div></td>
      <td width="34" height="19" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id47; ?>"  value="<?php echo $retour47 ;?>" size="2">
      </td>
      <td height="19" width="256" bgcolor="#CCCCCC">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom72.' '.$tabPrenom72;?>
        </div></td>
      <td width="33" height="19" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id72; ?>"  value="<?php echo $retour72 ;?>" size="2">
      </td>
      <td width="317" height="19" bgcolor="#CCCCCC">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom97.' '.$tabPrenom97;?>
        </div></td>
      <td width="38" height="19" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id97; ?>"  value="<?php echo $retour97 ;?>" size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="18"> 
      ...
      <td width="317" height="18">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom98.' '.$tabPrenom98;?>
        </div></td>
      <td width="38" height="18"> 
        <input type="text" name="M<?php echo $id98; ?>"  value="<?php echo $retour98 ;?>" size="2">
      </td>
    </tr>
    <tr> 
      <td width="267" height="23" bgcolor="#CCCCCC"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom24.' '.$tabPrenom24;?>
        </div>
      </td>
      <td width="28" height="23" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id24; ?>"  value="<?php echo $retour24 ;?>" size="2">
      </td>
      <td height="23" width="255" bgcolor="#CCCCCC">
<div id="listeJoueurs"> 
          <?php echo $tabNom49.' '.$tabPrenom49;?>
        </div></td>
      <td width="34" height="23" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id49; ?>"  value="<?php echo $retour49 ;?>" size="2">
      </td>
      <td height="23" width="256" bgcolor="#CCCCCC">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom74.' '.$tabPrenom74;?>
        </div></td>
      <td width="33" height="23" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id74; ?>"  value="<?php echo $retour74 ;?>" size="2">
      </td>
      <td width="317" height="23" bgcolor="#CCCCCC">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom99.' '.$tabPrenom99;?>
        </div></td>
      <td width="38" height="23" bgcolor="#CCCCCC"> 
        <input type="text" name="M<?php echo $id99; ?>"  value="<?php echo $retour99 ;?>" size="2">
      </td>
    </tr>
    <tr> 
      ...
      <td width="28" height="3"> 
        <input type="text" name="M<?php echo $id25; ?>"  value="<?php echo $retour25 ;?>" size="2">
      </td>
      <td height="3" width="255"> 
        <div id="listeJoueurs"> 
          <?php echo $tabNom50.' '.$tabPrenom50;?>
        </div></td>
      <td width="34" height="3"> 
        <input type="text" name="M<?php echo $id50; ?>"  value="<?php echo $retour50 ;?>" size="2">
      </td>
      <td height="3" width="256">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom75.' '.$tabPrenom75;?>
        </div></td>
      <td width="33" height="3"> 
        <input type="text" name="M<?php echo $id75; ?>"  value="<?php echo $retour75 ;?>" size="2">
      </td>
      <td width="317" height="3">
	  <div id="listeJoueurs"> 
          <?php echo $tabNom100.' '.$tabPrenom100;?>
        </div></td>
      <td width="38" height="3"> 
        <input type="text" name="M<?php echo $id100; ?>"  value="<?php echo $retour100 ;?>" size="2">
      </td>
    </tr>
    <tr> 
  ...
  <table width="1297" border="0" align="left" cellspacing="0" cellpadding="0">
    <tr> 
...
?>
      ...
      <td width="177" valign="middle" height="19">&nbsp;</td>
      <td width="358" valign="middle" height="19">&nbsp;</td>
      <td colspan="2" valign="middle" height="19">&nbsp;</td>
      <td width="165" valign="middle" height="19">&nbsp;</td>
    </tr>
    <tr> 
      <td valign="middle" height="19" bgcolor="#E3F3FF" width="10"></td>
      ...
      <td width="177" valign="middle" height="19"> <font size="3" face="Arial, Helvetica, sans-serif"> 
      ...
      <td width="358" valign="top" height="19">&nbsp;</td>
      <td colspan="2" valign="middle" height="19">&nbsp;</td>
      <td width="165" valign="middle" height="19">&nbsp;</td>
    </tr>
    <tr> 
...
?>
      ...
      <td height="23" valign="middle" width="174"> <font size="3" face="Arial, Helvetica, sans-serif"> 
      ...
      <td height="23" valign="middle" width="502">&nbsp;</td>
    </tr>
  </table>
  <br /> <br />
  <hr />
...
?>
      ...
      <td height="10" valign="bottom" width="176"> 
      ...
      <td height="23" valign="middle" width="501"> <font size="3" face="Arial, Helvetica, sans-serif"> 
        </font></td>
    </tr>
  </table>
    <br /> <br />
