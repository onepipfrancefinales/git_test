...
<?php 
//****** Elements ajout�s pour le FM libre ********
...
// test de la pr�sence de l'�quipe invitee dans sa ligue
...
//test de la presence e f1
	...
	// ******** recherche de l'id du match  (code_match)*******
		...
		// Cr�ation des tuples dans les deux bases de donn�es

		//Base de donn�es EquipeA
