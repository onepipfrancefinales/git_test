 ...
 ?>
      ...
      <td width="240" height="25"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">61 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'   and photo='1' ORDER BY nom_cache LIMIT 60,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="25"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">81 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 80,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="32"><font face="Arial, Helvetica, sans-serif">2 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY  nom_cache LIMIT 1,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="32"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">22 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 21,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="32"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">42 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 41,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="32"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">62 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 61,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="32"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">82 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'   and photo='1' ORDER BY nom_cache LIMIT 81,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240"><font face="Arial, Helvetica, sans-serif">3 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 2,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">23 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 22,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">43 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'   and photo='1' ORDER BY nom_cache LIMIT 42,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">63 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 62,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">83 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 82,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240"><font face="Arial, Helvetica, sans-serif">4 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 3,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">24 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 23,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">44 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 43,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">64 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 63,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">84 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 83,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240"><font face="Arial, Helvetica, sans-serif">5 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 4,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">25 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1' ORDER BY nom_cache LIMIT 24,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">45 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 44,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">65 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 64,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">85 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'   and photo='1' ORDER BY nom_cache LIMIT 84,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="26"><font face="Arial, Helvetica, sans-serif">6 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 5,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="26" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">26 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 25,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="26" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">46 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 45,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="26"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">66 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 65,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="26"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">86 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 85,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240"><font face="Arial, Helvetica, sans-serif">7 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 6,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">27 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 26,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">47 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 46,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">67 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 66,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">87 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 86,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240"><font face="Arial, Helvetica, sans-serif">8 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 7,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">28 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'   ORDER BY nom_cache LIMIT 27,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">48 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 47,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">68 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 67,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">88 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 87,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="2"><font face="Arial, Helvetica, sans-serif">9 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 8,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="2" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">29 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'   ORDER BY nom_cache LIMIT 28,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="2" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">49 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 48,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="2"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">69 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 68,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="2"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">89 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 88,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240"><font face="Arial, Helvetica, sans-serif">10 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 9,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">30 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 29,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">50 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 49,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">70 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 69,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">90 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 89,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="21"><font face="Arial, Helvetica, sans-serif">11 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 10,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="21" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">31 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 30,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="21" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">51 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 50,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="21"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">71 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 70,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="21"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">91 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 90,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="22"><font face="Arial, Helvetica, sans-serif">12 
        <?php
$reponse = mysql_query("SELECT  nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 11,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="22" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">32 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1' ORDER BY nom_cache LIMIT 31,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="22" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">52 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 51,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="22"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">72 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 71,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="22"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">92 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'   and photo='1' ORDER BY nom_cache LIMIT 91,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="31"><font face="Arial, Helvetica, sans-serif">13 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 12,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="31" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">33 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 32,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="31" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">53 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 52,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="31"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">73 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 72,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="31"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">93 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 92,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="22"><font face="Arial, Helvetica, sans-serif">14 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 13,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="22" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">34 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1' ORDER BY nom_cache LIMIT 33,1"); // Requ�te SQL
...
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'   ORDER BY nom_cache LIMIT 53,1"); // Requ�te SQL
while ($donnees = mysql_fetch_array($reponse) )
	{ 
 	$nom54= $donnees['nom'];
   ...
   ?>
      ...
      <td width="240" height="22"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">74 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 73,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="22"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">94 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 93,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="13"><font face="Arial, Helvetica, sans-serif">15 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 14,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="13" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">35 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1' ORDER BY nom_cache LIMIT 34,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="13" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">55 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'   ORDER BY nom_cache LIMIT 54,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="13"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">75 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 74,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="13"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">95 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 94,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="20"><font face="Arial, Helvetica, sans-serif">16 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 15,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="20" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">36 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1' ORDER BY nom_cache LIMIT 35,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="20" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">56 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 55,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="20"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">76 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 75,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="20"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">96
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 95,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="2"><font face="Arial, Helvetica, sans-serif">17 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 16,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="2" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">37 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1' ORDER BY nom_cache LIMIT 36,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="2" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">57 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 56,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="2"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">77 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 76,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="2"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">97 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 96,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="29"><font face="Arial, Helvetica, sans-serif">18 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 17,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="29" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">38 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 37,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="29" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">58 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 57,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="29"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">78 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 77,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="29"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">98 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 97,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="12"><font face="Arial, Helvetica, sans-serif">19 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 18,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="12" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">39 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 38,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="12" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">59 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 58,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="12"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">79 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 78,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="12"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">99 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 98,1"); // Requ�te SQL
 ...
 ?>
    ...
    <tr> 
      <td width="240" height="36"><font face="Arial, Helvetica, sans-serif">20 
        <?php
$reponse = mysql_query("SELECT   nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1' ORDER BY nom_cache LIMIT 19,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="36" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">40 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe' and photo='1'  ORDER BY nom_cache LIMIT 39,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td height="36" width="240"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">60 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 59,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="36"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">80 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 79,1"); // Requ�te SQL
 ...
 ?>
      ...
      <td width="240" height="36"> 
        <div align="left"><font face="Arial, Helvetica, sans-serif">100 
          <?php
$reponse = mysql_query("SELECT nom, prenom, id_perso FROM $bdcomite WHERE club='$equipe'  and photo='1'  ORDER BY nom_cache LIMIT 99,1"); // Requ�te SQL
