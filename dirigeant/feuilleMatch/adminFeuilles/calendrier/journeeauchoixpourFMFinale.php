...
?>
    ...
    <td width="114"> 
	  ...
	  echo "  </b> <a href=\"http://francefinalesrugby.franceserv.com/admin/feuille_matchA/page_select_joueurs.php?php=$php&connect=$connect&id_equipe=$id_equipe&equipe=$equipe&comite=$comite&code_div=$row[1]&equipeA=$equipeA&equipeB=$equipeB&comite=$comite&date=$row[3]&code_match=$idF\" target=_top >R�aliser</a>";
      else
	  echo "";
