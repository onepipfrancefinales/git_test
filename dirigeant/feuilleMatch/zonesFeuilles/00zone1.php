...
?>
  ...
  <table width="900" border="1" cellspacing="0"  cellpadding="0" align="left" height="500">
    <tr> 
      ...
      <td colspan="3" height="39" bgcolor="#CCCCCC" bordercolor="#000000"> 
      ...
      <td colspan="3" height="39" bgcolor="#CCCCCC" bordercolor="#000000"> 
        <div id="Taille" align="center">Type<br>
          Qualif</div>
      </td>
    ...
    <tr> 
      ...
      <td width="17" height="25" bgcolor="#CCCCCC" bordercolor="#000000"> 
        <div id="Taille">A</div>
      </td>
      <td width="17" height="25" bgcolor="#CCCCCC" bordercolor="#000000"> 
        <div id="Taille">B</div>
      ...
      <td height="25" width="12" bgcolor="#CCCCCC" bordercolor="#000000"> 
        <div id="Taille" align="center">A</div>
      </td>
      <td height="25" width="13" bgcolor="#CCCCCC" bordercolor="#000000"> 
        <div id="Taille" align="center">B</div>
      </td>
      <td height="25" width="13" bgcolor="#CCCCCC" bordercolor="#000000"> 
        <div id="Taille" align="center"> C</div>
      </td>
    </tr>
...
?>
    ...
    <tr bordercolor="#000000" valign="middle" align="center"> 
      ...
      <td width="12" bgcolor="#CCCCCC" height="22" ></td>
      <td width="13" bgcolor="#CCCCCC" height="22" ></td>
      <td width="13" bgcolor="#CCCCCC" height="22" ></td>
...
//***********    Nom et licence du joueur N°3    ************
 ...
 ?>
    ...
    <tr valign="middle" align="center"> 
      ...
      <td width="12" bgcolor="#CCCCCC"  bordercolor="#000000"></td>
      <td width="13" bgcolor="#CCCCCC"  bordercolor="#000000"></td>
      <td width="13" bgcolor="#CCCCCC"  bordercolor="#000000"></td>
    ...
    <tr bordercolor="#000000" valign="middle" align="center"> 
      ...
      <td width="12" bgcolor="#CCCCCC" height="18" ></td>
      <td width="13" bgcolor="#CCCCCC" height="18" ></td>
      <td width="13" bgcolor="#CCCCCC" height="18" ></td>
