...
?>
                <?php
$requete = "SELECT essai, transf, penalite, drop1  FROM $bdfeuilleA WHERE id='$code_match'"; // Requ�te SQL 
...
?>
                <?php
$requete = "SELECT essai, transf, penalite, drop1  FROM $bdfeuilleB WHERE id='$code_match'"; // Requ�te SQL 
$result = mysql_query($requete)or die (mysql_error ()) ;
While ($row = mysql_fetch_array($result) )
{ 
		 $essaiB=$row[0];
...
?>
          ...
          <tr bordercolor="#000000"> 
            <td height="24"> 
              <div align="center">But après essai</div>
            </td>
