...
<table width="1300" border="0">
  ...
  <tr valign="middle" align="center"> 
    ...
    <td colspan="3" height="37" bgcolor="#CC6633" width="653"> 
      <div align="center"><font size="4"><b><font size="4"><b><font face="Arial, Helvetica, sans-serif"><a href="page_liste_compet2.php?reserve=<?php echo $reserve;?>&equipe=<?php echo $equipe;?>&id_equipe=<?php echo $id_equipe;?>&comite=<?php echo $comite; ?>&php=<?php echo $php; ?>&connect=<?php echo $connect; ?>">Accès 
...
?>
  ...
  <tr valign="top"> 
    <td width="377" height="24"><a href="formulairefinale.php?comite=<?php echo $comite;?>&php=<?php echo $php;?>&connect=<?php echo $connect;?>&id_equipe=<?php echo $id_equipe;?>&equipe=<?php echo $equipe;?>&bdfeuilleA=<?php echo $bdfeuilleA;?>&bdfeuilleB=<?php echo $bdfeuilleB;?>" target="_top">Cr&eacute;ation 
      d'un feuille de match sans &eacute;l&eacute;ments pr&eacute;-compl&eacute;t&eacute;</a></td>
...
?>
    ...
    <td width="114"> 
	  ...
	  echo "  </b> <a href=\"http://francefinalesrugby.franceserv.com/admin/feuille_matchA/page_select_joueurs.php?php=$php&connect=$connect&id_equipe=$id_equipe&equipe=$equipe&comite=$comite&code_div=$row[1]&equipeA=$equipeA&equipeB=$equipeB&comite=$comite&date=$row[3]&code_match=$idF\" target=_top >R&eacute;aliser</a>";
      else
	  echo "";
...
$query = "SELECT id,equipe_dom, equipe_ext,poule FROM $bdfeuilleA where id>2000 and equipe_dom=$equipe";
$result = mysql_query($query);
while ($row = mysql_fetch_array($result) )
{
$idF= $row[0];
...
?>
	    ...
	    <?php
$query = "SELECT bdclubs.code, bdclubs.nom_1, Phpmpy_feuilleA.equipe_dom, Phpmpy_feuilleA.id, Phpmpy_feuilleA.equipe_ext FROM bdclubs, Phpmpy_feuilleA  where bdclubs.id=Phpmpy_feuilleA.equipe_dom and Phpmpy_feuilleA.equipe_dom=$equipe ORDER BY Phpmpy_feuilleA.id DESC";
$result = mysql_query($query);
while ($row = mysql_fetch_array($result) )
{
$equipe_dom1= $row[1]; 
...
?>
      <?php
$query = "SELECT bdclubs.code, bdclubs.nom_1, Phpmpy_feuilleA.equipe_dom, Phpmpy_feuilleA.equipe_ext FROM bdclubs, Phpmpy_feuilleA  where bdclubs.id=Phpmpy_feuilleA.equipe_ext and Phpmpy_feuilleA.equipe_dom=$equipe ORDER BY Phpmpy_feuilleA.id DESC";
$result = mysql_query($query);
while ($row = mysql_fetch_array($result) )
{
$equipe_ext1= $row[1];   
...
$query = "SELECT bdclubs.code, bdclubs.nom_1, Phpmpy_feuilleA.equipe_dom, Phpmpy_feuilleA.equipe_ext FROM bdclubs, Phpmpy_feuilleA  where bdclubs.id=Phpmpy_feuilleA.equipe_dom and Phpmpy_feuilleA.equipe_dom=$equipe ORDER BY Phpmpy_feuilleA.id DESC";
$result = mysql_query($query);
while ($row = mysql_fetch_array($result) )
{
?>
...
?>
	  ...
	  echo "  </b> <a href=\"http://francefinalesrugby.franceserv.com/admin/feuille_matchA/select_joueurmodif.php?php=$php&connect=$connect&id_equipe=$id_equipe&equipe=$equipe&comite=$comite&code_match=$row[3]\" target=_top >Modifier</a>";
