...
echo "Nom :".' '.$nomDir;echo "<br />";
echo "Pr&eacute;nom :".' '.$prenomDir;echo "<br />";
...
mysql_query (" INSERT INTO $bdcomite Values ('$nomDir','$nomDir','$prenomDir','0000-00-00','$licenceDir','$fonction','0','$comite','$equipe','5','$nb3','$id')");
