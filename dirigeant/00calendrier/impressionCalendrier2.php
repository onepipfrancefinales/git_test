...
// d�claration des fichiers contenant des fonctions
...
<td height="388" width="260" valign="top"> 
    <table width="593" border="0" align="left">
      <tr> 
        <td width="289"> 
          <div align="center"><b><font face="Arial, Helvetica, sans-serif" color="#000000" size="3">Palmarès 
             </font></b></div>
        ...
        <?php
		echo "<br />";?>
		<p align="center"><?php echo "Ligue r&eacute;gionale";?>
		<?php echo "<br />.$nomLigue";?></p>
