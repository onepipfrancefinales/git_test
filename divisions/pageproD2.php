...
<title>Champions de FRANCE Pro D2</title>
...
<div align="center">
  <table width="1100" height="639">
    <tr valign="middle" align="center" bordercolor="#FFFFFF"> 
      <td colspan="3" height="74"> 
        <table width="100%" border="2" bordercolor="#000000">
          <tr> 
            <td> 
              <div align="center"><img src="../images/bouclierpro%20d22.jpg" width="1100" height="150"></div>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr valign="middle" align="center" bgcolor="#000000">
      <td height="18" colspan="3"><font color="#FFFFFF">
        <?php
    ...
    <tr valign="middle" align="center" bgcolor="#FFFFFF"> 
      <td height="18" colspan="3"><font color="#FFFFFF"></font><font color="#FFFFFF"> 
        <?php
    // On inclut le haut de la page
