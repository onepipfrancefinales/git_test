...
<title>Champions de FRANCE TOP 14</title>

<div align="center">
  <table width="1000" height="639" cellspacing="0" cellpadding="0" border="0">
    <tr valign="middle" align="center" bordercolor="#FFFFFF"> 
      <td colspan="3" height="74"> 
        <table width="1100" border="2" bordercolor="#000000">
          <tr> 
            <td height="153"> 
              <div align="center"><img src="../images/brennusGrand.jpg" width="1100" height="150"></div>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr valign="middle" align="center" bgcolor="#000000">
      <td height="28" colspan="3"><font color="#FFFFFF">
        <?php
    ...
    <tr valign="middle" align="center" bgcolor="#FFFFFF"> 
      <td height="28" colspan="3"><font color="#FFFFFF"></font><font color="#FFFFFF"> 
        <?php
    // On inclut le haut de la page
    ...
    ?>
          ...
          <p><font color="#FFFFFF">22222222222222222222222222222222222222222222222222222222222222</font> 
          </p>
        </div>
      </td>
