...
<p class="equipe"> 
	<?php $reponse = mysql_query("	SELECT division, champion, comite1 
									FROM bdjeunes 
									WHERE saison='$annee' and titre='champion' and rang<360 and rang>300 order by rang"); // Requête SQL
										while ($donnees = mysql_fetch_array($reponse) )
											{ 
											echo $donnees['division']." : ".  $donnees['champion']."  ". $donnees['comite1'];
											 ?>	
...
<p class="equipe">  
	<?php $reponse = mysql_query("	SELECT division, champion, comite1 
									FROM bdjeunes 
									WHERE saison='$annee' and titre='champion' and rang<380 and rang>=360 and rang2<380 and rang2>=360 order by rang"); // Requête SQL
											while ($donnees = mysql_fetch_array($reponse) )
														{ 
															echo $donnees['division']." : ".  $donnees['champion']."  ". $donnees['comite1'];
															 ?>	
