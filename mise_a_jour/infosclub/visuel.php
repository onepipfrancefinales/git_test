...
<table border="1" align="center" cellspacing="2" cellpadding="2" width="500" bordercolor="#0000FF">
  <tr align="center" bordercolor="#FFFFFF"> 
    <td colspan="2"><font color="#000000">Cr&eacute;ation du club : </font></td>
    <td width="75"> <strong> <b><font size="4"> </font></b> </strong></td>
    <td width="50">&nbsp;</td>
    <td width="33">&nbsp;</td>
    <td width="47">&nbsp;</td>
  </tr>
...
<table border="1" align="center" cellspacing="0" cellpadding="0" width="500" bordercolor="#0000FF">
  <tr align="center" bordercolor="#FFFFFF"> 
    <td colspan="5"><b><font color="#FF0000" size="3">Bureau</font></b></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
    <td width="49">&nbsp;</td>
    <td width="108"> 
...
<table border="1" align="center" cellspacing="0" cellpadding="0" width="500" bordercolor="#0000FF">
  ...
  <tr align="center" bordercolor="#FFFFFF"> 
    ...
    <td width="48" height="23"><strong> <b><font size="4"> </font></b></strong> 
    </td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
    <td width="44">&nbsp;</td>
...
<table border="1" align="center" cellspacing="0" cellpadding="0" width="500" bordercolor="#0000FF">
  ...
  <tr align="center" bordercolor="#FFFFFF"> 
    ...
    <td colspan="3" height="41"><strong> </strong> </td>
    <td width="11" height="41">&nbsp;</td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
    <td width="19">&nbsp;</td>
    <td colspan="3"> <b><font size="4"> </font></b> </td>
    <td width="11">&nbsp;</td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
    <td width="19" height="14">&nbsp;</td>
    <td colspan="3" height="14" valign="top">&nbsp; </td>
    <td width="11" height="14"><strong> </strong> </td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
    ...
    <td width="253" height="24"><b><font size="4"> </font></b> </td>
  ...
  <tr align="center" bordercolor="#FFFFFF"> 
    <td width="19">&nbsp;</td>
    <td width="96"> 
      <div align="right"><font color="#000000">capacit&eacute; :</font><b> </b></div>
    </td>
    <td width="253">&nbsp; </td>
    <td width="109">&nbsp; </td>
    <td width="11">&nbsp;</td>
...
<table border="1" align="center" cellspacing="0" cellpadding="0" width="500" bordercolor="#0000FF">
  ...
  <tr align="center" bordercolor="#FFFFFF"> 
    ...
    <td colspan="2"><strong> <a href="<?php echo $donnees['A1620'];?>" target="_blank" > 
      </a> </strong> </td>
    <td width="40">&nbsp;</td>
    <td width="59">&nbsp;</td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
    ...
    <td colspan="2"><strong><b><font color="#000000"><a href="mailto:<?php echo $donnees['A1616'];?>" oldref=""><font color="#000000"> 
      </font></a></font></b> </strong> </td>
    <td width="40">&nbsp;</td>
    <td width="59">&nbsp;</td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF"> 
...
<table border="1" align="center" cellspacing="0" cellpadding="0" width="540" bordercolor="#0000FF">
  <tr align="center" bordercolor="#FFFFFF"> 
    <td colspan="6" height="25" bordercolor="#FF0000"> 
      <div align="center"><b><font color="#0000FF">Modifier la fiche du club (Bient&ocirc;t)</font></b></div>
    </td>
  </tr>
</table>
<p>&nbsp;</p>
