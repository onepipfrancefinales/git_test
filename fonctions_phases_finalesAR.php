...
//$query = "	SELECT bdclubs.code, bdclubs.nom_1, bdclubs.siglecomite, bdpf$annee.E00 
//			FROM bdclubs, bdpf$annee 
//			WHERE bdclubs.code=bdpf$annee.E00 and bdpf$annee.id=$id "; 
...
<?php //E64
$query = "	SELECT bdclubs.code, bdclubs.nom_1, bdclubs.siglecomite, bdpf$annee.E64 
			FROM bdclubs, bdpf$annee 
			WHERE bdclubs.code=bdpf$annee.E64 and bdpf$annee.id=$id "; // Requête SQL
 $result = mysql_query($query);
 	while ($row = mysql_fetch_array($result) )
	{ 
	$nom = $row[1];
...
$query = "SELECT id, A1601, A1602, A1603, A1604, A1605, A1606, A1607, A1608, A1609, A1610, A1611, A1612, A1613, A1614, A1615, A1616, 
					 A1617, A1618, A1619, A1620, A1621, A1622, A1623, A1624, A1625, A1626, A1627, A1628, A1629, A1630, A1631, A1632 
					 FROM $bdannee_2 WHERE id= $id2 "; // Requête SQL
 $result = mysql_query($query);
 	while ($row = mysql_fetch_array($result) )
	{ 
	$pts3A1601 = $row[1];
