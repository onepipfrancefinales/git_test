...
content="Résulats de toutes les compétitions territoriales séniors du comité de Provence. Calendriers, résultats et statistiques de l'honneur à la 4me Série, équipes II comprises. Egalement disponible les phases finales territoriales des années précédentes et les palmarès territoriaux des differentes divisions du comité.">
<meta name="keywords"
...
$query = "SELECT  phppr_matchs.id_equipe_dom, phppr_matchs.id_equipe_ext, phppr_matchs.id_journee, phppr_matchs.date_reelle, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_journees.date_prevue, phppr_journees.id_champ, phppr_clubs.nom, phppr_clubs.id FROM  phppr_matchs, phppr_journees, phppr_clubs WHERE phppr_journees.id_champ='271' and (phppr_clubs.id + 900000)=phppr_matchs.id_equipe_dom and phppr_matchs.id_journee= phppr_journees.id and phppr_matchs.date_reelle != phppr_journees.date_prevue and
 (phppr_clubs.id + 900000)=phppr_matchs.id_equipe_dom and phppr_matchs.buts_dom is NULL and phppr_matchs.buts_ext is NULL"; // Requête SQL
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {    
		 $journeer275="$row[2]";
...
height="450" width="290"" type="text/html"   />
	...
	$query = "SELECT  phppr_matchs.id_equipe_dom, phppr_matchs.id_equipe_ext, phppr_matchs.id_journee, phppr_matchs.date_reelle, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_journees.date_prevue, phppr_journees.id_champ, phppr_clubs.nom, phppr_clubs.id FROM  phppr_matchs, phppr_journees, phppr_clubs WHERE  phppr_journees.id_champ='185' and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.id_journee= phppr_journees.id and phppr_matchs.date_reelle != phppr_journees.date_prevue and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.buts_dom is NULL and phppr_matchs.buts_ext is NULL"; // Requête SQL
	$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {    
		 $journee181="$row[2]";
...
height="400" width="440"" type="text/html"   />
	...
	$query = "SELECT  phppr_matchs.id_equipe_dom, phppr_matchs.id_equipe_ext, phppr_matchs.id_journee, phppr_matchs.date_reelle, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_journees.date_prevue, phppr_journees.id_champ, phppr_clubs.nom, phppr_clubs.id FROM  phppr_matchs, phppr_journees, phppr_clubs WHERE  phppr_journees.id_champ='191' and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.id_journee= phppr_journees.id and phppr_matchs.date_reelle != phppr_journees.date_prevue and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.buts_dom is NULL and phppr_matchs.buts_ext is NULL"; // Requête SQL
	$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {    
		 $journee191="$row[2]";
...
height="370" width="440"" type="text/html"   />
	...
	$query = "SELECT  phppr_matchs.id_equipe_dom, phppr_matchs.id_equipe_ext, phppr_matchs.id_journee, phppr_matchs.date_reelle, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_journees.date_prevue, phppr_journees.id_champ, phppr_clubs.nom, phppr_clubs.id FROM  phppr_matchs, phppr_journees, phppr_clubs WHERE  phppr_journees.id_champ='201' and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.id_journee= phppr_journees.id and phppr_matchs.date_reelle != phppr_journees.date_prevue and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.buts_dom is NULL and phppr_matchs.buts_ext is NULL"; // Requête SQL
	$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {    
		 $journee201="$row[2]";
...
height="370" width="440"" type="text/html"   />
	...
	$query = "SELECT  phppr_matchs.id_equipe_dom, phppr_matchs.id_equipe_ext, phppr_matchs.id_journee, phppr_matchs.date_reelle, phppr_matchs.buts_dom, phppr_matchs.buts_ext, phppr_journees.date_prevue, phppr_journees.id_champ, phppr_clubs.nom, phppr_clubs.id FROM  phppr_matchs, phppr_journees, phppr_clubs WHERE  phppr_journees.id_champ='221' and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.id_journee= phppr_journees.id and phppr_matchs.date_reelle != phppr_journees.date_prevue and phppr_clubs.id=phppr_matchs.id_equipe_dom and phppr_matchs.buts_dom is NULL and phppr_matchs.buts_ext is NULL"; // Requête SQL
	$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {    
		 $journee221="$row[2]";
