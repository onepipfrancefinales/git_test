...
<table class = "marginAuto width550 borderWidth3" >
   <tr class="fond" >
    <td rowspan="3"  valign="middle" width="303"> 
      <h4><a class="decorationNone" href="/phases_finales2019/affichagePhasesFinales/pagePhaseFinale.php?division=<?php echo $division; ?>&annee=<?php echo $annee;?>"		target="_top">Phases finales <br /> Championnat de France</font></a></h4></td>
...
?>
<table class = "marginAuto width550 borderWidth3" border color="#000000" >
   <tr class="fond" >
