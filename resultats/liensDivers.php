...
<table class = "marginAuto width550 borderWidth3" >
   <tr class="fond" >
    <td rowspan="3"   > 
      <h4><a class="decorationNone" href="/phases_finales2019/affichagePhasesFinales/pagePhaseFinale.php?division=<?php echo $division; ?>&annee=<?php echo $annee;?>"		target="_top">Phases finales <br> Championnat de France</a></h4></td>
...
<table  class = "marginAuto width550 borderWidth3">
  <tr class="borderColorBlue"> 
    <td rowspan="2" class="backgroundBlue borderColorblue center"> 
      <h4><a class="decorationNone" href="/phases_finales2019/affichagePhasesFinales/pagePhaseFinale.php?division=<?php echo $division; ?>&annee=<?php echo $finSaison;?>"
...
<table class = "marginAuto width550 borderWidth3"  >
  ...
  <tr class="fond">     
    ...
    <h4 ><a class="decorationNone" href="/phases_finales2019/affichagePhasesFinales/pagePhaseFinale.php?division=170&annee=<?php echo $finSaison;?>"
