...
ATTENTION LIGNE 942, MODIFIER LES COMMENTAIRES AVANT TOUT TRANSFERT FTP
...
//	echo "1re journee: ".$premiereJournee;
	...
	while ($row = $requete->fetch())
		...
		echo "<br>";
//	echo "n journee : ".$numeroJournee;echo "<br>";
...
//	echo "nbreMatchsReportee : ".$nbreMatchsReportes[0];echo "<br>";
...
$date1 = date("Y-m-d", strtotime($dateDuJour.'- 1 days'));	
//echo "date1 : ".$date1;
		 ...
		 <tr bgcolor = "#CCCCCC">
		   <th> 
			 <font color = "#000000" size="2pt" face="arial , Helvetica, sans-serif">
				...
				//echo "JJ : ".$j;
				//changement de la date US en FR
				$DateTime = DateTime::createFromFormat('Y-m-d', $datePrevue[$i]);
				$datePrevueFR = $DateTime->format('d-M-Y');
				echo "<center>";
				echo "journée n° ".$j." prévue le ".$datePrevueFR ;
				echo "</center>";
				?>
			  </font>
			</th>
