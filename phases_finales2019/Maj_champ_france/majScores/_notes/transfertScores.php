...
//*********   affichage des r�sultats, pour savoir si la modification a marée;: ******
...
//*********   affichage des r�sultats, pour savoir si la modification a marée;: ******
	...
	if($requete)
	  	{
		echo "<br />";
		 echo("La modification des résultats Aller a été correctement effectuée");
	  	}
	else
	  	{
		echo "<br />";
		echo("La modification des résultats Aller a échouée") ;
	  	}
...
//*********   affichage des r�sultats, pour savoir si la modification a marée;e: ******
  
	if($requetePTSA)
	  	{
		echo "<br />";
		 echo("La modification des points terrain Aller a été correctement effectuée");
	  	}
	else
	  	{
		echo "<br />";
		echo("La modification des points terrain Aller a échouée") ;
	  	}
...
//*********   affichage des r�sultats, pour savoir si la modification a marée;: ******
	...
	if($requete)
	  	{
		echo "<br />";
		 echo("La modification des résultats Retour a été correctement effectuée");
	  	}
	else
	  	{
		echo "<br />";
		echo("La modification des résultats Retour a échouée") ;
	  	}
...
//*********   affichage des r�sultats, pour savoir si la modification a marée;: ******
	...
	if($requetePTSR)
	  	{
		echo "<br />";
		 echo("La modification des points terrain Retour a été correctement effectuée");
	  	}
	else
	  	{
		echo "<br />";
		echo("La modification des points terrain Retour a échouée") ;
	  	}
