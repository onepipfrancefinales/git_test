...
//*****************************************************************************	
	...
	{	 
		...
		$reponse = $bdd->query("	SELECT bdclubs2019.code, bdclubs2019.nom_1, bdclubs2019.sigleComite, $bdpfAnnee.$equipes 
	 ...
	 if (substr($type,1,2) >= '32')
		{
			if (substr($type,1,2) >= '64')
			{
				...
				if ($A3263Pts+$A3264Pts>6) {if ($A3253Pts > $A3264Pts or ($A3263Pts == $A3264Pts and $A3263>$A3264)) {$clubA1632= $clubA3263;} else	{$clubA1632= $clubA3264;}} else {$clubA1632="-";}
	 ...
	 if (substr($type,1,2) >= '32')
		{
			if (substr($type,1,2) >= '64')
			{
				...
				if ($A3201Pts+$A3202Pts>6) {if ($A3201Pts > $A3202Pts or ($A3201Pts == $A3202Pts and $A3201>$A3202)) {$clubAB1601= $clubAB3201;} else {$clubAB1601= $clubAB3202;}} else {$clubAB1601="-";}	
				if ($A3203Pts+$A3204Pts>6) {if ($A3203Pts > $A3204Pts or ($A3203Pts == $A3204Pts and $A3203>$A3204)) {$clubAB1602= $clubAB3203;} else {$clubAB1602= $clubAB3204;}} else {$clubAB1602="-";}
				if ($A3205Pts+$A3206Pts>6) {if ($A3205Pts > $A3206Pts or ($A3205Pts == $A3206Pts and $A3205>$A3206)) {$clubAB1603= $clubAB3205;} else	{$clubAB1603= $clubAB3206;}} else {$clubAB1603="-";}
				if ($A3207Pts+$A3208Pts>6) {if ($A3207Pts > $A3208Pts or ($A3207Pts == $A3208Pts and $A3207>$A3208)) {$clubAB1604= $clubAB3207;} else	{$clubAB1604= $clubAB3208;}} else {$clubAB1604="-";}
			
				if ($A3209Pts+$A3210Pts>6) {if ($A3209Pts > $A3210Pts or ($A3209Pts == $A3210Pts and $A3209>$A3210)) {$clubAB1605= $clubAB3209;} else {$clubAB1605= $clubAB3210;}} else {$clubAB1605="-";}	
				if ($A3211Pts+$A3212Pts>6) {if ($A3211Pts > $A3212Pts or ($A3211Pts == $A3212Pts and $A3211>$A3212)) {$clubAB1606= $clubAB3211;} else {$clubAB1606= $clubAB3212;}} else {$clubAB1606="-";}
				if ($A3213Pts+$A3214Pts>6) {if ($A3213Pts > $A3214Pts or ($A3213Pts == $A3214Pts and $A3213>$A3214)) {$clubAB1607= $clubAB3213;} else	{$clubAB1607= $clubAB3214;}} else {$clubAB1607="-";}
				if ($A3215Pts+$A3216Pts>6) {if ($A3215Pts > $A3216Pts or ($A3215Pts == $A3216Pts and $A3215>$A3216)) {$clubAB1608= $clubAB3215;} else	{$clubAB1608= $clubAB3216;}} else {$clubAB1608="-";}
			
				if ($A3217Pts+$A3218Pts>6) {if ($A3217Pts > $A3218Pts or ($A3217Pts == $A3218Pts and $A3217>$A3218)) {$clubAB1609= $clubAB3217;} else {$clubAB1609= $clubAB3218;}} else {$clubAB1609="-";}	
				if ($A3219Pts+$A3220Pts>6) {if ($A3219Pts > $A3220Pts or ($A3219Pts == $A3220Pts and $A3219>$A3220)) {$clubAB1610= $clubAB3219;} else {$clubAB1610= $clubAB3220;}} else {$clubAB1610="-";}
				if ($A3221Pts+$A3222Pts>6) {if ($A3221Pts > $A3222Pts or ($A3221Pts == $A3222Pts and $A3221>$A3222)) {$clubAB1611= $clubAB3221;} else	{$clubAB1611= $clubAB3222;}} else {$clubAB1611="-";}
				if ($A3223Pts+$A3224Pts>6) {if ($A3223Pts > $A3224Pts or ($A3223Pts == $A3224Pts and $A3223>$A3224)) {$clubAB1612= $clubAB3223;} else	{$clubAB1612= $clubAB3224;}} else {$clubAB1612="-";}
			
				if ($A3225Pts+$A3226Pts>6) {if ($A3225Pts > $A3226Pts or ($A3225Pts == $A3226Pts and $A3225>$A3226)) {$clubAB1613= $clubAB3225;} else {$clubAB1613= $clubAB3226;}} else {$clubAB1613="-";}	
				if ($A3227Pts+$A3228Pts>6) {if ($A3227Pts > $A3228Pts or ($A3227Pts == $A3228Pts and $A3227>$A3228)) {$clubAB1614= $clubAB3227;} else {$clubAB1614= $clubAB3228;}} else {$clubAB1614="-";}
				if ($A3229Pts+$A3230Pts>6) {if ($A3229Pts > $A3230Pts or ($A3229Pts == $A3230Pts and $A3229>$A3230)) {$clubAB1615= $clubAB3229;} else	{$clubAB1615= $clubAB3230;}} else {$clubAB1615="-";}
				if ($A3231Pts+$A3232Pts>6) {if ($A3231Pts > $A3232Pts or ($A3231Pts == $A3232Pts and $A3231>$A3232)) {$clubAB1616= $clubAB3231;} else	{$clubAB1616= $clubAB3232;}} else {$clubAB1616="-";}
			
				if ($A3233Pts+$A3234Pts>6) {if ($A3232Pts > $A3234Pts or ($A3233Pts == $A3234Pts and $A3233>$A3234)) {$clubAB1617= $clubAB3233;} else {$clubAB1617= $clubAB3234;}} else {$clubAB1617="-";}	
				if ($A3235Pts+$A3236Pts>6) {if ($A3235Pts > $A3236Pts or ($A3235Pts == $A3236Pts and $A3235>$A3236)) {$clubAB1618= $clubAB3235;} else {$clubAB1618= $clubAB3236;}} else {$clubAB1618="-";}
				if ($A3237Pts+$A3238Pts>6) {if ($A3237Pts > $A3238Pts or ($A3237Pts == $A3238Pts and $A3237>$A3238)) {$clubAB1619= $clubAB3237;} else	{$clubAB1619= $clubAB3238;}} else {$clubAB1619="-";}
				if ($A3239Pts+$A3240Pts>6) {if ($A3239Pts > $A3240Pts or ($A3239Pts == $A3240Pts and $A3239>$A3240)) {$clubAB1620= $clubAB3239;} else	{$clubAB1620= $clubAB3240;}} else {$clubAB1620="-";}
		
				if ($A3241Pts+$A3242Pts>6) {if ($A3241Pts > $A3242Pts or ($A3241Pts == $A3242Pts and $A3241>$A3242)) {$clubAB1621= $clubAB3241;} else {$clubAB1621= $clubAB3242;}} else {$clubAB1621="-";}	
				if ($A3243Pts+$A3244Pts>6) {if ($A3243Pts > $A3244Pts or ($A3243Pts == $A3244Pts and $A3243>$A3244)) {$clubAB1622= $clubAB3243;} else {$clubAB1622= $clubAB3244;}} else {$clubAB1622="-";}
				if ($A3245Pts+$A3246Pts>6) {if ($A3245Pts > $A3246Pts or ($A3245Pts == $A3246Pts and $A3245>$A3246)) {$clubAB1623= $clubAB3245;} else	{$clubAB1623= $clubAB3246;}} else {$clubAB1623="-";}
				if ($A3247Pts+$A3248Pts>6) {if ($A3247Pts > $A3248Pts or ($A3247Pts == $A3248Pts and $A3247>$A3248)) {$clubAB1624= $clubAB3247;} else	{$clubAB1624= $clubAB3248;}} else {$clubAB1624="-";}
			
				if ($A3249Pts+$A3250Pts>6) {if ($A3249Pts > $A3250Pts or ($A3249Pts == $A3250Pts and $A3249>$A3250)) {$clubAB1625= $clubAB3249;} else {$clubAB1625= $clubAB3250;}} else {$clubAB1625="-";}	
				if ($A3251Pts+$A3252Pts>6) {if ($A3251Pts > $A3252Pts or ($A3251Pts == $A3252Pts and $A3251>$A3252)) {$clubAB1626= $clubAB3251;} else {$clubAB1626= $clubAB3252;}} else {$clubAB1626="-";}
				if ($A3253Pts+$A3254Pts>6) {if ($A3253Pts > $A3254Pts or ($A3253Pts == $A3254Pts and $A3253>$A3254)) {$clubAB1627= $clubAB3253;} else	{$clubAB1627= $clubAB3254;}} else {$clubAB1627="-";}
				if ($A3255Pts+$A3256Pts>6) {if ($A3255Pts > $A3256Pts or ($A3255Pts == $A3256Pts and $A3255>$A3256)) {$clubAB1628= $clubAB3255;} else	{$clubAB1628= $clubAB3256;}} else {$clubAB1628="-";}
			
				if ($A3257Pts+$A3258Pts>6) {if ($A3257Pts > $A3258Pts or ($A3257Pts == $A3258Pts and $A3257>$A3258)) {$clubAB1629= $clubAB3257;} else {$clubAB1629= $clubAB3258;}} else {$clubAB1629="-";}	
				if ($A3259Pts+$A3260Pts>6) {if ($A3259Pts > $A3260Pts or ($A3259Pts == $A3260Pts and $A3259>$A3260)) {$clubAB1630= $clubAB3259;} else {$clubAB1630= $clubAB3260;}} else {$clubAB1630="-";}
				if ($A3261Pts+$A3262Pts>6) {if ($A3261Pts > $A3262Pts or ($A3261Pts == $A3262Pts and $A3261>$A3262)) {$clubAB1631= $clubAB3261;} else	{$clubAB1631= $clubAB3262;}} else {$clubAB1631="-";}
				if ($A3263Pts+$A3264Pts>6) {if ($A3253Pts > $A3264Pts or ($A3263Pts == $A3264Pts and $A3263>$A3264)) {$clubAB1632= $clubAB3263;} else	{$clubAB1632= $clubAB3264;}} else {$clubAB1632="-";}
			
			
			}
			else
			{
			 if ($A3201+$A3202>0) if ($A3201>$A3202) 	$clubAB1601= $clubAB3201;	else	$clubAB1601= $clubAB3202; else $clubAB1601="-";
			 if ($A3203+$A3204>0) if ($A3203>$A3204)	$clubAB1602= $clubAB3203;	else	$clubAB1602= $clubAB3204; else $clubAB1602="-";
			 if ($A3205+$A3206>0) if ($A3205>$A3206)	$clubAB1603= $clubAB3205;	else	$clubAB1603= $clubAB3206; else $clubAB1603="-";
			 if ($A3207+$A3208>0) if ($A3207>$A3208)	$clubAB1604= $clubAB3207;	else	$clubAB1604= $clubAB3208; else $clubAB1604="-";

			 if ($A3209+$A3210>0) if ($A3209>$A3210)	$clubAB1605= $clubAB3209;	else	$clubAB1605= $clubAB3210; else $clubAB1605="-";
			 if ($A3211+$A3212>0) if ($A3211>$A3212)	$clubAB1606= $clubAB3211;	else	$clubAB1606= $clubAB3212; else $clubAB1606="-";
			 if ($A3213+$A3214>0) if ($A3213>$A3214)	$clubAB1607= $clubAB3213;	else	$clubAB1607= $clubAB3214; else $clubAB1607="-";
			 if ($A3215+$A3216>0) if ($A3215>$A3216)	$clubAB1608= $clubAB3215;	else	$clubAB1608= $clubAB3216; else $clubAB1608="-";
		 
			 if ($A3217+$A3218>0) if ($A3217>$A3218) 	$clubAB1609= $clubAB3217;	else	$clubAB1609= $clubAB3218; else $clubAB1609="-";
			 if ($A3219+$A3220>0) if ($A3219>$A3220)	$clubAB1610= $clubAB3219;	else	$clubAB1610= $clubAB3220; else $clubAB1610="-";
			 if ($A3221+$A3222>0) if ($A3221>$A3222)	$clubAB1611= $clubAB3221;	else	$clubAB1611= $clubAB3222; else $clubAB1611="-";
			 if ($A3223+$A3224>0) if ($A3223>$A3224)	$clubAB1612= $clubAB3223;	else	$clubAB1612= $clubAB3224; else $clubAB1612="-";
				  
			 if ($A3225+$A3226>0) if ($A3225>$A3226)	$clubAB1613= $clubAB3225;	else	$clubAB1613= $clubAB3226; else $clubAB1613="-";
			 if ($A3227+$A3228>0) if ($A3227>$A3228)	$clubAB1614= $clubAB3227;	else	$clubAB1614= $clubAB3228; else $clubAB1614="-";
			 if ($A3229+$A3230>0) if ($A3229>$A3230)	$clubAB1615= $clubAB3229;	else	$clubAB1615= $clubAB3230; else $clubAB1615="-";
			 if ($A3231+$A3232>0) if ($A3231>$A3232)	$clubAB1616= $clubAB3231;	else	$clubAB1616= $clubAB3232; else $clubAB1616="-";

			  
			 if ($A3233+$A3234>0) if ($A3233>$A3234)	$clubAB1617= $clubAB3233;	else	$clubAB1617= $clubAB3234; else $clubAB1617="-";
			 if ($A3235+$A3236>0) if ($A3235>$A3236)	$clubAB1618= $clubAB3235;	else	$clubAB1618= $clubAB3236; else $clubAB1618="-";
			 if ($A3237+$A3238>0) if ($A3237>$A3238)	$clubAB1619= $clubAB3237;	else	$clubAB1619= $clubAB3238; else $clubAB1619="-";
			 if ($A3239+$A3240>0) if ($A3239>$A3240)	$clubAB1620= $clubAB3239;	else	$clubAB1620= $clubAB3240; else $clubAB1620="-";

			 if ($A3241+$A3242>0) if ($A3241>$A3242)	$clubAB1621= $clubAB3241;	else	$clubAB1621= $clubAB3242; else $clubAB1621="-";
			 if ($A3243+$A3244>0) if ($A3243>$A3244)	$clubAB1622= $clubAB3243;	else	$clubAB1622= $clubAB3244; else $clubAB1622="-";
			 if ($A3245+$A3246>0) if ($A3245>$A3246)	$clubAB1623= $clubAB3245;	else	$clubAB1623= $clubAB3246; else $clubAB1623="-";
			 if ($A3247+$A3248>0) if ($A3247>$A3248)	$clubAB1624= $clubAB3247;	else	$clubAB1624= $clubAB3248; else $clubAB1624="-";

			 if ($A3249+$A3250>0) if ($A3249>$A3250)	$clubAB1625= $clubAB3249;	else	$clubAB1625= $clubAB3250; else $clubAB1625="-";
			 if ($A3251+$A3252>0) if ($A3251>$A3252)	$clubAB1626= $clubAB3251;	else	$clubAB1626= $clubAB3252; else $clubAB1626="-";
			 if ($A3253+$A3254>0) if ($A3253>$A3254)	$clubAB1627= $clubAB3253;	else	$clubAB1627= $clubAB3254; else $clubAB1627="-";
			 if ($A3255+$A3256>0) if ($A3255>$A3256)	$clubAB1628= $clubAB3255;	else	$clubAB1628= $clubAB3256; else $clubAB1628="-";

			 if ($A3257+$A3258>0) if ($A3257>$A3258)	$clubAB1629= $clubAB3257;	else	$clubAB1629= $clubAB3258; else $clubAB1629="-";
			 if ($A3259+$A3260>0) if ($A3259>$A3260)	$clubAB1630= $clubAB3259;	else	$clubAB1630= $clubAB3260; else $clubAB1630="-";
			 if ($A3261+$A3262>0) if ($A3261>$A3262)	$clubAB1631= $clubAB3261;	else	$clubAB1631= $clubAB3262; else $clubAB1631="-";
			 if ($A3263+$A3264>0) if ($A3263>$A3264)	$clubAB1632= $clubAB3263;	else	$clubAB1632= $clubAB3264; else $clubAB1632="-";	
		 ...
		 if (substr($type,3,2) >= '16')
			{
				...
				if (substr($type,3,2) >= '32')
				{
					...
					if ($A1601Pts+$A1602Pts>6) {if ($A1601Pts > $A1602Pts or ($A1601Pts == $A1602Pts and $A1601>$A1602)) {$clubAB8001= $clubAB1601;} else {$clubAB8001= $clubAB1602;}} else {$clubAB8001="-";}	
					if ($A1603Pts+$A1604Pts>6) {if ($A1603Pts > $A1604Pts or ($A1603Pts == $A1604Pts and $A1603>$A1604)) {$clubAB8002= $clubAB1603;} else {$clubAB8002= $clubAB1604;}} else {$clubAB8002="-";}
					if ($A1605Pts+$A1606Pts>6) {if ($A1605Pts > $A1606Pts or ($A1605Pts == $A1606Pts and $A1605>$A1606)) {$clubAB8003= $clubAB1605;} else	{$clubAB8003= $clubAB1606;}} else {$clubAB8003="-";}
					if ($A1607Pts+$A1608Pts>6) {if ($A1607Pts > $A1608Pts or ($A1607Pts == $A1608Pts and $A1607>$A1608)) {$clubAB8004= $clubAB1607;} else	{$clubAB8004= $clubAB1608;}} else {$clubAB8004="-";}
				
					if ($A1609Pts+$A1610Pts>6) {if ($A1609Pts > $A1610Pts or ($A1609Pts == $A1610Pts and $A1609>$A1610)) {$clubAB8005= $clubAB1609;} else {$clubAB8005= $clubAB1610;}} else {$clubAB8005="-";}	
					if ($A1611Pts+$A1612Pts>6) {if ($A1611Pts > $A1612Pts or ($A1611Pts == $A1612Pts and $A1611>$A1612)) {$clubAB8006= $clubAB1611;} else {$clubAB8006= $clubAB1612;}} else {$clubAB8006="-";}
					if ($A1613Pts+$A1614Pts>6) {if ($A1613Pts > $A1614Pts or ($A1613Pts == $A1614Pts and $A1613>$A1614)) {$clubAB8007= $clubAB1613;} else	{$clubAB8007= $clubAB1614;}} else {$clubAB8007="-";}
					if ($A1615Pts+$A1616Pts>6) {if ($A1615Pts > $A1616Pts or ($A1615Pts == $A1616Pts and $A1615>$A1616)) {$clubAB8008= $clubAB1615;} else	{$clubAB8008= $clubAB1616;}} else {$clubAB8008="-";}
				
					if ($A1617Pts+$A1618Pts>6) {if ($A1617Pts > $A1618Pts or ($A1617Pts == $A1618Pts and $A1617>$A1618)) {$clubAB8009= $clubAB1617;} else {$clubAB8009= $clubAB1618;}} else {$clubAB8009="-";}	
					if ($A1619Pts+$A1620Pts>6) {if ($A1619Pts > $A1620Pts or ($A1619Pts == $A1620Pts and $A1619>$A1620)) {$clubAB8010= $clubAB1619;} else {$clubAB8010= $clubAB1620;}} else {$clubAB8010="-";}
					if ($A1621Pts+$A1622Pts>6) 
					{
						if ($A1621Pts > $A1622Pts or ($A1621Pts == $A1622Pts and $A1621>$A1622)) 
					...
					if ($A1623Pts+$A1624Pts>6) {if ($A1623Pts > $A1624Pts or ($A1623Pts == $A1624Pts and $A1623>$A1624)) {$clubAB8012= $clubAB1623;} else	{$clubAB8012= $clubAB1624;}} else {$clubAB8012="-";}
			
				
					if ($A1625Pts+$A1626Pts>6) {if ($A1625Pts > $A1626Pts or ($A1625Pts == $A1626Pts and $A1625>$A1626)) {$clubAB8013= $clubAB1625;} else {$clubAB8013= $clubAB1626;}} else {$clubAB8013="-";}	
					if ($A1627Pts+$A1628Pts>6) {if ($A1627Pts > $A1628Pts or ($A1627Pts == $A1628Pts and $A1627>$A1628)) {$clubAB8014= $clubAB1627;} else {$clubAB8014= $clubAB1628;}} else {$clubAB8014="-";}
					if ($A1629Pts+$A1630Pts>6) {if ($A1629Pts > $A1630Pts or ($A1629Pts == $A1630Pts and $A1629>$A1630)) {$clubAB8015= $clubAB1629;} else	{$clubAB8015= $clubAB1630;}} else {$clubAB8015="-";}
					if ($A1631Pts+$A1632Pts>6) {if ($A1631Pts > $A1632Pts or ($A1631Pts == $A1632Pts and $A1631>$A1632)) {$clubAB8016= $clubAB1631;} else	{$clubAB8016= $clubAB1632;}} else {$clubAB8016="-";}
				...
				else
				{
				 ...
				 if ($A1601+$A1602 > 0) {if ($A1601>$A1602)	{$clubAB8001=$clubAB1601;	} else  {$clubAB8001=$clubAB1602;	}}  else {	$A1601="-";	$A1602="-";	$clubAB8001="-";}
				 if ($A1603+$A1604 > 0)	{if ($A1603>$A1604)	{$clubAB8002=$clubAB1603;	} else  {$clubAB8002=$clubAB1604; }}  else {  $A1603="-";	$A1604="-";	$clubAB8002="-";}
				 if ($A1605+$A1606 > 0)	{if ($A1605>$A1606)	{$clubAB8003=$clubAB1605;	} else  {$clubAB8003=$clubAB1606; }}  else {  $A1605="-";	$A1606="-";	$clubAB8003="-";}
				 if ($A1607+$A1608 > 0)	{if ($A1607>$A1608)	{$clubAB8004=$clubAB1607;	} else  {$clubAB8004=$clubAB1608; }}  else {  $A1607="-";	$A1608="-";	$clubAB8004="-";}
				 if ($A1609+$A1610 > 0)	{if ($A1609>$A1610)	{$clubAB8005=$clubAB1609;	} else  {$clubAB8005=$clubAB1610; }}  else {  $A1609="-";	$A1610="-";	$clubAB8005="-";}
				 if ($A1611+$A1612 > 0)	{if ($A1611>$A1612)	{$clubAB8006=$clubAB1611;	} else  {$clubAB8006=$clubAB1612; }}  else {  $A1611="-";	$A1612="-";	$clubAB8006="-";}
				 if ($A1613+$A1614 > 0)	{if ($A1613>$A1614)	{$clubAB8007=$clubAB1613;	} else  {$clubAB8007=$clubAB1614; }}  else {  $A1613="-";	$A1614="-";	$clubAB8007="-";}
				 if ($A1615+$A1616 > 0)	{if ($A1615>$A1616)	{$clubAB8008=$clubAB1615;	} else  {$clubAB8008=$clubAB1616; }}  else {  $A1615="-";	$A1616="-";	$clubAB8008="-";}
				 if ($A1617+$A1618 > 0)	{if ($A1617>$A1618)	{$clubAB8009=$clubAB1617;	} else  {$clubAB8009=$clubAB1618; }}  else {  $A1617="-";	$A1618="-";	$clubAB8009="-";}
				 if ($A1619+$A1620 > 0)	{if ($A1619>$A1620)	{$clubAB8010=$clubAB1619;	} else  {$clubAB8010=$clubAB1620; }}  else {  $A1619="-";	$A1620="-";	$clubAB8010="-";}
				 if ($A1621+$A1622 > 0)	{if ($A1621>$A1622)	{$clubAB8011=$clubAB1621;	} else  {$clubAB8011=$clubAB1622; }}  else {  $A1621="-";	$A1622="-";	$clubAB8011="-";}
				 if ($A1623+$A1624 > 0)	{if ($A1623>$A1624)	{$clubAB8012=$clubAB1623;	} else  {$clubAB8012=$clubAB1624; }}  else {  $A1623="-";	$A1624="-";	$clubAB8012="-";}
				 if ($A1625+$A1626 > 0)	{if ($A1625>$A1626)	{$clubAB8013=$clubAB1625;	} else  {$clubAB8013=$clubAB1626; }}  else {  $A1625="-";	$A1626="-";	$clubAB8013="-";}
				 if ($A1627+$A1628 > 0)	{if ($A1627>$A1628)	{$clubAB8014=$clubAB1627;	} else  {$clubAB8014=$clubAB1628; }}  else {  $A1627="-";	$A1628="-";	$clubAB8014="-";}			
				 if ($A1629+$A1630 > 0)	{if ($A1629>$A1630)	{$clubAB8015=$clubAB1629;	} else  {$clubAB8015=$clubAB1630; }}  else {  $A1629="-";	$A1630="-";	$clubAB8015="-";}			
				 if ($A1631+$A1632 > 0)	{if ($A1631>$A1632)	{$clubAB8016=$clubAB1631;	} else  {$clubAB8016=$clubAB1632; }}  else {  $A1631="-";	$A1632="-";	$clubAB8016="-";}			
				}	
			}
			 // 8me de finale
		if (substr($type,5,2) >= '08')
			{
				...
				if ($A8001Pts+$A8002Pts>6) {if ($A8001Pts > $A8002Pts or ($A8001Pts == $A8002Pts and $A8001>$A8002)) {$clubAB4001= $clubAB8001;} else {$clubAB4001= $clubAB8002;}} else {$clubAB4001="-";}	
				if ($A8003Pts+$A8004Pts>6) {if ($A8003Pts > $A8004Pts or ($A8003Pts == $A8004Pts and $A8003>$A8004)) {$clubAB4002= $clubAB8003;} else {$clubAB4002= $clubAB8004;}} else {$clubAB4002="-";}
				if ($A8005Pts+$A8006Pts>6) {if ($A8005Pts > $A8006Pts or ($A8005Pts == $A8006Pts and $A8005>$A8006)) {$clubAB4003= $clubAB8005;} else	{$clubAB4003= $clubAB8006;}} else {$clubAB4003="-";}
				if ($A8007Pts+$A8008Pts>6) {if ($A8007Pts > $A8008Pts or ($A8007Pts == $A8008Pts and $A8007>$A8008)) {$clubAB4004= $clubAB8007;} else	{$clubAB4004= $clubAB8008;}} else {$clubAB4004="-";}
				
				if ($A8009Pts+$A8010Pts>6) {if ($A8009Pts > $A8010Pts or ($A8009Pts == $A8010Pts and $A8009>$A8010)) {$clubAB4005= $clubAB8009;} else {$clubAB4005= $clubAB8010;}} else {$clubAB4005="-";}	
				if ($A8011Pts+$A8012Pts>6) {if ($A8011Pts > $A8012Pts or ($A8011Pts == $A8012Pts and $A8011>$A8012)) {$clubAB4006= $clubAB8011;} else {$clubAB4006= $clubAB8012;}} else {$clubAB4006="-";}
				if ($A8013Pts+$A8014Pts>6) {if ($A8013Pts > $A8014Pts or ($A8013Pts == $A8014Pts and $A8013>$A8014)) {$clubAB4007= $clubAB8013;} else	{$clubAB4007= $clubAB8014;}} else {$clubAB4007="-";}
				if ($A8015Pts+$A8016Pts>6) {if ($A8015Pts > $A8016Pts or ($A8015Pts == $A8016Pts and $A8015>$A8016)) {$clubAB4008= $clubAB8015;} else	{$clubAB4008= $clubAB8016;}} else {$clubAB4008="-";}
				
				}
				else
				{				

					 if ($A8001+$A8002 > 0)	{if ($A8001>$A8002)	{$clubAB4001=$clubAB8001;	} else	{$clubAB4001=$clubAB8002;	}}	else{	$A8001="-";	$A8002="-";	$clubAB4001="-";}
					 if ($A8003+$A8004 > 0)	{if ($A8003>$A8004)	{$clubAB4002=$clubAB8003;	} else	{$clubAB4002=$clubAB8004;	}}	else{	$A8003="-";	$A8004="-";	$clubAB4002="-";}
					 if ($A8005+$A8006 > 0)	{if ($A8005>$A8006)	{$clubAB4003=$clubAB8005;	} else	{$clubAB4003=$clubAB8006;	}}	else{	$A8005="-";	$A8006="-";	$clubAB4003="-";}
					 if ($A8007+$A8008 > 0)	{if ($A8007>$A8008)	{$clubAB4004=$clubAB8007;	} else	{$clubAB4004=$clubAB8008;	}}	else{	$A8007="-";	$A8008="-";	$clubAB4004="-";}
					 if ($A8009+$A8010 > 0)	{if ($A8009>$A8010)	{$clubAB4005=$clubAB8009;	} else	{$clubAB4005=$clubAB8010;	}}	else{	$A8009="-";	$A8010="-";	$clubAB4005="-";}
					 if ($A8011+$A8012 > 0)	{if ($A8011>$A8012)	{$clubAB4006=$clubAB8011;	} else	{$clubAB4006=$clubAB8012;	}}	else{	$A8011="-";	$A8012="-";	$clubAB4006="-";}
					 if ($A8013+$A8014 > 0)	{if ($A8013>$A8014)	{$clubAB4007=$clubAB8013;	} else	{$clubAB4007=$clubAB8014;	}}	else{	$A8013="-";	$A8014="-";	$clubAB4007="-";}
					 if ($A8015+$A8016 > 0)	{if ($A8015>$A8016)	{$clubAB4008=$clubAB8015;	} else	{$clubAB4008=$clubAB8016;	}}	else{	$A8015="-";	$A8016="-";	$clubAB4008="-";}
					}
				}	
					// Quarts de finale
					if (substr($type,7,2) >= '04')
					{
						...
						if ($A4001Pts+$A4002Pts>6) {if ($A4001Pts > $A4002Pts or ($A4001Pts == $A4002Pts and $A4001>$A4002)) {$clubAB2001= $clubAB4001;} else {$clubAB2001= $clubAB4002;}} else {$clubAB2001="-"; }	
						if ($A4003Pts+$A4004Pts>6) {if ($A4003Pts > $A4004Pts or ($A4003Pts == $A4004Pts and $A4003>$A4004)) {$clubAB2002= $clubAB4003;} else {$clubAB2002= $clubAB4004;}} else {$clubAB2002="-";}
						if ($A4005Pts+$A4006Pts>6) {if ($A4005Pts > $A4006Pts or ($A4005Pts == $A4006Pts and $A4005>$A4006)) {$clubAB2003= $clubAB4005;} else	{$clubAB2003= $clubAB4006;}} else {$clubAB2003="-";}
						if ($A4007Pts+$A4008Pts>6) {if ($A4007Pts > $A4008Pts or ($A4007Pts == $A4008Pts and $A4007>$A4008)) {$clubAB2004= $clubAB4007;} else	{$clubAB2004= $clubAB4008;}} else {$clubAB2004="-";}
						...
						{			
						 ...
						 if ($A4001+$A4002 > 0)	{if ($A4001>$A4002)	{$clubAB2001=$clubAB4001;	} else	{$clubAB2001=$clubAB4002;	}}	else{	$A4001="-";	$A4002="-";	$clubAB2001="-";}
						 if ($A4003+$A4004 > 0)	{if ($A4003>$A4004)	{$clubAB2002=$clubAB4003;	} else	{$clubAB2002=$clubAB4004;	}}	else{	$A4003="-";	$A4004="-";	$clubAB2002="-";}
						 if ($A4005+$A4006 > 0)	{if ($A4005>$A4006)	{$clubAB2003=$clubAB4005;	} else	{$clubAB2003=$clubAB4006;	}}	else{	$A4005="-";	$A4006="-";	$clubAB2003="-";}
						 if ($A4007+$A4008 > 0)	{if ($A4007>$A4008)	{$clubAB2004=$clubAB4007;	} else	{$clubAB2004=$clubAB4008;	}}	else{	$A4007="-";	$A4008="-";	$clubAB2004="-";}
						...
						if (substr($type,9,2) >= '02')
						{
							...
							if ($A2001Pts+$A2002Pts>6) {if ($A2001Pts > $A2002Pts or ($A2001Pts == $A2002Pts and $A2001>$A2002)) {$clubAB1001= $clubAB2001;} else {$clubAB1001= $clubAB2002;}} else {$clubAB1001="-";}	
							if ($A2003Pts+$A2004Pts>6)
								{
									if ($A2003Pts > $A2004Pts or ($A2003Pts == $A2004Pts and $A2003>$A2004))
									{
							...
							if ($A2001+$A2002 > 0)	{if ($A2001>$A2002)	{$clubAB1001=$clubAB2001;	} else	{$clubAB1001=$clubAB2002;	}}	else{	$A2001="-";	$A2002="-";	$clubAB1001="-";}
							if ($A2003+$A2004 > 0)	{if ($A2003>$A2004)	{$clubAB1002=$clubAB2003;	} else	{$clubAB1002=$clubAB2004;	}}	else{	$A2003="-";	$A2004="-";	$clubAB1002="-";}
							}
						}	
						
						//finale
						 if ($A1001+$A1002 > 0)	{if ($A2001>$A2002)	{$clubAB1001=$clubAB2001;	} else	{$clubAB1001=$clubAB2002;	}}	else{	$A1001="-";	$A1002="-";}
