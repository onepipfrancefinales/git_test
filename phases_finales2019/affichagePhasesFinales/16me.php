<table width="2000" border="0" height="500" cellspacing="" align="center">
    ...
    <td id="cal" width="200">
      ...
      <div class="coin5-32BarrageFed2">
        <?php if (substr($type, 0, 1) == 7 and $annee > 2021) { ?>
          <a href="javascript:ouvrirPopup('barrages.php?annee=<?php echo $annee; ?>&division=7250','','top=10, right=10,resizable=no, directories=no, statut=no, location=no, width=330, height=600, menubar=no')">
            <font color="#FFFFFF">Barrages accès aux 16me<br />
            </font>
          </a>
      </div>
    <?php } ?>
  ...
  <tr>
    ...
    <td class="coin5pts"><?php echo $A1631; ?>
    <td>
