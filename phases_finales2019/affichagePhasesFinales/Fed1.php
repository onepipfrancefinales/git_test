...
$clubA8001="Tyrosse (CBL)";
$clubA8002="Blagnac (MPY)";	
$clubA8003="Carqueiranne Hyeres (CAZ)";	
$clubA8004="Oloron (BE)";	
$clubA8005="Anglet (CBL)";	
$clubA8006="Saint Jean de luz (CBL)";	
$clubA8007="La Seyne sur Mer (CAZ)";	
$clubA8008="Trelissac (PA)";	
$clubA8009="Vienne (LY)";	
$clubA8010="Cognac (PCH)";	
$clubA8011="Lavaur (MPY)";	
$clubA8012="Valence d'Agen (MPY)";	
$clubA8013="Castanet (MPY)";	
$clubA8014="Macon (BG)";	
$clubA8015="Nantes (PL)";	
$clubA8016="Nimes (PR)";	
...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="180" align="left" height="13">&nbsp;</td>
    <td width="27" height="13">&nbsp;</td>
    <td width="27" height="13">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="23" height="13">&nbsp;</td>
    <td width="27" height="13">&nbsp;</td>
    <td width="180" align="left" height="13"> 
      <div class="coin5" >Demi finale</div>
    </td>
    <td width="27" height="13">&nbsp;</td>
    <td width="27" height="13">&nbsp;</td>
    <td width="21" height="13">&nbsp;</td>
    <td width="176" height="13"> 
    ...
    <td height="13" colspan="5"> 
      <div class="coin5" >Accession &agrave; la Pro D2</div>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td height="13" colspan="5"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5">1er 
        de poule</font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="28"> 
      <div class="coin4pts" >0</div>
    </td>
    <td width="32"> 
      <div class="coin4" >17</div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
    <td width="204">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="28" height="5"> 
      <div class="coin4pts" > 9</div>
    </td>
    <td width="32" height="5"> 
      <div class="coin4" ><font size="2"> 59</font></div>
    </td>
    ...
    <td width="29" height="5"> 
      <div class="coin4pts" > 3</div>
    </td>
    <td width="23" height="5"> 
      <div class="coin4" > 25</div>
    </td>
    <td rowspan="7" height="25" width="27"><img src="../../images/accolade.png" width="8" height="140"></td>
    <td width="180" height="5" align="left">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32" height="22"> 
      <div class="coin4" ><font size="2">32</font></div>
    </td>
    ...
    <td width="29" height="22"> 
      <div class="coin4pts" > 6</div>
    </td>
    <td width="23" height="22"> 
      <div class="coin4" > 28</div>
    </td>
    <td width="180" align="left" height="22">&nbsp;</td>
    <td width="27" height="22">&nbsp;</td>
    <td width="27" height="22">&nbsp;</td>
    ...
    <td width="30" height="22">&nbsp;</td>
    <td width="34" height="22">&nbsp;</td>
    <td width="28" bgcolor="#FFCC66" height="22">&nbsp;</td>
    <td valign="top" width="36" height="22">&nbsp;</td>
    <td valign="top" colspan="2" height="22" bgcolor="#FFFF00"> 
      <div align="center"><font face="Times New Roman, Times, serif" size="5"><b><font face="Arial, Helvetica, sans-serif" color="#FF0000">Provence 
        Rugby (PR)</font></b></font></div>
    </td>
    <td valign="top" width="31" height="22">&nbsp;</td>
    <td valign="top" width="24" height="22">&nbsp;</td>
  </tr>
  <tr> 
    <td width="229"> 
      <div class="coin4" > 
    ...
    <td width="32"> 
      <div class="coin4" ><font size="2">37</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="23">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="27"> 
      <div class="coin4" > 22</div>
    </td>
    <td rowspan="11" width="21"><img src="../../images/accolade.png" width="10" height="220"></td>
    <td width="176">&nbsp;</td>
    <td width="30">&nbsp;</td>
    <td width="34">&nbsp;</td>
    <td width="28" bgcolor="#FFCC66">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="28" height="11"> 
      <div class="coin5pts" >4</div>
    </td>
    <td width="32" height="11"> 
      <div class="coin5" ><font size="2">36</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
    <td width="204" height="11">&nbsp;</td>
    ...
    <td width="27"> 
      <div class="coin4pts" > 4</div>
    </td>
    <td width="27"> 
      <div class="coin4" > 32</div>
    </td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div class="coin5" ><font size="2">37</font></div>
    </td>
    <td width="204"> 
      <div class="coin4" > 
        <?php echo $clubA8006; ?>
    ...
    <td width="29"> 
      <div class="coin4pts" > 5</div>
    </td>
    <td width="23"> 
      <div class="coin4" > 48</div>
    </td>
    <td width="180" align="left">&nbsp;</td>
    <td width="27">&nbsp;</td>
    <td width="27">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32" height="15"> 
      <div class="coin5" ><font size="2">54</font></div>
    </td>
    ...
    <td valign="top" height="15" width="36"> 
      <div align="center"><b></b></div>
    </td>
    <td valign="top" height="15" width="217">&nbsp;</td>
    <td valign="top" height="15" width="27">&nbsp;</td>
    <td valign="top" height="15" width="31">&nbsp;</td>
    <td valign="top" height="15" width="24">&nbsp;</td>
  </tr>
  <tr> 
    <td width="229"> 
      <div class="coin5" > 
    ...
    <td width="32"> 
      <div class="coin5" ><font size="2">56</font></div>
    </td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
    <td width="23">&nbsp;</td>
    ...
    <td width="27">&nbsp;</td>
    <td width="176"> 
      <div class="coin4" >Trelissac (PA)</div>
    </td>
    <td width="30"> 
      <div class="coin4" > 21</div>
    </td>
    <td width="34">&nbsp;</td>
    <td width="28" bgcolor="#FFCC66">&nbsp;</td>
    ...
    <td valign="top" width="217"> 
      <div class="coin4" >Tarbes (AB)</div>
    </td>
    <td valign="bottom" width="27"> 
      <div class="coin4pts" >1</div>
    </td>
    <td valign="bottom" width="31"> 
      <div class="coin4" >29</div>
    </td>
    <td valign="top" width="24">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="28">&nbsp;</td>
    <td width="204" height="25">&nbsp;</td>
    <td width="29" height="25">&nbsp;</td>
    <td width="23" height="25">&nbsp;</td>
    <td width="27">&nbsp;</td>
    <td width="180" height="25" align="left">&nbsp;</td>
    <td width="27" height="25">&nbsp;</td>
    <td width="27" height="25">&nbsp;</td>
    <td width="176"> 
      <div class="coin4" > Lavaur (MPY)</div>
    </td>
    <td width="30"> 
      <div class="coin4" > 24</div>
    </td>
    <td width="34" height="25">&nbsp;</td>
    <td width="28" height="25" bgcolor="#FFCC66">&nbsp;</td>
    <td valign="top" width="36">&nbsp;</td>
    <td valign="top" width="217"> 
      <div class="coin4" >Bourg en Bresse (LY)</div>
    </td>
    <td valign="top" width="27"> 
      <div class="coin4pts" >8</div>
    </td>
    <td valign="top" width="31"> 
      <div class="coin4" >44</div>
    </td>
    <td valign="top" width="24">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="32"> 
      <div class="coin4" ><font size="2">47</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
    <td width="204">&nbsp;</td>
    <td width="29">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="32"> 
      <div class="coin4" ><font size="2">38</font></div>
    </td>
    <td width="204"> 
      <div class="coin4" > 
        <?php echo $clubA8009; ?>
    ...
    <td valign="top" width="36">&nbsp;</td>
    <td valign="top" width="217"> 
      <div class="coin4" >Rouen (N)</div>
    </td>
    <td valign="bottom" width="27"> 
      <div class="coin4pts" >8</div>
    </td>
    <td valign="bottom" width="31"> 
      <div class="coin4" >33</div>
    </td>
    <td valign="top" width="24">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="32" height="20"> 
      <div class="coin4" ><font size="2">44</font></div>
    </td>
    ...
    <td width="23" height="20"> 
      <div class="coin4" > 51</div>
    </td>
    <td width="180" align="left" height="20">&nbsp;</td>
    ...
    <td valign="top" width="217" height="20"> 
      <div class="coin4" >Albi (MPY)</div>
    </td>
    <td valign="top" width="27" height="20"> 
      <div class="coin4pts" >2</div>
    </td>
  ...
  <tr> 
    ...
    <td width="32" height="11"> 
      <div class="coin4" ><font size="2">39</font></div>
    </td>
    <td width="204" height="11">&nbsp;</td>
    <td width="29" height="11">&nbsp;</td>
    <td width="23" height="11">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="28" height="16">&nbsp;</td>
    <td width="204" height="16">&nbsp;</td>
    <td width="29" height="16">&nbsp;</td>
    <td width="23" height="16">&nbsp;</td>
    <td width="180" height="16" valign="middle"> 
      <div class="coin4" > 
        <?php echo $clubA8014; ?>
      </div>
    </td>
    <td width="27" height="16" valign="middle"> 
      <div class="coin4pts" > 0</div>
    </td>
    <td width="27" height="16" valign="middle"> 
      <div class="coin4" > 14</div>
    </td>
    ...
    <td valign="top" colspan="5" height="16"> 
      <div align="center"><b></b></div>
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="5">Finale 
        (A/R) </font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td width="32" height="20"> 
      <div class="coin5" ><font size="2">53</font></div>
    </td>
    <td rowspan="4" width="28"><img src="../../images/accolade.png" width="7" height="75"></td>
    ...
    <td width="28" height="20" bgcolor="#FFCC66">&nbsp;</td>
    <td valign="top" width="36" height="20">&nbsp;</td>
    <td valign="bottom" width="217" height="20"> 
      <div class="coin4" >Rouen (N)</div>
    </td>
    <td valign="bottom" width="27" height="20"> 
      <div class="coin4pts" >1</div>
    </td>
    <td valign="bottom" width="31" height="20"> 
      <div class="coin4" >34</div>
    </td>
    <td valign="top" width="24" height="20">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="28" height="5"> 
      <div class="coin5pts" >5</div>
    </td>
    <td width="32" height="5"> 
      <div class="coin5" ><font size="2">73</font></div>
    </td>
    <td width="204" height="5"> 
      <div class="coin4" > 
        <?php echo $clubA8014; ?>
    ...
    <td width="23" height="5"> 
      <div class="coin4" > 53</div>
    </td>
    <td width="180" align="left" height="5">&nbsp;</td>
    <td width="27" height="5">&nbsp;</td>
    <td width="27" height="5">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="28" height="2"> 
      <div class="coin5pts" >8</div>
    </td>
    <td width="32" height="2"> 
      <div class="coin5" ><font size="2">58</font></div>
    </td>
    ...
    <td width="23" height="2"> 
      <div class="coin4" > 38</div>
    </td>
    <td width="180" height="2" align="left">&nbsp;</td>
    <td width="27" height="2">&nbsp;</td>
    <td width="27" height="2">&nbsp;</td>
    <td height="2" width="21">&nbsp;</td>
    <td width="176" height="2">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="28" height="3"> 
      <div class="coin5pts" >1</div>
    </td>
    <td width="32" height="3"> 
      <div class="coin5" ><font size="2">47</font></div>
    </td>
    <td width="204" height="3">&nbsp;</td>
    <td width="29" height="3">&nbsp;</td>
    <td width="23" height="3">&nbsp;</td>
    <td height="3" width="27">&nbsp;</td>
    <td width="180" align="left" height="3">&nbsp;</td>
    <td width="27" height="3">&nbsp;</td>
    <td width="27" height="3">&nbsp;</td>
    <td height="3" width="21">&nbsp;</td>
    <td width="176" height="3">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="27">&nbsp;</td>
    <td width="180" align="left" height="17">&nbsp;</td>
    ...
    <td height="17" width="36">&nbsp;</td>
    <td height="17" colspan="2" bgcolor="#FFFF00"> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif" color="#FF0000" size="4">Bourg 
        en Bresse (LY)</font></b></div>
    </td>
    <td height="17" width="31">&nbsp;</td>
    <td height="17" width="24">&nbsp;</td>
  </tr>
  <tr> 
    <td colspan="15" height="17" bgcolor="#FFCC66">&nbsp;</td>
    <td colspan="6" height="17" bgcolor="#FFCC66">&nbsp;</td>
  </tr>
</table>
