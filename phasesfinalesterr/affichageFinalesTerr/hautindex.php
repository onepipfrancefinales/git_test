...
?>
  ...
  <tr > 
    ...
    <td class="equipeI"><a href="pageAffichage.php?page=S2S3S4&comite=<?php echo $comite;?>&annee=<?php echo $annee;?>&division=<?php echo $div200;?>" target="_top">2i&egrave;meSérie</a></td>
    <td class="equipeI"><a href="pageAffichage.php?page=S2S3S4&comite=<?php echo $comite;?>&annee=<?php echo $annee;?>&division=<?php echo $div210;?>" target="_top">3i&egrave;meSérie</a></td>
    <td class="vide" colspan="2" ><a href="/palmares/palmTerritorial/tableauPalmReg.php?sigleLigue=<?php echo $appartenanceLigue;?>" target="_top">Palmar&egrave;s régional </a></td>
  </tr>
  <tr > 
    ...
    <td class="equipeI"><a href="pageAffichage.php?page=S2S3S4&comite=<?php echo $comite;?>&annee=<?php echo $annee;?>&division=<?php echo $div220;?>" target="_top">4i&egrave;meSérie</a></td>
