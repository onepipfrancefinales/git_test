...
<br>
<br>
<table width="989" border="0" align="left" height="500" cellspacing="0">
  <tr> 
    <td height="13" bgcolor="#FFCC66" colspan="12"><i><b>Honneur Honneur Honneur 
      Honneur Honneur Honneur Honneur Honneur Honneur Honneur Honneur Honneur 
      Honneur Honneur Honneu</b></i></td>
  </tr>
  <tr> 
    <td width="184" height="13">&nbsp;</td>
    <td width="33" height="13">&nbsp;</td>
    <td width="35" height="13">&nbsp;</td>
    <td width="184" height="13">&nbsp;</td>
    <td width="33" height="13">&nbsp;</td>
    <td width="23" height="13">&nbsp;</td>
    <td width="184" align="left" height="13">&nbsp;</td>
    <td width="33" height="13">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="33" height="13">&nbsp;</td>
    <td width="23" height="13">&nbsp;</td>
    <td width="184" align="left" height="13"> 
...
$result = mysql_query($query);
       ...
       ?>
      <?
$reponse = mysql_query("SELECT A8005, A8006, A8007, A8008 FROM Phpmpy_pf$annee WHERE id='170'");
...
?>
    ...
    <td width="184" align="left" height="26"> 
      <?
...
echo "";	
  ...
  <tr> 
    <td width="184" height="25"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="2"><b> 
      </b></font> </td>
    <td width="33" height="25"> </td>
    <td width="35" height="25">&nbsp;</td>
    <td width="184" height="25"><font size="2" face="Arial, Helvetica, sans-serif"><b><i> 
      <?php
...
?>
    ...
    <td width="184" height="25" align="left">&nbsp;</td>
    <td width="33" height="25">&nbsp;</td>
    <td width="24" height="25">&nbsp;</td>
    <td width="184" height="25">&nbsp;</td>
    <td width="33" height="25">&nbsp;</td>
...
$result = mysql_query($query);
       ...
       ?>
        <?
$reponse = mysql_query("SELECT A8001, A8002, A8003, A8004 FROM Phpmpy_pf$annee WHERE id='170'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A8001= $donnees['A8001'];
 $A8002= $donnees['A8002'];
...
?>
  ...
  <tr> 
    ...
    <td width="184" align="left" height="15"><font size="2" face="Arial, Helvetica, sans-serif"> 
      <strong> 
      <?php
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion � MySQL
mysql_select_db("onepip-france-db1"); // S&egrave;lection de la base onepip
...
echo "";	
  ...
  <tr> 
    ...
    <td width="33">&nbsp;</td>
    <td width="35">&nbsp;</td>
    <td width="184"><font size="2" face="Arial, Helvetica, sans-serif"><strong> 
      <?php
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion � MySQL
mysql_select_db("onepip-france-db1"); // S&egrave;lection de la base onepip
$reponse = mysql_query("SELECT * FROM Phpmpy_pf$annee WHERE id='170' "); // Requ�te SQL
...
echo "";	
  ...
  <tr> 
    ...
    <td width="184" height="24"><font size="2" face="Arial, Helvetica, sans-serif"><b><i> 
      <?php
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion � MySQL
mysql_select_db("onepip-france-db1"); // S&egrave;lection de la base onepip
$reponse = mysql_query("SELECT * FROM Phpmpy_pf$annee WHERE id='170' "); // Requ�te SQL
...
?>
  ...
  <tr> 
    ...
    <td width="184" height="11" align="left">&nbsp;</td>
    <td width="33" height="11">&nbsp;</td>
...
echo "";	
  ...
  <tr valign="top"> 
    <td width="184" height="6"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b> 
      </b></font> </td>
    <td width="33" height="6"> </td>
    <td width="35" height="6">&nbsp; </td>
    <td width="184" height="6"><font size="2" face="Arial, Helvetica, sans-serif"> 
      <strong> 
      <?php
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion � MySQL
mysql_select_db("onepip-france-db1"); // S&egrave;lection de la base onepip
...
?>
    ...
    <td width="184" height="6" align="left"><font color="#000000" face="Geneva, Arial, Helvetica, san-serif"size="4"><b> 
      </b></font></td>
    <td width="33" height="6">&nbsp;</td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="184" align="left" height="20"><font size="2" face="Arial, Helvetica, sans-serif"> 
      <strong> 
      <?php
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion � MySQL
mysql_select_db("onepip-france-db1"); // S&egrave;lection de la base onepip	  
