...
WHERE phpmpy_pf$annee.clubA8005=phpmpy_clubs.id and phpmpy_pf$annee.id='210'";
...
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo 
FROM phpmpy_pf$annee, phpmpy_clubs 
WHERE phpmpy_pf$annee.clubA8008=phpmpy_clubs.id and phpmpy_pf$annee.id='210'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                      		      
		$clubA8008=$row[0];
       ...
       ?>
      <?php
$reponse = mysql_query("SELECT A8005, A8006, A8007, A8008 
...
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo 
FROM phpmpy_pf$annee, phpmpy_clubs 
WHERE phpmpy_pf$annee.clubA4005=phpmpy_clubs.id and phpmpy_pf$annee.id='210'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                  
		$clubA4005=$row[0];
...
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo 
FROM phpmpy_pf$annee, phpmpy_clubs 
WHERE phpmpy_pf$annee.clubA4007=phpmpy_clubs.id and phpmpy_pf$annee.id='210'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                		      
		$clubA4007=$row[0];
...
?>
  ...
  ?>
      <?php
$reponse = mysql_query("SELECT A4005, A4006, A4007, A4008 
FROM phpmpy_pf$annee 
WHERE id='210'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
...
$reponse = mysql_query("SELECT Quart1, Demi1, Finale
						FROM phpmpy_pf$annee 
						WHERE id='210' "); // Requête SQL
while ($donnees = mysql_fetch_array($reponse) )
{ 
?>
      <strong> 
      <?php echo $donnees['Quart1'];?>
       <?php $Demi1 = $donnees['Demi1'];?>
	   <?php $Finale = $donnees['Finale'];?>
