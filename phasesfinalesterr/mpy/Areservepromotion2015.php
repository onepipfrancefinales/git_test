  ...
  <table width="100%" border="0" height="30">
    ...
    <tr valign="top" align="center"> 
      <td colspan="3" bgcolor="#006699" height="31"><font size="5"><b><font color="#FFCC00"> 
        <? echo "Championnat des Pyr�n�es $annee : R�serve Promotion Honneur";?>
        </font></b></font></td>
    </tr>
  </table>
</div>
...
$result = mysql_query($query);
       ...
       ?>
      <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8006=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                        		      
		$clubA8006=$row[0];
       ...
       ?>
      <?  
$query = "SELECT  Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8007=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                        		      
		$clubA8007=$row[0];
       ...
       ?>
      <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8008=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                      		      
		$clubA8008=$row[0];
       ...
       ?>
      <?
$reponse = mysql_query("SELECT A8005, A8006, A8007, A8008 FROM Phpmpy_pf$annee WHERE id='9180'");
...
?>
    ...
    <td width="160" height="26"> 
      <?  
$query = "SELECT  Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA4005=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                  
		$clubA4005=$row[0];
...
?>
  ...
  ?>
      <?  
$query = "SELECT  Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA4007=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                		      
		$clubA4007=$row[0];
...
?>
  ...
  ?>
      <?
$reponse = mysql_query("SELECT A4005, A4006, A4007, A4008 FROM Phpmpy_pf$annee WHERE id='9180'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A4005= $donnees['A4005'];
 $A4006= $donnees['A4006'];
...
?>
    ...
    <td width="160" align="left" height="26"> 
      <?
$reponse = mysql_query("SELECT A2001, A2002, A2003, A2004 FROM Phpmpy_pf$annee WHERE id='9180'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A2001= $donnees['A2001'];
 $A2002= $donnees['A2002'];
...
echo "";	
  ...
  <tr> 
    <td width="160"> 
      <div id="barrage" > 
        <?  
$query = "SELECT  Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8001=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                         		      
		$clubA8001=$row[0];
       ...
       ?>
        <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8002=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                    		      
		$clubA8002=$row[0];
       ...
       ?>
        <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8003=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                 
       ...
       ?>
        <?  
$query = "SELECT  Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8004=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                      
		$clubA8004=$row[0];
       ...
       ?>
        <?
$reponse = mysql_query("SELECT A8001, A8002, A8003, A8004 FROM Phpmpy_pf$annee WHERE id='9180'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A8001= $donnees['A8001'];
 $A8002= $donnees['A8002'];
...
?>
    ...
    <td width="160"> 
      <div id="quarts" > 
        <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA4001=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                            
		$clubA4001=$row[0];
...
echo "";	
  ...
  ?>
        <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA4003=Phpmpy_clubs.id and Phpmpy_pf$annee.id='9180'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                            		      
		$clubA4003=$row[0];
...
echo "";	
  ...
  ?>
        <?
$reponse = mysql_query("SELECT A4001, A4002, A4003, A4004 FROM Phpmpy_pf$annee WHERE id='9180'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A4001= $donnees['A4001'];
 $A4002= $donnees['A4002'];
...
echo "";	
  ...
  ?>
    ...
    <td width="30"> 
      <div id="quarts" > 
        <?
$reponse = mysql_query("SELECT A1001 FROM Phpmpy_pf$annee WHERE id='9180'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A1001= $donnees['A1001'];
 echo $A1001;     
...
echo "";	
  ...
  ?>
    ...
    <td width="30" height="11"> 
      <div id="quarts" > 
        <?
$reponse = mysql_query("SELECT A1002 FROM Phpmpy_pf$annee WHERE id='9180'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A1002= $donnees['A1002'];
 echo $A1002;     
