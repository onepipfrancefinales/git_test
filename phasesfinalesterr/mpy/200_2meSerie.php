...
$result = mysql_query($query);
       ...
       ?>
        <?  
$query = "SELECT  Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA8004=Phpmpy_clubs.id and Phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                      
		$clubA8004=$row[0];
       ...
       ?>
        <?
$reponse = mysql_query("SELECT A8001, A8002, A8003, A8004 FROM Phpmpy_pf$annee WHERE id='200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A8001= $donnees['A8001'];
 $A8002= $donnees['A8002'];
...
?>
    ...
    <td width="160"> 
      <div id="quarts" > 
        <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA4001=Phpmpy_clubs.id and Phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                            
		$clubA4001=$row[0];
...
echo "";	
  ...
  ?>
        <?  
$query = "SELECT Phpmpy_clubs.nom, Phpmpy_clubs.url_logo FROM Phpmpy_pf$annee, Phpmpy_clubs WHERE Phpmpy_pf$annee.clubA4003=Phpmpy_clubs.id and Phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                            		      
		$clubA4003=$row[0];
