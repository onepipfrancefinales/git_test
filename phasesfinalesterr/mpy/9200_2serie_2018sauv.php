  ...
  <table width="100%" border="0" height="30">
    ...
    <tr valign="top" align="center"> 
      <td colspan="3" bgcolor="#006699" height="31"><font size="5"><b><font color="#FFCC00"> 
        <?php echo "Championnat des Pyr&eacute;n&eacute;es $annee : R&eacute;serve 2me S&egrave;rie";?>
        </font></b></font></td>
    </tr>
  </table>
</div>
...
<table width="1000" border="0" align="left" height="500" cellspacing="0">
  <tr> 
    <td height="22" bgcolor="#FFCC66" colspan="12"><i><b> R&eacute;serve 2me S&eacute;rie 
...
$result = mysql_query($query);
       ...
       ?>
        <?  
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8004=phpmpy_clubs.id and phpmpy_pf$annee.id='9200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                      
		$clubA8004=$row[0];
       ...
       ?>
        <?
$reponse = mysql_query("SELECT A8001, A8002, A8003, A8004 FROM phpmpy_pf$annee WHERE id='9200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A8001= $donnees['A8001'];
 $A8002= $donnees['A8002'];
...
?>
    ...
    <td width="160"> 
      <div id="quarts" > 
        <?  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4001=phpmpy_clubs.id and phpmpy_pf$annee.id='9200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                            
		$clubA4001=$row[0];
...
echo "";	
  ...
  ?>
        <?  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4003=phpmpy_clubs.id and phpmpy_pf$annee.id='9200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                            		      
		$clubA4003=$row[0];
...
echo "";	
  ...
  <tr> 
    ...
    <td width="21">&nbsp;</td>
    <td rowspan="3" align="left" colspan="2">Caraman disqualifi&eacute;, pour 
      non respect des r&eacute;gles administratives (joueur avec plus de 9 matchs 
      en &eacute;quipe Une) </td>
  </tr>
  <tr> 
    <td width="160" height="11"> 
      <div id="barrage" > 
