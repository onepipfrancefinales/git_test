...
<table width="1000" border="0" align="left" height="500" cellspacing="0">
  <tr> 
    <td height="13" bgcolor="#FFCC66" colspan="12">
      <div align="center"><i><b> R&eacute;serve R&eacute;serve R&eacute;serve 
...
$result = mysql_query($query);
       ...
       ?>
      <?php
$reponse = mysql_query("SELECT A8005, A8006, A8007, A8008 FROM phpmpy_pf$annee WHERE id='270'");
...
?>
    ...
    <td width="160" height="26"> 
      <?php  
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4005=phpmpy_clubs.id and phpmpy_pf$annee.id='270'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                  
		$clubA4005=$row[0];
...
?>
  ...
  ?>
      <?php 
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4007=phpmpy_clubs.id and phpmpy_pf$annee.id='270'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                		      
		$clubA4007=$row[0];
...
?>
  ...
  ?>
      <?php
$reponse = mysql_query("SELECT A4005, A4006, A4007, A4008 FROM phpmpy_pf$annee WHERE id='270'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A4005= $donnees['A4005'];
 $A4006= $donnees['A4006'];
...
$result = mysql_query($query);
       ...
       ?>
        <?
$reponse = mysql_query("SELECT A8001, A8002, A8003, A8004 FROM phpmpy_pf$annee WHERE id='270'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A8001= $donnees['A8001'];
 $A8002= $donnees['A8002'];
...
?>
    ...
    <td width="160"> 
      <div id="quarts" > 
        <?  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4001=phpmpy_clubs.id and phpmpy_pf$annee.id='270'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                            
		$clubA4001=$row[0];
...
echo "";	
  ...
  ?>
        <?  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4003=phpmpy_clubs.id and phpmpy_pf$annee.id='270'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                            		      
		$clubA4003=$row[0];
...
echo "";	
  ...
  ?>
        <?
$reponse = mysql_query("SELECT A4001, A4002, A4003, A4004 FROM phpmpy_pf$annee WHERE id='270'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A4001= $donnees['A4001'];
 $A4002= $donnees['A4002'];
