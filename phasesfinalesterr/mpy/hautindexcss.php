...
<div id="Layer1" style="position:absolute; width:1000px; height:55px; z-index:1; left: -1px; top: 0px; visibility: visible"> 
  <TABLE WIDTH="100%" BORDER="0" HEIGHT="62">
    ...
    <TR VALIGN="top" ALIGN="center"> 
      ...
      <TD HEIGHT="10" WIDTH="110"> 
        <div id="equipeI" ><A HREF="pagehonneur2010.php?variable_1=<?php echo $saison;?>" TARGET="_top">Honneur</A></DIV>
      </TD>
      <TD HEIGHT="10" WIDTH="110"> 
        <div id="equipeI" ><A HREF="pagepromotion.php?variable_1=<?php echo $saison;?>" TARGET="_top">Promotion</A></DIV>
      </TD>
      <TD WIDTH="110" HEIGHT="10"> 
    ...
    <TR VALIGN="top" ALIGN="center"> 
      <TD WIDTH="118" HEIGHT="2" valign="top"> 
        <div id="vide"><font color="#006699">--</font></div>
      </TD>
      <TD WIDTH="110" HEIGHT="2" valign="top"> 
        <div id="equipeIItitre" >Réserve</div>
      </TD>
      <TD  HEIGHT="2"  WIDTH="110" valign="top"> 
        <div id="equipeII" ><A HREF="pagereservehonneur.php?variable_1=<?php echo $saison;?>" TARGET="_top">Honneur</A></DIV>
      </TD>
      <TD HEIGHT="2"  WIDTH="110" valign="top"> 
        <div id="equipeII" ><A HREF="pagereservepromotion.php?variable_1=<?php echo $saison;?>" TARGET="_top">Promotion</A></DIV>
      </TD>
      <TD WIDTH="110" HEIGHT="2" valign="top"> 
