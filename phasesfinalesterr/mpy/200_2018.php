  ...
  <table width="100%" border="0" height="30">
	...
	include("../../pub7.php"); ?>
      ...
      <td valign="middle" bgcolor="#EAECEB" height="29" align="left">
        <div align="center"><font size="5"><b><font size="5"><b><font size="5"><b><font size="5"><b><font color="#FF0000" size="2"> 
          ...
          </font></b></font></b><font color="#000000" size="2"><a href="http://francefinalesrugby.franceserv.com/phasesfinalesterr/mpy/page2serie.php?variable_1=<?php echo $anneemoins;?>" target="_top"><font size="6" color="#FF0000">&lt;&lt;</font></a></font></font></b></font><font color="#000000" size="2"><font size="5" color="#EAECEB">nnnne</font><font size="5"> 
          </font></font></b><a href="http://francefinalesrugby.franceserv.com/phasesfinalesterr/mpy/page2serie.php?variable_1=<?php echo $anneeplus;?>"target="_top"><font color="#FF0000" size="6"><b>&gt;&gt;</b></font></a></font></div>
        </td>
    ...
    <tr valign="top" align="center"> 
      <td colspan="3" bgcolor="#006699" height="31"><font size="5"><b><font color="#FFCC00"> 
        ...
        <? echo "Championnat des Pyr&eacute;n&eacute;es $annee : 2me S&eacute;rie";?>
...
<table width="1000" border="0" align="left" height="500" cellspacing="0">
  <tr> 
    <td height="13" bgcolor="#FFCC66" colspan="12"><i><b>me S&eacute;rie 2me S&eacute;rie 
      ...
      2me S&eacute;rie 2me S&eacute;rie 2me S&eacute;rie 2me </b></i></td>
  </tr>
  <tr> 
...
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8005=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
       ...
       ?>
      <?php  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8006=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                        		      
		$clubA8006=$row[0];
       ...
       ?>
      <?php  
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8007=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                        		      
		$clubA8007=$row[0];
       ...
       ?>
      <?php 
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8008=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                      		      
		$clubA8008=$row[0];
       ...
       ?>
      <?php
$reponse = mysql_query("SELECT A8005, A8006, A8007, A8008 FROM phpmpy_pf$annee WHERE id='200'");
...
?>
    ...
    <td width="160" height="26"> 
      <?php  
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4005=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                  
		$clubA4005=$row[0];
...
?>
  ...
  ?>
      <?php  
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA4007=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                		      
		$clubA4007=$row[0];
...
?>
  ...
  ?>
      <?php
$reponse = mysql_query("SELECT A4005, A4006, A4007, A4008 FROM phpmpy_pf$annee WHERE id='200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A4005= $donnees['A4005'];
 $A4006= $donnees['A4006'];
...
?>
    ...
    <td width="160" align="left" height="26"> 
      <?php
$reponse = mysql_query("SELECT A2001, A2002, A2003, A2004 FROM phpmpy_pf$annee WHERE id='200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A2001= $donnees['A2001'];
 $A2002= $donnees['A2002'];
...
$reponse = mysql_query("SELECT Quart1 
						FROM phpmpy_pf$annee WHERE id='200' "); // Requête SQL
while ($donnees = mysql_fetch_array($reponse) )
{ 
?>
      <strong> 
...
?>
  ...
  <tr> 
    <td width="160"> 
      <div id="barrage" > 
        <?php  
$query = "SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8001=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                         		      
		$clubA8001=$row[0];
       ...
       ?>
        <?php  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8002=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                    		      
		$clubA8002=$row[0];
       ...
       ?>
        <?php  
$query = "SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo FROM phpmpy_pf$annee, phpmpy_clubs WHERE phpmpy_pf$annee.clubA8003=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                 
...
$query = "	SELECT  phpmpy_clubs.nom, phpmpy_clubs.url_logo 
			...
			WHERE phpmpy_pf$annee.clubA8004=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                      
		$clubA8004=$row[0];
...
$query = "	SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo 
			FROM phpmpy_pf$annee, phpmpy_clubs 
			WHERE phpmpy_pf$annee.clubA4001=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                                            
		$clubA4001=$row[0];
...
$query = "	SELECT phpmpy_clubs.nom, phpmpy_clubs.url_logo 
			FROM phpmpy_pf$annee, phpmpy_clubs 
			WHERE phpmpy_pf$annee.clubA4003=phpmpy_clubs.id and phpmpy_pf$annee.id='200'";
$result = mysql_query($query);
         while($row = mysql_fetch_array($result))
         {                            		      
		$clubA4003=$row[0];
...
echo "";	
  ...
  ?>
        <?php
$reponse = mysql_query("SELECT A4001, A4002, A4003, A4004 FROM phpmpy_pf$annee WHERE id='200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A4001= $donnees['A4001'];
 $A4002= $donnees['A4002'];
...
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion à MySQL
mysql_select_db("onepip-france-db3"); // S&egrave;lection de la base onepip
$reponse = mysql_query("SELECT * FROM phpmpy_pf$annee WHERE id='200' "); // Requête SQL
while ($donnees = mysql_fetch_array($reponse) )
{      
       echo $donnees['Quart2'];
}
...
echo "";	
  ...
  ?>
    ...
    <td width="30"> 
      <div id="quarts" > 
        <?php
$reponse = mysql_query("SELECT A1001 FROM phpmpy_pf$annee WHERE id='200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A1001= $donnees['A1001'];
 echo $A1001;     
...
echo "";	
  ...
  ?>
    ...
    <td width="30" height="11"> 
      <div id="quarts" > 
        <?php
$reponse = mysql_query("SELECT A1002 FROM phpmpy_pf$annee WHERE id='200'");
while ($donnees = mysql_fetch_array($reponse) )
{ 
 $A1002= $donnees['A1002'];
 echo $A1002;     
...
echo "";	
  ...
  <tr valign="top"> 
    <td width="160" height="17"><font color="#FFFFFF" face="Geneva, Arial, Helvetica, san-serif"size="3"><b> 
      </b></font> </td>
    <td width="30" height="17"> </td>
    <td width="32" height="17">&nbsp; </td>
    <td width="160" height="17"><font size="2" face="Arial, Helvetica, sans-serif"> 
      <strong> 
      <?php
mysql_connect("sql.franceserv.fr", "onepip-france", "lavelan09"); // Connexion à MySQL
mysql_select_db("onepip-france-db3"); // S&egrave;lection de la base onepip
...
?>
    ...
    <td width="21" height="17"> 
      <div align="center"><font face="Arial, Helvetica, sans-serif" size="2"><b>t.a.b</b></font></div>
    </td>
    <td width="160" height="17" align="left"><font color="#000000" face="Geneva, Arial, Helvetica, san-serif"size="4"><b> 
      </b></font></td>
    <td width="30" height="17">&nbsp;</td>
  </tr>
  <tr> 
