...
<table >
  ...
  <tr > 
    ...
    <td class="equipeI" > 
		<a href="pagehonneur.php?page=S2S3S4&comite=<?php echo $comite;?>&variable_1=<?php echo $annee;?>" target="_top">2ièmeSérie</a> 
    </td>
    <td class="equipeI" >
		<a href="pagehonneur.php?page=S2S3S4&comite=<?php echo $comite;?>&variable_1=<?php echo $annee;?>" target="_top">3ièmeSérie</a> 
    </td>
    <td class="vide" colspan="2" > 
		<a href="http://francefinalesrugby.franceserv.com/palm_terr2tableau.php?variable_1=<?php echo $comiteMaj; ?>" target="_blank">Palmarès territorial</a> </td>
 	 </tr>
  <tr > 
    ...
    <td class="equipeI"  > 
	<a href="pagehonneur.php?page=S2S3S4&comite=<?php echo $comite;?>&variable_1=<?php echo $annee;?>" target="_top">4ièmeSérie</a> 
    </td>
