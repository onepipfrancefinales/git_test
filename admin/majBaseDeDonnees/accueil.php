...
<h2 >Champions régionaux </h2>
  <p><a href="championsRegionaux.php?annee=<?php echo $saison;?>">G&eacute;n&eacute;rer le fichier des champions 
  des diff&eacute;rentes ligues (Equipes premières) (table bdequipe1)</a></p>

<p><a href="championsRegionauxReserves.php?annee=<?php echo $saison;?>">G&eacute;n&eacute;rer le fichier des champions 
  ...
  <p><a href="championsFrance.php?annee=<?php echo $saison;?>">Liste des clubs participants aux phases finales 
...
<p><a href="selectionLigue.php?annee=<?php echo $saison;?>">Liste des clubs participants aux 
  phases finales du champs des ligues <br/>(Maj tables bdsaison et bdequipe1)</a></p>
</body>
</html>
