...
{
if ($comite == "au") {$ligue = "ARA"; $codeLigue =100000; $titreRegional ="Auvergne Rhone Alpes";}
if ($comite == "ca") {$ligue = "NAQ"; $codeLigue =190000; $titreRegional ="Nouvelle Aquitaine";}
if ($comite == "ab") {$ligue = "OCC"; $codeLigue =200000; $titreRegional ="Occitanie";}
...
if ($comite == 11) {$ligue = "BFC"; $codeLigue =110000;$titreRegional ="Bourgogne Franche Comté";}
if ($comite == 12) {$ligue = "BRE"; $codeLigue =120000;$titreRegional ="Bretagne";}
if ($comite == 13) {$ligue = "CVL"; $codeLigue =130000;$titreRegional ="Centre Val de Loire";}
if ($comite == 16) {$ligue = "HDF"; $codeLigue =160000;$titreRegional ="Hauts de France";}
if ($comite == 21) {$ligue = "PDL"; $codeLigue =210000;$titreRegional ="Pays de la Loire";}
...
$phpComite_pfterr_e = "phppl_pfterr_e";
	...
	echo $id1.';'.$annee.';'.$nomDivision.';'."Champion".';'.$clubChampion.';'.$clubChampion.';'.$clubChampion.';'.'('.$ligue.')'.';'.$clubViceChampion.';'.'('.$ligue.")".';'.$scoreFinale1.';'.$scoreFinale2.';'.$titreRegional.';'.substr($division,-3).';'.$constante.';'."A";
	echo "<br />";	
	echo $id2.';'.$annee.';'.$nomDivision.';'."Vice champion".';'.$clubViceChampion.';'.$clubViceChampion.';'.$clubViceChampion.';'.';'.';'.'('.$ligue.")".';'.$scoreFinale1.';'.$scoreFinale2.';'.$titreRegional.';'.substr($division,-3).';'.$constante.';'."A";
		}	
}	
...
if ($comite == 15) {$ligue = "GES"; $codeLigue =150000;$titreRegional ="Grand Est";}
if ($comite == 17) {$ligue = "IDF"; $codeLigue =170000;$titreRegional ="Ile de France";}
if ($comite == 18) {$ligue = "NOR"; $codeLigue =180000;$titreRegional ="Normandie";}
if ($comite == 22) {$ligue = "PCA"; $codeLigue =220000;$titreRegional ="Provence Alpes Cote d'Azur";}
