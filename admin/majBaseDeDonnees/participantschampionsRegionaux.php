...
if (isset($_POST['selection'])){
	...
	{	
		if ($ligue == "ARA")
			{$division = 10 * 10000 + $division1;	$comite = "au";	$nomLigue = "ARA"; }
		elseif ($ligue == 'NAQ')
			{$division = 19 * 10000 + $division1; $comite = "ca"; $nomLigue = "Nouvelle Aquitaine";}
		elseif ($ligue == 'OCC') 
			{$division = 20 * 10000 + $division1; $comite = "ab";$nomLigue = "Occitanie";}
			
		elseif ($ligue == 'BFC')
			{$division = 11 * 10000 + $division1; $comite = "pl";$nomLigue = "Bourgogne Franche Comté";}
		elseif ($ligue == 'BRE')
			{$division = 12 * 10000 + $division1; $comite = "pl";$nomLigue = "Bretagne";}
		elseif ($ligue == 'CVL')
			{$division = 13 * 10000 + $division1; $comite = "pl";$nomLigue = "Centre Val de Loire";}
		elseif ($ligue == 'HDF')
			{$division = 16 * 10000 + $division1; $comite = "pl";$nomLigue = "Hauts de France";}
		elseif ($ligue == 'PDL')
			{$division = 21 * 10000 + $division1; $comite = "pl";$nomLigue = "Pays de Loire";}

		elseif ($ligue == 'GES')
			{$division = 15 * 10000 + $division1; $comite = "idf";$nomLigue = "Grand Est";}
		elseif ($ligue == 'IDF')
			{$division = 17 * 10000 + $division1; $comite = "idf";$nomLigue = "Ile de France";}
		elseif ($ligue == 'NOR')
			{$division = 18 * 10000 + $division1; $comite = "idf";$nomLigue = "Normandie";}
		elseif ($ligue == 'PCA')
			{$division = 22 * 10000 + $division1; $comite = "idf";$nomLigue = "PCA";}
     ...
     ?>
		...
		echo "<br/>";echo "<br/>";			
			...
			require "insertionBdequipe1.php";
