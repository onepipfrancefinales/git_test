...
define("TEAM","Equipes");
define("MATCH","Matchs");
define("PARAMETRE","Param�tres");
define("GENERER","G�n�rer"); //0.82
define("JOUEURS","Joueurs"); // 0.82
define("BUTEUR","Buteurs");
define("RESULT","R�sultats");
...
define("ADMIN_JOURNEES_MSG9","Journ�e N�");
...
define("ADMIN_COHERENCE_MSG2","Journ�e");
...
define("ADMIN_PARAM_MSG4","Points pour une d�faite ?");
define("ADMIN_PARAM_MSG5","Nombre d'�quipe pour l'accession directe ?");
define("ADMIN_PARAM_MSG6","Nombre d'�quipe pour l'accession en barrages ?");
define("ADMIN_PARAM_MSG7","Nombre d'�quipe pour la r�l�gation ?");
define("ADMIN_PARAM_MSG8","Votre �quipe pr�f�r�e ?");
define("ADMIN_PARAM_TITRE","Param�tres de");
...
define("ADMIN_TAPVERT_MSG1","Ici, vous pouvez g�rer les points de p�nalit� (sanctions administratives, forfaits, etc ...)");
define("ADMIN_TAPVERT_MSG3","Entrez les points de p�nalit� (Ex: -1, -2, ...)");
...
// R�sultats
define("ADMIN_RESULTS_TITRE","R�sultats de");
...
//Graphiques
define("ADMIN_GRAPH_TITRE","G�n�ration des graphiques et des pronos de");
define("ADMIN_GRAPH","La cr�ation des graphiques et des classements a �t� r�alis�e avec succ�s"); //0.82
...
define("ADMIN_GRAPH_4","Erreur lors de la cr�ation de graphique, r�essayez !<br />
                      Si le probl�me persiste modifier le max_execution_time dans php.ini.");
...
define("ADMIN_GESTEQUIPE_1","R�glage des param�tres de : "); // 0.82
...
define("ADMIN_RENS_5","<b>Supprimez</b> les param�tres des renseignements (Choix multiple possible avec la touche SHIFT et CTRL) : ");
...
define("GENERAL","G�n�ral");
define("ATTAQUE","Attaque");
define("DEFENSE","D�fense");
define("GOALDIFF","Diff");
define("CONSULT_CLMNT_MSG2"," de la journ�e ");
define("CONSULT_CLMNT_MSG3"," � la journ�e ");
define("CONSULT_CLMNT_MSG4","Classement g�n�ral, journ�es ");
define("CONSULT_CLMNT_MSG5"," � ");
define("CONSULT_CLMNT_MSG6","Derni�re journ�e : n�");
define("CONSULT_CLMNT_MSG61","Pr�c�dente journ�e (n�");
define("CONSULT_CLMNT_MSG62","Prochaine journ�e : n�");
define("CONSULT_CLMNT_MSG7","ESTIMATION DES SCORES DE LA PROCHAINE JOURNEE :");
define("CONSULT_CLMNT_MSG8","Estim. prochaine journ�e (n�");
define("CONSULT_CLMNT_MSG9","Prochaine journ�e : n� ");
define("CONSULT_CLMNT_MSG10","Classement � domicile, journ�es ");
define("CONSULT_CLMNT_MSG11","Classement des attaques, journ�es ");
define("CONSULT_CLMNT_MSG12","Classement des d�fenses, journ�es ");
define("CONSULT_CLMNT_MSG13","Classement au Goal Average, journ�es ");
define("CONSULT_CLMNT_MSG14","Classement � l'ext�rieur, journ�es ");
...
define("CONSULT_CALENDAR_4","Matchs pr�c�dentsourn�e n�");
define("CONSULT_CALENDAR_5","Derniers r�sultats : journ�e n�");
...
define("PRONO_INSCRIPTION_SUCCES","Inscription réalisée avec succ�s ! Un email vous a �t� adress� pour vous communiquez votre mot de passe !");
define("PRONO_INSCRIPTION_CONNEXION","Connexion");
define("PRONO_INSCRIPTION_ECHOUE","L'envoie de l'e-mail a échouéé !");
