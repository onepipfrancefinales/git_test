...
//echo "test presence";			
		...
		//GÈnÈration du championnat
	    //	require '../../Phpleague/phpca/admin/index5.php?page=championnat&action=generer&champ=190171';
		?>
		<!--
		<meta http-equiv="refresh" content="0; URL=/Phpleague/phpca/admin/index5.php?page=championnat&action=generer&champ=190171">
	    -->
	<?php
