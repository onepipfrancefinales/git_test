...
<?php if ($comiteA=="phpmpy" OR $comiteA=="phppr" OR $comiteA=="phppl" OR $comiteA=="phpbr" OR $comiteA=="phpfed2" OR $comiteA=="phpf1" OR $comiteA=="phpfed3NE" OR $comiteA=="phpfed3GS" OR $comiteA=="phppro") include ("../../connection3.php");
...
<a href="http://francefinalesrugby.franceserv.com/personnalisation/admin/pageChoix.php?comiteA=<?php echo $comiteA; ?>&codeDivision=<?php echo $codeDivision; ?>"><?php echo $division; ?></a><?php echo "<br />"; } mysql_close(); ?>
<hr></div>
