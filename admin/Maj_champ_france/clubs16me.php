...
?>
  ...
  <table border="0" cellspacing="2" cellpadding="2" width="500">
    ...
    <tr align="center" valign="top" bgcolor="#FF0000"> 
      <td valign="middle" width="75"><a href="http://francefinalesrugby.franceserv.com/admin/sadmin.php" target="_top"><b></b></a></td>
      <td colspan="2"> 
        <input type="submit" value="modifier" name="submit">
      </td>
    </tr>
    <tr align="center" valign="top" bgcolor="#FF0000"> 
      <td valign="middle" colspan="3" bgcolor="#00FFFF"><a href="http://francefinalesrugby.franceserv.com/admin/sadmin2.php" target="_top"><b><font face="Arial, Helvetica, sans-serif">Retour 
