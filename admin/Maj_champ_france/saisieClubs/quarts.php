...
?>
  ...
  <table border="0" cellspacing="2" cellpadding="2" width="500">
    ...
    <tr align="center" bgcolor="#CCCCCC"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4001" value="<?php echo($result->E101) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center" bgcolor="#CCCCCC"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4002" value="<?php echo($result->E102) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center" bgcolor="#CCCCCC"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4003" value="<?php echo($result->E103) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center" bgcolor="#CCCCCC"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4004" value="<?php echo($result->E104) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4005" value="<?php echo($result->E105) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4006" value="<?php echo($result->E106) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4007" value="<?php echo($result->E107) ;?>" size="3">
        </div>
      </td>
    </tr>
    <tr align="center"> 
      ...
      <td width="131"> 
        <div align="center"> 
          <input type="text" name="clubA4008" value="<?php echo($result->E108) ;?>" size="3">
        </div>
      </td>
    </tr>
