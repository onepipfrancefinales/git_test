...
<?php echo $niv; ?>
<form name="insertion" action="quarts3AR_fed1.php" method="POST">
  <b><font size="4"> 
  <?php
  ...
  <table border="0" cellspacing="0" cellpadding="10" width="100%">
    ...
    <tr align="center"> 
      ...
      <td width="214" bgcolor="#CCCCCC"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1617" value="<?php echo($result->A1617) ;?>" size="2">
        </font></td>
      <td width="6" bgcolor="#CCCCCC">&nbsp;</td>
      <td width="236" bgcolor="#CCCCCC"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1618" value="<?php echo($result->A1618) ;?>" size="2">
        </font></td>
    </tr>
    <tr align="center"> 
    ...
    <tr align="center"> 
      ...
      <td width="214"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1619" value="<?php echo($result->A1619) ;?>" size="2">
        </font></td>
      <td width="6">&nbsp;</td>
      <td width="236"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1620" value="<?php echo($result->A1620) ;?>" size="2">
        </font></td>
    </tr>
    <tr align="center" bgcolor="#CCCCCC"> 
    ...
    <tr align="center"> 
      <td bgcolor="#CCCCCC">&nbsp;</td>
      <td width="214" bgcolor="#CCCCCC"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1621" value="<?php echo($result->A1621) ;?>" size="2">
        </font></td>
      <td width="6" bgcolor="#CCCCCC">&nbsp;</td>
      <td width="236" bgcolor="#CCCCCC"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1622" value="<?php echo($result->A1622) ;?>" size="2">
        </font></td>
    </tr>
    <tr align="center"> 
    ...
    <tr align="center"> 
      ...
      <td><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1623" value="<?php echo($result->A1623) ;?>" size="2">
        </font></td>
      <td>&nbsp;</td>
      <td><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1624" value="<?php echo($result->A1624) ;?>" size="2">
        </font></td>
    </tr>
    <tr align="center" bgcolor="#FF0000"> 
    ...
    <tr align="center" bgcolor="#CCCCCC"> 
      <td>&nbsp;</td>
      <td width="214"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1625" value="<?php echo($result->A1625) ;?>" size="2">
        </font></td>
      <td width="6">&nbsp;</td>
      <td width="236"><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1626" value="<?php echo($result->A1626) ;?>" size="2">
        </font></td>
    </tr>
    <tr align="center"> 
      <td><font face="Arial, Helvetica, sans-serif">2</font></td>
    ...
    <tr align="center"> 
      <td>&nbsp;</td>
      <td><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1627" value="<?php echo($result->A1627) ;?>" size="2">
        </font></td>
      <td>&nbsp;</td>
      <td><font face="Arial, Helvetica, sans-serif">Pts 
        <input type="text" name="A1628" value="<?php echo($result->A1628) ;?>" size="2">
        </font></td>
    </tr>
    <tr align="center" bgcolor="#FF0000"> 
