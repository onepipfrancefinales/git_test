...
echo "****************************"."<br/>";
require ("../../../connect1/connection3.php") ;
$reponse = $bdd->query("SELECT phpfed3NE_clubs.nom,  phpfed3NE_equipes.id_champ, phpfed3NE_equipes.penalite
						FROM phpfed3NE_equipes
						INNER JOIN phpfed3NE_clubs 	ON phpfed3NE_clubs.id = phpfed3NE_equipes.id
						WHERE phpfed3NE_equipes.id_champ ='161'
...
echo  $equipe.','.$penalite.', '.$division."<br/>";
			}
