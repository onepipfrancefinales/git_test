...
//								 FROM phpab_pronostics WHERE id_match='$val_matchs_id'");
          
 //          while ($row2=mysqli_fetch_array($resultats2))
 //          {
            //  if ($buts_dom >$buts_ext and $row2[0]=="1"){$query3="UPDATE phpab_pronostics SET points='$points_prono_exact', participation='1' WHERE id_membre='$row2[1]' AND id_match='$val_matchs_id'";}
             // elseif ($buts_dom ==$buts_ext and $row2[0]=="N"){$query3="UPDATE phpab_pronostics SET points='$points_prono_exact', participation='1' WHERE id_membre='$row2[1]' AND id_match='$val_matchs_id'";}
            //  elseif ($buts_dom <$buts_ext and $row2[0]=="2"){$query3="UPDATE phpab_pronostics SET points='$points_prono_exact', participation='1' WHERE id_membre='$row2[1]' AND id_match='$val_matchs_id'";}
             // else 
			 // {
...
if ($action2=="1")
    ...
    if ( !(($val_butd=='') or ($val_butv=='')))
       {
		...
		$requete="UPDATE phpab_matchs SET phpab_matchs.buts_dom='$val_butd', phpab_matchs.buts_ext='$val_butv', phpab_matchs.date_reelle='$date_us'
                     WHERE phpab_matchs.id='$val_matchs_id'";
					 
			
		//Insertion des données dans la table pronostics	
		$requetePronos="UPDATE phpab_pronostics SET buts_dom='$val_butd', buts_ext='$val_butv'
		...
		$resultats2=$idconnect->query("SELECT pronostic, id_membre 
           ...
           while ($row2=mysqli_fetch_array($resultats2))
           {
              if ($val_butd>$val_butv and $row2[0]=="1"){$query3="UPDATE phpab_pronostics SET points='$points_prono_exact', participation='1' WHERE id_membre='$row2[1]' AND id_match='$val_matchs_id'";}
              elseif ($val_butd==$val_butv and $row2[0]=="N"){$query3="UPDATE phpab_pronostics SET points='$points_prono_exact', participation='1' WHERE id_membre='$row2[1]' AND id_match='$val_matchs_id'";}
              elseif ($val_butd<$val_butv and $row2[0]=="2"){$query3="UPDATE phpab_pronostics SET points='$points_prono_exact', participation='1' WHERE id_membre='$row2[1]' AND id_match='$val_matchs_id'";}
              else 
			  {
			 mysqli_query ($idconnect, ("UPDATE phpab_pronostics 
						SET points='$pts_prono_participation', participation='1' 
 ...
 mysqli_query ($idconnect, ("UPDATE phpab_matchs 
					SET phpab_matchs.buts_dom=NULL, phpab_matchs.buts_ext=NULL, phpab_matchs.date_reelle='$date_us'
                    WHERE phpab_matchs.id='$val_matchs_id' ")) ;	
