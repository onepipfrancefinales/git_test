...
$color=0;
$result= $idconnect->query("SELECT phpca_divisions.nom, phpca_saisons.annee, (phpca_saisons.annee)+1 
...
echo "<table class=\"tablephpca2\" align=\"center\" cellspacing=\"0\"  width=\"100%\">";


$result= $idconnect->query("SELECT phpca_journees.numero, cldom.nom, clext.nom, phpca_matchs.buts_dom, phpca_matchs.buts_ext, phpca_matchs.date_reelle, phpca_matchs.id
...
echo "<tr class=\"trphpca3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
