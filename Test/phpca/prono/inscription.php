...
*/
/*
$tabTables = array('phpau', 'phpca', 'phpca', 'phppl', 'phpidf', 'phpfed3NE', 'phppro');								   
...
//$tabTables =        array('phpau', 'phpca', 'phpca', 'phpca', 'phpidf', 'phpfed3NE', 'phppro');
$tabTables = array('phpau', 'phpca', 'phpca', 'phpidf', 'phppl', 'phpfed3NE', 'phppro');		
foreach ($tabTables as $table) {
  //phpca_pronostics
  $tableMembres = $table . "_membres";
...
<font face=\"Verdana\" size=\"3\" color=\"#000000\"><a href=\"mailto:mailto:francefinalesrugby@free.fr\">francefinalesrugby@free.fr</a></font>
    ...
    //echo "<tr><td colspan=\"2\" align=\"center\"> <font color=\"#ffffff\">" . PRONO_INSCRIPTION_SUCCES . "</font><br /><a class=\"colorWhite\" href=\"index.php?page=pronos&champLigue=$champLigue&user=$pseudo&mot_de_passe=$mdpcrypt\">" . PRONO_INSCRIPTION_CONNEXION . "</font></a></td></tr>";
      ...
      echo "<table align=\"center\">";
      echo "<tr><td colspan=\"2\" align=\"center\"> <font color=\"#ffffff\">" . PRONO_INSCRIPTION_ECHOUE . "</font><br /><a href=\"/Test/phpca/prono/index.php?page=inscription\"><font color=\"#FFFFFF\">Connexion !</font></a></td></tr>";
      echo "</table>";
    }
  } else {
    echo "<table align=\"center\">";
    echo "<tr><td colspan=\"2\" align=\"center\"> <font color=\"#ffffff\">$message<br /><a href=\"/Test/phpca/prono/index.php?page=inscription&champ=$champ&champLigue=$champLigue\"></font></font>" . "Réessayer" . "</a></td></tr>";
    echo "</table>";
  }
}
