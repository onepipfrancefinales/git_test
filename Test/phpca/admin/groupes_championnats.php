...
echo "newId : ".$newId;echo "<br>";
  mysqli_query ($idconnect,("INSERT INTO phpca_gr_championnats (id, nom) VALUES ('$newId','$nom_group')"));
}

// Suppression d'un groupe de championnat
if ($confirm=="ok" and $gr_champ and $action=="supp")
{
  mysqli_query($idconnect,("DELETE FROM phpca_gr_championnats WHERE id ='$gr_champ' "));
}
?>
