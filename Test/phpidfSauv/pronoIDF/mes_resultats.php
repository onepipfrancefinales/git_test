...
$result=$idconnect->query("
		...
		FROM phpidf_clmnt_pronos, phpidf_membres, phpidf_gr_championnats
		WHERE type='general' 
		AND phpidf_membres.id=phpidf_clmnt_pronos.id_membre 
		AND phpidf_gr_championnats.id='$gr_champ' 
		AND phpidf_clmnt_pronos.id_champ='$gr_champ' 
		AND phpidf_membres.id_prono='$user_id'
		GROUP BY participation
		ORDER by points 
		DESC, participation 
		DESC, phpidf_membres.pseudo");
...
FROM phpidf_clmnt_pronos, phpidf_membres, phpidf_gr_championnats
WHERE type='mensuel_en_cours' AND phpidf_membres.id=phpidf_clmnt_pronos.id_membre and phpidf_gr_championnats.id='$gr_champ' and phpidf_clmnt_pronos.id_champ='$gr_champ' and phpidf_membres.id_prono='$user_id'
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpidf_clmnt_pronos, phpidf_membres, phpidf_gr_championnats
WHERE type='mensuel_30_jours' AND phpidf_membres.id=phpidf_clmnt_pronos.id_membre and phpidf_gr_championnats.id='$gr_champ' and phpidf_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpidf_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpidf_clmnt_pronos, phpidf_membres, phpidf_gr_championnats
WHERE type='hebdo' AND phpidf_membres.id=phpidf_clmnt_pronos.id_membre and phpidf_gr_championnats.id='$gr_champ' and phpidf_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpidf_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
