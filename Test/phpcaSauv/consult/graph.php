...
$query="SELECT phpca_clubs.nom, phpca_equipes.id_club, phpca_equipes.id_champ FROM phpca_equipes, phpca_clubs where phpca_clubs.id=phpca_equipes.id_club AND phpca_equipes.id='$equipe'";
...
$query="SELECT phpca_equipes.id FROM phpca_equipes, phpca_clubs WHERE id_champ='$champ' AND phpca_equipes.id_club=phpca_clubs.id AND phpca_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpca_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpca_saisons.annee, phpca_divisions.nom FROM phpca_saisons, phpca_divisions, phpca_championnats where phpca_championnats.id=$champ AND phpca_divisions.id=phpca_championnats.id_division and phpca_championnats.id_saison=phpca_saisons.id";
$result=mysql_query($query);
