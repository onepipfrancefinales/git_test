...
function nb_journees($id_champ, $idconnect)
         ...
         $reponse=$idconnect->query("SELECT id FROM phpca_equipes WHERE id_champ='$id_champ'");
...
function aff_journee($champ, $numero, $legende, $proba, $fiches_clubs, $id_equipe_fetiche)
    ...
    // cellule d'affichage des derniers résultats
      // cellule d'affichage des derniers résultats
  $color=0;
        $reponse=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phpca_matchs.buts_dom, phpca_matchs.buts_ext,
...
//suppression des liens sur les scores
  ...
  $resultats=$idconnect->query("SELECT phpca_clubs.nom, CLEXT.nom, phpca_matchs.buts_dom, phpca_matchs.buts_ext,
...
{
echo "<table class=\"tablephpca2\" align=\"center\" cellspacing=\"0\" width=\"95%\"><tr class=\"trphpca3\"><th colspan=\"11\">".$legende."</th></tr>\n";
echo "<tr class=\"trphpca3\">
