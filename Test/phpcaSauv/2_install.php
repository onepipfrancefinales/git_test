<link rel="stylesheet" type="text/css" href="../phpca/league.css">
<body class=phpl>
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpca_buteurs,
  championnats TO phpca_championnats,
  classe TO phpca_classe,
  clmnt TO phpca_clmnt,
  clmnt_graph TO phpca_clmnt_graph,
  clmnt_pronos TO phpca_clmnt_pronos,
  clubs TO phpca_clubs,
  divisions TO phpca_divisions,
  donnee TO phpca_donnee,
  equipes TO phpca_equipes,
  joueurs TO phpca_joueurs,
  journees TO phpca_journees,
  logo TO phpca_logo,
  matchs TO phpca_matchs,
  membres TO phpca_membres,
  parametres TO phpca_parametres,
  pronostics TO phpca_pronostics,
  rens TO phpca_rens,
  saisons TO phpca_saisons,
  tapis_vert TO phpca_tapis_vert;
  ALTER TABLE `phpca_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpca_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpca_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpca_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpca_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpca_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpca_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpca_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpca_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpca_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpca_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpca_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpca_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpca_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpca_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpca_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpca_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpca_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpca_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpca_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpca_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpca_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpca_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpca_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpca_buteurs` DROP `id_joueur`;
ALTER TABLE `phpca_joueurs` DROP `id_club`;
DROP TABLE `phpca_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpca_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpca_clubs` DROP INDEX `id`;
ALTER TABLE `phpca_clubs` DROP INDEX `nom`;
ALTER TABLE `phpca_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpca_championnats` DROP INDEX `id`;
ALTER TABLE `phpca_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpca_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpca_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpca_classe` DROP INDEX `id`;
ALTER TABLE `phpca_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpca_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpca_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpca_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpca_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpca_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpca_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpca_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpca_divisions` DROP INDEX `id`;
ALTER TABLE `phpca_equipes` DROP INDEX `id`;
ALTER TABLE `phpca_journees` DROP INDEX `id`;
ALTER TABLE `phpca_journees` DROP INDEX `numero`;
ALTER TABLE `phpca_logo` DROP PRIMARY KEY;
ALTER TABLE `phpca_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpca_logo` DROP INDEX `id_club`;
ALTER TABLE `phpca_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpca_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpca_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpca_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpca_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpca_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpca_rens` DROP INDEX `id`;
ALTER TABLE `phpca_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpca_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpca_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpca_tapis_vert`;
ALTER TABLE `phpca_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpca_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpca_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpca_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpca_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpca_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpca_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpca_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpca_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpca_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpca_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpca_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpca_joueurs.id, phpca_equipes.id
          FROM phpca_joueurs, phpca_equipes, phpca_buteurs, phpca_matchs, phpca_clubs
          WHERE phpca_equipes.id_club=phpca_clubs.id
          AND (
           phpca_matchs.id_equipe_dom = phpca_equipes.id
           OR phpca_matchs.id_equipe_ext = phpca_equipes.id
              )
          AND phpca_matchs.id=phpca_buteurs.id_match
          AND phpca_joueurs.id_club=phpca_equipes.id_club
          AND phpca_buteurs.id_joueur=phpca_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpca_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpca_effectif.id, phpca_buteurs.id_match, phpca_joueurs.id
          FROM phpca_joueurs, phpca_equipes, phpca_buteurs, phpca_matchs, phpca_clubs, phpca_effectif
          WHERE phpca_equipes.id_club=phpca_clubs.id
          AND (
           phpca_matchs.id_equipe_dom = phpca_equipes.id
           OR phpca_matchs.id_equipe_ext = phpca_equipes.id
          ...
          AND phpca_joueurs.id_club=phpca_equipes.id_club
          AND phpca_buteurs.id_joueur=phpca_joueurs.id
          AND phpca_effectif.id_joueur=phpca_joueurs.id
          AND phpca_effectif.id_equipe=phpca_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpca_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpca_joueurs.nom, phpca_joueurs.prenom, phpca_buteurs.id, phpca_journees.numero, phpca_matchs.date_reelle, phpca_joueurs.id
FROM phpca_joueurs, phpca_buteurs, phpca_matchs, phpca_equipes, phpca_journees
WHERE phpca_matchs.id = phpca_buteurs.id_match
AND phpca_buteurs.id_joueur = phpca_joueurs.id
AND phpca_buteurs.id_effectif =0
AND (
phpca_matchs.id_equipe_dom = phpca_equipes.id
OR phpca_matchs.id_equipe_ext = phpca_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpca//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpca_clubs.nom, phpca_equipes.id, phpca_matchs.id
             FROM phpca_joueurs, phpca_equipes, phpca_buteurs, phpca_matchs, phpca_clubs, phpca_journees
             WHERE phpca_equipes.id_club = phpca_clubs.id
             AND (
             phpca_matchs.id_equipe_dom = phpca_equipes.id
             OR phpca_matchs.id_equipe_ext = phpca_equipes.id
...
$sql_maj_1="ALTER TABLE `phpca_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpca_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpca_clubs` DROP INDEX `id`;
ALTER TABLE `phpca_clubs` DROP INDEX `nom`;
ALTER TABLE `phpca_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpca_championnats` DROP INDEX `id`;
ALTER TABLE `phpca_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpca_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpca_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpca_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpca_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpca_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpca_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpca_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpca_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpcaeague@univert.org<phpleague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phpcaeague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpca//%22$url_site/%22>$url_site</a></font></p>
