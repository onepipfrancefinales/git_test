<link rel="stylesheet" type="text/css" href="../phpau/league.css">
<body class=phpl>
  ...
  if (!$test=="erreur")
    {
     ...
     $contenu .= "\$lang=\"$lang\";\n";
     $contenu .= "\$phpauEAGUE_RACINE=\"$repertoire_script\";\n";
     $contenu .= "?>\n";
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpau_buteurs,
  championnats TO phpau_championnats,
  classe TO phpau_classe,
  clmnt TO phpau_clmnt,
  clmnt_graph TO phpau_clmnt_graph,
  clmnt_pronos TO phpau_clmnt_pronos,
  clubs TO phpau_clubs,
  divisions TO phpau_divisions,
  donnee TO phpau_donnee,
  equipes TO phpau_equipes,
  joueurs TO phpau_joueurs,
  journees TO phpau_journees,
  logo TO phpau_logo,
  matchs TO phpau_matchs,
  membres TO phpau_membres,
  parametres TO phpau_parametres,
  pronostics TO phpau_pronostics,
  rens TO phpau_rens,
  saisons TO phpau_saisons,
  tapis_vert TO phpau_tapis_vert;
  ALTER TABLE `phpau_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpau_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpau_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpau_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpau_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpau_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpau_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpau_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpau_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpau_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpau_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpau_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpau_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpau_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpau_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpau_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpau_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpau_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpau_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpau_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpau_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpau_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpau_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpau_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpau_buteurs` DROP `id_joueur`;
ALTER TABLE `phpau_joueurs` DROP `id_club`;
DROP TABLE `phpau_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpau_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpau_clubs` DROP INDEX `id`;
ALTER TABLE `phpau_clubs` DROP INDEX `nom`;
ALTER TABLE `phpau_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpau_championnats` DROP INDEX `id`;
ALTER TABLE `phpau_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpau_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpau_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpau_classe` DROP INDEX `id`;
ALTER TABLE `phpau_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpau_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpau_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpau_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpau_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpau_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpau_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpau_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpau_divisions` DROP INDEX `id`;
ALTER TABLE `phpau_equipes` DROP INDEX `id`;
ALTER TABLE `phpau_journees` DROP INDEX `id`;
ALTER TABLE `phpau_journees` DROP INDEX `numero`;
ALTER TABLE `phpau_logo` DROP PRIMARY KEY;
ALTER TABLE `phpau_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpau_logo` DROP INDEX `id_club`;
ALTER TABLE `phpau_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpau_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpau_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpau_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpau_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpau_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpau_rens` DROP INDEX `id`;
ALTER TABLE `phpau_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpau_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpau_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpau_tapis_vert`;
ALTER TABLE `phpau_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpau_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpau_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpau_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpau_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpau_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpau_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpau_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpau_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpau_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpau_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpau_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpau_joueurs.id, phpau_equipes.id
          FROM phpau_joueurs, phpau_equipes, phpau_buteurs, phpau_matchs, phpau_clubs
          WHERE phpau_equipes.id_club=phpau_clubs.id
          AND (
           phpau_matchs.id_equipe_dom = phpau_equipes.id
           OR phpau_matchs.id_equipe_ext = phpau_equipes.id
              )
          AND phpau_matchs.id=phpau_buteurs.id_match
          AND phpau_joueurs.id_club=phpau_equipes.id_club
          AND phpau_buteurs.id_joueur=phpau_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpau_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpau_effectif.id, phpau_buteurs.id_match, phpau_joueurs.id
          FROM phpau_joueurs, phpau_equipes, phpau_buteurs, phpau_matchs, phpau_clubs, phpau_effectif
          WHERE phpau_equipes.id_club=phpau_clubs.id
          AND (
           phpau_matchs.id_equipe_dom = phpau_equipes.id
           OR phpau_matchs.id_equipe_ext = phpau_equipes.id
          ...
          AND phpau_joueurs.id_club=phpau_equipes.id_club
          AND phpau_buteurs.id_joueur=phpau_joueurs.id
          AND phpau_effectif.id_joueur=phpau_joueurs.id
          AND phpau_effectif.id_equipe=phpau_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpau_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpau_joueurs.nom, phpau_joueurs.prenom, phpau_buteurs.id, phpau_journees.numero, phpau_matchs.date_reelle, phpau_joueurs.id
FROM phpau_joueurs, phpau_buteurs, phpau_matchs, phpau_equipes, phpau_journees
WHERE phpau_matchs.id = phpau_buteurs.id_match
AND phpau_buteurs.id_joueur = phpau_joueurs.id
AND phpau_buteurs.id_effectif =0
AND (
phpau_matchs.id_equipe_dom = phpau_equipes.id
OR phpau_matchs.id_equipe_ext = phpau_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpau//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpau_clubs.nom, phpau_equipes.id, phpau_matchs.id
             FROM phpau_joueurs, phpau_equipes, phpau_buteurs, phpau_matchs, phpau_clubs, phpau_journees
             WHERE phpau_equipes.id_club = phpau_clubs.id
             AND (
             phpau_matchs.id_equipe_dom = phpau_equipes.id
             OR phpau_matchs.id_equipe_ext = phpau_equipes.id
...
$sql_maj_1="ALTER TABLE `phpau_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpau_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpau_clubs` DROP INDEX `id`;
ALTER TABLE `phpau_clubs` DROP INDEX `nom`;
ALTER TABLE `phpau_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpau_championnats` DROP INDEX `id`;
ALTER TABLE `phpau_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpau_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpau_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpau_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpau_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpau_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpau_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpau_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpau_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpaueague@univert.org<phpleague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phpaueague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpau//%22$url_site/%22>$url_site</a></font></p>
