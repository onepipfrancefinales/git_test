...
reset ($date);
	...
	mysqli_query($idconnect,("UPDATE phpal_journees 
...
<table class=phpal width="80%">
 ...
 // $resultats=mysql_query($requete);
  ...
  {
    mysqli_query($idconnect, ("DELETE FROM phpal_journees WHERE id_champ='$champ'"));
    $x=1;
    while ($x <= ($nb_equipes*2)-2)
		{
		mysqli_query($idconnect, ("INSERT INTO phpal_journees (numero, id_champ) VALUES ('$x','$champ')"));
		//$result= mysql_query($query);
		$x++;
		}
  }
