...
if ($action2=="1")
  ...
  $resultats2=$idconnect->query("SELECT pronostic, id_membre 
           ...
           while ($row2=mysqli_fetch_array($resultats2))
           {
			  ...
			  {
			   mysqli_query ($idconnect, ("UPDATE phpal_pronostics 
       ...
       {
          mysqli_query ($idconnect, ("UPDATE phpal_matchs 
					SET phpal_matchs.buts_dom=NULL, phpal_matchs.buts_ext=NULL, phpal_matchs.date_reelle='$date_us'
                    WHERE phpal_matchs.id='$val_matchs_id' ")) ;	
