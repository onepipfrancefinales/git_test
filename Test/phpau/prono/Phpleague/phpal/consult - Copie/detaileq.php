...
$color=0;
$result= $idconnect->query("SELECT phpal_divisions.nom, phpal_saisons.annee, (phpal_saisons.annee)+1 
...
$result= $idconnect->query("SELECT phpal_journees.numero, cldom.nom, clext.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, phpal_matchs.date_reelle, phpal_matchs.id
