...
$query="SELECT phpal_clubs.nom, phpal_equipes.id_club, phpal_equipes.id_champ FROM phpal_equipes, phpal_clubs where phpal_clubs.id=phpal_equipes.id_club AND phpal_equipes.id='$equipe'";
...
$query="SELECT phpal_equipes.id FROM phpal_equipes, phpal_clubs WHERE id_champ='$champ' AND phpal_equipes.id_club=phpal_clubs.id AND phpal_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpal_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpal_saisons.annee, phpal_divisions.nom FROM phpal_saisons, phpal_divisions, phpal_championnats where phpal_championnats.id=$champ AND phpal_divisions.id=phpal_championnats.id_division and phpal_championnats.id_saison=phpal_saisons.id";
$result=mysql_query($query);
