...
function nb_journees($id_champ, $idconnect)
         ...
         $reponse=$idconnect->query("SELECT id FROM phpal_equipes WHERE id_champ='$id_champ'");
...
function aff_journee($champ, $numero, $legende, $proba, $fiches_clubs, $id_equipe_fetiche)
    ...
    // cellule d'affichage des derniers résultats
      // cellule d'affichage des derniers résultats
  $color=0;
        $reponse=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phpal_matchs.buts_dom, phpal_matchs.buts_ext,
...
{
echo "<table class=\"tablephpal2\" align=\"center\" cellspacing=\"0\" width=\"95%\"><tr class=\"trphpal3\"><th colspan=\"11\">".$legende."</th></tr>\n";
echo "<tr class=\"trphpal3\">
