...
$resultat=$idconnect->query("
		  SELECT phpal_clubs.nom FROM phpal_clubs, phpal_equipes 
		  WHERE phpal_equipes.id='$id_equipe' 
...
$resultat=$idconnect->query("
		SELECT phpal_journees.numero, cldom.nom, clext.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, phpal_matchs.date_reelle, phpal_matchs.id
...
echo "<tr class=\"trphpal3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5% align=\"center\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\ align=\"center\"><b>Oppositions</b></td></tr>";
        while  ($row=mysqli_fetch_array($resultat))
        {
