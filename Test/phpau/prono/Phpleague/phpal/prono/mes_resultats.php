...
FROM phpal_clmnt_pronos, phpal_membres, phpal_gr_championnats
WHERE type='general' AND phpal_membres.id=phpal_clmnt_pronos.id_membre AND phpal_gr_championnats.id='$gr_champ' AND phpal_clmnt_pronos.id_champ='$gr_champ' AND phpal_membres.id_prono='$user_id'
...
FROM phpal_clmnt_pronos, phpal_membres, phpal_gr_championnats
WHERE type='mensuel_en_cours' AND phpal_membres.id=phpal_clmnt_pronos.id_membre and phpal_gr_championnats.id='$gr_champ' and phpal_clmnt_pronos.id_champ='$gr_champ' and phpal_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpal_membres.pseudo";
$result=mysql_query($query) or die ("probleme " .mysql_error());
 $non_classe=0;
while ($row=mysql_fetch_array($result))
...
$query="SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpal_clmnt_pronos, phpal_membres, phpal_gr_championnats
WHERE type='mensuel_30_jours' AND phpal_membres.id=phpal_clmnt_pronos.id_membre and phpal_gr_championnats.id='$gr_champ' and phpal_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpal_membres.pseudo";
$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$query="SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpal_clmnt_pronos, phpal_membres, phpal_gr_championnats
WHERE type='hebdo' AND phpal_membres.id=phpal_clmnt_pronos.id_membre and phpal_gr_championnats.id='$gr_champ' and phpal_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpal_membres.pseudo";
$result=mysql_query($query) or die ("probleme " .mysql_error());
