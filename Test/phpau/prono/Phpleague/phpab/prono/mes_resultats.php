...
$result = $idconnect->query("SELECT points, participation, id_prono, pts_prono_participation, pts_prono_exact, AVG(points)
FROM phpab_clmnt_pronos, phpab_membres, phpab_gr_championnats
WHERE type='general' AND phpab_membres.id=phpab_clmnt_pronos.id_membre AND phpab_gr_championnats.id='$gr_champ' AND phpab_clmnt_pronos.id_champ='$gr_champ' AND phpab_membres.id_prono='$user_id'
...
$result = $idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpab_clmnt_pronos, phpab_membres, phpab_gr_championnats
WHERE type='mensuel_30_jours' AND phpab_membres.id=phpab_clmnt_pronos.id_membre and phpab_gr_championnats.id='$gr_champ' and phpab_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpab_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result= $idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpab_clmnt_pronos, phpab_membres, phpab_gr_championnats
WHERE type='hebdo' AND phpab_membres.id=phpab_clmnt_pronos.id_membre and phpab_gr_championnats.id='$gr_champ' and phpab_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpab_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
