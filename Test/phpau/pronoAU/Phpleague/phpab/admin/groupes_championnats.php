...
{   
  mysqli_query ($idconnect,("INSERT INTO phpab_gr_championnats (nom) VALUES ('$nom_group')")) or die ("probleme " .mysql_error($idconnect));
}


if ($confirm=="ok" and $gr_champ and $action=="supp")
{
      mysqli_query($idconnect,("DELETE FROM phpab_gr_championnats WHERE id ='$gr_champ' "))or die ("probleme " .mysql_error($idconnect));
}
?>
...
<table class=phpab width="90%">
            ...
            <tr>
              <td class=phpab5 align="right" colspan="4"><a href="?page=groupes_championnats&action=creer">> <?php echo ADMIN_GR_CHAMP_CREER;?></a></td>
            </tr>
