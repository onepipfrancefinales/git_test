<link rel="stylesheet" type="text/css" href="../phpab/league.css">
<body class=phpl>
...
{
echo "<form method=\"post\" action=../phpab//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
...
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpab//%22$url_site/%22>$url_site</a></font></p>
