...
mysql_query("UPDATE phpal_membres SET mot_de_passe='$new_mot_de_passe_crypt' WHERE mail='$mail'");
$query = mysql_query("SELECT pseudo, mail FROM phpal_membres WHERE mail='$mail'");
...
<p><font face=\"Verdana\" size=\"2\">Ce script a été créé par <a href=\"http://phpaleague.univert.org\">phpaleague</a> : Gestionnaire de championnats sportifs et de pronostics !</font></p>
</body>
</html>";
