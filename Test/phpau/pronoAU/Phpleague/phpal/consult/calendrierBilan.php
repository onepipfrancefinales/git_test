...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpal_divisions.nom, phpal_saisons.annee, (phpal_saisons.annee)+1
...
$resultats2=$idconnect->query("SELECT phpal_clubs.nom, CLEXT.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, phpal_matchs.id, phpal_matchs.date_reelle
...
$result=$idconnect->query("SELECT phpal_journees.numero, phpal_journees.date_prevue, cldom.nom, clext.nom, phpal_matchs.buts_dom, phpal_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpal2" cellspacing="0" width="290" align="center">
...
<table class="tablephpal2" cellspacing="0" width="290" align="center">
<tr class="trphpal3"><td colspan="3" align="center"><b>
<?php echo ADMIN_COHERENCE_MSG2." ".$row[0].CONSULT_MATCHS_MSG2.$date."</b></td></tr>";
                $x=2;
            }
