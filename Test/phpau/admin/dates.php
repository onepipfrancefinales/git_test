...
reset ($date);
	...
	mysqli_query($idconnect,("UPDATE phpau_journees 
...
<table class=phpau width="80%">
            <tr>
              <td class=phpau2 align="center" colspan="3"><?php echo ADMIN_DATES_TITRE." "; affich_champ ($champ, $idconnect); ?></td><td class=phpau2 align="right"><a href="#" onclick="window.open('Assistant_fr/dates.htm','Assistant','toolbar=0,location=0,directories=0,status=0,scrollbars=1,resizable=0,copyhistory=0,menuBar=0,width=512,height=512');return false;"><img border="0" alt="Assistant" src="aide.gif"></a></td>
 ...
 // $resultats=mysql_query($requete);
  ...
  if ($nb_equipes1!==(($nb_equipes)*2-2))
  {
    ...
    while ($x <= ($nb_equipes*2)-2)
		{
		mysqli_query($idconnect, ("INSERT INTO phpau_journees (numero, id_champ) VALUES ('$x','$champ')"));
		//$result= mysql_query($query);
		$x++;
		}
  }
