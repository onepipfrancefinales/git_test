...
// Nombres de renseignement dans cette classe à partir de l'id_classe  (utilisé dans phpau_classe.php)
...
// Nombres de classes enregistrées (ulilisé dans phpau_classe.php)
