...
<head>
  ...
  <title>Ligue Occitanie - Administration</title>
...
<body topmargin="0" leftmargin="0" class="phpab">
 ...
 if (isset($_GET['champ'])) $champ = $_GET['champ']; else $champ ="AAAA";
?>
  ...
  <div align="center">
    <center>
      ...
      case (($codeLigue >= 100000 and $codeLigue < 110000) or ($ligue >= 100000 and $ligue < 110000)):
      ...
      case (($codeLigue >= 140000 and $codeLigue < 150000) or ($ligue >= 140000 and $ligue < 150000)):
			echo  "Corse - Administration";
      $ligue = 140000;
			break;

      case (($codeLigue >= 150000 and $codeLigue < 160000) or ($ligue >= 150000 and $ligue < 160000)):
      ...
      $ligue = 160000;
			...
			case (($codeLigue >= 170000 and $codeLigue < 180000) or ($ligue >= 170000 and $ligue < 180000)):
			echo "Ile de France - Administration";
      $ligue = 170000;
			break;

      case (($codeLigue >= 180000 and $codeLigue < 190000) or ($ligue >= 180000 and $ligue < 190000)):
			echo  "Normandie - Administration";
      $ligue = 180000;
			break;

      case (($codeLigue >= 190000 and $codeLigue < 200000) or ($ligue >= 190000 and $ligue < 200000)):
			echo  "Nouvelle Aquitaine - Administration";
      $ligue = 190000;
			break;

      case (($codeLigue >= 200000 and $codeLigue < 210000) or ($ligue >= 200000 and $ligue < 210000)):
      ...
      case (($codeLigue >= 220000 and $codeLigue < 230000) or ($ligue >= 220000 and $ligue < 230000)):
      ...
      break;
        ...
        <tr>
          <td class="phpab3" width="12%" valign="top" style="border-right-style: dashed;border-right-width : 1px; border-color:#3b487f">
           ...
           <a href="?page=groupes_championnats&ligue=<?php echo $ligue; ?>&champ=<?php echo $champ; ?>"><?php echo "Groupes championnats"; ?></a><br /><br />
