...
//  echo "journee : ".$journee;echo "</br>";
 ...
 $result=$bdd->query("SELECT cldom.nom as cldom, clext.nom as clext, phpab_matchs.buts_dom, phpab_matchs.buts_ext,
  ...
  echo "<br />";
  echo "<table align=\"center\" class=\"tablephpab2\"  width=\"90%\" cellspacing=\"1\" cellpadding=\"1\"><tr><td><table cellspacing=\"0\" align=\"center\" width=\"100%\" cellpadding=\"1\">\n";
  $x=1;
 ...
 while ($row=$result->fetch())
 {
  ...
  { 
   ...
   {   
    ...
    ?>    
	<table class="tablephpab2" cellspacing="0" width="290" align="center">
	  <tr class="trphpab3"><td colspan="3" align="center"><b><font color="#FFFF00">
