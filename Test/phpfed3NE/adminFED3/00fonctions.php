...
function affich_championnats ($champ, $action, $idconnect)
{
 ...
 if (($champ >= 991160 and $champ < 991170) or ($champ >= 991260 and $champ < 991270)) {
	$valLigueMin  = 991160;   $valLigueMax  = 991170;
	$valLigueMin2 = 991260;   $valLigueMax2 = 991270;
   } 
  
else{
	$valLigueMin  = 992160;   $valLigueMax  = 992170;
	$valLigueMin2 = 992260;   $valLigueMax2 = 992270;
  ...
  $result=$idconnect->query("SELECT phpfed3NE_clubs.nom, phpfed3NE_equipes.penalite, phpfed3NE_equipes.id
	...
	*/
    while($row = mysqli_fetch_array($result))
    {
		...
		if($cache=="1")
		{
		 mysqli_query($idconnect, ("INSERT INTO phpfed3NE_clmnt_cache(NOM, POINTS, JOUES, G, N, P, BUTSPOUR, BUTSCONTRE, DIFF, PEN, DOMPOINTS, DOMJOUES, DOMG, DOMN, DOMP, DOMBUTSPOUR, DOMBUTSCONTRE, DOMDIFF, EXTPOINTS, EXTJOUES, EXTG, EXTN, EXTP, EXTBUTSPOUR, EXTBUTSCONTRE, EXTDIFF, ID_EQUIPE, ID_CHAMP) 
		...
		{
		 mysqli_query($idconnect, ("INSERT INTO phpfed3NE_clmnt(NOM, POINTS, JOUES, G, N, P, BUTSPOUR, BUTSCONTRE, DIFF, PEN, DOMPOINTS, DOMJOUES, DOMG, DOMN, DOMP, DOMBUTSPOUR, DOMBUTSCONTRE, DOMDIFF, EXTPOINTS, EXTJOUES, EXTG, EXTN, EXTP, EXTBUTSPOUR, EXTBUTSCONTRE, EXTDIFF, ID_EQUIPE, ID_CHAMP) 
									  VALUES('$NOM','$POINTS','$JOUES','$G','$N','$P','$BUTSPOUR','$BUTSCONTRE','$DIFF','$PEN','$DOMPOINTS','$DOMJOUES','$DOMG','$DOMN','$DOMP','$DOMBUTSPOUR','$DOMBUTSCONTRE','$DOMDIFF','$EXTPOINTS','$EXTJOUES','$EXTG','$EXTN','$EXTP','$EXTBUTSPOUR','$EXTBUTSCONTRE','$EXTDIFF','$ID_EQUIPE','$ID_CHAMP')"));
...
// Nombres de renseignement dans cette classe à partir de l'id_classe  (utilisé dans phpfed3NE_classe.php)
...
// Nombres de classes enregistrées (ulilisé dans phpfed3NE_classe.php)
