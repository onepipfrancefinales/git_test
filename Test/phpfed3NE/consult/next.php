...
// Nom du champ
$query2="SELECT nom FROM phpfed3NE_divisions, phpfed3NE_championnats WHERE id_division=phpfed3NE_divisions.id and phpfed3NE_championnats.id='$champ'";
...
$query1="SELECT cldom.nom as cldom, clext.nom as clext, phpfed3NE_matchs.buts_dom, phpfed3NE_matchs.buts_ext , phpfed3NE_journees.date_prevue, cldom.id as cliddom, clext.id as clidext, phpfed3NE_matchs.date_reelle
      ...
      $row[1] = stripslashes($row[1]);
             ...
             if ($x==1)
                ...
                echo "<TR class=phpfed3NE ><TH class=phpfed3NE colspan=5 text-align=\"center\"><b> ". $numero."".$legende." le ".$jour."/".$mois."/".$annee."".CONSULT_CLMNT_MSG5."".$heure."h".$minute."</b></th></tr>";
                }
                ...
                echo "<TR class=phpfed3NE bgcolor=$bgcolor width=\"100%\"><TD class=phpfed3NE align=\"right\" width=\"40%\"><a href=\"club.php?id_clubs=$row[5]&champ=$champ\">".$DebMarqueur1.$row[0].$FinMarqueur1."</a><TD class=phpfed3NE align=\"center\">".$domproba."<TD class=phpfed3NE align=center>-<TD class=phpfed3NE>".$extproba."<TD class=phpfed3NE align=\"left\" width=\"40%\"><a href=\"club.php?id_clubs=$row[6]&champ=$champ\">".$DebMarqueur2.$row[1].$FinMarqueur2."</a>";
                $x++;
             }
