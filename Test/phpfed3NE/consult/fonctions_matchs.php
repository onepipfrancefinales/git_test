...
function aff_journee($champ, $bdd)
{
  ...
  echo "<br>";
  echo "<table class=\"tablephpfed3NE2 marginAuto width90PC \" ><tr><td>
...
//mise en forme tableau oppositions
echo "<br>";
echo "<table class=\"marginAuto tablephpfed3NE2 width90PC \" ><tr>
        ...
        AND phpfed3NE_equipes.id_club=phpfed3NE_clubs.id");
          ...
          PEN='$PEN'";
              ...
              function clmnt($champ, $smart, $bdd)
              {
                ...
                echo "<table class=\"tablephpfed3NE2 marginAuto width80PC borderSpacing\" ><tr class=\"trphpfed3NE3\"><th colspan=\"4\">" . $legende . "</th></tr>\n";
                echo "<tr class=\"trphpfed3NE3\">
