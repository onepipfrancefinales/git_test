...
$result= $idconnect->query("SELECT phpfed3NE_clubs.id, phpfed3NE_clubs.nom, id_champ, id_club
							FROM phpfed3NE_clubs, phpfed3NE_equipes
							WHERE phpfed3NE_equipes.id_champ='$champ' and phpfed3NE_equipes.id_club=phpfed3NE_clubs.id
							ORDER BY nom");
...
$result= $idconnect->query("SELECT phpfed3NE_classe.nom, phpfed3NE_classe.id 
...
//$result=mysql_query ($query);
        ...
        echo "<tr class=\"trphpfed3NE3\"><td align=\"center\"><b>$row[0]</b></td></tr>";
        $id_classe=$row[1];
        echo "<tr><td><table cellspacing=\"0\"><tr class=\"trphpfed3NE\"><td>";
...
echo "<table class=\"tablephpfed3NE2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpfed3NE3\"><td align=\"center\"><b>Effectif</b></td></tr><tr><td>";

$result= $idconnect->query("SELECT phpfed3NE_equipes.id 
							FROM phpfed3NE_equipes, phpfed3NE_clubs 
							WHERE phpfed3NE_clubs.id='$id_clubs' 
							AND id_champ='$champ' 
...
{ $row[0]=addslashes($row[0]);
 $resultats1 = $idconnect->query("SELECT nom, prenom, phpfed3NE_joueurs.id
									FROM phpfed3NE_joueurs, phpfed3NE_effectif
									WHERE phpfed3NE_joueurs.id=phpfed3NE_effectif.id_joueur
									AND phpfed3NE_effectif.id_equipe='$equipe'
...
echo "<table class=\"tablephpfed3NE2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpfed3NE3\"><td align=\"center\"><b>".CONSULT_CLUB_4."</b></td></tr>";
        echo "<tr><td><center><img src=\"graph.php?equipe=$equipe\" alt=\"\"></center></td></tr>";


echo"</table><br /><br /><br />";

echo "<table class=\"tablephpfed3NE2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpfed3NE3\" align=\"center\"><td><b>".CONSULT_CLUB_3."</b></td></tr>";
...
$result= $idconnect->query("SELECT annee, phpfed3NE_divisions.nom, phpfed3NE_championnats.id, phpfed3NE_equipes.id
							...
							AND phpfed3NE_equipes.id_club='$id_clubs'
