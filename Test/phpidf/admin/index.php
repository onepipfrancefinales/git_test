...
<title>phpidfeague - Administration</title>
<link rel="stylesheet" type="text/css" href="style.css">

</head>

<body topmargin="0" leftmargin="0" class="phpidf">
...
<div align="center">
  ...
  <td colspan="1" background="haut.gif" valign="middle" align="center" style="border-bottom-style: dashed;border-bottom-width : 1px; border-color:#3b487f"><font class="phpidf">Ligue 
             
  <?php 
		 switch ($codeLigue){
					
			case ($codeLigue < 160000):
			echo  "Grand Est - Administration";
			break;
			
			case ($codeLigue < 180000):
			echo  "Ile de France - Administration";
			break;
			
			case ($codeLigue < 190000):
			echo  "Normandie - Administration";
			break;
			
			case ($codeLigue < 230000):
	   ...
	   <td colspan="1" background="haut.gif" valign="middle" align="center" style="border-bottom-style: dashed;border-bottom-width : 1px; border-color:#3b487f"><font class="phpidf"> 
          </font></td>
...
/*pas de verif du mdp et user php7*/
   if (VerifSession ($user_pseudo,$user_mdp, $idconnect)=="1" or VerifSession ($user_pseudo,$user_mdp, $idconnect)=="0")
    ...
    <tr>
      <td class="phpidf" height="10" colspan="1"><img border="0" src="bouton.gif" width="111" height="25">
        </td>
      <td class="phpidf" colspan="3" width="70%" height="10" colspan="2" align="right">
        </td>
    </tr>
  </table>
  </center>
