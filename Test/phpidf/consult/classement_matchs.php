...
if (isset($type))
{
   ...
   $row=mysqli_fetch_array($res);
    ...
    $res2=$idconnect->query("SELECT phpidf_equipes.id FROM phpidf_equipes, phpidf_clubs
...
if ($debut=="1" and $fin==$nb_journees)
{
   ...
   $res3=$idconnect->query("SELECT max(phpidf_journees.numero) FROM phpidf_journees, phpidf_matchs WHERE phpidf_journees.id=phpidf_matchs.id_journee and buts_dom is not NULL and     phpidf_journees.id_champ='$champ'");
