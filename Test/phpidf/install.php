<link rel="stylesheet" type="text/css" href="../phpidf/league.css">
<body class=phpl>
  ...
  if (!$test=="erreur")
    {
     ...
     $contenu .= "\$lang=\"$lang\";\n";
     $contenu .= "\$phpidfEAGUE_RACINE=\"$repertoire_script\";\n";
     $contenu .= "?>\n";
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpidf_buteurs,
  championnats TO phpidf_championnats,
  classe TO phpidf_classe,
  clmnt TO phpidf_clmnt,
  clmnt_graph TO phpidf_clmnt_graph,
  clmnt_pronos TO phpidf_clmnt_pronos,
  clubs TO phpidf_clubs,
  divisions TO phpidf_divisions,
  donnee TO phpidf_donnee,
  equipes TO phpidf_equipes,
  joueurs TO phpidf_joueurs,
  journees TO phpidf_journees,
  logo TO phpidf_logo,
  matchs TO phpidf_matchs,
  membres TO phpidf_membres,
  parametres TO phpidf_parametres,
  pronostics TO phpidf_pronostics,
  rens TO phpidf_rens,
  saisons TO phpidf_saisons,
  tapis_vert TO phpidf_tapis_vert;
  ALTER TABLE `phpidf_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpidf_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpidf_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpidf_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpidf_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpidf_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpidf_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpidf_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpidf_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpidf_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpidf_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpidf_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpidf_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpidf_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpidf_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpidf_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpidf_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpidf_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpidf_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpidf_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpidf_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpidf_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpidf_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpidf_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpidf_buteurs` DROP `id_joueur`;
ALTER TABLE `phpidf_joueurs` DROP `id_club`;
DROP TABLE `phpidf_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpidf_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpidf_clubs` DROP INDEX `id`;
ALTER TABLE `phpidf_clubs` DROP INDEX `nom`;
ALTER TABLE `phpidf_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpidf_championnats` DROP INDEX `id`;
ALTER TABLE `phpidf_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpidf_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpidf_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpidf_classe` DROP INDEX `id`;
ALTER TABLE `phpidf_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpidf_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpidf_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpidf_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpidf_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpidf_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpidf_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpidf_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpidf_divisions` DROP INDEX `id`;
ALTER TABLE `phpidf_equipes` DROP INDEX `id`;
ALTER TABLE `phpidf_journees` DROP INDEX `id`;
ALTER TABLE `phpidf_journees` DROP INDEX `numero`;
ALTER TABLE `phpidf_logo` DROP PRIMARY KEY;
ALTER TABLE `phpidf_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpidf_logo` DROP INDEX `id_club`;
ALTER TABLE `phpidf_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpidf_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpidf_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpidf_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpidf_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpidf_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpidf_rens` DROP INDEX `id`;
ALTER TABLE `phpidf_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpidf_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpidf_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpidf_tapis_vert`;
ALTER TABLE `phpidf_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpidf_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpidf_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpidf_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpidf_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpidf_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpidf_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpidf_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpidf_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpidf_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpidf_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpidf_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpidf_joueurs.id, phpidf_equipes.id
          FROM phpidf_joueurs, phpidf_equipes, phpidf_buteurs, phpidf_matchs, phpidf_clubs
          WHERE phpidf_equipes.id_club=phpidf_clubs.id
          AND (
           phpidf_matchs.id_equipe_dom = phpidf_equipes.id
           OR phpidf_matchs.id_equipe_ext = phpidf_equipes.id
              )
          AND phpidf_matchs.id=phpidf_buteurs.id_match
          AND phpidf_joueurs.id_club=phpidf_equipes.id_club
          AND phpidf_buteurs.id_joueur=phpidf_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpidf_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpidf_effectif.id, phpidf_buteurs.id_match, phpidf_joueurs.id
          FROM phpidf_joueurs, phpidf_equipes, phpidf_buteurs, phpidf_matchs, phpidf_clubs, phpidf_effectif
          WHERE phpidf_equipes.id_club=phpidf_clubs.id
          AND (
           phpidf_matchs.id_equipe_dom = phpidf_equipes.id
           OR phpidf_matchs.id_equipe_ext = phpidf_equipes.id
          ...
          AND phpidf_joueurs.id_club=phpidf_equipes.id_club
          AND phpidf_buteurs.id_joueur=phpidf_joueurs.id
          AND phpidf_effectif.id_joueur=phpidf_joueurs.id
          AND phpidf_effectif.id_equipe=phpidf_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpidf_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpidf_joueurs.nom, phpidf_joueurs.prenom, phpidf_buteurs.id, phpidf_journees.numero, phpidf_matchs.date_reelle, phpidf_joueurs.id
FROM phpidf_joueurs, phpidf_buteurs, phpidf_matchs, phpidf_equipes, phpidf_journees
WHERE phpidf_matchs.id = phpidf_buteurs.id_match
AND phpidf_buteurs.id_joueur = phpidf_joueurs.id
AND phpidf_buteurs.id_effectif =0
AND (
phpidf_matchs.id_equipe_dom = phpidf_equipes.id
OR phpidf_matchs.id_equipe_ext = phpidf_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpidf//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpidf_clubs.nom, phpidf_equipes.id, phpidf_matchs.id
             FROM phpidf_joueurs, phpidf_equipes, phpidf_buteurs, phpidf_matchs, phpidf_clubs, phpidf_journees
             WHERE phpidf_equipes.id_club = phpidf_clubs.id
             AND (
             phpidf_matchs.id_equipe_dom = phpidf_equipes.id
             OR phpidf_matchs.id_equipe_ext = phpidf_equipes.id
...
$sql_maj_1="ALTER TABLE `phpidf_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpidf_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpidf_clubs` DROP INDEX `id`;
ALTER TABLE `phpidf_clubs` DROP INDEX `nom`;
ALTER TABLE `phpidf_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpidf_championnats` DROP INDEX `id`;
ALTER TABLE `phpidf_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpidf_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpidf_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpidf_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpidf_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpidf_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpidf_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpidf_parametres` (
  `id_champ` int(4) unsigned NOT NULL default '0',
...
CREATE TABLE `phpidf_pronostics` (
  `id_membre` smallint(5) unsigned NOT NULL default '0',
  `id_champ` int(3) unsigned NOT NULL default '0',
...
CREATE TABLE `phpidf_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpidf_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpidfeague@univert.org<phpleague@univert.org>";
...
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpidf//%22$url_site/%22>$url_site</a></font></p>
