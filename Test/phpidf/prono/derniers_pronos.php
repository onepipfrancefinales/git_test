...
$result = $idconnect->query("SELECT phpidf_clubs.nom, CLEXT.nom, phpidf_matchs.buts_dom, phpidf_matchs.buts_ext, phpidf_matchs.id, phpidf_matchs.date_reelle, phpidf_journees.numero, pts_prono_exact, pts_prono_participation,phpidf_matchs.id_equipe_dom,phpidf_matchs.id_equipe_ext
