...
echo "pass : ".$pass;echo "<br>";
	...
	if(!isset($_REQUEST['user']) or !isset($_REQUEST['pass']))
	{
		...
		echo "test5";echo "<br>";
   	 header("Location: /Test/phppro/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=0");
	}
	...
	else
	{
      echo "test7";echo "<br>";
		...
		{
        	header("Location: /Test/phppro/prono/index.php?champLigue=$champLigue&mode=$mode&page=erreur_login&t=1");
		}
	...
	echo "login.php : mot_de_passe -".$_SESSION['mot_de_passe'];echo "<br>";
		...
		//header("Location: /Test/phppro/prono/index.php?champLigue=$champLigue");
		header("Location: /Test/phppro/prono/index.php?page=pronos&champLigue=$champLigue");
