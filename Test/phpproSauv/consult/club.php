...
$result= $idconnect->query("SELECT phppro_clubs.id, phppro_clubs.nom, id_champ, id_club
							FROM phppro_clubs, phppro_equipes
							WHERE phppro_equipes.id_champ='$champ' and phppro_equipes.id_club=phppro_clubs.id
							ORDER BY nom");
...
$result= $idconnect->query("SELECT phppro_classe.nom, phppro_classe.id 
							FROM phppro_classe 
							order by rang");
//$result=mysql_query ($query);
        ...
        echo "<tr class=\"trphppro3\"><td align=\"center\"><b>$row[0]</b></td></tr>";
        $id_classe=$row[1];
        echo "<tr><td><table cellspacing=\"0\"><tr class=\"trphppro\"><td>";
...
echo "<table class=\"tablephppro2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphppro3\"><td align=\"center\"><b>Effectif</b></td></tr><tr><td>";

$result= $idconnect->query("SELECT phppro_equipes.id 
							FROM phppro_equipes, phppro_clubs 
							WHERE phppro_clubs.id='$id_clubs' 
							AND id_champ='$champ' 
...
{ $row[0]=addslashes($row[0]);
 $resultats1 = $idconnect->query("SELECT nom, prenom, phppro_joueurs.id
									FROM phppro_joueurs, phppro_effectif
									WHERE phppro_joueurs.id=phppro_effectif.id_joueur
									AND phppro_effectif.id_equipe='$equipe'
...
echo "<table class=\"tablephppro2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphppro3\"><td align=\"center\"><b>".CONSULT_CLUB_4."</b></td></tr>";
        echo "<tr><td><center><img src=\"graph.php?equipe=$equipe\" alt=\"\"></center></td></tr>";


echo"</table><br /><br /><br />";

echo "<table class=\"tablephppro2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphppro3\" align=\"center\"><td><b>".CONSULT_CLUB_3."</b></td></tr>";
...
$result= $idconnect->query("SELECT annee, phppro_divisions.nom, phppro_championnats.id, phppro_equipes.id
							...
							AND phppro_equipes.id_club='$id_clubs'
