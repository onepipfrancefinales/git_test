<link rel="stylesheet" type="text/css" href="../phppro/league.css">
<body class=phppro>
 <table class=tablephppro2 border="0" cellspacing="0" width="100%">
    <tr class=trphppro3>
      <td width="100%">
...
$requete="SELECT id FROM phppro_effectif WHERE id_joueur='$id_joueur' AND id_equipe='$id_equipes'";
$resultats=mysql_query($requete);
//if (!$result) die mysql_error();
$nb=mysql_num_rows( $resultats );

     if ($nb=="0") { mysql_query ("INSERT INTO phppro_effectif (id_joueur, id_equipe) VALUES ('$id_joueur', '$id_equipes')");}

          $requete="SELECT DISTINCT phppro_effectif.id
FROM phppro_joueurs, phppro_buteurs, phppro_matchs, phppro_equipes, phppro_effectif
WHERE phppro_matchs.id = phppro_buteurs.id_match
AND (
phppro_matchs.id_equipe_dom = phppro_equipes.id
OR phppro_matchs.id_equipe_ext = phppro_equipes.id
)
AND phppro_matchs.id = '$id_match'
AND phppro_equipes.id ='$id_equipes'
AND phppro_joueurs.id ='$id_joueur'
AND phppro_joueurs.id = phppro_effectif.id_joueur
AND phppro_effectif.id_equipe=phppro_equipes.id";

    
          $resultats = mysql_query ($requete) or die (mysql_error());
          while ($row=mysql_fetch_array($resultats))
          {
           mysql_query ("UPDATE phppro_buteurs SET phppro_buteurs.id_effectif='$row[0]' WHERE id_match='$id_match' and id_effectif='0'");
          }
...
$sql_maj_1="
  RENAME TABLE buteurs TO phppro_buteurs,
  championnats TO phppro_championnats,
  classe TO phppro_classe,
  clmnt TO phppro_clmnt,
  clmnt_graph TO phppro_clmnt_graph,
  clmnt_pronos TO phppro_clmnt_pronos,
  clubs TO phppro_clubs,
  divisions TO phppro_divisions,
  donnee TO phppro_donnee,
  equipes TO phppro_equipes,
  joueurs TO phppro_joueurs,
  journees TO phppro_journees,
  logo TO phppro_logo,
  matchs TO phppro_matchs,
  membres TO phppro_membres,
  parametres TO phppro_parametres,
  pronostics TO phppro_pronostics,
  rens TO phppro_rens,
  saisons TO phppro_saisons,
  tapis_vert TO phppro_tapis_vert;
  ALTER TABLE `phppro_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phppro_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phppro_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phppro_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phppro_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppro_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phppro_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phppro_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phppro_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppro_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phppro_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phppro_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phppro_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppro_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phppro_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppro_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phppro_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phppro_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phppro_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppro_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppro_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppro_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppro_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phppro_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phppro_buteurs` DROP `id_joueur`;
ALTER TABLE `phppro_joueurs` DROP `id_club`;
DROP TABLE `phppro_logo`";
  
$sql_maj_3 = "ALTER TABLE `phppro_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phppro_clubs` DROP INDEX `id`;
ALTER TABLE `phppro_clubs` DROP INDEX `nom`;
ALTER TABLE `phppro_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppro_championnats` DROP INDEX `id`;
ALTER TABLE `phppro_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phppro_championnats` DROP INDEX `id_division`;
ALTER TABLE `phppro_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppro_classe` DROP INDEX `id`;
ALTER TABLE `phppro_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phppro_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phppro_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phppro_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phppro_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phppro_divisions` DROP PRIMARY KEY;
ALTER TABLE `phppro_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phppro_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppro_divisions` DROP INDEX `id`;
ALTER TABLE `phppro_equipes` DROP INDEX `id`;
ALTER TABLE `phppro_journees` DROP INDEX `id`;
ALTER TABLE `phppro_journees` DROP INDEX `numero`;
ALTER TABLE `phppro_logo` DROP PRIMARY KEY;
ALTER TABLE `phppro_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phppro_logo` DROP INDEX `id_club`;
ALTER TABLE `phppro_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phppro_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phppro_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phppro_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phppro_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phppro_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppro_rens` DROP INDEX `id`;
ALTER TABLE `phppro_saisons` DROP INDEX `id_2`;
ALTER TABLE `phppro_saisons` DROP PRIMARY KEY;
ALTER TABLE `phppro_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phppro_tapis_vert`;
ALTER TABLE `phppro_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phppro_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phppro_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phppro_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppro_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppro_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppro_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppro_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppro_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppro_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phppro_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phppro_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phppro_joueurs.id, phppro_equipes.id
          FROM phppro_joueurs, phppro_equipes, phppro_buteurs, phppro_matchs, phppro_clubs
          ...
          AND phppro_joueurs.id_club=phppro_equipes.id_club
          AND phppro_buteurs.id_joueur=phppro_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phppro_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phppro_effectif.id, phppro_buteurs.id_match, phppro_joueurs.id
          FROM phppro_joueurs, phppro_equipes, phppro_buteurs, phppro_matchs, phppro_clubs, phppro_effectif
          WHERE phppro_equipes.id_club=phppro_clubs.id
          AND (
           phppro_matchs.id_equipe_dom = phppro_equipes.id
           OR phppro_matchs.id_equipe_ext = phppro_equipes.id
          ...
          AND phppro_joueurs.id_club=phppro_equipes.id_club
          AND phppro_buteurs.id_joueur=phppro_joueurs.id
          AND phppro_effectif.id_joueur=phppro_joueurs.id
          AND phppro_effectif.id_equipe=phppro_equipes.id";
...
while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phppro_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phppro_joueurs.nom, phppro_joueurs.prenom, phppro_buteurs.id, phppro_journees.numero, phppro_matchs.date_reelle, phppro_joueurs.id
FROM phppro_joueurs, phppro_buteurs, phppro_matchs, phppro_equipes, phppro_journees
WHERE phppro_matchs.id = phppro_buteurs.id_match
AND phppro_buteurs.id_joueur = phppro_joueurs.id
AND phppro_buteurs.id_effectif =0
AND (
phppro_matchs.id_equipe_dom = phppro_equipes.id
OR phppro_matchs.id_equipe_ext = phppro_equipes.id
    )
AND phppro_journees.id = phppro_matchs.id_journee";
          
$resultat=mysql_query($requete) or die (mysql_error());

if (!mysql_num_rows( $resultat )=='0')
{
echo "<form method=\"post\" action=../phppro//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phppro_clubs.nom, phppro_equipes.id, phppro_matchs.id
             FROM phppro_joueurs, phppro_equipes, phppro_buteurs, phppro_matchs, phppro_clubs, phppro_journees
             WHERE phppro_equipes.id_club = phppro_clubs.id
             AND (
             phppro_matchs.id_equipe_dom = phppro_equipes.id
             OR phppro_matchs.id_equipe_ext = phppro_equipes.id
...
$sql_maj_1="ALTER TABLE `phppro_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phppro_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phppro_clubs` DROP INDEX `id`;
ALTER TABLE `phppro_clubs` DROP INDEX `nom`;
ALTER TABLE `phppro_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppro_championnats` DROP INDEX `id`;
ALTER TABLE `phppro_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phppro_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phppro_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phppro_clmnt_pronos` (
  `id_champ` tinyint(3) unsigned NOT NULL default '0',
...
CREATE TABLE `phppro_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phppro_pronostics` (
  `id_membre` smallint(5) unsigned NOT NULL default '0',
  `id_champ` int(3) unsigned NOT NULL default '0',
...
INSERT INTO `phppro_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpproeague@univert.org<phpproeague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phpproeague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phppro//%22$url_site/%22>$url_site</a></font></p>
