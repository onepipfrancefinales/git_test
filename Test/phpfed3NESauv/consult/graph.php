...
$query="SELECT phpfed3NE_clubs.nom, phpfed3NE_equipes.id_club, phpfed3NE_equipes.id_champ FROM phpfed3NE_equipes, phpfed3NE_clubs where phpfed3NE_clubs.id=phpfed3NE_equipes.id_club AND phpfed3NE_equipes.id='$equipe'";
...
$query="SELECT phpfed3NE_equipes.id FROM phpfed3NE_equipes, phpfed3NE_clubs WHERE id_champ='$champ' AND phpfed3NE_equipes.id_club=phpfed3NE_clubs.id AND phpfed3NE_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpfed3NE_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpfed3NE_saisons.annee, phpfed3NE_divisions.nom FROM phpfed3NE_saisons, phpfed3NE_divisions, phpfed3NE_championnats where phpfed3NE_championnats.id=$champ AND phpfed3NE_divisions.id=phpfed3NE_championnats.id_division and phpfed3NE_championnats.id_saison=phpfed3NE_saisons.id";
$result=mysql_query($query);
