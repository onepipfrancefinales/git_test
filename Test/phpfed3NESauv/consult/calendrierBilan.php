...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpfed3NE_divisions.nom, phpfed3NE_saisons.annee, (phpfed3NE_saisons.annee)+1
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpfed3NE2" cellspacing="0" width="290" align="center">
