<link rel="stylesheet" type="text/css" href="../phpfed3NE/league.css">
<body class=phpl>
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpfed3NE_buteurs,
  championnats TO phpfed3NE_championnats,
  classe TO phpfed3NE_classe,
  clmnt TO phpfed3NE_clmnt,
  clmnt_graph TO phpfed3NE_clmnt_graph,
  clmnt_pronos TO phpfed3NE_clmnt_pronos,
  clubs TO phpfed3NE_clubs,
  divisions TO phpfed3NE_divisions,
  donnee TO phpfed3NE_donnee,
  equipes TO phpfed3NE_equipes,
  joueurs TO phpfed3NE_joueurs,
  journees TO phpfed3NE_journees,
  logo TO phpfed3NE_logo,
  matchs TO phpfed3NE_matchs,
  membres TO phpfed3NE_membres,
  parametres TO phpfed3NE_parametres,
  pronostics TO phpfed3NE_pronostics,
  rens TO phpfed3NE_rens,
  saisons TO phpfed3NE_saisons,
  tapis_vert TO phpfed3NE_tapis_vert;
  ALTER TABLE `phpfed3NE_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpfed3NE_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpfed3NE_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpfed3NE_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpfed3NE_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed3NE_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpfed3NE_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpfed3NE_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpfed3NE_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed3NE_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpfed3NE_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpfed3NE_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpfed3NE_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed3NE_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpfed3NE_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed3NE_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpfed3NE_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpfed3NE_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpfed3NE_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed3NE_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed3NE_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed3NE_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed3NE_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpfed3NE_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpfed3NE_buteurs` DROP `id_joueur`;
ALTER TABLE `phpfed3NE_joueurs` DROP `id_club`;
DROP TABLE `phpfed3NE_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpfed3NE_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpfed3NE_clubs` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_clubs` DROP INDEX `nom`;
ALTER TABLE `phpfed3NE_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed3NE_championnats` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpfed3NE_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpfed3NE_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed3NE_classe` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpfed3NE_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpfed3NE_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpfed3NE_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpfed3NE_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpfed3NE_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpfed3NE_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpfed3NE_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed3NE_divisions` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_equipes` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_journees` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_journees` DROP INDEX `numero`;
ALTER TABLE `phpfed3NE_logo` DROP PRIMARY KEY;
ALTER TABLE `phpfed3NE_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpfed3NE_logo` DROP INDEX `id_club`;
ALTER TABLE `phpfed3NE_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpfed3NE_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpfed3NE_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpfed3NE_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpfed3NE_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpfed3NE_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed3NE_rens` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpfed3NE_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpfed3NE_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpfed3NE_tapis_vert`;
ALTER TABLE `phpfed3NE_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpfed3NE_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpfed3NE_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpfed3NE_clmnt_cache` (
...
CREATE TABLE `phpfed3NE_effectif` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed3NE_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed3NE_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed3NE_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed3NE_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed3NE_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed3NE_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpfed3NE_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpfed3NE_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpfed3NE_joueurs.id, phpfed3NE_equipes.id
          FROM phpfed3NE_joueurs, phpfed3NE_equipes, phpfed3NE_buteurs, phpfed3NE_matchs, phpfed3NE_clubs
          WHERE phpfed3NE_equipes.id_club=phpfed3NE_clubs.id
          AND (
           phpfed3NE_matchs.id_equipe_dom = phpfed3NE_equipes.id
           OR phpfed3NE_matchs.id_equipe_ext = phpfed3NE_equipes.id
              )
          AND phpfed3NE_matchs.id=phpfed3NE_buteurs.id_match
          AND phpfed3NE_joueurs.id_club=phpfed3NE_equipes.id_club
          AND phpfed3NE_buteurs.id_joueur=phpfed3NE_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpfed3NE_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpfed3NE_effectif.id, phpfed3NE_buteurs.id_match, phpfed3NE_joueurs.id
          FROM phpfed3NE_joueurs, phpfed3NE_equipes, phpfed3NE_buteurs, phpfed3NE_matchs, phpfed3NE_clubs, phpfed3NE_effectif
          WHERE phpfed3NE_equipes.id_club=phpfed3NE_clubs.id
          AND (
           phpfed3NE_matchs.id_equipe_dom = phpfed3NE_equipes.id
           OR phpfed3NE_matchs.id_equipe_ext = phpfed3NE_equipes.id
          ...
          AND phpfed3NE_joueurs.id_club=phpfed3NE_equipes.id_club
          AND phpfed3NE_buteurs.id_joueur=phpfed3NE_joueurs.id
          AND phpfed3NE_effectif.id_joueur=phpfed3NE_joueurs.id
          AND phpfed3NE_effectif.id_equipe=phpfed3NE_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpfed3NE_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpfed3NE_joueurs.nom, phpfed3NE_joueurs.prenom, phpfed3NE_buteurs.id, phpfed3NE_journees.numero, phpfed3NE_matchs.date_reelle, phpfed3NE_joueurs.id
FROM phpfed3NE_joueurs, phpfed3NE_buteurs, phpfed3NE_matchs, phpfed3NE_equipes, phpfed3NE_journees
WHERE phpfed3NE_matchs.id = phpfed3NE_buteurs.id_match
AND phpfed3NE_buteurs.id_joueur = phpfed3NE_joueurs.id
AND phpfed3NE_buteurs.id_effectif =0
AND (
phpfed3NE_matchs.id_equipe_dom = phpfed3NE_equipes.id
OR phpfed3NE_matchs.id_equipe_ext = phpfed3NE_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpfed3NE//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpfed3NE_clubs.nom, phpfed3NE_equipes.id, phpfed3NE_matchs.id
             FROM phpfed3NE_joueurs, phpfed3NE_equipes, phpfed3NE_buteurs, phpfed3NE_matchs, phpfed3NE_clubs, phpfed3NE_journees
             WHERE phpfed3NE_equipes.id_club = phpfed3NE_clubs.id
             AND (
             phpfed3NE_matchs.id_equipe_dom = phpfed3NE_equipes.id
             OR phpfed3NE_matchs.id_equipe_ext = phpfed3NE_equipes.id
             ...
             AND phpfed3NE_buteurs.id_effectif =0
             AND phpfed3NE_journees.id = phpfed3NE_matchs.id_journee
             AND phpfed3NE_buteurs.id='$row[2]'";
...
$sql_maj_1="ALTER TABLE `phpfed3NE_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpfed3NE_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpfed3NE_clubs` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_clubs` DROP INDEX `nom`;
ALTER TABLE `phpfed3NE_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed3NE_championnats` DROP INDEX `id`;
ALTER TABLE `phpfed3NE_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpfed3NE_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpfed3NE_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
$sql_admin = "
CREATE TABLE `phpfed3NE_buteurs` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
CREATE TABLE `phpfed3NE_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpfed3NE_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpfed3NE_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpfed3NE_equipes` (
...
CREATE TABLE `phpfed3NE_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpfed3NE_joueurs` (
...
CREATE TABLE `phpfed3NE_journees` (
...
CREATE TABLE `phpfed3NE_membres` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
...
CREATE TABLE `phpfed3NE_parametres` (
  `id_champ` int(4) unsigned NOT NULL default '0',
...
CREATE TABLE `phpfed3NE_pronostics` (
  `id_membre` smallint(5) unsigned NOT NULL default '0',
  `id_champ` int(3) unsigned NOT NULL default '0',
...
CREATE TABLE `phpfed3NE_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpfed3NE_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpfed3NEeague@univert.org<phpleague@univert.org>";
...
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpfed3NE//%22$url_site/%22>$url_site</a></font></p>
