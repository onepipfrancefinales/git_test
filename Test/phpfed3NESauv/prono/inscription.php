...
$tabTables = array('phpau', 'phpfed3NE', 'phpca', 'phpfed3NE', 'phpidf', 'phpfed3NE', 'phppro');
...
*/
$tabTables = array('phpau', 'phpab', 'phpca', 'phpfed3NE', 'phpidf', 'phpfed3NE', 'phppro');								   
foreach ($tabTables as $table) {
  //phpfed3NE_pronostics
...
<font face=\"Verdana\" size=\"3\" color=\"#000000\"><a href=\"mailto:mailto:francefinalesrugby@free.fr\">francefinalesrugby@free.fr</a></font>
    ...
    if ($email) {
      ...
      echo "<table align=\"center\">";
      echo "<tr><td colspan=\"2\" align=\"center\"> <font color=\"#ffffff\">" . PRONO_INSCRIPTION_ECHOUE . "</font><br /><a href=\"/Test/phpfed3NE/prono/index.php?page=inscription\"><font color=\"#FFFFFF\">Connexion !</font></a></td></tr>";
      echo "</table>";
    }
  } else {
    echo "<table align=\"center\">";
    echo "<tr><td colspan=\"2\" align=\"center\"> <font color=\"#ffffff\">$message<br /><a href=\"/Test/phpfed3NE/prono/index.php?page=inscription&champ=$champ&champLigue=$champLigue\"></font></font>" . "Réessayer" . "</a></td></tr>";
    echo "</table>";
  }
}
