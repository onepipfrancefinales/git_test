 ...
 $nb_resultats=mysqli_num_rows($resultats);
  ...
  if ($nb_resultats>0)
   ...
   else
     {
	  ...
	  mysqli_query($idconnect,("
	  INSERT INTO phpfed3NE_gr_championnats (id_champ, pts_prono_exact, pts_prono_participation, id_master, tps_avant_prono) 
...
<table class=phpfed3NE width="80%">
            ...
            <tr>
              ...
              <td class=phpfed3NE3 colspan="5" align="center"><?php  champ_gr_menu ($gr_champ, $idconnect);echo "test3"; ?></td>
