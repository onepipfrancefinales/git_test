<link rel="stylesheet" type="text/css" href="../phpal/league.css">
<body class=phpl>
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpal_buteurs,
  championnats TO phpal_championnats,
  classe TO phpal_classe,
  clmnt TO phpal_clmnt,
  clmnt_graph TO phpal_clmnt_graph,
  clmnt_pronos TO phpal_clmnt_pronos,
  clubs TO phpal_clubs,
  divisions TO phpal_divisions,
  donnee TO phpal_donnee,
  equipes TO phpal_equipes,
  joueurs TO phpal_joueurs,
  journees TO phpal_journees,
  logo TO phpal_logo,
  matchs TO phpal_matchs,
  membres TO phpal_membres,
  parametres TO phpal_parametres,
  pronostics TO phpal_pronostics,
  rens TO phpal_rens,
  saisons TO phpal_saisons,
  tapis_vert TO phpal_tapis_vert;
  ALTER TABLE `phpal_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpal_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpal_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpal_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpal_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpal_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpal_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpal_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpal_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpal_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpal_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpal_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpal_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpal_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpal_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpal_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpal_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpal_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpal_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpal_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpal_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpal_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpal_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpal_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpal_buteurs` DROP `id_joueur`;
ALTER TABLE `phpal_joueurs` DROP `id_club`;
DROP TABLE `phpal_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpal_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpal_clubs` DROP INDEX `id`;
ALTER TABLE `phpal_clubs` DROP INDEX `nom`;
ALTER TABLE `phpal_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpal_championnats` DROP INDEX `id`;
ALTER TABLE `phpal_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpal_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpal_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpal_classe` DROP INDEX `id`;
ALTER TABLE `phpal_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpal_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpal_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpal_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpal_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpal_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpal_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpal_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpal_divisions` DROP INDEX `id`;
ALTER TABLE `phpal_equipes` DROP INDEX `id`;
ALTER TABLE `phpal_journees` DROP INDEX `id`;
ALTER TABLE `phpal_journees` DROP INDEX `numero`;
ALTER TABLE `phpal_logo` DROP PRIMARY KEY;
ALTER TABLE `phpal_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpal_logo` DROP INDEX `id_club`;
ALTER TABLE `phpal_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpal_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpal_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpal_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpal_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpal_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpal_rens` DROP INDEX `id`;
ALTER TABLE `phpal_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpal_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpal_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpal_tapis_vert`;
ALTER TABLE `phpal_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpal_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpal_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpal_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpal_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpal_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpal_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpal_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpal_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpal_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpal_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpal_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpal_joueurs.id, phpal_equipes.id
          FROM phpal_joueurs, phpal_equipes, phpal_buteurs, phpal_matchs, phpal_clubs
          WHERE phpal_equipes.id_club=phpal_clubs.id
          AND (
           phpal_matchs.id_equipe_dom = phpal_equipes.id
           OR phpal_matchs.id_equipe_ext = phpal_equipes.id
              )
          AND phpal_matchs.id=phpal_buteurs.id_match
          AND phpal_joueurs.id_club=phpal_equipes.id_club
          AND phpal_buteurs.id_joueur=phpal_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpal_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpal_effectif.id, phpal_buteurs.id_match, phpal_joueurs.id
          FROM phpal_joueurs, phpal_equipes, phpal_buteurs, phpal_matchs, phpal_clubs, phpal_effectif
          WHERE phpal_equipes.id_club=phpal_clubs.id
          AND (
           phpal_matchs.id_equipe_dom = phpal_equipes.id
           OR phpal_matchs.id_equipe_ext = phpal_equipes.id
          ...
          AND phpal_joueurs.id_club=phpal_equipes.id_club
          AND phpal_buteurs.id_joueur=phpal_joueurs.id
          AND phpal_effectif.id_joueur=phpal_joueurs.id
          AND phpal_effectif.id_equipe=phpal_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpal_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpal_joueurs.nom, phpal_joueurs.prenom, phpal_buteurs.id, phpal_journees.numero, phpal_matchs.date_reelle, phpal_joueurs.id
FROM phpal_joueurs, phpal_buteurs, phpal_matchs, phpal_equipes, phpal_journees
WHERE phpal_matchs.id = phpal_buteurs.id_match
AND phpal_buteurs.id_joueur = phpal_joueurs.id
AND phpal_buteurs.id_effectif =0
AND (
phpal_matchs.id_equipe_dom = phpal_equipes.id
OR phpal_matchs.id_equipe_ext = phpal_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpal//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpal_clubs.nom, phpal_equipes.id, phpal_matchs.id
             FROM phpal_joueurs, phpal_equipes, phpal_buteurs, phpal_matchs, phpal_clubs, phpal_journees
             WHERE phpal_equipes.id_club = phpal_clubs.id
             AND (
             phpal_matchs.id_equipe_dom = phpal_equipes.id
             OR phpal_matchs.id_equipe_ext = phpal_equipes.id
...
$sql_maj_1="ALTER TABLE `phpal_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpal_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpal_clubs` DROP INDEX `id`;
ALTER TABLE `phpal_clubs` DROP INDEX `nom`;
ALTER TABLE `phpal_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpal_championnats` DROP INDEX `id`;
ALTER TABLE `phpal_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpal_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpal_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpal_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpal_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpal_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpal_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpal_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpal_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpaleague@univert.org<phpleague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phpaleague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpal//%22$url_site/%22>$url_site</a></font></p>
