...
$query="SELECT id FROM phpab_equipes WHERE id_champ='$champ' AND id='$id_equipe'";
$result = mysql_query($query);
while ($row=mysql_fetch_array($result))
    {
    $id_equipe=$row[0];
    }
$query="SELECT phpab_clubs.nom FROM phpab_clubs, phpab_equipes WHERE phpab_equipes.id='$id_equipe' AND phpab_equipes.id_club=phpab_clubs.id";
$result = mysql_query($query);
while ($row=mysql_fetch_array($result))
    {
...
$query1="SELECT phpab_journees.numero, cldom.nom, clext.nom, phpab_matchs.buts_dom, phpab_matchs.buts_ext, phpab_matchs.date_reelle, phpab_matchs.id
