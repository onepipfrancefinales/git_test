...
$query="SELECT phpab_clubs.id, phpab_clubs.nom, id_champ, id_club
...
$query="SELECT id, url_logo FROM phpab_clubs WHERE id='$id_clubs'";
$result = mysql_query($query);
...
$query="SELECT phpab_classe.nom, phpab_classe.id FROM phpab_classe order by rang";
$result=mysql_query ($query);
...
$query="SELECT phpab_equipes.id FROM phpab_equipes, phpab_clubs 
        WHERE phpab_clubs.id='$id_clubs' AND id_champ='$champ' AND phpab_clubs.id=phpab_equipes.id_club";
$result = mysql_query($query);
...
{ $row[0]=addslashes($row[0]);
 $requete1="SELECT nom, prenom, phpab_joueurs.id
...
$query="SELECT annee, phpab_divisions.nom, phpab_championnats.id, phpab_equipes.id
