...
//  echo "journee : ".$journee;echo "</br>";
 ...
 $result=$bdd->query("SELECT cldom.nom as cldom, clext.nom as clext, phpau_matchs.buts_dom, phpau_matchs.buts_ext,
  ...
  echo "<br />";
  echo "<table align=\"center\" class=\"tablephpau2\"  width=\"90%\" cellspacing=\"1\" cellpadding=\"1\"><tr><td><table cellspacing=\"0\" align=\"center\" width=\"100%\" cellpadding=\"1\">\n";
  $x=1;
 ...
 while ($row=$result->fetch())
 {
  ...
  { 
   ...
   {   
	...
	?>    
	<table class="tablephpau2" cellspacing="0" width="290" align="center">
	  <tr class="trphpau3"><td colspan="3" align="center"><b><font color="#FFFF00">
	 ...
	 $pl=1;
		...
		{ 
		  ...
		  elseif (($pl%2)==0){echo "<tr class=\"ligne1\">";}
			...
			//colonne 1
			echo "<td ><div align=\"center\"><font color=\"#000000\"> $pl</font> </div></td>";
			//echo "<td class=\"affichageNumClassement\"> $pl </td>";
			$pl++;
			$x=0;
