...
$result=$idconnect->query("SELECT id_equipe_fetiche, phpau_divisions.nom, phpau_saisons.annee, (phpau_saisons.annee)+1
...
$resultats2=$idconnect->query("SELECT phpau_clubs.nom, CLEXT.nom, phpau_matchs.buts_dom, phpau_matchs.buts_ext, phpau_matchs.id, phpau_matchs.date_reelle
...
$result=$idconnect->query("SELECT phpau_journees.numero, phpau_journees.date_prevue, cldom.nom, clext.nom, phpau_matchs.buts_dom, phpau_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpau2" cellspacing="0" width="290" align="center">
