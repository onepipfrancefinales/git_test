...
$color=0;
$result= $idconnect->query("SELECT phpau_divisions.nom, phpau_saisons.annee, (phpau_saisons.annee)+1 
...
echo "<table class=\"tablephpau2\" align=\"center\" cellspacing=\"0\"  width=\"100%\">";


$result= $idconnect->query("SELECT phpau_journees.numero, cldom.nom, clext.nom, phpau_matchs.buts_dom, phpau_matchs.buts_ext, phpau_matchs.date_reelle, phpau_matchs.id
...
echo "<tr class=\"trphpau3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
