<link rel="stylesheet" type="text/css" href="../phppl/league.css">
<body class=phpl>
...
$sql_maj_1="
  RENAME TABLE buteurs TO phppl_buteurs,
  championnats TO phppl_championnats,
  classe TO phppl_classe,
  clmnt TO phppl_clmnt,
  clmnt_graph TO phppl_clmnt_graph,
  clmnt_pronos TO phppl_clmnt_pronos,
  clubs TO phppl_clubs,
  divisions TO phppl_divisions,
  donnee TO phppl_donnee,
  equipes TO phppl_equipes,
  joueurs TO phppl_joueurs,
  journees TO phppl_journees,
  logo TO phppl_logo,
  matchs TO phppl_matchs,
  membres TO phppl_membres,
  parametres TO phppl_parametres,
  pronostics TO phppl_pronostics,
  rens TO phppl_rens,
  saisons TO phppl_saisons,
  tapis_vert TO phppl_tapis_vert;
  ALTER TABLE `phppl_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phppl_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phppl_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phppl_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phppl_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppl_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phppl_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phppl_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phppl_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppl_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phppl_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phppl_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phppl_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppl_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phppl_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppl_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phppl_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phppl_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phppl_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppl_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phppl_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppl_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phppl_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phppl_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phppl_buteurs` DROP `id_joueur`;
ALTER TABLE `phppl_joueurs` DROP `id_club`;
DROP TABLE `phppl_logo`";
  
$sql_maj_3 = "ALTER TABLE `phppl_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phppl_clubs` DROP INDEX `id`;
ALTER TABLE `phppl_clubs` DROP INDEX `nom`;
ALTER TABLE `phppl_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppl_championnats` DROP INDEX `id`;
ALTER TABLE `phppl_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phppl_championnats` DROP INDEX `id_division`;
ALTER TABLE `phppl_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppl_classe` DROP INDEX `id`;
ALTER TABLE `phppl_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phppl_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phppl_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phppl_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phppl_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phppl_divisions` DROP PRIMARY KEY;
ALTER TABLE `phppl_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phppl_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppl_divisions` DROP INDEX `id`;
ALTER TABLE `phppl_equipes` DROP INDEX `id`;
ALTER TABLE `phppl_journees` DROP INDEX `id`;
ALTER TABLE `phppl_journees` DROP INDEX `numero`;
ALTER TABLE `phppl_logo` DROP PRIMARY KEY;
ALTER TABLE `phppl_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phppl_logo` DROP INDEX `id_club`;
ALTER TABLE `phppl_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phppl_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phppl_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phppl_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phppl_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phppl_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppl_rens` DROP INDEX `id`;
ALTER TABLE `phppl_saisons` DROP INDEX `id_2`;
ALTER TABLE `phppl_saisons` DROP PRIMARY KEY;
ALTER TABLE `phppl_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phppl_tapis_vert`;
ALTER TABLE `phppl_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phppl_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phppl_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phppl_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppl_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppl_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppl_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppl_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppl_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phppl_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phppl_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phppl_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phppl_joueurs.id, phppl_equipes.id
          FROM phppl_joueurs, phppl_equipes, phppl_buteurs, phppl_matchs, phppl_clubs
          WHERE phppl_equipes.id_club=phppl_clubs.id
          AND (
           phppl_matchs.id_equipe_dom = phppl_equipes.id
           OR phppl_matchs.id_equipe_ext = phppl_equipes.id
              )
          AND phppl_matchs.id=phppl_buteurs.id_match
          AND phppl_joueurs.id_club=phppl_equipes.id_club
          AND phppl_buteurs.id_joueur=phppl_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phppl_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phppl_effectif.id, phppl_buteurs.id_match, phppl_joueurs.id
          FROM phppl_joueurs, phppl_equipes, phppl_buteurs, phppl_matchs, phppl_clubs, phppl_effectif
          WHERE phppl_equipes.id_club=phppl_clubs.id
          AND (
           phppl_matchs.id_equipe_dom = phppl_equipes.id
           OR phppl_matchs.id_equipe_ext = phppl_equipes.id
          ...
          AND phppl_joueurs.id_club=phppl_equipes.id_club
          AND phppl_buteurs.id_joueur=phppl_joueurs.id
          AND phppl_effectif.id_joueur=phppl_joueurs.id
          AND phppl_effectif.id_equipe=phppl_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phppl_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phppl_joueurs.nom, phppl_joueurs.prenom, phppl_buteurs.id, phppl_journees.numero, phppl_matchs.date_reelle, phppl_joueurs.id
FROM phppl_joueurs, phppl_buteurs, phppl_matchs, phppl_equipes, phppl_journees
WHERE phppl_matchs.id = phppl_buteurs.id_match
AND phppl_buteurs.id_joueur = phppl_joueurs.id
AND phppl_buteurs.id_effectif =0
AND (
phppl_matchs.id_equipe_dom = phppl_equipes.id
OR phppl_matchs.id_equipe_ext = phppl_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phppl//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phppl_clubs.nom, phppl_equipes.id, phppl_matchs.id
             FROM phppl_joueurs, phppl_equipes, phppl_buteurs, phppl_matchs, phppl_clubs, phppl_journees
             WHERE phppl_equipes.id_club = phppl_clubs.id
             AND (
             phppl_matchs.id_equipe_dom = phppl_equipes.id
             OR phppl_matchs.id_equipe_ext = phppl_equipes.id
...
$sql_maj_1="ALTER TABLE `phppl_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phppl_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phppl_clubs` DROP INDEX `id`;
ALTER TABLE `phppl_clubs` DROP INDEX `nom`;
ALTER TABLE `phppl_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phppl_championnats` DROP INDEX `id`;
ALTER TABLE `phppl_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phppl_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phppl_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phppl_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phppl_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phppl_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phppl_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phppl_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phppl_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phppleague@univert.org<phpleague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phppleague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phppl//%22$url_site/%22>$url_site</a></font></p>
