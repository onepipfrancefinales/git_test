...
mysqli_query($idconnect, ("UPDATE phppl_membres SET mot_de_passe='$new_mot_de_passe_crypt' WHERE mail='$mail'"));
...
<p><font face=\"Verdana\" size=\"2\">Ce script a été créé par <a href=\"http://phppleague.univert.org\">phppleague</a> : Gestionnaire de championnats sportifs et de pronostics !</font></p>
</body>
</html>";
