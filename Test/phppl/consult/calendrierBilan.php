...
$result=$idconnect->query("SELECT id_equipe_fetiche, phppl_divisions.nom, phppl_saisons.annee, (phppl_saisons.annee)+1
...
$resultats2=$idconnect->query("SELECT phppl_clubs.nom, CLEXT.nom, phppl_matchs.buts_dom, phppl_matchs.buts_ext, phppl_matchs.id, phppl_matchs.date_reelle
...
$result=$idconnect->query("SELECT phppl_journees.numero, phppl_journees.date_prevue, cldom.nom, clext.nom, phppl_matchs.buts_dom, phppl_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephppl2" cellspacing="0" width="290" align="center">
