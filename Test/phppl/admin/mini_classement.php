...
<br /><font class=phppl><?php echo ADMIN_MINI_1; ?></mysql_fetch_array><br /><br />
<table class=phppl width="80%">
            <tr>
              <td class=phppl2 align=center><?php echo ADMIN_MINI_24; ?></td>
              </tr><tr><td>
...
{
echo "<table class=tablephppl2 cellspacing=\"0\" align=center width=\"100%\">";
echo "<tr><td>";


echo "<form method=\"post\" action=\"\">";

echo "<tr><td class=phppl3>".ADMIN_MINI_2."</td>";
echo "<td class=phppl3><select name=\"presentationmini\">";
...
// $idconnect=@mysqli_connect('127.0.0.1','root','','onepip-france-db3');	
  ...
  $result=$idconnect->query("SELECT max(id) FROM phppl_championnats");
...
echo "<tr><td width=\"50%\" class=phppl4>".ADMIN_MINI_3."</td><td width=\"50%\" class=phppl4><select name=\"typemini\">";
echo "<option value=\"\"></option>";
...
echo "<tr><td class=phppl3>".ADMIN_MINI_4."</td><td class=phppl3><select name=\"champmini\">";
echo "<option value=\"\" align=\"center\"> </option>";

 //$idconnect=@mysqli_connect('127.0.0.1','root','','onepip-france-db3');	
  
  $result=$idconnect->query("SELECT phppl_divisions.nom, phppl_saisons.annee, phppl_championnats.id
...
echo "<tr><td class=phppl4>".ADMIN_MINI_15."</td>";
...
echo "<tr>";
echo "<td class=phppl4><input type=\"radio\" value=\"0\" checked name=\"classmini\">".ADMIN_MINI_17."</td><td class=phppl4></td></tr>";
echo "<tr><td class=phppl4>".ADMIN_MINI_5."</td>";
echo "<td class=phppl4><input type=\"text\" name=\"nb_dessusmini\" size=2 maxlength=2></td></tr>";

echo "<tr><td class=phppl4>".ADMIN_MINI_14."</td>";
echo "<td class=phppl4><input type=\"text\" name=\"nb_dessousmini\" size=2 maxlength=2></td></tr>";

echo "<tr>";
echo "<td class=phppl3><input type=\"radio\" value=\"1\" name=\"classmini\">".ADMIN_MINI_18." ";
...
echo "<tr><td class=phppl3>".ADMIN_MINI_13." </td>";
echo "<td class=phppl3><textarea readonly name=\"code_ajouter\" rows=\"7\" cols=\"50\" onclick=\"this.focus();this.select()\">";
echo "&lt;iframe src=&quot;".$phpplEAGUE_RACINE."consult/miniseul.php?";
...
echo "</td></tr>";
echo "<td class=phppl3>".ADMIN_MINI_7."</td><td class=phppl3>";
...
echo "</td><td class=phppl3></td></tr></table>";
