...
//						  WHERE id_champ = '0'"));
    ...
    //     {
		...
		$val=$champ[0];
		  mysqli_query($idconnect,("INSERT INTO phppl_gr_championnats (id, nom, id_champ, activ_prono, pts_prono_exact, pts_prono_participation, id_master,tps_avant_prono)
...
<table class=phppl width="80%">
            ...
            <tr>
              <td align="center" class=phppl6 colspan="4"><b><?php echo ADMIN_GR_CHAMP_EDIT_5; ?></b></td>
            </tr>
              <td class=phppl3 colspan="5" align="center"><?php  champ_gr_menu ($gr_champ, $idconnect); ?></td>
...
<table class=phppl width="80%">
            <tr>
              <td class=phppl2 align="center" colspan="3"><?php echo ADMIN_PARAM_MSG13." "; affich_gr_champ ($gr_champ, $idconnect);echo "test4"; ?></td>
            </tr>
            <tr>
