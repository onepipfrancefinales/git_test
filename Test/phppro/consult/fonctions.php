...
// cellule d'affichage des derniers r�sultats
  $color=0;
        $reponse=$idconnect->query("SELECT cldom.nom as cldom, clext.nom as clext, phppro_matchs.buts_dom, phppro_matchs.buts_ext,
...
//suppression des liens sur les scores
  ...
  $resultats=$idconnect->query("SELECT phppro_clubs.nom, CLEXT.nom, phppro_matchs.buts_dom, phppro_matchs.buts_ext,
