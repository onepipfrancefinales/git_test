...
<br /><font class=phppro><?php echo ADMIN_MINI_1; ?></mysql_fetch_array><br /><br />
<table class=phppro width="80%">
            <tr>
              <td class=phppro2 align=center><?php echo ADMIN_MINI_24; ?></td>
              </tr><tr><td>
...
{
echo "<table class=tablephppro2 cellspacing=\"0\" align=center width=\"100%\">";
echo "<tr><td>";


echo "<form method=\"post\" action=\"\">";

echo "<tr><td class=phppro3>".ADMIN_MINI_2."</td>";
echo "<td class=phppro3><select name=\"presentationmini\">";
...
// $idconnect=@mysqli_connect('127.0.0.1','root','','onepip-france-db3');	
  ...
  $result=$idconnect->query("SELECT max(id) FROM phppro_championnats");
...
echo "<tr><td width=\"50%\" class=phppro4>".ADMIN_MINI_3."</td><td width=\"50%\" class=phppro4><select name=\"typemini\">";
echo "<option value=\"\"></option>";
...
echo "<tr><td class=phppro3>".ADMIN_MINI_4."</td><td class=phppro3><select name=\"champmini\">";
echo "<option value=\"\" align=\"center\"> </option>";

 //$idconnect=@mysqli_connect('127.0.0.1','root','','onepip-france-db3');	
  
  $result=$idconnect->query("SELECT phppro_divisions.nom, phppro_saisons.annee, phppro_championnats.id
...
echo "<tr><td class=phppro4>".ADMIN_MINI_15."</td>";
...
echo "<tr>";
echo "<td class=phppro4><input type=\"radio\" value=\"0\" checked name=\"classmini\">".ADMIN_MINI_17."</td><td class=phppro4></td></tr>";
echo "<tr><td class=phppro4>".ADMIN_MINI_5."</td>";
echo "<td class=phppro4><input type=\"text\" name=\"nb_dessusmini\" size=2 maxlength=2></td></tr>";

echo "<tr><td class=phppro4>".ADMIN_MINI_14."</td>";
echo "<td class=phppro4><input type=\"text\" name=\"nb_dessousmini\" size=2 maxlength=2></td></tr>";

echo "<tr>";
echo "<td class=phppro3><input type=\"radio\" value=\"1\" name=\"classmini\">".ADMIN_MINI_18." ";
...
echo "</td><td class=phppro3></td></tr>";
...
echo "<tr><td class=phppro3>".ADMIN_MINI_13." </td>";
echo "<td class=phppro3><textarea readonly name=\"code_ajouter\" rows=\"7\" cols=\"50\" onclick=\"this.focus();this.select()\">";
echo "&lt;iframe src=&quot;".$phpproEAGUE_RACINE."consult/miniseul.php?";
...
echo "</td></tr>";
echo "<td class=phppro3>".ADMIN_MINI_7."</td><td class=phppro3>";
...
echo "</td><td class=phppro3></td></tr></table>";
