...
echo $dt;
echo "<br>";
echo "minutes : ". date( "i", $dt );echo "<br>";



echo "minutes +2 : ".date( "i", $dt )+2;echo "<br>";
echo "<br>";
...
/*
$listeEmails = array ('onepipthib@gmail.com', 'onepip@free.fr', 'francefinalesrugby@free.fr');

foreach ($listeEmails as $mail) {


$mail_admin =$mail;
$mail ="onepipthib@gmail.com";
...
<p><font face=\"Verdana\" size=\"3\" color=\"#000000\">Login :&nbsp;  
<br />
Mot de passe :   </font></p>
