...
$result=$idconnect->query("
		...
		FROM phppl_clmnt_pronos, phppl_membres, phppl_gr_championnats
		WHERE type='general' 
		AND phppl_membres.id=phppl_clmnt_pronos.id_membre 
		AND phppl_gr_championnats.id='$gr_champ' 
		AND phppl_clmnt_pronos.id_champ='$gr_champ' 
		AND phppl_membres.id_prono='$user_id'
		GROUP BY participation
		ORDER by points 
		DESC, participation 
		DESC, phppl_membres.pseudo");
...
FROM phppl_clmnt_pronos, phppl_membres, phppl_gr_championnats
WHERE type='mensuel_en_cours' AND phppl_membres.id=phppl_clmnt_pronos.id_membre and phppl_gr_championnats.id='$gr_champ' and phppl_clmnt_pronos.id_champ='$gr_champ' and phppl_membres.id_prono='$user_id'
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phppl_clmnt_pronos, phppl_membres, phppl_gr_championnats
WHERE type='mensuel_30_jours' AND phppl_membres.id=phppl_clmnt_pronos.id_membre and phppl_gr_championnats.id='$gr_champ' and phppl_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phppl_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phppl_clmnt_pronos, phppl_membres, phppl_gr_championnats
WHERE type='hebdo' AND phppl_membres.id=phppl_clmnt_pronos.id_membre and phppl_gr_championnats.id='$gr_champ' and phppl_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phppl_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
