 ...
 ?> 
  ...
  <tr > 
    ...
    <td class="equipeI" > <a href="pageAffichage.php?page=S2S3S4&comite=<?php echo $comite;?>&annee=<?php echo $annee;?>&division=200" target="_top">2i&egrave;meS&eacute;rie</a>ee</td>
    <td class="equipeI" >
