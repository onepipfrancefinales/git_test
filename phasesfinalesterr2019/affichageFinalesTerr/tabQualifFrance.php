...
<table wclassth="1000" border="0" align="left"  cellspacing="0"  >
  ...
  <tr> 
    ...
    <td height="13"> 
      <div align="center"><i>14 Avril</i></div>
    </td>
...
<table  border="0" align="left"  cellspacing="0" >
  <tr> 
    ...
    <td rowspan="20" valign="top" width="18"> 
      <?php
require '../../phasesfinalesterr2019/qualification/QTableau3.php';
?>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td wclassth="160" colspan="2"  > 
      <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><i><b>5me 
        tour</b></i></font></div>
    </td>
  ...
  <tr> 
    ...
    <td width="112" height="13"> 
      <div align="center"><i>24 Mars</i></div>
    </td>
    ...
    <td colspan="2" height="13"> 
      <div align="center"><i></i></div>
      <div align="center"><i>31 Mars</i></div>
    </td>
    ...
    <td colspan="2" height="13"> 
      <div align="center"><i></i></div>
      <div align="center"><i>le 07 Mars</i></div>
    </td>
    <td width="42" height="13"> 
      <div align="center"><i></i></div>
    </td>
...
huitiemeEtBarrages2019($bdcomiteClub, $division, $annee);
    ...
    <td wclassth="160" width="22" > 
      <div class="affichageGA" > 
        <?php	 echo $A1601; ?>
      </div>
    </td>
    <td wclassth="160" width="50" > 
      <div class="affichageEquipe" > 
        <?php	 echo $clubA8001; ?>
      </div>
    </td>
    <td wclassth="30" width="17" > 
      <div class="affichageGA" > 
        <?php echo $A8001; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td wclassth="32" width="34"></td>
    <td wclassth="160" width="25" > 
      <div class="affichageEquipe" > 
        <?php echo $clubA4001; ?>
      </div>
    </td>
    <td wclassth="30" width="28"> 
      <div class="affichageGA" > 
        <?php 	echo $A4001; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td wclassth="30" width="28"></td>
    <td wclassth="21" width="24"></td>
    <td wclassth="160" width="27" > 
      <div class="affichageEquipe" > 
        <?php echo $clubA2001; ?>
      </div>
    </td>
    <td wclassth="30" width="26" > 
      <div class="affichageGA" > 
        <?php echo $A2001; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td wclassth="160" height="20" width="50"> 
      <div class="affichageEquipe" > 
        <?php	 echo $clubA8011; ?>
      </div>
    </td>
    <td wclassth="30" height="20" width="17"> 
      <div class="affichageGA" > 
        <?php	 echo $A8011; ?>
      </div>
    </td>
    <td wclassth="32" height="20" width="34"></td>
    <td wclassth="160" height="20" width="25" > 
      <div class="affichageEquipe" > 
        <?php	 echo $clubA4006; ?>
      </div>
    </td>
    <td wclassth="30" height="20" width="28"> 
      <div class="affichageGA" > 
        <?php 	echo $A4006; ?>
      </div>
    </td>
