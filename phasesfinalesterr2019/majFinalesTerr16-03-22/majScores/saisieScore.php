...
<table width="62%" border="0" height="658">
  ...
  <tr bgcolor="#006699"> 
    <td valign="top" height="11" width="17%" bgcolor="#000000"> 
      <div align="center"><font color="#FFFFFF" size="6" face="Arial, Helvetica, sans-serif"><b>5</b></font></div>
    </td>
    <td valign="middle" height="11" width="83%"><b><font face="Arial, Helvetica, sans-serif" color="#FFFFFF"> 
  ...
  <tr> 
    ...
    <td width="83%" valign="top" height="18" bgcolor="#0099FF"> 
  ...
  <tr> 
    ...
    <td width="83%" valign="top" height="21" bgcolor="#0099FF"> 
      <div align="center"> 
        <?php echo $comite;?>
      </div>
    </td>
