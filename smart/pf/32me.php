...
<table class="borderDouble width90PC marginAuto">
  <tr>
    <td class="titre"> 32me de finale<br>
      <span class="pf_lieux"><?php echo $D32ME; ?></span>
    </td>
  </tr>
</table>
<table class="borderNone width90PC marginAuto">
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3201; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3203; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3205; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3207; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3209; ?></td>
    <td class=<?php echo $cssScore; ?>><?php echo $A3209; ?></td>
  </tr>
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3210; ?></td>
    <td class=<?php echo $cssScore; ?>><?php echo $A3210; ?></td>
  </tr>
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3211; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3213; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3215; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3217; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3219; ?></td>
    <td class=<?php echo $cssScore2; ?>><?php echo $A3219; ?></td>
  </tr>
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3220; ?></td>
    <td class=<?php echo $cssScore2; ?>><?php echo $A3220; ?></td>
  </tr>
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3221; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3223; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3225; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3227; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3229; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3231; ?></td>
  ...
  <tr>
    ...
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3233; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3235; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3237; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3239; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3241; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3243; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3245; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3247; ?></td>
...
<table class="borderNone width90PC marginAuto">
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3249; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3251; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3253; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3255; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3257; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3259; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe; ?>><?php echo $clubA3261; ?></td>
  ...
  <tr>
    <td class=<?php echo $cssEquipe2; ?>><?php echo $clubA3263; ?></td>
