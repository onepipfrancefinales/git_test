 <table width="90%" border="1" align="center">
    <tr> 
      ...
      <span><div class="pf_lieux"><?php echo $D16ME; ?></div></span></td>
    </tr>
  </table>
  <br />
...
<table width="90%" border="0" align="center">
  <tr> 
    <td class="equipe4"><?php echo $clubA1617;?></td>
    <td class="coin4GA"><?php echo $A1617;?></td>
  </tr>
  <tr> 
    <td class="equipe4"><?php echo $clubA1618;?></td>
    <td class="coin4GA"><?php echo $A1618;?></td>
  </tr>
  <tr> 
    <td class="equipe5"><?php echo $clubA1619;?></td>
    <td class="coin5GA"><?php echo $A1619;?></td>
  </tr>
  <tr> 
    <td class="equipe5"><?php echo $clubA1620;?></td>
    <td class="coin5GA"><?php echo $A1620;?></td>
  </tr>
  <tr> 
    <td class="equipe4"><?php echo $clubA1621;?></td>
    <td class="coin4GA"><?php echo $A1621;?></td>
  </tr>
  <tr> 
    <td class="equipe4"><?php echo $clubA1622;?></td>
    <td class="coin4GA"><?php echo $A1622;?></td>
  </tr>
  <tr> 
