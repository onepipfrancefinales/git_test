...
<table align="center" border="1" width="95%">
  <tbody>
    ...
    <tr>  
      <td class="h12"> Mise à jours des résultats <br /> <?php echo $nomChampionnat; ?> </td>
    </tr>
  </tbody>
</table>
  ...
  <br><br><br>
  <p class="tab3">
   <a href="saisie1.php?comite=<?php echo $comite; ?>&journee=<?php echo $journee ; ?>&codeEquipe=<?php echo $codeEquipe; ?>">Retour pour modif</a>
  </p>
 </body>
</html>
