...
if ($champ == 990110 ){$ligne2="Compétitions professionnellles";}
			...
			elseif ($champ == 991160){$ligne2="Fédérale 3";}
			elseif ($champ == 990240){$ligne2="Espoir Fédérale 1";}
			elseif ($champ == 990250){$ligne2="Fédérale B";}
			elseif ($champ == 991260){$ligne2="Excellence B";}
			elseif ($champ == 880281){$ligne2="Compétitions féminines";}
