...
<p class="tab4"> 
<a href="../171.php?comite=<?php echo $comite; ?>&bddComite=<?php echo $bddComite; ?>&champ=<?php echo $codeChampionnatAffichage; ?>">Confirmer ces r&eacutesultats et <br />acc&egrave;der au nouveau classement</a>
</p>
