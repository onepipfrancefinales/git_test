...
<?php
function nomChampionnat ($codeEquipe, $journee, $comite, $bdd)
{
...
function affichageEquipeUne($journee, $codeEquipe, $comite, $bdd){
...
function affichageEquipeDeux($journee, $codeEquipe, $comite, $bdd){
