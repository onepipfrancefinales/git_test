<table width="100%">
  <tr> 
    ...
    <td> 
      <div align="center"><span class="gras"><font face="Arial, Helvetica, sans-serif" size="6" color="#000000">Fratelli 
        d'Italia</font></span></div>
    </td>
    <td> 
      <div align="center"><img src="../../../images/drapeaux/Grand_format/ITA.png" width="75" height="50"></div>
    </td>
  ...
  <tr> 
    <td colspan="3" class="texte"> 
      ...
      <p> <span class="gras">L'Italia s'è desta,</span><br>
        ...
        <span class="gras">L'Italia chiam&ograve;.</span><br>
      ...
      <p><span class="gras">Noi siamo da secoli</span><br>
        ...
        L'Italie nous appelle.</p>
      ---------------------------------------------------- 
      <p><span class="gras">Uniamoci, amiamoci,</span><br>
        ...
        <span class="gras">Il suolo nat&igrave;o :</span><br>
        Notre sol natal :<br>
        <span class="gras">Uniti per Dio</span><br>
        Unis par Dieu<br>
        <span class="gras">Chi vincer ci pu&ograve; ?</span><br>
      ...
      <p><span class="gras">Dall'Alpi a Sicilia</span><br>
        ...
        <span class="gras">Ha il core, ha la mano,</span><br>
        A le coeur, a la main,<br>
        <span class="gras">I bimbi d'Italia</span><br>
        Les enfants d'Italie<br>
        <span class="gras">Si chiaman Balilla,</span><br>
        S'appellent Balilla <br>
        <span class="gras">Il suon d'ogni squilla</span><br>
        Le son de toutes les cloches<br>
        <span class="gras">I Vespri suon&ograve;.</span><br>
