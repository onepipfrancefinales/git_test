<table width="100%" >
  <tr> 
    <td width="87"> 
      <div align="center"><span class="gras"><img src="../../../images/drapeaux/Grand_format/IRA.png" width="75" height="50"></span></div>
    </td>
    <td width="393"> 
      <div align="center"><span class="gras"><font size="6" face="Arial, Helvetica, sans-serif" color="#000000">Ireland 
        Call <br>
  ...
  <tr> 
    <td colspan="3" class="texte"> 
      <br> <br>
	   <p>
      <span class="gras">Come the day and come the hour </span> <br>
        ...
        Depuis les quatre provinces d'Irlande <br></p>
        --------------------------------------------------------------------
       <p>
	   REFRAIN :<span class="gras"> Ireland, Ireland, </span><br>
        Irlande, Irlande <br>
