...
<body>
    ...
    <tr>
        ...
        <tr>
            <td colspan="2" class="size5 background003366 colorWhite bold borderWidth1 width50PC">
              Phases finales <br> du championnat de France
            </td>
        </tr>
        <tr>
            <td colspan="2" class="borderWidth1 ">
...
-->
        ...
        <tr>
            <td colspan="2" class="size5 background003366 colorWhite bold borderWidth1"> Champions de l'année </td>
        ...
        <tr>
            <td colspan="2" class="size5 background003366 colorWhite bold borderWidth1"> Expressions </td>
