...
<table width="95%" class="borderWidth1 marginAuto">
  ...
  <tr>
    <td colspan="2" class="borderWidth1 ">  <br>
      <p class="size4">
...
-->
  ...
  <tr>
    ...
    <td height="37" width="340" class="size5 borderWidth1">
      <a href="dossiers/divisions/pageEvolutionsDivisions.php?type=seniors1"><br>Evolution des divisions<br>du rugby Français</a><br>
