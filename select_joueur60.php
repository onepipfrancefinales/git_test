...
$nb=mysql_query("	SELECT COUNT(photo) 
					FROM $bdcomite 
					WHERE club=$equipe AND comite='1' AND photo='1'"); 
...
?>
        <?php
$reponse = mysql_query("SELECT sigle,comite, id 
						FROM bdclubs 
						WHERE id='$equipeC' or id=$equipeC-90000000"); 
							While ($donnees = mysql_fetch_array($reponse) )
							{ 		
					         echo $donnees['sigle'];
							}
 ...
 ?>
    ...
    <tr> 
      ...
      <td height="31" bgcolor="#999999"> 
        <div align="right"> <font face="Arial, Helvetica, sans-serif"><b><font size="2"> 
          <div align="center"> <font face="Arial, Helvetica, sans-serif"><b><font size="2"> 
            <div align="center">Juge de touche</div>
            </font></b></font> 
  ...
  <table width="1250" border="0">
    <tr>
      <td bgcolor="#000000" valign="middle" height="59"><font face="Arial, Helvetica, sans-serif"><b><font size="5" color="#FFFFFF"> 
        <br>
