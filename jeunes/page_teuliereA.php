...
<html lang="fr">
<head>
<?php $comite="phpap";?><?php $CMT="AP";?><?php $cmt="ap";?><?php $comiteNom=" des Alpes";?>
...
<table width="1100">
 ...
 width="1100"></td>
    ...
    <tr valign="middle">
      ...
      <h2><big><big>Teulière A</big></big><?php echo $comiteNom; ?>
      </h2>
      ...
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Poule 1 </h3>
<?php $comite="phply";?><?php $CMT="LY";?><?php $cmt="ly";?><?php $id=171 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Poule 2</h3>
<?php $id=271 ; ?><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Poule 3</h3>
<?php $id=172 ; $height=440; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Poule 4</h3>
<?php $id=272 ; ?><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
