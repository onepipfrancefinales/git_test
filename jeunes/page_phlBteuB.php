...
<html lang="fr">
<head>
<?php $comite="phpbal";?><?php $CMT="BAL";?><?php $cmt="bal";?><?php $comiteNom=" des Alpes";?>
...
<table width="1100">
  <tbody>
    <tr>
      <td colspan="3"> <img src="../images/banniere_haut/stade10.jpg"
 height="150" width="1100"></td>
    </tr>
    <tr>
      <td colspan="3">
    ...
    <tr valign="middle">
      ...
      <h2><big>Phliponeau B / Teulière B</big> </h2>
      <table border="3" bordercolor="#000000" cellpadding="0"
 cellspacing="0" width="550">
        <tbody>
          <tr>
            <td colspan="1" rowspan="1">Palmarès</td>
            <td></td>
          </tr>
 ...
 target="_blank">Phase finale Championnat de France</a></h4>
            </td>
            <td></td>
          </tr>
        </tbody>
      ...
      <table class="tableau1">
        <tbody>
          <tr>
            <td class="tab3"> <a href="#1">Poule
1</a> </td>
            <td class="tab3"> <a href="#2">poule
2</a> </td>
            <td class="tab3"> <a href="#3">poule
3</a> </td>
            <td class="tab3"> <a href="#4">Poule
4</a> </td>
          </tr>
          <tr>
            <td class="tab3"> <a href="#5">Poule
5</a> </td>
            <td class="tab3"> <a href="#6">Poule
6 </a> </td>
            <td class="tab3"> <a href="#7">Poule
7</a> </td>
            <td class="tab3"> <a href="#8">Poule
8</a> </td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Phliponeau B- Poule 1 </h3>
<?php $comite="phpphl";?><?php $CMT="PHL";?><?php $cmt="phl";?><?php $id=34102 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Teulière B - Poule 1</h3>
            <php title="$comite=&quot;phpteu&quot;;"
 xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $comite="phpteu";?></php><php
 title="$CMT=&quot;TEU&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $CMT="TEU";?></php><php
 title="$cmt=&quot;teu&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $cmt="teu";?></php><php
 title="$id=37102 ; $height=400; "
 xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $id=37101 ; $height=400; ?></php><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="515">
        <tbody>
          <tr>
            <td width="220"><?php $id=34101; $CMT="PHL"; ?>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/171.php?id=%3C?php%20echo%20$id;?%3E"
 target="_blank"
 title="Différents Classements et évolutions des Equipes unes">Plus
d'infos </a> </h6>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/calendrier.php?id=%3C?php%20echo%20$id;?%3E"
 target="_blank"
 title="Résultats et calendrier complet de la compétition">Calendrier
complet</a></h6>
            </td>
            <td width="178">&nbsp;</td>
            <td width="220"><?php $id=37101; $CMT="TEU"; ?>
            <h6><a
 href="%3C?php%20echo%20$CMT;?%3E/171.php?id=%3C?php%20echo%20$id;?%3E"
 target="_blank"
...
<?php include("../pub4.php"); ?>
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Phliponeau B- Poule 2 </h3>
<?php $comite="phpphl";?><?php $CMT="PHL";?><?php $cmt="phl";?><?php $id=34102 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Teulière B - Poule 2</h3>
<?php $comite="phpteu";?><?php $CMT="TEU";?><?php $cmt="teu";?><?php $id=37102 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
      <table width="515">
        <tbody>
          <tr>
            <td width="220"><?php $id=34102; $CMT="PHL"; ?>
            <h6> <a
...
complet</a></h6>
            ...
            <td width="178">&nbsp;</td>
            <td width="220"><?php $id=37102; $CMT="TEU"; ?>
            <h6><a
 href="<?php echo $CMT;?>/171.php?id=<?php echo $id;?> " target="_blank"
 title="Différents Classements et évolutions des Equipes réserves">Plus
d'infos </a></h6>
...
et un classement dès la fin des rencontre</big>s<br>
 ...
 class="MsoNormal">Pour<span style=""> </span>les
plus
impliqués d’entres <span style="">&nbsp;</span>vous,
possibilité de
...
Renseignement au 06.82.24.70.57</p>
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Phliponeau B - Poule 3</h3>
<?php $comite="phpphl";?><?php $CMT="PHL";?><?php $cmt="phl";?><?php $id=34103 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Teulière B - Poule 3</h3>
<?php $comite="phpteu";?><?php $CMT="TEU";?><?php $cmt="teu";?><?php $id=37103 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
      <table width="515">
        <tbody>
          <tr>
            <td width="219"><?php $id=34103; $CMT="PHL"; ?>
            <h6> <a
 href="<?php echo $CMT;?>/171.php?id=<?php echo $id ;?>" target="_blank"
 title="Différents Classements et évolutions des Equipes unes">Plus
d'infos</a></h6>
...
complet</a></h6>
            ...
            <td width="73"> </td>
            <td width="209"><?php $id=37103; $CMT="TEU"; ?>
            <h6> <a
 href="<?php echo $CMT;?>/171.php?id=<?php echo $id;?>" target="_blank"
 title="Différents Classements et évolutions des Equipes réserves">Plus
d'infos </a></h6>
...
les résultats et les classements d’une poule (résultats,
bonus…). <br>
Renseignement au 06.82.24.70.57<br>
      <br>
      <br>
      </p>
      <br>
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Phliponeau B - Poule 4</h3>
<?php $comite="phpphl";?><?php $CMT="PHL";?><?php $cmt="phl";?><?php $id=34104 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Teulière B - Poule 4</h3>
            <php title="$comite=&quot;phpteu&quot;;"
 xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $comite="phpteu";?></php><php
 title="$CMT=&quot;TEU&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $CMT="TEU";?></php><php
 title="$cmt=&quot;teu&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $cmt="teu";?></php><php
 title="$id=37103 ; $height=400; "
 xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $id=37104 ; $height=400; ?></php><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="515">
        <tbody>
          <tr>
            <td width="219"><?php $id=34104; $CMT="PHL"; ?>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/171.php?id=%3C?php%20echo%20$id%20;?%3E"
 target="_blank"
 title="Différents Classements et évolutions des Equipes unes">Plus
d'infos</a></h6>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/calendrier.php?id=%3C?php%20echo%20$id%20;?%3E"
 target="_blank"
 title="Résultats et calendrier complet de la compétition">Calendrier
complet</a></h6>
            </td>
            <td width="73"> </td>
            <td width="209"><?php $id=37104; $CMT="TEU"; ?>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/171.php?id=%3C?php%20echo%20$id;?%3E"
 target="_blank"
 title="Différents Classements et évolutions des Equipes réserves">Plus
...
<?php include("../pub4.php"); ?><br>
      ...
      <table width="600">
        <tbody>
          <tr>
            <td>
            <h3>Phliponeau B - Poule 5</h3>
<?php $comite="phpphl";?><?php $CMT="PHL";?><?php $cmt="phl";?><?php $id=34105 ; $height=400; ?><?php require ("maquette.php") ; ?>
            </td>
            <td>
            <h3>Teulière B - Poule 5</h3>
            <php title="$comite=&quot;phpteu&quot;;"
 xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $comite="phpteu";?></php><php
 title="$CMT=&quot;TEU&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $CMT="TEU";?></php><php
 title="$cmt=&quot;teu&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $cmt="teu";?></php><php
 title="$id=37103 ; $height=400; "
 xmlns="http://disruptive-innovations.com/zoo/nvu"><?php $id=37105 ; $height=400; ?></php><?php require ("maquette.php") ; ?>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="515">
        <tbody>
          <tr>
            <td width="219"><?php $id=34105; $CMT="PHL"; ?>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/171.php?id=%3C?php%20echo%20$id%20;?%3E"
 target="_blank"
 title="Différents Classements et évolutions des Equipes unes">Plus
...
complet</a></h6>
            ...
            <td width="73"> </td>
            <td width="209"><?php $id=37105; $CMT="TEU"; ?>
            <h6> <a
 href="%3C?php%20echo%20$CMT;?%3E/171.php?id=%3C?php%20echo%20$id;?%3E"
 target="_blank"
 title="Différents Classements et évolutions des Equipes réserves">Plus
      ...
      <table class="tableau1">
        <tbody>
          <tr>
            ...
            <td class="tab3"> <a href="#1">1re
Série</a> </td>
            <td class="tab3"> <a href="#2">2me
Série</a> </td>
          </tr>
          <tr>
            <td class="tab3"> <a href="#3">3me
Série</a> </td>
            <td class="tab3"> <a href="#4">4me
Série </a> </td>
