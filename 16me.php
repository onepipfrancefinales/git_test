...
<table width="1500" border="0" align="left" height="500" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="32" height="13">&nbsp;</td>
    <td rowspan="37" height="271" valign="top"> 
      <?php  
	   //	if ($division==270)
  ...
  <tr> 
    ...
    <td width="32" height="13">&nbsp;</td>
    <td width="19" height="13">&nbsp;</td>
    <td width="190" align="left" height="13"> 
  ...
  <tr> 
    ...
    <td width="43" height="13">&nbsp;</td>
    <td width="22" height="13">&nbsp;</td>
    <td width="207" height="13"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      </strong></i></b></font></td>
    <td width="32" height="13">&nbsp;</td>
    <td width="19" height="13">&nbsp;</td>
    <td width="190" align="left" height="13"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      </strong></i></b></font></td>
    <td width="46" height="13">&nbsp;</td>
    <td width="18" height="13">&nbsp;</td>
    <td width="216" height="13"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      </strong></i></b></font></td>
    <td width="23" height="13">&nbsp;</td>
    <td width="32" height="13">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td rowspan="4" height="38"><img src="../../images/accolade.png" width="8" height="55"> 
    </td>
    <td width="202" height="13">&nbsp;</td>
    <td width="43" height="13">&nbsp;</td>
    <td width="22" height="13">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="207" height="16"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      <?php  echo $L4001; ?>
      </strong></i></b></font></td>
  ...
  <tr> 
    <td width="166" height="4"> 
      <div class="coin5" > 
        <?php	echo $clubA1605;?>
      </div>
    </td>
    <td width="47" height="4"> 
      <div class="coin5" > 
        <?php	echo $A1605; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td width="207" height="2">&nbsp;</td>
    <td width="32" height="2">&nbsp;</td>
    <td width="190" height="2" align="left"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      <?php  echo $L2001; ?>
      </strong></i></b></font></td>
    <td width="46" height="2">&nbsp;</td>
    <td width="18" height="2">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="207" height="2">&nbsp;</td>
    <td width="32" height="2">&nbsp;</td>
    <td width="190" align="left" height="2"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA2001; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td rowspan="4"><img src="../../images/accolade.png" width="9" height="59"> 
    </td>
    <td width="202" height="4">&nbsp;</td>
    <td width="43" height="4">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="202" height="3"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA8005; ?>
      </div>
    </td>
    <td width="43" height="3"> 
      <div class="affichageGA" > 
        <?php	echo $A8005; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td width="207" height="2"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      <?php  echo $L4003; ?>
      </strong></i></b></font></td>
    <td width="32" height="2">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="190" align="left" height="2">&nbsp;</td>
    <td width="46" height="2">&nbsp;</td>
    <td width="216" height="2"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      <?php  echo $L1001; ?>
      </strong></i></b></font></td>
    <td width="23" height="2">&nbsp;</td>
    <td width="32" height="2">&nbsp;</td>
  ...
  <tr> 
    ...
    <td rowspan="4"><img src="../../images/accolade.png" width="8" height="56"> 
    </td>
    <td width="202">&nbsp;</td>
    <td width="43">&nbsp;</td>
    <td width="22">&nbsp;</td>
  ...
  <tr> 
    ...
    <td height="17" rowspan="4"> 
      <div align="center"><font size="5"><b><strong><font size="2" face="Arial, Helvetica, sans-serif"><b><font color="#FF0000" size="5" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong><img src="<?php echo $champLogo;  ?>" width="100" height="100"></strong></i></b></font></strong></font></b></font></strong></b></font></div>
    </td>
    <td height="11">&nbsp;</td>
    <td height="11">&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td width="202" height="4"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA8010; ?>
      </div>
    </td>
    <td width="43" height="4"> 
      <div class="affichageGA" > 
        <?php	echo $A8010; ?>
      </div>
    </td>
    <td width="207" height="4"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      <?php  echo $L4005; ?>
      </strong></i></b></font></td>
    <td width="32" height="4">&nbsp;</td>
  ...
  <tr> 
    ...
    <td height="8" rowspan="3"> 
      <div align="center"><b><font size="5"><b><strong><font size="5" face="Arial, Helvetica, sans-serif"><b><i><strong> 
        <?php echo $champion; ?>
        </strong></i></b></font></strong></b></font></b></div>
    </td>
    <td height="2">&nbsp;</td>
    <td height="2">&nbsp;</td>
  </tr>
  ...
  <tr> 
    ...
    <td width="207" height="4">&nbsp;</td>
    <td width="32" height="4">&nbsp;</td>
    <td width="190" align="left" height="4"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA2003; ?>
      </div>
    </td>
  ...
  <tr> 
    <td width="166" height="14"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA1626; ?>
      </div>
    </td>
    <td width="47" height="14"> 
      <div class="affichageGA" > 
        <?php	echo $A1626; ?>
      </div>
    </td>
    <td width="202" height="14"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA8013; ?>
      </div>
    </td>
  ...
  <tr> 
    ...
    <td width="207" height="3"><font size="2" face="Arial, Helvetica, sans-serif"><b><i><strong> 
      <?php  echo $L4007; ?>
      </strong></i></b></font></td>
    <td width="32" height="3">&nbsp;</td>
  ...
  <tr> 
    <td width="166" height="12"> 
      <div class="affichageEquipe" > 
        <?php	echo $clubA1628; ?>
      </div>
    </td>
    <td width="47" height="12"> 
      <div class="affichageGA" > 
        <?php	echo $A1628; ?>
      </div>
    </td>
