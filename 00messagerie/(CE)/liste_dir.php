...
if ($liste_album) {
	...
	echo "<span class=\"texte\"><table cellpadding=\"0\" cellspacing=\"0\" class=\"tablo\" width=\"100%\">
			...
			if (test_admin()) {
			echo "	<td class=\"tablo-titre\" align=\"center\"><span class=\"texte-titre\"><a class=\"lien-titre\" </a></span></td>
	...
	for ($i=0;$i<$nb;$i++) {
		...
		echo "<tr>";
			...
			echo "	<td colspan=2><img border=\"0\" src=\"images/trans.gif\" width=\"2\" height=\"14\" alt=\"\" /><a class=\"lien\" href=\"?id=1&amp;album=$liste_album[$i]\">$liste_album[$i]</a></td>
					...
					<td align=\"center\"><span class=\"texte\"><a href=\"?id=7&amp;album=$liste_album[$i]\"></a></span></td>";
			}
			else {
