...
require ("connection.php") ;
 ?>
            <?php
$reponse = mysql_query("SELECT nom_1, code FROM bdclubs WHERE   code='$chaine' or nom_1='$chaine' or nom_2='$chaine' or sigle='$chaine' or nom_3='$chaine' or nom_4='$chaine' "); // Requête SQL 
