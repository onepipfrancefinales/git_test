...
<table width="899" border="0" align="center">
  <tr> 
    <td rowspan="5" width="560"> 
      <div align="center"> 
        <?php
mysql_connect("coupedumondexv.free.fr", "coupedumondexv", "Lavelan1969&"); // Connexion � MySQL
mysql_select_db("statspays"); // S�lection de la base onepip
?>
        <?php

$reponse = mysql_query("SELECT * FROM statpays WHERE miniequipe='$sigle' "); // Requ�te SQL
...
<?php
mysql_connect("coupedumondexv.free.fr", "coupedumondexv", "Lavelan1969&"); // Connexion � MySQL
mysql_select_db("bilancdm"); // S�lection de la base onepip
?>
<?php 


 $reponse = mysql_query("SELECT * FROM bilancdm WHERE miniequipe='$sigle' "); // Requ�te SQL
...
<p align="center"><br>
  ...
  <?php
mysql_connect("coupedumondexv.free.fr", "coupedumondexv", "Lavelan1969&"); // Connexion � MySQL
mysql_select_db("rencontresbdcm2"); // S�lection de la base onepip
?>
  <?php 


 $reponse = mysql_query("SELECT * FROM rencontresbdcdm2 WHERE VND='V' and mini_equipe1 ='$sigle'"); // Requ�te SQL
...
<p align="center"><br/>
  ...
  <?php
mysql_connect("coupedumondexv.free.fr", "coupedumondexv", "Lavelan1969&"); // Connexion � MySQL
mysql_select_db("rencpntresbdcm2"); // S�lection de la base onepip
?>
  <?php 


 $reponse = mysql_query("SELECT * FROM rencontresbdcdm2 WHERE VND='N' and mini_equipe1 ='$sigle'"); // Requ�te SQL
...
?>
 ...
 $reponse = mysql_query("SELECT * FROM rencontresbdcdm2 WHERE VND='D' and mini_equipe1 ='$sigle'"); // Requ�te SQL
