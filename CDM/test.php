...
<?php 
 ...
 $reponse = mysql_query("SELECT * FROM bilancdm WHERE miniequipe='NZ' "); // Requ�te SQL
...
?>
 ...
 $reponse = mysql_query("SELECT * FROM rencontresbdcdm2 WHERE VND='V' and mini_equipe1 ='NZ'"); // Requ�te SQL
...
<p align="left"><br/>
  <b><font size="5">Nul : </font></b><br/>
   <?php
mysql_connect("coupedumondexv.free.fr", "coupedumondexv", "Lavelan1969&"); // Connexion � MySQL
mysql_select_db("rencontresbdcdm2"); // S�lection de la base onepip
?>
...
echo $donnees['prix_total'];
 ...
 $reponse = mysql_query("SELECT * FROM rencontresbdcdm2 WHERE VND='D' and mini_equipe1 ='NZ'"); // Requ�te SQL
